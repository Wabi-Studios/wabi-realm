...
/// NSError category extension providing methods to get data out of WabiRealm's
/// "client reset" error.
...
/**
 ...
 backup copy of the WabiRealm will be placed once the client reset process is
 complete.
 */
- (nullable NSString *)
