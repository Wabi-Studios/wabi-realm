...
/**
 ...
 - Note:
 `RLMSet` supports storing primitive and `RLMObject` types. `RLMSet` does not
 support storing Embedded WabiRealm Objects.
 */
...
/**
 The WabiRealm which manages the set. Returns `nil` for unmanaged set.
 */
...
/**
 ...
 @param objects     An enumerable object such as `NSArray`, `NSSet` or
 `RLMResults` which contains objects of the same class as the set.
 */
...
/**
 Removes from the receiving set each object that isn’t a member of another given
 set.
...
/**
 ...
 @return YES if at least one object in the receiving set is also present in
 otherSet, otherwise NO.
 */
- (BOOL)intersectsSet:(RLMSet<RLMObjectType> *)set;

/**
 Returns a Boolean value that indicates whether every object in the receiving
 set is also present in another given set.

 @param set The RLMSet to compare the receiving set to.

 @return YES if every object in the receiving set is also present in otherSet,
 otherwise NO.
 */
- (BOOL)isSubsetOfSet:(RLMSet<RLMObjectType> *)set;

/**
 Returns a Boolean value that indicates whether a given object is present in the
 set.
...
/**
 ...
 @return YES if the contents of otherSet are equal to the contents of the
 receiving set, otherwise NO.
 */
...
- (RLMNotificationToken *)addNotificationBlock:
    (void (^)(RLMSet<RLMObjectType> *_Nullable set,
...
- (RLMNotificationToken *)
    addNotificationBlock:(void (^)(RLMSet<RLMObjectType> *_Nullable set,
                                   RLMCollectionChange *_Nullable changes,
                                   NSError *_Nullable error))block
...
/**
 ...
 @warning You cannot use this method on `RLMObject`,  `RLMArray`,  `RLMSet`, and
 `NSData` properties.
...
/**
 ...
 @warning You cannot use this method on `RLMObject`, `RLMSet`,  `RLMArray`, and
 `NSData` properties.
 ...
 @return    The average value of the given property, or `nil` if the set is
 empty.
 */
...
/**
 ...
 containing WabiRealm. Unlike live sets, frozen sets can be accessed from any
 thread.
 ...
 */
- (instancetype)init
    __attribute__((unavailable("RLMSets cannot be created directly")));
 ...
 */
+ (instancetype)new
    __attribute__((unavailable("RLMSet cannot be created directly")));
