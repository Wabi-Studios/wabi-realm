...
- (void)testPopulateEmptyDictionary {
  ...
  DictionaryPropertyObject *dict =
      [DictionaryPropertyObject createInRealm:realm withValue:@[ @{}, @{} ]];
  XCTAssertNotNil(dict.stringDictionary,
                  @"Should be able to get an empty dictionary");
  XCTAssertEqual(dict.stringDictionary.count, 0U,
                 @"Should start with no dictionary elements");

  StringObject *obj = [[StringObject alloc] init];
  obj.stringCol = @"a";

  dict.stringDictionary[@"one"] = obj;
  dict.stringDictionary[@"two"] = [StringObject createInRealm:realm
                                                    withValue:@[ @"b" ]];
  dict.stringDictionary[@"three"] = obj;

  [realm commitWriteTransaction];

  XCTAssertEqual(dict.stringDictionary.count, 3U,
                 @"Should have three elements in the dictionary");
  XCTAssertEqualObjects([dict.stringDictionary[@"one"] stringCol], @"a",
                        @"First element should have property value 'a'");
  XCTAssertEqualObjects([dict.stringDictionary[@"two"] stringCol], @"b",
                        @"Second element should have property value 'b'");
  XCTAssertEqualObjects([dict.stringDictionary[@"three"] stringCol], @"a",
                        @"Third element should have property value 'a'");

  RLMDictionary *dictionaryProp = dict.stringDictionary;
  RLMAssertThrowsWithReasonMatching(
      [dictionaryProp setObject:obj forKey:@"four"], @"write transaction");

  for (NSString *key in dictionaryProp) {
    XCTAssertTrue(((RLMDictionary *)dictionaryProp[key]).description.length,
                  @"Object should have description");
  }
}
...
- (void)testKeyType {
  ...
  [realm beginWriteTransaction];
  DictionaryPropertyObject *managed =
      [DictionaryPropertyObject createInRealm:realm withValue:@[]];
  [realm commitWriteTransaction];
...
- (void)testModifyDetatchedDictionary {
  ...
  [realm beginWriteTransaction];
  DictionaryPropertyObject *dictObj =
      [DictionaryPropertyObject createInRealm:realm withValue:@[]];
  XCTAssertNotNil(dictObj.stringDictionary,
                  @"Should be able to get an empty dictionary");
  ...
  dict[@"one"] = obj;
  [dict setObject:[StringObject createInRealm:realm withValue:@[ @"b" ]]
           forKey:@"two"];
  [realm commitWriteTransaction];

  XCTAssertEqual(dictObj.stringDictionary.count, 2U,
                 @"Should have two elements in dictionary");
  XCTAssertEqualObjects([dictObj.stringDictionary[@"one"] stringCol], @"a",
                        @"First element should have property value 'a'");
  XCTAssertEqualObjects([dictObj.stringDictionary[@"two"] stringCol], @"b",
                        @"Second element should have property value 'b'");

  RLMAssertThrowsWithReasonMatching([dictObj.stringDictionary setObject:obj
                                                                 forKey:@"one"],
                                    @"write transaction");
}
...
- (void)testDeleteUnmanagedObjectWithDictionaryProperty {
  DictionaryPropertyObject *dictObj =
      [[DictionaryPropertyObject alloc] initWithValue:@[]];
  RLMDictionary *stringDictionary = dictObj.stringDictionary;
  XCTAssertFalse(stringDictionary.isInvalidated,
                 @"stringDictionary should be valid after creation.");
  dictObj = nil;
  XCTAssertFalse(
      stringDictionary.isInvalidated,
      @"stringDictionary should still be valid after parent deletion.");
}
...
- (void)testDeleteObjectWithDictionaryProperty {
  ...
  XCTAssertFalse(dictionary.isInvalidated,
                 @"dictionary should be valid after creation.");
  [realm deleteObject:dictObj];
  XCTAssertTrue(dictionary.isInvalidated,
                @"dictionary should be invalid after parent deletion.");
  [realm commitWriteTransaction];
}
...
- (void)testDeleteObjectInDictionaryProperty {
  ...
  StringObject *obj = [[StringObject alloc] init];
  [realm beginWriteTransaction];
  DictionaryPropertyObject *dictObj = [DictionaryPropertyObject
      createInRealm:realm
          withValue:@{@"stringDictionary" : @{@"one" : obj}}];
  RLMDictionary *stringDictionary = dictObj.stringDictionary;
  StringObject *one = stringDictionary[@"one"];
  [realm deleteObjects:[StringObject allObjectsInRealm:realm]];
  XCTAssertFalse(
      stringDictionary.isInvalidated,
      @"stringDictionary should be valid after member object deletion.");
  XCTAssertTrue(one.isInvalidated,
                @"firstObject should be invalid after deletion.");
  XCTAssertEqual(stringDictionary.count, 1U,
                 @"stringDictionary.count should be one as it holds onto the "
                 @"invalidated object.");
  [realm commitWriteTransaction];
}
...
- (void)testKeyedSubscript {
  ...
  [realm beginWriteTransaction];
  DictionaryPropertyObject *obj = [DictionaryPropertyObject createInRealm:realm
                                                                withValue:@[]];
...
- (void)testRemoveObject {
  ...
  XCTAssertTrue(
      [[obj.stringDictionary[@"three"] stringCol] isEqualToString:@"c"]);
...
- (void)testAddInvalidated {
  ...
  CompanyObject *company =
      [CompanyObject createInDefaultRealmWithValue:@[ @"company", @[] ]];
  EmployeeObject *person = [[EmployeeObject alloc] init];
  person.name = @"Mary";
  [realm addObject:person];
  [realm deleteObjects:[EmployeeObject allObjects]];
  RLMAssertThrowsWithReasonMatching([company.employeeDict setObject:person
                                                             forKey:@"person1"],
                                    @"invalidated");
...
- (void)testAddNil {
  ...
  CompanyObject *company =
      [CompanyObject createInDefaultRealmWithValue:@[ @"company", @[] ]];
  RLMAssertThrowsWithReason([company.employeeDict setObject:self.nonLiteralNil
                                                     forKey:@"blah"],
...
- (void)testUnmanaged {
  ...
  XCTAssertNotNil(dict.stringDictionary,
                  @"RLMDictionary property should get created on access");

  XCTAssertEqual(dict.stringDictionary.allValues.count, 0U,
                 @"No objects added yet");
  XCTAssertEqual(dict.stringDictionary.allKeys.count, 0U,
                 @"No objects added yet");
  ...
  XCTAssertEqualObjects(dict.stringDictionary[@"one"], obj1,
                        @"Objects should be equal");
  XCTAssertEqualObjects(dict.stringDictionary[@"three"], obj3,
                        @"Objects should be equal");
  XCTAssertEqualObjects(dict.stringDictionary.allValues[1], obj2,
                        @"Objects should be equal");
  ...
  XCTAssertTrue([dict.stringDictionary[@"one"] isEqualToObject:obj3],
                @"Objects should be replaced");
  dict.stringDictionary[@"one"] = obj1;
  XCTAssertTrue([obj1 isEqualToObject:dict.stringDictionary[@"one"]],
                @"Objects should be replaced");
  ...
  DictionaryPropertyObject *intDictionary =
      [[DictionaryPropertyObject alloc] init];
  ...
  XCTAssertThrows([intDictionary.intObjDictionary objectsWhere:@"intCol == 1"],
                  @"Should throw on unmanaged RLMDictionary");
  XCTAssertThrows(
      ([intDictionary.intObjDictionary
          objectsWithPredicate:[NSPredicate
                                   predicateWithFormat:@"intCol == %i", 1]]),
      @"Should throw on unmanaged RLMDictionary");
  XCTAssertThrows([intDictionary.intObjDictionary
                      sortedResultsUsingKeyPath:@"intCol"
                                      ascending:YES],
                  @"Should throw on unmanaged RLMDictionary");

  // test unmanaged with literals
  __unused DictionaryPropertyObject *obj =
      [[DictionaryPropertyObject alloc] initWithValue:@[
        @{}, @{}, @{}, @{@"one" : [[IntObject alloc] initWithValue:@[ @1 ]]}
      ]];
}
...
- (void)testUnmanagedComparision {
  ...
  XCTAssertNotNil(dict.stringDictionary,
                  @"RLMDictionary property should get created on access");
  XCTAssertNotNil(dict2.stringDictionary,
                  @"RLMDictionary property should get created on access");
  XCTAssertTrue([dict.stringDictionary isEqual:dict2.stringDictionary],
                @"Empty dictionaries should be equal");
  ...
  XCTAssertFalse([dict.stringDictionary isEqual:dict2.stringDictionary],
  ...
  XCTAssertFalse(
      [dict.stringDictionary isEqual:dict2.stringDictionary],
      @"Comparing a managed dictionary to an unmanaged one should fail");
  XCTAssertFalse(
      [dict2.stringDictionary isEqual:dict.stringDictionary],
      @"Comparing a managed dictionary to an unmanaged one should fail");
}
...
- (void)testDeleteObjectInUnmanagedDictionary {
  ...
  XCTAssertEqualObjects(dict.stringDictionary[@"one"], stringObj1,
                        @"Objects should be equal");
  XCTAssertEqualObjects([dict.stringDictionary objectForKey:@"two"], stringObj2,
                        @"Objects should be equal");
  XCTAssertEqualObjects(dict.stringDictionary[@"three"], stringObj3,
                        @"Objects should be equal");
  XCTAssertEqual(dict.stringDictionary.count, 3U,
                 @"Should have 3 elements in string dictionary");

  XCTAssertEqualObjects(dict.intObjDictionary[@"one"], intObj1,
                        @"Objects should be equal");
  XCTAssertEqualObjects([dict.intObjDictionary objectForKey:@"two"], intObj2,
                        @"Objects should be equal");
  XCTAssertEqualObjects(dict.intObjDictionary[@"three"], intObj3,
                        @"Objects should be equal");
  XCTAssertEqual(dict.intObjDictionary.count, 3U,
                 @"Should have 3 elements in int dictionary");
  ...
  XCTAssertEqualObjects([dict.stringDictionary objectForKey:@"two"], stringObj2,
                        @"Objects should be equal");
  XCTAssertEqual(dict.stringDictionary.count, 2U,
                 @"Should have 2 elements in string dictionary");
  ...
  XCTAssertEqualObjects(dict.stringDictionary[@"one"], stringObj1,
                        @"Objects should be equal");
  XCTAssertEqualObjects([dict.stringDictionary objectForKey:@"one"], stringObj1,
                        @"Objects should be equal");
  XCTAssertEqual(dict.stringDictionary.count, 1U,
                 @"Should have 1 elements in string dictionary");

  [dict.stringDictionary removeAllObjects];

  XCTAssertEqual(dict.stringDictionary.count, 0U,
                 @"Should have 0 elements in string dictionary");

  [dict.intDictionary removeObjectsForKeys:@[ @"one", @"two", @"three" ]];
  XCTAssertEqual(dict.intDictionary.count, 0U,
                 @"Should have 0 elements in int dictionary");
}
...
- (void)testFastEnumeration {
  ...
  [company.employeeDict
      enumerateKeysAndObjectsUsingBlock:^(__unused id _Nonnull key,
  ...
  [company.employeeDict enumerateKeysAndObjectsUsingBlock:^(
                            id _Nonnull key, EmployeeObject *_Nonnull obj,
                            __unused BOOL *_Nonnull stop) {
    XCTAssertEqualObjects([company.employeeDict[key] name], [obj name]);
    XCTAssertEqual(((EmployeeObject *)company.employeeDict[key]).age,
                   [obj age]);
...
- (void)testDeleteDuringEnumeration {
  ...
  for (size_t i = 0; i < totalCount; ++i) {
    ...
    company.employeeDict[key] =
        [EmployeeObject createInRealm:realm withValue:@[ @"name", @(i), @NO ]];
  }
  ...
  [realm beginWriteTransaction];
  [company.employeeDict enumerateKeysAndObjectsUsingBlock:^(
                            __unused id _Nonnull key, __unused id _Nonnull obj,
                            __unused BOOL *_Nonnull stop) {
...
- (void)testValueForKey {
  ...
  EmbeddedIntObject *unmanChild2 =
      [[EmbeddedIntObject alloc] initWithValue:@[ @123 ]];

  [unmanObj.stringDictionary setValue:unmanChild1 forKey:@"one"];
  XCTAssertTrue([[unmanObj.stringDictionary valueForKey:@"one"][@"stringCol"]
      isEqualToString:unmanChild1.stringCol]);

  [unmanObj.embeddedDictionary setValue:unmanChild2 forKey:@"two"];
  XCTAssertEqual([[unmanObj.embeddedDictionary valueForKey:@"two"][@"intCol"]
                     integerValue],
                 unmanChild2.intCol);

  unmanObj.intDictionary[@"one"] = @1;
  XCTAssertEqualObjects([unmanObj.intDictionary valueForKey:@"invalidated"],
                        @NO);
  ...
  DictionaryPropertyObject *obj = [DictionaryPropertyObject createInRealm:realm
                                                                withValue:@[]];
  StringObject *child1 = [StringObject createInRealm:realm withValue:@[ @"a" ]];
  EmbeddedIntObject *child2 =
      [[EmbeddedIntObject alloc] initWithValue:@[ @123 ]];

  [obj.stringDictionary setValue:child1 forKey:@"one"];
  XCTAssertTrue([[obj.stringDictionary valueForKey:@"one"][@"stringCol"]
      isEqualToString:child1.stringCol]);

  [obj.embeddedDictionary setValue:child2 forKey:@"two"];
  XCTAssertEqual(
      [[obj.embeddedDictionary valueForKey:@"two"][@"intCol"] integerValue],
      child2.intCol);
...
- (void)testObjectAggregate {
  ...
  [realm transactionWithBlock:^{
    [AggregateObject createInRealm:realm
                         withValue:@[ @0, @1.2f, @0.0, @YES, dateMinInput ]];
    [AggregateObject createInRealm:realm
                         withValue:@[ @1, @0.0f, @2.5, @NO, dateMaxInput ]];
    [AggregateObject createInRealm:realm
                         withValue:@[ @0, @1.2f, @0.0, @YES, dateMinInput ]];
    [AggregateObject createInRealm:realm
                         withValue:@[ @1, @0.0f, @2.5, @NO, dateMaxInput ]];
    ...
    RLMResults<AggregateObject *> *allObjects =
        [AggregateObject allObjectsInRealm:realm];
  ...
  void (^test)(void) = ^{
    ...
    XCTAssertEqualWithAccuracy(
        [dictionary sumOfProperty:@"floatCol"].floatValue, 7.2f, 0.1f);
    XCTAssertEqualWithAccuracy(
        [dictionary sumOfProperty:@"doubleCol"].doubleValue, 10.0, 0.1f);
    RLMAssertThrowsWithReasonMatching([dictionary sumOfProperty:@"foo"],
                                      @"foo.*AggregateObject");
    RLMAssertThrowsWithReasonMatching([dictionary sumOfProperty:@"boolCol"],
                                      @"sum.*bool");
    RLMAssertThrowsWithReasonMatching([dictionary sumOfProperty:@"dateCol"],
                                      @"sum.*date");

    // Average
    XCTAssertEqualWithAccuracy(
        [dictionary averageOfProperty:@"intCol"].doubleValue, 0.4, 0.1f);
    XCTAssertEqualWithAccuracy(
        [dictionary averageOfProperty:@"floatCol"].doubleValue, 0.72, 0.1f);
    XCTAssertEqualWithAccuracy(
        [dictionary averageOfProperty:@"doubleCol"].doubleValue, 1.0, 0.1f);
    RLMAssertThrowsWithReasonMatching([dictionary averageOfProperty:@"foo"],
                                      @"foo.*AggregateObject");
    RLMAssertThrowsWithReasonMatching([dictionary averageOfProperty:@"boolCol"],
                                      @"average.*bool");
    RLMAssertThrowsWithReasonMatching([dictionary averageOfProperty:@"dateCol"],
                                      @"average.*date");
    ...
    RLMAssertThrowsWithReasonMatching([dictionary minOfProperty:@"foo"],
                                      @"foo.*AggregateObject");
    RLMAssertThrowsWithReasonMatching([dictionary minOfProperty:@"boolCol"],
                                      @"min.*bool");
    ...
    RLMAssertThrowsWithReasonMatching([dictionary maxOfProperty:@"foo"],
                                      @"foo.*AggregateObject");
    RLMAssertThrowsWithReasonMatching([dictionary maxOfProperty:@"boolCol"],
                                      @"max.*bool");
  };
...
- (void)testRenamedPropertyAggregate {
  ...
  [realm transactionWithBlock:^{
    ...
    RLMResults<RenamedProperties1 *> *allObjects =
        [RenamedProperties1 allObjectsInRealm:realm];
    for (NSUInteger i = 0; i < allObjects.count; i++) {
      NSString *key = [NSString stringWithFormat:@"item%lu", (unsigned long)i];
      obj.dictionary[key] = allObjects[i];
    }
...
- (void)testRenamedPropertyObservation {
  ...
  [realm transactionWithBlock:^{
    ...
    RenamedProperties *linkedObject =
        [RenamedProperties createInRealm:realm withValue:@[ @1, @"" ]];
    obj.dictionary[@"item"] = linkedObject;
  }];

  __block bool first = true;
  __block id expectation = [self expectationWithDescription:@""];
  id token = [obj.dictionary
  ...
  [self dispatchAsyncAndWait:^{
    RLMRealm *realm = self.realmWithTestPath;
    [realm transactionWithBlock:^{
      RLMDictionary *dict = [(LinkToRenamedProperties *)[LinkToRenamedProperties
                                 allObjectsInRealm:realm]
...
- (void)testInsertMultiple {
  ...
  [realm beginWriteTransaction];
  DictionaryPropertyObject *obj =
      [DictionaryPropertyObject createInRealm:realm
                                    withValue:@{@"stringDictionary" : @{}}];

  StringObject *child1 = [StringObject createInRealm:realm withValue:@[ @"a" ]];
  StringObject *child2 = [[StringObject alloc] init];
  child2.stringCol = @"b";
  [obj.stringDictionary
      setValuesForKeysWithDictionary:@{@"a" : child1, @"b" : child2}];
  [realm commitWriteTransaction];
...
- (void)testReplaceObjectInUnmanagedDictionary {
  ...
  StringObject *stringObj1 =
      [[StringObject alloc] initWithValue:@{@"stringCol" : @"a"}];
  StringObject *stringObj2 =
      [[StringObject alloc] initWithValue:@{@"stringCol" : @"b"}];
  StringObject *stringObj3 =
      [[StringObject alloc] initWithValue:@{@"stringCol" : @"c"}];
  ...
  XCTAssertEqualObjects(dict.stringDictionary[@"a"], stringObj1,
                        @"Objects should be equal");
  XCTAssertEqualObjects(dict.stringDictionary[@"b"], stringObj2,
                        @"Objects should be equal");
  XCTAssertEqualObjects(dict.stringDictionary[@"c"], stringObj3,
                        @"Objects should be equal");
  XCTAssertEqual(dict.stringDictionary.count, 3U,
                 @"Should have 3 elements in stringDictionary");

  XCTAssertEqualObjects(dict.intObjDictionary[@"a"], intObj1,
                        @"Objects should be equal");
  XCTAssertEqualObjects(dict.intObjDictionary[@"b"], intObj2,
                        @"Objects should be equal");
  XCTAssertEqualObjects(dict.intObjDictionary[@"c"], intObj3,
                        @"Objects should be equal");
  XCTAssertEqual(dict.intObjDictionary.count, 3U,
                 @"Should have 3 elements in intDictionary");

  StringObject *stringObj4 =
      [[StringObject alloc] initWithValue:@{@"stringCol" : @"d"}];

  dict.stringDictionary[@"a"] = stringObj4;

  XCTAssertEqualObjects(dict.stringDictionary[@"a"], stringObj4,
                        @"Objects should be replaced");
  XCTAssertEqual(dict.stringDictionary.count, 3U,
                 @"Should have 3 elements in stringDictionary");
  ...
  RLMAssertThrowsWithReasonMatching([dict.stringDictionary setObject:(id)intObj4
                                                              forKey:@"a"],
                                    @"IntObject.*StringObject");
  RLMAssertThrowsWithReasonMatching(
      [dict.intObjDictionary setObject:(id)stringObj4 forKey:@"a"],
...
- (void)testExchangeObjectForKeyWithObjectForKey {
  ...
  DictionaryPropertyObject *dict =
      [[DictionaryPropertyObject alloc] initWithValue:@{
        @"stringDictionary" : @{
          @"a" : [[StringObject alloc] initWithValue:@{@"stringCol" : @"a"}],
          @"b" : [[StringObject alloc] initWithValue:@{@"stringCol" : @"b"}]
        }
      }];
...
- (void)testObjectForKey {
  ...
  [realm beginWriteTransaction];
  EmployeeObject *po1 = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"Joe", @"age" : @40, @"hired" : @YES}];
  EmployeeObject *po2 = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"John", @"age" : @30, @"hired" : @NO}];
  EmployeeObject *po3 = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"Jill", @"age" : @25, @"hired" : @YES}];
  EmployeeObject *deleted = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"Jill", @"age" : @25, @"hired" : @YES}];
  EmployeeObject *indirectlyDeleted =
      [EmployeeObject allObjectsInRealm:realm].lastObject;
...
- (void)testObjectWhere {
  ...
  [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"Bill", @"age" : @55, @"hired" : @YES}];
  ...
  // test unmanaged
  RLMAssertThrowsWithReasonMatching(
      [company.employeeDict objectsWhere:@"name = 'Jill'"],
  ...
  XCTAssertEqualObjects(
      @"Jill",
      [[company.employeeDict objectsWhere:@"name = 'Jill'"].firstObject name]);
  XCTAssertEqualObjects(
      @"Joe",
      [[company.employeeDict objectsWhere:@"name = 'Joe'"].firstObject name]);
  XCTAssertEqual([company.employeeDict objectsWhere:@"name = 'JoJo'"].count,
                 0U);
  ...
  XCTAssertEqual((NSUInteger)NSNotFound,
                 [results indexOfObjectWhere:@"name = 'John'"]);
  XCTAssertEqual((NSUInteger)NSNotFound,
                 [results indexOfObjectWhere:@"name = 'Jill'"]);
}
...
- (void)testSetValueForKey {
  ...
  RLMAssertThrowsWithReasonMatching(
      ...
      @"Value of type '__NSCFConstantString' does not match RLMDictionary "
      @"value type 'EmployeeObject'.");

  EmployeeObject *e = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"Jane", @"age" : @(1), @"hired" : @YES}];
  [company.employeeDict setValue:e forKey:@"e"];
  XCTAssertEqualObjects(
      ((EmployeeObject *)[company.employeeDict valueForKey:@"e"]).name,
      @"Jane");
  ...
  for (int i = 0; i < 30; ++i) {
    ...
    EmployeeObject *eo = [EmployeeObject
        createInRealm:realm
            withValue:@{@"name" : @"Joe", @"age" : @(i), @"hired" : @YES}];
    company.employeeDict[[NSString stringWithFormat:@"%d", i]] = eo;
  }

  [realm commitWriteTransaction];
  EmployeeObject *o =
      [[EmployeeObject objectsInRealm:realm
                                where:@"name = 'Jane'"] firstObject];
  XCTAssertEqualObjects(
      ((EmployeeObject *)[company.employeeDict valueForKey:@"e"]).name, o.name);
  ...
  for (int i = 0; i < 30; ++i) {
    [ages addObject:@(20)];
    EmployeeObject *eo = [[EmployeeObject alloc]
        initWithValue:@{@"name" : @"Jamie", @"age" : @(i), @"hired" : @YES}];
    company.employeeDict[[NSString stringWithFormat:@"%d", i]] = eo;
  }

  XCTAssertEqualObjects(
      ((EmployeeObject *)[company.employeeDict valueForKey:@"0"]).name,
      @"Jamie");
}
...
- (void)testValueForCollectionOperationKeyPath {
  ...
  [realm beginWriteTransaction];
  EmployeeObject *e1 = [PrimaryEmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"A", @"age" : @20, @"hired" : @YES}];
  EmployeeObject *e2 = [PrimaryEmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"B", @"age" : @30, @"hired" : @NO}];
  EmployeeObject *e3 = [PrimaryEmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"C", @"age" : @40, @"hired" : @YES}];
  EmployeeObject *e4 = [PrimaryEmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"D", @"age" : @50, @"hired" : @YES}];
  PrimaryCompanyObject *c1 = [PrimaryCompanyObject
      createInRealm:realm
          withValue:@{
            @"name" : @"ABC AG",
            @"employeeDict" : @{@"e1" : e1, @"e2" : e2, @"e3" : e3, @"e4" : e2},
            @"employee" : @[],
            @"employeeSet" : @[]
          }];
  PrimaryCompanyObject *c2 =
      [PrimaryCompanyObject createInRealm:realm
                                withValue:@{
                                  @"name" : @"ABC AG 2",
                                  @"employeeDict" : @{@"e1" : e1, @"e4" : e4},
                                  @"employee" : @[],
                                  @"employeeSet" : @[]
                                }];

  ArrayOfPrimaryCompanies *companies =
      [ArrayOfPrimaryCompanies createInRealm:realm withValue:@[ @[ c1, c2 ] ]];
  [realm commitWriteTransaction];
  ...
  XCTAssertEqual([[c1.employeeDict valueForKeyPath:@"@sum.age"] integerValue],
                 120);
  XCTAssertEqualWithAccuracy(
      [[c1.employeeDict valueForKeyPath:@"@avg.age"] doubleValue], 30, 0.1f);

  // collection
  XCTAssertEqualObjects(
      [[c1.employeeDict valueForKeyPath:@"@unionOfObjects.name"]
          sortedArrayUsingSelector:@selector(compare:)],
      ([@[ @"A", @"B", @"C", @"B" ]
          sortedArrayUsingSelector:@selector(compare:)]));
  XCTAssertEqualObjects(
      [[c1.employeeDict valueForKeyPath:@"@distinctUnionOfObjects.name"]
          sortedArrayUsingSelector:@selector(compare:)],
      (@[ @"A", @"B", @"C" ]));
  ...
  XCTAssertEqualObjects(
      [[companies.companies valueForKeyPath:@"@unionOfArrays.employeeDict"]
          sortedArrayUsingComparator:cmp],
      (@[ @"e1", @"e1", @"e2", @"e3", @"e4", @"e4" ]));
  XCTAssertEqualObjects(
      [[companies.companies
          valueForKeyPath:@"@distinctUnionOfArrays.employeeDict"]
          sortedArrayUsingComparator:cmp],
      (@[ @"e1", @"e2", @"e3", @"e4" ]));

  // invalid key paths
  RLMAssertThrowsWithReasonMatching(
      [c1.employeeDict valueForKeyPath:@"@invalid.name"],
      @"Unsupported KVC collection operator found in key path '@invalid.name'");
  RLMAssertThrowsWithReasonMatching(
      [c1.employeeDict valueForKeyPath:@"@sum"],
      @"Missing key path for KVC collection operator sum in key path '@sum'");
  RLMAssertThrowsWithReasonMatching(
      [c1.employeeDict valueForKeyPath:@"@sum."],
      @"Missing key path for KVC collection operator sum in key path '@sum.'");
  RLMAssertThrowsWithReasonMatching(
      [c1.employeeDict valueForKeyPath:@"@sum.employees.@sum.age"],
...
- (void)testCrossThreadAccess {
  ...
  EmployeeObject *eo = [[EmployeeObject alloc]
      initWithValue:@{@"name" : @"Joe", @"age" : @40, @"hired" : @YES}];
...
- (void)testSortByNoColumns {
  ...
  RLMDictionary<NSString *, DogObject *><RLMString, DogObject> *dict =
      [DogDictionaryObject createInDefaultRealmWithValue:@[
...
- (void)testSortByRenamedColumns {
  ...
  LinkToRenamedProperties *obj = [LinkToRenamedProperties createInRealm:realm
                                                              withValue:value];

  XCTAssertEqualObjects([[obj.dictionary sortedResultsUsingKeyPath:@"intCol"
                                                         ascending:YES]
                            valueForKeyPath:@"intCol"],
                        (@[ @1, @2, @3 ]));
  XCTAssertEqualObjects(
      [[obj.dictionary sortedResultsUsingKeyPath:@"intCol"
                                       ascending:NO] valueForKeyPath:@"intCol"],
      (@[ @3, @2, @1 ]));
...
- (void)testDeleteLinksAndObjectsInDictionary {
  RLMRealm *realm = [RLMRealm defaultRealm];
  [realm beginWriteTransaction];
  EmployeeObject *po1 = [EmployeeObject createInRealm:realm
                                            withValue:@[ @"Joe", @40, @YES ]];
  EmployeeObject *po2 = [EmployeeObject createInRealm:realm
                                            withValue:@[ @"John", @30, @NO ]];
  EmployeeObject *po3 = [EmployeeObject createInRealm:realm
                                            withValue:@[ @"Jill", @25, @YES ]];
  ...
  XCTAssertThrowsSpecificNamed([peopleInCompany removeObjectForKey:@"Joe"],
                               NSException, @"RLMException",
                               @"Not allowed in read transaction");
  XCTAssertEqual(peopleInCompany.count, 3U,
                 @"No links should have been deleted");

  [realm beginWriteTransaction];
  XCTAssertNoThrow([peopleInCompany removeObjectForKey:@"John"],
                   @"Should delete link to employee");
  [realm commitWriteTransaction];

  XCTAssertEqual(peopleInCompany.count, 2U,
                 @"link deleted when accessing via links");
  ...
  XCTAssertThrowsSpecificNamed([peopleInCompany removeAllObjects], NSException,
                               @"RLMException",
                               @"Not allowed in read transaction");
  XCTAssertThrowsSpecificNamed(peopleInCompany[@"Joe"] = po2, NSException,
                               @"RLMException",
                               @"Replace not allowed in read transaction");
  XCTAssertThrowsSpecificNamed(peopleInCompany[@"John"] = po2, NSException,
                               @"RLMException",
                               @"Add not allowed in read transaction");

  [realm beginWriteTransaction];
  XCTAssertNoThrow(peopleInCompany[@"Jill"] = nil,
                   @"Should delete value for key");
  ...
  XCTAssertNoThrow([peopleInCompany removeAllObjects],
                   @"Should delete all links");
  XCTAssertEqual(peopleInCompany.count, 0U, @"0 remaining links");
  [realm commitWriteTransaction];

  RLMResults *allPeople = [EmployeeObject allObjects];
  XCTAssertEqual(allPeople.count, 3U,
                 @"Only links should have been deleted, not the employees");
}
...
- (void)testDictionaryDescription {
  ...
  [realm beginWriteTransaction];
  RLMDictionary<NSString *, EmployeeObject *>
      <RLMString, EmployeeObject> *employees =
          [CompanyObject createInDefaultRealmWithValue:@[ @"company" ]]
              .employeeDict;
  RLMDictionary<NSString *, NSNumber *><RLMString, RLMInt> *ints =
      [AllPrimitiveDictionaries createInDefaultRealmWithValue:@[]].intObj;
...
- (void)testAssignIncorrectType {
  RLMRealm *realm = self.realmWithTestPath;
  [realm beginWriteTransaction];
  DictionaryPropertyObject *dict = [DictionaryPropertyObject
      createInRealm:realm
          withValue:@{
            @"stringDictionary" :
                @{@"a" : [[StringObject alloc] initWithValue:@[ @"a" ]]}
          }];

  RLMAssertThrowsWithReason(dict.intObjDictionary = (id)dict.stringDictionary,
                            @"RLMDictionary<string, StringObject?> does not "
                            @"match expected type 'IntObject?' for property "
                            @"'DictionaryPropertyObject.intObjDictionary'.");
  RLMAssertThrowsWithReason(dict[@"intObjDictionary"] =
...
- (void)testNotificationSentInitially {
  ...
  id token = [dict.stringDictionary
      addNotificationBlock:^(RLMDictionary *dictionary,
                             RLMDictionaryChange *change, NSError *error) {
        XCTAssertNotNil(dictionary);
        XCTAssertNil(change);
...
- (void)testNotificationSentAfterCommit {
  ...
  [self dispatchAsyncAndWait:^{
    ...
    [realm transactionWithBlock:^{
      RLMDictionary *dict =
          [(DictionaryPropertyObject *)[DictionaryPropertyObject
               allObjectsInRealm:realm]
                  .firstObject stringDictionary];
...
- (void)testAllMethodsCheckThread {
  ...
  [self dispatchAsyncAndWait:^{
    ...
    RLMAssertThrowsWithReasonMatching([dict setObject:io forKey:@"thread"],
                                      @"thread");
    RLMAssertThrowsWithReasonMatching([dict removeObjectForKey:@"thread"],
                                      @"thread");
    RLMAssertThrowsWithReasonMatching([dict setObject:nil forKey:@"thread"],
                                      @"thread");
    RLMAssertThrowsWithReasonMatching([dict removeAllObjects], @"thread");

    RLMAssertThrowsWithReasonMatching([dict objectsWhere:@"intCol = 0"],
                                      @"thread");
    RLMAssertThrowsWithReasonMatching(
        [dict objectsWithPredicate:[NSPredicate
                                       predicateWithFormat:@"intCol = 0"]],
        @"thread");
    RLMAssertThrowsWithReasonMatching(
        [dict sortedResultsUsingKeyPath:@"intCol" ascending:YES], @"thread");
    RLMAssertThrowsWithReasonMatching(
        [dict sortedResultsUsingDescriptors:@[
          [RLMSortDescriptor sortDescriptorWithKeyPath:@"intCol" ascending:YES]
        ]],
        @"thread");
...
- (void)testAllMethodsCheckForInvalidation {
  RLMDictionary<NSString *, IntObject *><RLMString, IntObject> *dictionary =
      managedTestDictionary();
  ...
  XCTAssertNoThrow([dictionary
      objectsWithPredicate:[NSPredicate predicateWithFormat:@"intCol = 0"]]);
  XCTAssertNoThrow([dictionary sortedResultsUsingKeyPath:@"intCol"
                                               ascending:YES]);
  ...
  RLMAssertThrowsWithReasonMatching([dictionary setObject:io forKey:@"another"],
                                    @"invalidated");
  RLMAssertThrowsWithReasonMatching(dictionary[@"new"] = nil, @"invalidated");
  RLMAssertThrowsWithReasonMatching([dictionary removeObjectForKey:@"another"],
                                    @"invalidated");

  RLMAssertThrowsWithReasonMatching([dictionary objectsWhere:@"intCol = 0"],
                                    @"invalidated");
  RLMAssertThrowsWithReasonMatching(
      [dictionary
          objectsWithPredicate:[NSPredicate predicateWithFormat:@"intCol = 0"]],
      @"invalidated");
  RLMAssertThrowsWithReasonMatching(
      [dictionary sortedResultsUsingKeyPath:@"intCol" ascending:YES],
      @"invalidated");
  RLMAssertThrowsWithReasonMatching(
  ...
  RLMAssertThrowsWithReasonMatching([dictionary setValue:io forKey:@"foo"],
                                    @"invalidated");
  RLMAssertThrowsWithReasonMatching(({
                                      for (__unused id obj in dictionary)
                                        ;
...
- (void)testMutatingMethodsCheckForWriteTransaction {
  ...
  XCTAssertNoThrow([dict sortedResultsUsingDescriptors:@[
    [RLMSortDescriptor sortDescriptorWithKeyPath:@"intCol" ascending:YES]
  ]]);
  ...
  RLMAssertThrowsWithReasonMatching([dict setObject:nil forKey:@"thread"],
                                    @"write transaction");
  RLMAssertThrowsWithReasonMatching([dict removeAllObjects],
                                    @"write transaction");

  RLMAssertThrowsWithReasonMatching(dict[@"0"] = io, @"write transaction");
  RLMAssertThrowsWithReasonMatching([dict setValue:io forKey:@"intCol"],
                                    @"write transaction");
}
...
- (void)testFreezeFromWrongThread {
  ...
  [self dispatchAsyncAndWait:^{
    RLMAssertThrowsWithReason([dict freeze],
                              @"WabiRealm accessed from incorrect thread");
  }];
}
...
- (void)testObserveFrozenDictionary {
  ...
  RLMAssertThrowsWithReason(
      [frozen addNotificationBlock:block],
...
- (void)testQueryFrozenDictionary {
  RLMDictionary *frozen = [managedTestDictionary() freeze];
  XCTAssertEqualObjects(
      [[frozen objectsWhere:@"intCol > 0"] valueForKey:@"intCol"], (@[ @1 ]));
}
...
- (void)testAddEntriesFromDictionaryUnmanaged {
  RLMDictionary<NSString *, StringObject *> *dict =
      [[DictionaryPropertyObject alloc] init].stringDictionary;
  RLMAssertThrowsWithReasonMatching(
      [dict addEntriesFromDictionary:@[ @"string" ]],
      @"Cannot add entries from object of class '.*Array.*'");
  RLMAssertThrowsWithReason(
      [dict addEntriesFromDictionary:@{@"" : [[IntObject alloc] init]}],
      @"Value of type 'IntObject' does not match RLMDictionary value type "
      @"'StringObject'.");
  RLMAssertThrowsWithReason(
      [dict addEntriesFromDictionary:@{@1 : [[StringObject alloc] init]}],
      @"Invalid key '1' of type '" RLMConstantInt
  ...
  [dict addEntriesFromDictionary:@{
    @"a" : [[StringObject alloc] initWithValue:@[ @"1" ]],
  ...
  [dict addEntriesFromDictionary:@{
    @"a" : [[StringObject alloc] initWithValue:@[ @"3" ]],
  ...
  RLMDictionary<NSString *, StringObject *> *dict2 =
      [[DictionaryPropertyObject alloc] init].stringDictionary;
...
- (void)testAddEntriesFromDictionaryManaged {
  ...
  RLMAssertThrowsWithReasonMatching(
      ...
      @"Cannot add entries from object of class '.*Array.*'");
  RLMAssertThrowsWithReason(
      [dict addEntriesFromDictionary:@{@"" : [[StringObject alloc] init]}],
      @"Value of type 'StringObject' does not match RLMDictionary value type "
      @"'IntObject'.");
  RLMAssertThrowsWithReason(
      [dict addEntriesFromDictionary:@{@1 : [[IntObject alloc] init]}],
      @"Invalid key '1' of type '" RLMConstantInt
       "' for expected type 'string'.");
  ...
  // Add into empty adds those entries
  [dict addEntriesFromDictionary:@{
    @"a" : [[IntObject alloc] initWithValue:@[ @1 ]],
  ...
  // Duplicate keys overwrite the old values and leave any non-duplicates
  [dict addEntriesFromDictionary:@{
    @"a" : [[IntObject alloc] initWithValue:@[ @3 ]],
  ...
  // Add from a RLMDictionary rather than a NSDictionary
  RLMDictionary<NSString *, IntObject *> *dict2 =
      [[DictionaryPropertyObject alloc] init].intObjDictionary;
...
- (void)testSetDictionaryUnmanaged {
  RLMDictionary<NSString *, StringObject *> *dict =
      [[DictionaryPropertyObject alloc] init].stringDictionary;
  RLMAssertThrowsWithReasonMatching(
      [dict setDictionary:@[ @"string" ]],
      @"Cannot set dictionary to object of class '.*Array.*'");
  RLMAssertThrowsWithReason(
      [dict setDictionary:@{@"" : [[IntObject alloc] init]}],
      @"Value of type 'IntObject' does not match RLMDictionary value type "
      @"'StringObject'.");
  RLMAssertThrowsWithReason(
      [dict setDictionary:@{@1 : [[StringObject alloc] init]}],
      @"Invalid key '1' of type '" RLMConstantInt
       "' for expected type 'string'.");
...
- (void)testSetDictionaryManaged {
  ...
  RLMAssertThrowsWithReasonMatching(
      ...
      @"Cannot set dictionary to object of class '.*Array.*'");
  RLMAssertThrowsWithReason(
      [dict setDictionary:@{@"" : [[StringObject alloc] init]}],
      @"Value of type 'StringObject' does not match RLMDictionary value type "
      @"'IntObject'.");
  RLMAssertThrowsWithReason(
      [dict setDictionary:@{@1 : [[IntObject alloc] init]}],
      @"Invalid key '1' of type '" RLMConstantInt
       "' for expected type 'string'.");
...
- (void)testInitWithNullLink {
  id value = @{
    @"stringDictionary" : @{@"1" : NSNull.null},
  ...
  DictionaryPropertyObject *obj =
      [[DictionaryPropertyObject alloc] initWithValue:value];
