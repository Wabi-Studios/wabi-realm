...
- (void)setUp {
  ...
  [self initValues];
  [allMixed addObjects:@[
    unmanaged.boolVal,   unmanaged.intVal,     unmanaged.floatVal,
    unmanaged.doubleVal, unmanaged.stringVal,  unmanaged.dataVal,
    unmanaged.dateVal,   unmanaged.decimalVal, unmanaged.objectIdVal,
    unmanaged.uuidVal,   managed.boolVal,      managed.intVal,
    managed.floatVal,    managed.doubleVal,    managed.stringVal,
    managed.dataVal,     managed.dateVal,      managed.decimalVal,
    managed.objectIdVal, managed.uuidVal,
  ]];
}
...
- (void)initValues {
  ...
  XCTAssert([(NSUUID *)unmanaged.uuidVal
      isEqual:uuid(@"00000000-0000-0000-0000-000000000000")]);
  ...
  XCTAssert([(NSUUID *)managed.uuidVal
      isEqual:uuid(@"00000000-0000-0000-0000-000000000000")]);
}
...
- (void)testInitNull {
  ...
  AllPrimitiveRLMValues *man = [AllPrimitiveRLMValues createInRealm:realm
                                                          withValue:@[]];
  ...
  XCTAssertNil(unman.floatVal,
               @"RLMValue should be able to initialize as null");
  XCTAssertNil(unman.doubleVal,
               @"RLMValue should be able to initialize as null");
  XCTAssertNil(unman.stringVal,
               @"RLMValue should be able to initialize as null");
  ...
  XCTAssertNil(unman.decimalVal,
               @"RLMValue should be able to initialize as null");
  XCTAssertNil(unman.objectIdVal,
               @"RLMValue should be able to initialize as null");
  ...
  XCTAssertNil(man.decimalVal,
               @"RLMValue should be able to initialize as null");
  XCTAssertNil(man.objectIdVal,
               @"RLMValue should be able to initialize as null");
...
- (void)testUpdateDecimal {
  ...
  XCTAssertEqual(unmanaged.objectIdVal.rlm_valueType,
                 RLMPropertyTypeDecimal128);
...
- (void)testUpdateUuidType {
  ...
  XCTAssert([(NSUUID *)unmanaged.boolVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)unmanaged.intVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)unmanaged.floatVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)unmanaged.doubleVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)unmanaged.stringVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)unmanaged.dataVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)unmanaged.dateVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)unmanaged.decimalVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)unmanaged.objectIdVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)unmanaged.uuidVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)managed.boolVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)managed.intVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)managed.floatVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)managed.doubleVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)managed.stringVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)managed.dataVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)managed.dateVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)managed.decimalVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)managed.objectIdVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  XCTAssert([(NSUUID *)managed.uuidVal
      isEqual:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
