...
- (void)testFastEnumeration {
  ...
  for (int i = 0; i < 18; ++i) {
    [AggregateObject createInRealm:realm
                         withValue:@[ @10, @1.2f, @0.0, @YES, NSDate.date ]];
  }
  [realm commitWriteTransaction];

  RLMResults *result = [AggregateObject objectsInRealm:realm
                                                 where:@"intCol < %i", 100];
...
- (void)testFirst {
  ...
  XCTAssertEqual(10,
                 [[IntObject objectsWhere:@"intCol > 5"].firstObject intCol]);
  XCTAssertEqual(20,
                 [[IntObject objectsWhere:@"intCol > 10"].firstObject intCol]);
}
...
- (void)testLast {
  ...
  XCTAssertEqual(10,
                 [[IntObject objectsWhere:@"intCol > 5"].lastObject intCol]);
  XCTAssertEqual(20,
                 [[IntObject objectsWhere:@"intCol > 10"].lastObject intCol]);
}

- (void)testSubscript {
  RLMAssertThrowsWithReasonMatching([IntObject allObjects][0],
                                    @"0.*less than 0");
  RLMAssertThrowsWithReasonMatching([IntObject objectsWhere:@"intCol > 5"][0],
                                    @"0.*less than 0");
  ...
  RLMAssertThrowsWithReasonMatching([IntObject allObjects][2],
                                    @"2.*less than 2");
  RLMAssertThrowsWithReasonMatching([IntObject objectsWhere:@"intCol > 5"][2],
                                    @"2.*less than 2");
}
...
- (void)testObjectsAtIndexes {
  ...
  XCTAssertEqual([[[IntObject allObjects] objectsAtIndexes:indexSet][0] intCol],
                 10);
  XCTAssertEqual([[[IntObject allObjects] objectsAtIndexes:indexSet][1] intCol],
                 20);
...
- (void)testValueForKey {
  ...
  XCTAssertEqualObjects(
      [[AggregateObject allObjectsInRealm:realm] valueForKey:@"intCol"], @[]);
  ...
  XCTAssertEqualObjects(
      [[AggregateObject allObjectsInRealm:realm] valueForKey:@"intCol"],
      (@[ @0, @1, @0, @1, @0, @1, @0, @1, @0, @0 ]));
  XCTAssertTrue([[[[AggregateObject allObjectsInRealm:realm]
      valueForKey:@"self"] firstObject]
      isEqualToObject:[AggregateObject allObjectsInRealm:realm].firstObject]);
  XCTAssertTrue([[[[AggregateObject allObjectsInRealm:realm]
      valueForKey:@"self"] lastObject]
      isEqualToObject:[AggregateObject allObjectsInRealm:realm].lastObject]);

  XCTAssertEqualObjects(
      [[AggregateObject objectsInRealm:realm
                                 where:@"intCol != 1"] valueForKey:@"intCol"],
      (@[ @0, @0, @0, @0, @0, @0 ]));
  XCTAssertTrue([[[[AggregateObject objectsInRealm:realm where:@"intCol != 1"]
      valueForKey:@"self"] firstObject]
      isEqualToObject:[AggregateObject objectsInRealm:realm
                                                where:@"intCol != 1"]
                          .firstObject]);
  XCTAssertTrue([[[[AggregateObject objectsInRealm:realm where:@"intCol != 1"]
      valueForKey:@"self"] lastObject]
  ...
  XCTAssertThrows(
      [[AggregateObject allObjectsInRealm:realm] valueForKey:@"invalid"]);
}
...
- (void)testSetValueForKey {
  ...
  [[AggregateObject objectsInRealm:realm
                             where:@"floatCol > 1"] setValue:@10
                                                      forKey:@"intCol"];
  XCTAssertEqualObjects(
      [[AggregateObject objectsInRealm:realm
                                 where:@"floatCol > 1"] valueForKey:@"intCol"],
      (@[ @10, @10, @10, @10, @10, @10 ]));
...
- (void)testObjectAggregate {
  ...
  [AggregateObject
      createInRealm:realm
          withValue:@[ @0, @1.2f, @0.0, @YES, dateMinInput, @0.0 ]];
  [AggregateObject createInRealm:realm
                       withValue:@[ @1, @0.0f, @2.5, @NO, dateMaxInput, @2.5 ]];
  [AggregateObject
      createInRealm:realm
          withValue:@[ @0, @1.2f, @0.0, @YES, dateMinInput, @0.0 ]];
  [AggregateObject createInRealm:realm
  ...
  // Test float sum
  XCTAssertEqualWithAccuracy([noArray sumOfProperty:@"floatCol"].floatValue,
                             0.0f, 0.1f);
  XCTAssertEqualWithAccuracy([yesArray sumOfProperty:@"floatCol"].floatValue,
                             7.2f, 0.1f);
  XCTAssertEqualWithAccuracy([allArray sumOfProperty:@"floatCol"].floatValue,
                             7.2f, 0.1f);

  // Test double sum
  XCTAssertEqualWithAccuracy([noArray sumOfProperty:@"doubleCol"].doubleValue,
                             10.0, 0.1f);
  XCTAssertEqualWithAccuracy([yesArray sumOfProperty:@"doubleCol"].doubleValue,
                             0.0, 0.1f);
  XCTAssertEqualWithAccuracy([allArray sumOfProperty:@"doubleCol"].doubleValue,
                             10.0, 0.1f);

  // Test RLMValue sum
  XCTAssertEqualWithAccuracy([noArray sumOfProperty:@"anyCol"].doubleValue,
                             10.0, 0.1f);
  XCTAssertEqualWithAccuracy([yesArray sumOfProperty:@"anyCol"].doubleValue,
                             0.0, 0.1f);
  XCTAssertEqualWithAccuracy([allArray sumOfProperty:@"anyCol"].doubleValue,
                             10.0, 0.1f);

  // Test invalid column name
  RLMAssertThrowsWithReasonMatching([yesArray sumOfProperty:@"foo"],
                                    @"foo.*AggregateObject");
  RLMAssertThrowsWithReasonMatching([allArray sumOfProperty:@"foo"],
                                    @"foo.*AggregateObject");

  // Test operation not supported
  RLMAssertThrowsWithReasonMatching([yesArray sumOfProperty:@"boolCol"],
                                    @"sum.*bool");
  RLMAssertThrowsWithReasonMatching([allArray sumOfProperty:@"boolCol"],
                                    @"sum.*bool");

  // Average ::::::::::::::::::::::::::::::::::::::::::::::
  // Test int average
  XCTAssertEqualWithAccuracy([noArray averageOfProperty:@"intCol"].doubleValue,
                             1.0, 0.1f);
  XCTAssertEqualWithAccuracy([yesArray averageOfProperty:@"intCol"].doubleValue,
                             0.0, 0.1f);
  XCTAssertEqualWithAccuracy([allArray averageOfProperty:@"intCol"].doubleValue,
                             0.4, 0.1f);

  // Test float average
  XCTAssertEqualWithAccuracy(
      [noArray averageOfProperty:@"floatCol"].doubleValue, 0.0, 0.1f);
  XCTAssertEqualWithAccuracy(
      [yesArray averageOfProperty:@"floatCol"].doubleValue, 1.2, 0.1f);
  XCTAssertEqualWithAccuracy(
      [allArray averageOfProperty:@"floatCol"].doubleValue, 0.72, 0.1f);

  // Test double average
  XCTAssertEqualWithAccuracy(
      [noArray averageOfProperty:@"doubleCol"].doubleValue, 2.5, 0.1f);
  XCTAssertEqualWithAccuracy(
      [yesArray averageOfProperty:@"doubleCol"].doubleValue, 0.0, 0.1f);
  XCTAssertEqualWithAccuracy(
      [allArray averageOfProperty:@"doubleCol"].doubleValue, 1.0, 0.1f);

  // Test RLMValue average
  XCTAssertEqualWithAccuracy([noArray averageOfProperty:@"anyCol"].doubleValue,
                             2.5, 0.1f);
  XCTAssertEqualWithAccuracy([yesArray averageOfProperty:@"anyCol"].doubleValue,
                             0.0, 0.1f);
  XCTAssertEqualWithAccuracy([allArray averageOfProperty:@"anyCol"].doubleValue,
                             1.0, 0.1f);

  // Test invalid column name
  RLMAssertThrowsWithReasonMatching([yesArray averageOfProperty:@"foo"],
                                    @"foo.*AggregateObject");
  RLMAssertThrowsWithReasonMatching([allArray averageOfProperty:@"foo"],
                                    @"foo.*AggregateObject");

  // Test operation not supported
  RLMAssertThrowsWithReasonMatching([yesArray averageOfProperty:@"boolCol"],
                                    @"average.*bool");
  RLMAssertThrowsWithReasonMatching([allArray averageOfProperty:@"boolCol"],
                                    @"average.*bool");
  ...
  // Test invalid column name
  RLMAssertThrowsWithReasonMatching([yesArray minOfProperty:@"foo"],
                                    @"foo.*AggregateObject");
  RLMAssertThrowsWithReasonMatching([allArray minOfProperty:@"foo"],
                                    @"foo.*AggregateObject");

  // Test operation not supported
  RLMAssertThrowsWithReasonMatching([yesArray minOfProperty:@"boolCol"],
                                    @"min.*bool");
  RLMAssertThrowsWithReasonMatching([allArray minOfProperty:@"boolCol"],
                                    @"min.*bool");
  ...
  // Test invalid column name
  RLMAssertThrowsWithReasonMatching([yesArray maxOfProperty:@"foo"],
                                    @"foo.*AggregateObject");
  RLMAssertThrowsWithReasonMatching([allArray maxOfProperty:@"foo"],
                                    @"foo.*AggregateObject");

  // Test operation not supported
  RLMAssertThrowsWithReasonMatching([yesArray maxOfProperty:@"boolCol"],
                                    @"max.*bool");
  RLMAssertThrowsWithReasonMatching([allArray maxOfProperty:@"boolCol"],
                                    @"max.*bool");
}
...
- (void)testRenamedPropertyObservation {
  ...
  RLMResults<LinkToRenamedProperties *> *allObjects =
      [LinkToRenamedProperties allObjectsInRealm:realm];
  id token = [allObjects
      addNotificationBlock:^(__unused RLMResults *results,
  ...
  [self dispatchAsyncAndWait:^{
    RLMRealm *realm = self.realmWithTestPath;
    [realm transactionWithBlock:^{
      LinkToRenamedProperties *object =
...
- (void)testValueForCollectionOperationKeyPath {
  ...
  [realm beginWriteTransaction];
  EmployeeObject *c1e1 = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"Joe", @"age" : @40, @"hired" : @YES}];
  EmployeeObject *c1e2 = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"John", @"age" : @30, @"hired" : @NO}];
  EmployeeObject *c1e3 = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"Jill", @"age" : @25, @"hired" : @YES}];
  [CompanyObject createInRealm:realm
                     withValue:@{
                       @"name" : @"InspiringNames LLC",
                       @"employees" : @[ c1e1, c1e2, c1e3 ],
                       @"employeeSet" : @[ c1e1, c1e2, c1e3 ]
                     }];

  EmployeeObject *c2e1 = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"A", @"age" : @20, @"hired" : @YES}];
  EmployeeObject *c2e2 = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"B", @"age" : @30, @"hired" : @NO}];
  EmployeeObject *c2e3 = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"C", @"age" : @40, @"hired" : @YES}];
  [CompanyObject createInRealm:realm
                     withValue:@{
                       @"name" : @"ABC AG",
                       @"employees" : @[ c2e1, c2e2, c2e3 ],
                       @"employeeSet" : @[ c2e1, c2e2, c2e3 ]
                     }];

  EmployeeObject *c3e1 = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"A", @"age" : @21, @"hired" : @YES}];
  [CompanyObject createInRealm:realm
                     withValue:@{
                       @"name" : @"ABC AG",
                       @"employees" : @[ c3e1 ],
  ...
  XCTAssertEqual([[allEmployees valueForKeyPath:@"@sum.age"] integerValue],
                 206);
  XCTAssertEqualWithAccuracy(
      [[allEmployees valueForKeyPath:@"@avg.age"] doubleValue], 29.43, 0.1f);

  // collection
  XCTAssertEqualObjects([allCompanies valueForKeyPath:@"@unionOfObjects.name"],
                        (@[ @"InspiringNames LLC", @"ABC AG", @"ABC AG" ]));
  XCTAssertEqualObjects(
      [allCompanies valueForKeyPath:@"@distinctUnionOfObjects.name"],
      (@[ @"ABC AG", @"InspiringNames LLC" ]));
  XCTAssertEqualObjects(
      [allCompanies valueForKeyPath:@"employees.@unionOfArrays.name"],
      (@[ @"Joe", @"John", @"Jill", @"A", @"B", @"C", @"A" ]));
  XCTAssertEqualObjects(
      [[allCompanies valueForKeyPath:@"employees.@distinctUnionOfArrays.name"]
          sortedArrayUsingSelector:@selector(compare:)],
      (@[ @"A", @"B", @"C", @"Jill", @"Joe", @"John" ]));

  // invalid key paths
  RLMAssertThrowsWithReasonMatching(
      [allCompanies valueForKeyPath:@"@invalid.name"],
      @"Unsupported KVC collection operator found in key path '@invalid.name'");
  RLMAssertThrowsWithReasonMatching(
      [allCompanies valueForKeyPath:@"@sum"],
      @"Missing key path for KVC collection operator sum in key path '@sum'");
  RLMAssertThrowsWithReasonMatching(
      [allCompanies valueForKeyPath:@"@sum."],
      @"Missing key path for KVC collection operator sum in key path '@sum.'");
  RLMAssertThrowsWithReasonMatching(
      [allCompanies valueForKeyPath:@"@sum.employees.@sum.age"],
...
- (void)testArrayDescription {
  ...
  XCTAssertTrue([description rangeOfString:@"912 objects skipped"].location !=
                NSNotFound);
}
...
- (void)testIndexOfObject {
  ...
  StringObject *deletedObject = [StringObject createInRealm:realm
                                                  withValue:@[ @"" ]];
  ...
  RLMAssertThrowsWithReasonMatching([results indexOfObject:so],
                                    @"StringObject.*EmployeeObject");
  RLMAssertThrowsWithReasonMatching([results indexOfObject:deletedObject],
  ...
  results = [[EmployeeObject objectsWhere:@"hired = YES"]
...
- (void)testIndexOfObjectWhere {
  ...
  [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"Phil", @"age" : @38, @"hired" : @NO}];
  [realm commitWriteTransaction];
  ...
  XCTAssertEqual((NSUInteger)NSNotFound,
                 ([results indexOfObjectWhere:@"age = %d", 30]));
  ...
  XCTAssertEqual((NSUInteger)NSNotFound,
                 ([results indexOfObjectWhere:@"age = %d", 35]));

  results = [[EmployeeObject allObjects] sortedResultsUsingKeyPath:@"age"
                                                         ascending:YES];
...
- (void)testSubqueryLifetime {
  ...
  [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"Jill", @"age" : @50, @"hired" : @YES}];
  [realm commitWriteTransaction];

  RLMResults<EmployeeObject *> *subarray = nil;
  {
    __attribute((objc_precise_lifetime)) RLMResults *results =
        [EmployeeObject objectsWhere:@"hired = YES"];
...
- (void)testMultiSortLifetime {
  ...
  {
    __attribute((objc_precise_lifetime)) RLMResults *results =
        [[EmployeeObject allObjects] sortedResultsUsingKeyPath:@"age"
                                                     ascending:YES];
...
- (void)testSortingExistingQuery {
  ...
  RLMResults *sortedAge =
      [[EmployeeObject allObjects] sortedResultsUsingKeyPath:@"age"
                                                   ascending:YES];
  RLMResults *sortedName = [sortedAge sortedResultsUsingKeyPath:@"name"
                                                      ascending:NO];
...
- (void)testQueryMemoryUsage {
  ...
  for (int i = 0; i < 10000; ++i) {
    @autoreleasepool {
      RLMResults *matches = [StringObject objectsInRealm:realm
                                           withPredicate:pred];
...
- (void)testDeleteAllObjects {
  ...
  RLMResults *results = [StringObject objectsInRealm:realm
                                               where:@"stringCol = 'name1'"];
  RLMAssertThrowsWithReasonMatching([realm deleteObjects:results],
                                    @"write transaction");
  [realm beginWriteTransaction];
...
- (void)testEnumerateAndMutateQueryCondition {
  ...
  XCTAssertEqual(0U,
                 [IntObject objectsInRealm:realm where:@"intCol = 0"].count);
  XCTAssertEqual(count, enumeratedCount);
...
- (void)testCallInvalidateDuringEnumeration {
  ...
  int enumeratedCount = 0;
  @try {
    for (__unused IntObject *io in [IntObject objectsInRealm:realm
                                                       where:@"intCol = 0"]) {
      ++enumeratedCount;
      [realm invalidate];
    }
...
- (void)testBeginWriteTransactionDuringEnumeration {
  ...
  XCTAssertEqual(40U,
                 [IntObject objectsInRealm:realm where:@"intCol = 1"].count);
}
...
- (void)testAllMethodsCheckThread {
  ...
  XCTAssertNoThrow([results sortedResultsUsingDescriptors:@[
  ...
  [self dispatchAsyncAndWait:^{
    ...
    XCTAssertThrows([results
        indexOfObjectWithPredicate:[NSPredicate
                                       predicateWithFormat:@"intCol = 0"]]);
    XCTAssertThrows([results objectsWhere:@"intCol = 0"]);
    XCTAssertThrows([results
        objectsWithPredicate:[NSPredicate predicateWithFormat:@"intCol = 0"]]);
    XCTAssertThrows([results sortedResultsUsingKeyPath:@"intCol"
                                             ascending:YES]);
    XCTAssertThrows([results sortedResultsUsingDescriptors:@[
      [RLMSortDescriptor sortDescriptorWithKeyPath:@"intCol" ascending:YES]
    ]]);
...
- (void)testResultsDependingOnDeletedLinkView {
  ...
  [realm transactionWithBlock:^{
    ...
    arrayObject = [IntegerArrayPropertyObject
        createInDefaultRealmWithValue:@[ @0, @[ intObject ] ]];
    setObject = [IntegerSetPropertyObject
        createInDefaultRealmWithValue:@[ @0, @[ intObject ] ]];
  }];

  RLMResults *arrayResults =
      [arrayObject.array sortedResultsUsingKeyPath:@"intCol" ascending:YES];
  [arrayResults firstObject];

  RLMResults *unevaluatedResults =
      [arrayObject.array sortedResultsUsingKeyPath:@"intCol" ascending:YES];
  ...
  RLMResults *setResults = [setObject.set sortedResultsUsingKeyPath:@"intCol"
                                                          ascending:YES];
  [setResults firstObject];

  RLMResults *unevaluatedResults2 =
      [setObject.set sortedResultsUsingKeyPath:@"intCol" ascending:YES];
...
- (void)testResultsDependingOnDeletedTableView {
  ...
  RLMResults *unevaluatedResults =
      [dog.owners objectsWhere:@"name != 'Not a real name'"];
...
- (void)testResultsDependingOnLinkingObjects {
  ...
  id token = [results addNotificationBlock:^(__unused RLMResults *results,
                                             RLMCollectionChange *change,
                                             __unused NSError *error) {
    if (change != nil) {
      [expectation fulfill];
...
- (void)testDistinctQuery {
  ...
  RLMResults *results =
      [[DogObject allObjects] distinctResultsUsingKeyPaths:@[ @"age" ]];
...
- (void)testDistinctQueryWithMultipleKeyPaths {
  ...
  RLMResults *results = [[DogObject allObjects]
      distinctResultsUsingKeyPaths:@[ @"dogName", @"age" ]];
  NSMutableArray *resultsArr = NSMutableArray.new;
  for (DogObject *result in results) {
    [resultsArr addObject:[NSString stringWithFormat:@"%@/%@", result.dogName,
                                                     @(result.age)]];
  }

  XCTAssertEqualObjects(
      resultsArr,
      (@[ @"Fido/3", @"Fido/4", @"Cujo/3", @"Buster/3", @"Rotunda/7" ]));
}
- (void)testDistinctQueryWithMultilevelKeyPath {
  ...
  RLMResults *results =
      [[OwnerObject allObjects] distinctResultsUsingKeyPaths:@[ @"dog.age" ]];
  NSMutableArray *resultsArr = NSMutableArray.new;
...
- (void)testDistinctQueryThrowsInvalidKeyPathsSpecified {
  ...
  [realm transactionWithBlock:^{
    ...
    AggregateObject *ao1 =
        [AggregateObject createInDefaultRealmWithValue:@[ @0 ]];
    AggregateObject *ao2 =
        [AggregateObject createInDefaultRealmWithValue:@[ @0 ]];
  ...
  XCTAssertThrows(
      [[DogObject allObjects] distinctResultsUsingKeyPaths:@[ @"\n" ]]);
  XCTAssertThrows(([[DogObject allObjects]
      distinctResultsUsingKeyPaths:@[ @"dogName", @"" ]]));
  XCTAssertThrows(([[DogObject allObjects]
      distinctResultsUsingKeyPaths:@[ @"dogName", @" " ]]));
  XCTAssertThrows(([[DogObject allObjects]
      distinctResultsUsingKeyPaths:@[ @"dogName", @"\n" ]]));
  XCTAssertThrows(
      ([[DogObject allObjects] distinctResultsUsingKeyPaths:@[ @"@max.age" ]]));
  XCTAssertThrows([[AllTypesObject allObjects]
      distinctResultsUsingKeyPaths:@[ @"linkingObjectsCol" ]]);
  XCTAssertThrows([[AllTypesObject allObjects]
      distinctResultsUsingKeyPaths:@[ @"objectCol" ]]);
  XCTAssertThrows([[AggregateArrayObject allObjects]
      distinctResultsUsingKeyPaths:@[ @"array" ]]);
  XCTAssertThrows([[AggregateSetObject allObjects]
      distinctResultsUsingKeyPaths:@[ @"set" ]]);
}
...
- (void)testQueryFrozenResults {
  RLMResults *frozen = [testResults() freeze];
  XCTAssertEqualObjects(
      [[frozen objectsWhere:@"intCol > 0"] valueForKey:@"intCol"],
      (@[ @1, @2 ]));
}
