...
- (void)testObjectIdInitialization {
  ...
  RLMObjectId *objectId = [[RLMObjectId alloc] initWithString:strValue
                                                        error:nil];
  ...
  XCTAssertEqual((int)now.timeIntervalSince1970,
                 objectId2.timestamp.timeIntervalSince1970);
}
...
- (void)testObjectIdComparision {
  ...
  RLMObjectId *objectId2 = [[RLMObjectId alloc] initWithString:strValue2
                                                         error:nil];

  NSString *strValue3 = @"000123450000ffbeef91906c";
  RLMObjectId *objectId3 = [[RLMObjectId alloc] initWithString:strValue3
                                                         error:nil];
