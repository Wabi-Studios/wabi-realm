...
- (void)testInitWithInvalidThings {
  RLMAssertThrowsWithReasonMatching(
      [[DogObject alloc] initWithValue:self.nonLiteralNil],
      @"Must provide a non-nil value");
  RLMAssertThrowsWithReasonMatching(
      [[DogObject alloc] initWithValue:NSNull.null],
      @"Must provide a non-nil value");
  RLMAssertThrowsWithReasonMatching(
      [[DogObject alloc] initWithValue:@"name"],
...
- (void)testInitWithArray {
  ...
  co = [[CompanyObject alloc]
      initWithValue:@[ @"one employee", @[ @[ @"name", @2, @YES ] ] ]];
...
- (void)testInitWithSet {
  ...
  co = [[CompanyObject alloc] initWithValue:@[
    @"one employee", @[ @[ @"name", @2, @YES ] ], @[ @[ @"name", @2, @YES ] ]
  ]];
  XCTAssertEqualObjects(co.name, @"one employee");
  ...
  co = [[CompanyObject alloc]
      initWithValue:@[ @"one employee", @[ eo ], @[ eo ] ]];
  XCTAssertEqualObjects(co.name, @"one employee");
  XCTAssertEqual(co.employeeSet.count, 1U);
...
- (void)testWithNonArrayEnumerableForRLMArrayProperty {
  ...
  auto co = [[CompanyObject alloc]
      initWithValue:@[ @"one employee", employees.reverseObjectEnumerator ]];
...
- (void)testWithNonSetEnumerableForRLMSetProperty {
  auto employees = @[ @[ @"name", @2, @YES ], @[ @"name 2", @3, @NO ] ];
  auto co = [[CompanyObject alloc] initWithValue:@[
    @"one employee", employees.reverseObjectEnumerator,
  ...
  XCTAssertTrue(
      [[co.employeeSet valueForKey:@"name"] containsObject:@"name 2"]);
}
...
- (void)testInitWithInvalidArray {
  RLMAssertThrowsWithReason(
      ([[DogObject alloc] initWithValue:@[ @"name", @"age" ]]),
      @"Invalid value 'age' of type '__NSCFConstantString' for 'int' property "
      @"'DogObject.age'.");
  RLMAssertThrowsWithReason(
      ([[DogObject alloc] initWithValue:@[ @"name", NSNull.null ]]),
      @"Invalid value '(null)' of type '(null)' for 'int' property "
      @"'DogObject.age'.");
  RLMAssertThrowsWithReason(
      ([[DogObject alloc] initWithValue:@[ @"name", @5, @"too many values" ]]),
...
- (void)testInitWithDictionary {
  ...
  co = [[CompanyObject alloc] initWithValue:@{
    @"name" : @"one employee",
    @"employees" : @[ @{@"name" : @"name", @"age" : @2, @"hired" : @YES} ],
    @"employeeSet" : @[ @{@"name" : @"name", @"age" : @2, @"hired" : @YES} ]
  }];
  XCTAssertEqualObjects(co.name, @"one employee");
  XCTAssertEqual(co.employees.count, 1U);
  XCTAssertEqual(co.employeeSet.count, 1U);
...
- (void)testInitWithInvalidDictionary {
  RLMAssertThrowsWithReason(
      ([[DogObject alloc]
          initWithValue:@{@"name" : @"a", @"age" : NSNull.null}]),
      @"Invalid value '(null)' of type '(null)' for 'int' property "
      @"'DogObject.age'");
  RLMAssertThrowsWithReasonMatching(
      ([[DogObject alloc]
          initWithValue:@{@"name" : @"a", @"age" : NSDate.date}]),
      @"Invalid value '20.*' of type '.*Date' for 'int' property "
      @"'DogObject.age'");
}
...
- (void)testInitWithObject {
  ...
  XCTAssertEqual(co.employees[0],
                 co2.employees[0]); // not EqualObjects as it's a shallow copy

  auto dogExt =
      [[DogExtraObject alloc] initWithValue:@[ @"Fido", @12, @"Poodle" ]];
...
- (void)testInitWithInvalidObject {
  ...
  RLMAssertThrowsWithReason([[IntObject alloc] initWithValue:so],
                            @"missing key 'intCol'");

  // Dog has some but not all of DogExtra's properties
  auto dog = [[DogObject alloc] initWithValue:@[ @"Fido", @10 ]];
  RLMAssertThrowsWithReason([[DogExtraObject alloc] initWithValue:dog],
                            @"missing key 'breed'");

  // Same property names, but different types
  RLMAssertThrowsWithReason(
      [[BizzaroDog alloc] initWithValue:dog],
      @"Invalid value 'Fido' of type '__NSCFConstantString' for 'int' property "
      @"'BizzaroDog.dogName'");
}

- (void)testInitPrimitiveArraysWithInvalidValues {
  RLMAssertThrowsWithReason(
      [[AllPrimitiveArrays alloc]
          initWithValue:@{@"intObj" : @[ NSNull.null ]}],
      @"Invalid value '<null>' of type 'NSNull' for 'int' array property "
      @"'AllPrimitiveArrays.intObj'.");
  RLMAssertThrowsWithReason(
      [[AllPrimitiveArrays alloc] initWithValue:@{@"intObj" : @[ @1.1 ]}],
      @"Invalid value '1.1' of type '" RLMConstantDouble
       "' for 'int' array property 'AllPrimitiveArrays.intObj'.");
  RLMAssertThrowsWithReason(
      [[AllPrimitiveArrays alloc] initWithValue:@{@"intObj" : @[ @"0" ]}],
      @"Invalid value '0' of type '__NSCFConstantString' for 'int' array "
      @"property 'AllPrimitiveArrays.intObj'.");
  RLMAssertThrowsWithReason(
      [[AllPrimitiveArrays alloc] initWithValue:@{@"intObj" : @1}],
      @"Invalid value (1) for 'int' array property "
      @"'AllPrimitiveArrays.intObj': value is not enumerable.");
}

- (void)testInitPrimitiveSetsWithInvalidValues {
  RLMAssertThrowsWithReason(
      [[AllPrimitiveSets alloc] initWithValue:@{@"intObj" : @[ NSNull.null ]}],
      @"Invalid value '<null>' of type 'NSNull' for 'int' set property "
      @"'AllPrimitiveSets.intObj'.");
  RLMAssertThrowsWithReason(
      [[AllPrimitiveSets alloc] initWithValue:@{@"intObj" : @[ @1.1 ]}],
      @"Invalid value '1.1' of type '" RLMConstantDouble
       "' for 'int' set property 'AllPrimitiveSets.intObj'.");
  RLMAssertThrowsWithReason(
      [[AllPrimitiveSets alloc] initWithValue:@{@"intObj" : @[ @"0" ]}],
      @"Invalid value '0' of type '" RLMConstantString
       "' for 'int' set property 'AllPrimitiveSets.intObj'.");
  RLMAssertThrowsWithReason(
      [[AllPrimitiveSets alloc] initWithValue:@{@"intObj" : @1}],
      @"Invalid value (1) for 'int' set property 'AllPrimitiveSets.intObj': "
...
- (void)testInitWithCustomAccessors {
  ...
  ca = [[CustomAccessorsObject alloc]
      initWithValue:@{@"name" : @"b", @"age" : @2}];
...
- (void)testInitWithRenamedColumns {
  ...
  // Create with dictionary
  obj = [[RenamedProperties1 alloc]
      initWithValue:@{@"propB" : @"b", @"propA" : @2}];
...
- (void)testInitAllPropertyTypes {
  ...
  so.stringCol = @"string";
  auto ao = [[AllTypesObject alloc] initWithValue:[AllTypesObject values:1
                                                            stringObject:so]];
  ...
  XCTAssertEqualObjects(ao.decimalCol,
  ...
  auto opt = [[AllOptionalTypes alloc] initWithValue:@[
  ...
  opt = [[AllOptionalTypes alloc]
      initWithValue:@[ @1, @2.2f, @3.3, @YES, @"str", bytes, now ]];
  ...
  auto arrays = [[AllPrimitiveArrays alloc] initWithValue:@{
    @"intObj" : @[ @1, @2, @3 ],
    @"boolObj" : @[ @YES, @NO ],
    @"floatObj" : @[ @1.1f, @2.2f ],
    @"doubleObj" : @[ @3.3, @4.4 ],
  ...
  XCTAssertEqualObjects([arrays.floatObj valueForKey:@"self"],
                        (@[ @1.1f, @2.2f ]));
  XCTAssertEqualObjects([arrays.doubleObj valueForKey:@"self"],
                        (@[ @3.3, @4.4 ]));
  XCTAssertEqualObjects([arrays.stringObj valueForKey:@"self"],
                        (@[ @"a", @"b" ]));
  XCTAssertEqualObjects([arrays.dateObj valueForKey:@"self"], (@[ now ]));
  XCTAssertEqualObjects([arrays.dataObj valueForKey:@"self"], (@[ bytes ]));

  auto sets = [[AllPrimitiveSets alloc] initWithValue:@{
    @"intObj" : @[ @1, @2, @3 ],
    @"boolObj" : @[ @YES, @NO ],
    @"floatObj" : @[ @1.1f, @2.2f ],
    @"doubleObj" : @[ @3.3, @4.4 ],
  ...
  XCTAssertTrue(
      [[NSSet setWithArray:[[sets.intObj valueForKey:@"self"] allObjects]]
          isEqualToSet:[NSSet setWithArray:(@[ @1, @2, @3 ])]]);
  XCTAssertTrue(
      [[NSSet setWithArray:[[sets.boolObj valueForKey:@"self"] allObjects]]
          isEqualToSet:[NSSet setWithArray:(@[ @YES, @NO ])]]);
  XCTAssertTrue(
      [[NSSet setWithArray:[[sets.floatObj valueForKey:@"self"] allObjects]]
          isEqualToSet:[NSSet setWithArray:(@[ @1.1f, @2.2f ])]]);
  XCTAssertTrue(
      [[NSSet setWithArray:[[sets.doubleObj valueForKey:@"self"] allObjects]]
          isEqualToSet:[NSSet setWithArray:(@[ @3.3, @4.4 ])]]);
  XCTAssertTrue(
      [[NSSet setWithArray:[[sets.stringObj valueForKey:@"self"] allObjects]]
          isEqualToSet:[NSSet setWithArray:(@[ @"a", @"b" ])]]);
  XCTAssertTrue(
      [[NSSet setWithArray:[[sets.dateObj valueForKey:@"self"] allObjects]]
          isEqualToSet:[NSSet setWithArray:(@[ now ])]]);
  XCTAssertTrue(
      [[NSSet setWithArray:[[sets.dataObj valueForKey:@"self"] allObjects]]
          isEqualToSet:[NSSet setWithArray:(@[ bytes ])]]);
}

- (void)testInitValidatesNumberTypes {
  XCTAssertNoThrow(([[NumberObject alloc] initWithValue:@{}]));
  RLMAssertThrowsWithReason(
      ([[NumberObject alloc] initWithValue:@{@"intObj" : @1.1}]),
      @"Invalid value '1.1' of type '" RLMConstantDouble
       "' for 'int?' property 'NumberObject.intObj'.");
  RLMAssertThrowsWithReason(
      ([[NumberObject alloc] initWithValue:@{@"intObj" : @1.1f}]),
      @"Invalid value '1.1' of type '" RLMConstantFloat
       "' for 'int?' property 'NumberObject.intObj'.");
  ...
  RLMAssertThrowsWithReason(
      ([[NumberObject alloc] initWithValue:@{@"boolObj" : @1.0}]),
      @"Invalid value '1' of type '" RLMConstantDouble
       "' for 'bool?' property 'NumberObject.boolObj'.");
  RLMAssertThrowsWithReason(
      ([[NumberObject alloc] initWithValue:@{@"boolObj" : @1.0f}]),
      @"Invalid value '1' of type '" RLMConstantFloat
       "' for 'bool?' property 'NumberObject.boolObj'.");
  RLMAssertThrowsWithReason(
      ([[NumberObject alloc] initWithValue:@{@"boolObj" : @2}]),
      @"Invalid value '2' of type '" RLMConstantInt
       "' for 'bool?' property 'NumberObject.boolObj'.");

  XCTAssertNoThrow(
      ([[NumberObject alloc] initWithValue:@{@"floatObj" : @1.1}]));
  RLMAssertThrowsWithReasonMatching(
      ([[NumberObject alloc] initWithValue:@{@"floatObj" : @DBL_MAX}]),
      @"Invalid value '.*' of type '" RLMConstantDouble
       "' for 'float\\?' property 'NumberObject.floatObj'");

  XCTAssertNoThrow(
      ([[NumberObject alloc] initWithValue:@{@"doubleObj" : @DBL_MAX}]));
}
...
- (void)testCreateWithArray {
  ...
  auto co = [CompanyObject
      createInRealm:realm
          withValue:@[ @"empty company", NSNull.null, NSNull.null ]];
  XCTAssertEqualObjects(co.name, @"empty company");
  XCTAssertEqual(co.employees.count, 0U);
  XCTAssertEqual(co.employeeSet.count, 0U);

  co = [CompanyObject createInRealm:realm
                          withValue:@[ @"empty company", @[], @[] ]];
  XCTAssertEqualObjects(co.name, @"empty company");
  XCTAssertEqual(co.employees.count, 0U);
  XCTAssertEqual(co.employeeSet.count, 0U);
...
- (void)testCreateWithInvalidArray {
  ...
  RLMAssertThrowsWithReason(
      ([DogObject createInRealm:realm withValue:@[ @"name", @"age" ]]),
      @"Invalid value 'age' of type '__NSCFConstantString' for 'int' property "
      @"'DogObject.age'");
  RLMAssertThrowsWithReason(
      ([DogObject createInRealm:realm withValue:@[ @"name", NSNull.null ]]),
      @"Invalid value '<null>' of type 'NSNull' for 'int' property "
      @"'DogObject.age'");
  RLMAssertThrowsWithReason(
      ([DogObject createInRealm:realm
                      withValue:@[ @"name", @5, @"too many values" ]]),
      @"Invalid array input: more values (3) than properties (2).");
  RLMAssertThrowsWithReason(
      ([PrimaryStringObject createInRealm:realm withValue:@[]]),
...
- (void)testCreateWithInvalidDictionary {
  ...
  RLMAssertThrowsWithReason(
      ([DogObject createInRealm:realm
                      withValue:@{@"name" : @"a", @"age" : NSNull.null}]),
      @"Invalid value '<null>' of type 'NSNull' for 'int' property "
      @"'DogObject.age'");
  RLMAssertThrowsWithReasonMatching(
      ([DogObject createInRealm:realm
                      withValue:@{@"name" : @"a", @"age" : NSDate.date}]),
...
- (void)testCreateWithObject {
  ...
  XCTAssertFalse([co.employeeSet.allObjects[0]
      isEqualToObject:co2.employeeSet.allObjects[0]]);
  XCTAssertEqualObjects(co.employeeSet.allObjects[0].name,
                        co2.employeeSet.allObjects[0].name);

  auto dogExt = [DogExtraObject createInRealm:realm
                                    withValue:@[ @"Fido", @12, @"Poodle" ]];
...
- (void)testCreateWithInvalidObject {
  ...
  RLMAssertThrowsWithReasonMatching(
      [DogObject createInRealm:realm withValue:self.nonLiteralNil],
      @"Must provide a non-nil value");
  RLMAssertThrowsWithReasonMatching([DogObject createInRealm:realm
                                                   withValue:NSNull.null],
                                    @"Must provide a non-nil value");
  RLMAssertThrowsWithReasonMatching(
      [DogObject createInRealm:realm withValue:@""],
      @"Invalid value '' to initialize object of type 'DogObject'");

  // No overlap in properties
  auto so = [StringObject createInRealm:realm withValue:@[ @"str" ]];
  RLMAssertThrowsWithReasonMatching(
      [IntObject createInRealm:realm withValue:so], @"missing key 'intCol'");

  // Dog has some but not all of DogExtra's properties
  auto dog = [DogObject createInRealm:realm withValue:@[ @"Fido", @10 ]];
  RLMAssertThrowsWithReasonMatching([DogExtraObject createInRealm:realm
                                                        withValue:dog],
                                    @"missing key 'breed'");

  // Same property names, but different types
  RLMAssertThrowsWithReasonMatching([BizzaroDog createInRealm:realm
                                                    withValue:dog],
                                    @"Invalid value 'Fido' of type '.*' for "
                                    @"'int' property 'BizzaroDog.dogName'");
...
- (void)testCreateAllPropertyTypes {
  ...
  auto so = [[StringObject alloc] init];
  so.stringCol = @"string";
  auto ao = [AllTypesObject createInRealm:realm
                                withValue:[AllTypesObject values:1
                                                    stringObject:so]];
  XCTAssertEqual(ao.boolCol, YES);
  XCTAssertEqual(ao.intCol, 1);
  XCTAssertEqual(ao.floatCol, 1.1f);
  ...
  opt = [AllOptionalTypes
      createInRealm:realm
          withValue:@[ @1, @2.2f, @3.3, @YES, @"str", bytes, now ]];
  XCTAssertEqualObjects(opt.intObj, @1);
  XCTAssertEqualObjects(opt.boolObj, @YES);
  XCTAssertEqualObjects(opt.floatObj, @2.2f);
  XCTAssertEqualObjects(opt.doubleObj, @3.3);
...
- (void)testCreateRequiredPrimitiveArrays {
  ...
  XCTAssertEqualObjects([req.floatObj valueForKey:@"self"],
                        (@[ @1.1f, @2.2f ]));
...
- (void)testCreateRequiredPrimitiveSets {
  ...
  XCTAssertEqualObjects([req.intObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ @1, @2, @3 ]]));
  XCTAssertEqualObjects([req.boolObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ @NO, @YES ]]));
  XCTAssertEqualObjects([req.floatObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ @1.1f, @2.2f ]]));
  XCTAssertEqualObjects([req.doubleObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ @3.3, @4.4 ]]));
  XCTAssertEqualObjects([req.stringObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ @"a", @"b" ]]));
  XCTAssertEqualObjects([req.dateObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ now ]]));
  XCTAssertEqualObjects([req.dataObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ bytes ]]));
...
- (void)testCreatePrimitiveArraysWithMissingKeys {
  ...
  auto req = [AllPrimitiveArrays
      createInRealm:realm
          withValue:@{@"intObj" : @[ @1, @2, @2 ], @"dataObj" : NSNull.null}];
  XCTAssertEqual(3U, req.intObj.count);
  XCTAssertEqual(0U, req.boolObj.count);
  XCTAssertEqual(0U, req.floatObj.count);
  XCTAssertEqual(0U, req.doubleObj.count);
...
- (void)testCreateRequiredPrimitiveArraysWithInvalidValues {
  ...
  RLMAssertThrowsWithReason(
      ...
      @"property 'AllPrimitiveArrays.intObj'.");
  RLMAssertThrowsWithReason(
      [AllPrimitiveArrays createInRealm:realm withValue:@{@"intObj" : @1}],
      @"Invalid value (1) for 'int' array property "
      @"'AllPrimitiveArrays.intObj': value is not enumerable.");
...
- (void)testCreateRequiredPrimitiveSetsWithInvalidValues {
  ...
  RLMAssertThrowsWithReason([AllPrimitiveSets
                                createInRealm:realm
                                    withValue:@{@"intObj" : @[ NSNull.null ]}],
                            @"Invalid value '<null>' of type 'NSNull' for "
                            @"'int' set property 'AllPrimitiveSets.intObj'.");
  RLMAssertThrowsWithReason(
      [AllPrimitiveSets createInRealm:realm withValue:@{@"intObj" : @[ @1.1 ]}],
      @"Invalid value '1.1' of type '" RLMConstantDouble
       "' for 'int' set property 'AllPrimitiveSets.intObj'.");
  RLMAssertThrowsWithReason(
      [AllPrimitiveSets createInRealm:realm withValue:@{@"intObj" : @[ @"0" ]}],
      @"Invalid value '0' of type '" RLMConstantString
       "' for 'int' set property 'AllPrimitiveSets.intObj'.");
  RLMAssertThrowsWithReason(
      [AllPrimitiveSets createInRealm:realm withValue:@{@"intObj" : @1}],
      @"Invalid value (1) for 'int' set property 'AllPrimitiveSets.intObj': "
      @"value is not enumerable.");
...
- (void)testCreateOptionalPrimitiveArrays {
  ...
  auto now = [NSDate date];
  auto bytes = [NSData dataWithBytes:"a" length:1];
  auto req = [AllOptionalPrimitiveArrays
      createInRealm:realm
          withValue:@{
            @"intObj" : @[ @1, @2, @3, NSNull.null ],
...
- (void)testCreateOptionalPrimitiveSets {
  ...
  auto now = [NSDate date];
  auto bytes = [NSData dataWithBytes:"a" length:1];
  auto req = [AllOptionalPrimitiveSets
      createInRealm:realm
          withValue:@{
            @"intObj" : @[ @1, @2, @3, NSNull.null ],
            @"boolObj" : @[ @YES, @NO, NSNull.null ],
  ...
  XCTAssertEqualObjects([req.intObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ NSNull.null, @1, @2, @3 ]]));
  XCTAssertEqualObjects([req.boolObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ NSNull.null, @NO, @YES ]]));
  XCTAssertEqualObjects([req.floatObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ NSNull.null, @1.1f, @2.2f ]]));
  XCTAssertEqualObjects([req.doubleObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ NSNull.null, @3.3, @4.4 ]]));
  XCTAssertEqualObjects([req.stringObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ NSNull.null, @"a", @"b" ]]));
  XCTAssertEqualObjects([req.dateObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ NSNull.null, now ]]));
  XCTAssertEqualObjects([req.dataObj valueForKey:@"self"],
                        ([NSSet setWithArray:@[ NSNull.null, bytes ]]));
...
- (void)testCreateOptionalPrimitiveArraysWithInvalidValues {
  ...
  RLMAssertThrowsWithReasonMatching(
      [AllOptionalPrimitiveArrays createInRealm:realm
                                      withValue:@{@"intObj" : @[ @1.1 ]}],
      @"Invalid value '1.1' of type '.*NS.*Number' for 'int\\?' array property "
      @"'AllOptionalPrimitiveArrays.intObj'.");
  RLMAssertThrowsWithReason(
      [AllOptionalPrimitiveArrays createInRealm:realm
                                      withValue:@{@"intObj" : @[ @"0" ]}],
      @"Invalid value '0' of type '__NSCFConstantString' for 'int?' array "
      @"property 'AllOptionalPrimitiveArrays.intObj'.");
  RLMAssertThrowsWithReason(
      [AllOptionalPrimitiveArrays createInRealm:realm
                                      withValue:@{@"intObj" : @1}],
      @"Invalid value (1) for 'int?' array property "
      @"'AllOptionalPrimitiveArrays.intObj': value is not enumerable.");
}
...
- (void)testCreateOptionalPrimitiveSetsWithInvalidValues {
  ...
  RLMAssertThrowsWithReason(
      [AllOptionalPrimitiveSets createInRealm:realm
                                    withValue:@{@"intObj" : @[ @1.1 ]}],
      @"Invalid value '1.1' of type '" RLMConstantDouble
       "' for 'int?' set property 'AllOptionalPrimitiveSets.intObj'.");
  RLMAssertThrowsWithReason(
      [AllOptionalPrimitiveSets createInRealm:realm
                                    withValue:@{@"intObj" : @[ @"0" ]}],
      @"Invalid value '0' of type '" RLMConstantString
  ...
  RLMAssertThrowsWithReason(
      [AllOptionalPrimitiveSets createInRealm:realm
                                    withValue:@{@"intObj" : @1}],
      @"Invalid value (1) for 'int?' set property "
      @"'AllOptionalPrimitiveSets.intObj': value is not enumerable.");
}
...
- (void)testCreateOnManagedObjectInSameRealmShallowCopies {
  ...
  auto links =
      [AllLinks createInRealm:realm
                    withValue:@[ so, pso, @[ io, io ], @[ pio, pio ] ]];
...
- (void)testCreateOnManagedObjectInDifferentRealmDeepCopies {
  ...
  auto links = [AllLinks createInRealm:realm
                             withValue:@[ so, pso, @[ io, io ], @[ pio ] ]];
...
- (void)
    testCreateOnManagedObjectInDifferentRealmDoesntReallyWorkUsefullyWithLinkedPKs {
  auto realm = [RLMRealm defaultRealm];
  [realm beginWriteTransaction];
  auto realm2 = [self realmWithTestPath];
  [realm2 beginWriteTransaction];
  ...
  auto links = [AllLinks
      createInRealm:realm
          withValue:@[ NSNull.null, NSNull.null, NSNull.null, @[ pio, pio ] ]];
...
- (void)testCreateWithInvalidatedObject {
  ...
  RLMAssertThrowsWithReasonMatching([IntObject createInRealm:realm
                                                   withValue:obj1],
...
- (void)testCreateInNilRealm {
  RLMAssertThrowsWithReasonMatching(([IntObject createInRealm:self.nonLiteralNil
                                                    withValue:@[ @0 ]]),
                                    @"WabiRealm must not be nil");
}
...
- (void)testCreateWithNonEnumerableValueForArrayProperty {
  ...
  [realm beginWriteTransaction];
  RLMAssertThrowsWithReason(
      ([CompanyObject createInRealm:realm withValue:@[ @"one employee", @1 ]]),
      @"Invalid value (1) for 'EmployeeObject' array property "
      @"'CompanyObject.employees': value is not enumerable.");
  RLMAssertThrowsWithReason(
      ([CompanyObject createInRealm:realm
                          withValue:@[ @"one employee", @[], @1 ]]),
      @"Invalid value (1) for 'EmployeeObject' set property "
      @"'CompanyObject.employeeSet': value is not enumerable.");
  [realm cancelWriteTransaction];
}
...
- (void)testCreateWithCustomAccessors {
  ...
  // Create with dictionary
  ca = [CustomAccessorsObject createInRealm:realm
                                  withValue:@{@"name" : @"b", @"age" : @2}];
  XCTAssertEqualObjects(ca.name, @"b");
  XCTAssertEqual(ca.age, 2);
...
- (void)testCreateWithRenamedColumns {
  ...
  // Create with dictionary
  obj = [RenamedProperties1 createInRealm:realm
                                withValue:@{@"propB" : @"b", @"propA" : @2}];
  XCTAssertEqual(obj.propA, 2);
  XCTAssertEqualObjects(obj.propB, @"b");
  ...
  RLMResults<RenamedProperties2 *> *results =
      [RenamedProperties2 allObjectsInRealm:realm];
...
- (void)testCreateOrUpdateWithoutPKThrows {
  auto realm = [RLMRealm defaultRealm];
  [realm beginWriteTransaction];
  RLMAssertThrowsWithReason([DogObject createOrUpdateInRealm:realm
                                                   withValue:@[]],
...
- (void)testCreateOrUpdateUpdatesExistingItemWithSamePK {
  ...
  auto so = [PrimaryStringObject createOrUpdateInRealm:realm
                                             withValue:@[ @"pk", @2 ]];
  XCTAssertEqual(1U, [PrimaryStringObject allObjectsInRealm:realm].count);
  XCTAssertEqual(so.intCol, 2);

  auto so2 = [PrimaryStringObject createOrUpdateInRealm:realm
                                              withValue:@[ @"pk", @3 ]];
  XCTAssertEqual(1U, [PrimaryStringObject allObjectsInRealm:realm].count);
...
- (void)testCreateOrUpdateWithNullPrimaryKey {
  ...
  [PrimaryNullableStringObject createOrUpdateInRealm:realm
                                           withValue:@{@"intCol" : @5}];
  [PrimaryNullableStringObject createOrUpdateInRealm:realm
                                           withValue:@{@"intCol" : @7}];
  XCTAssertEqual([PrimaryNullableStringObject objectInRealm:realm
                                              forPrimaryKey:NSNull.null]
                     .intCol,
                 7);
  [PrimaryNullableStringObject
      createOrUpdateInRealm:realm
                  withValue:@{@"stringCol" : NSNull.null, @"intCol" : @11}];
  XCTAssertEqual([PrimaryNullableStringObject objectInRealm:realm
                                              forPrimaryKey:nil]
                     .intCol,
                 11);

  [PrimaryNullableIntObject createOrUpdateInRealm:realm
                                        withValue:@{@"value" : @5}];
  [PrimaryNullableIntObject createOrUpdateInRealm:realm
                                        withValue:@{@"value" : @7}];
  XCTAssertEqual([PrimaryNullableIntObject objectInRealm:realm
                                           forPrimaryKey:NSNull.null]
                     .value,
                 7);
  [PrimaryNullableIntObject
      createOrUpdateInRealm:realm
                  withValue:@{@"optIntCol" : NSNull.null, @"value" : @11}];
  XCTAssertEqual(
      [PrimaryNullableIntObject objectInRealm:realm forPrimaryKey:nil].value,
      11);
...
- (void)testCreateOrUpdateDoesNotModifyKeysNotPresent {
  ...
  auto so = [PrimaryStringObject createOrUpdateInRealm:realm
                                             withValue:@[ @"pk", @2 ]];
  auto so2 =
      [PrimaryStringObject createOrUpdateInRealm:realm
...
- (void)testCreateOrUpdateDoesNotReplaceExistingValuesWithDefaults {
  ...
  auto so = [PrimaryKeyWithDefault createInRealm:realm
                                       withValue:@[ @"pk", @2 ]];
  [PrimaryKeyWithDefault createOrUpdateInRealm:realm
                                     withValue:@{@"stringCol" : @"pk"}];
  XCTAssertEqual(so.intCol, 2);
...
- (void)testCreateOrUpdateReplacesExistingArrayPropertiesAndDoesNotMergeThem {
  ...
  auto obj = [AllLinksWithPrimary createInRealm:realm
                                      withValue:@[
                                        @"pk", @[ @"str" ], @[ @"str pk", @5 ],
                                        @[ @[ @1 ], @[ @2 ], @[ @3 ] ]
                                      ]];
...
- (void)testCreateOrUpdateReusesExistingLinkedObjectsWithPrimaryKeys {
  ...
  [AllLinksWithPrimary
      createInRealm:realm
          withValue:@[ @"pk", NSNull.null, @[ @"str pk", @5 ] ]];
  [AllLinksWithPrimary
      createOrUpdateInRealm:realm
                  withValue:@[
                    @"pk", NSNull.null, @{@"stringCol" : @"str pk"}
                  ]];
  XCTAssertEqual(1U, [PrimaryStringObject allObjectsInRealm:realm].count);
...
- (void)testCreateOrUpdateCreatesNewLinkedObjectsWithoutPrimaryKeys {
  ...
  [AllLinksWithPrimary createOrUpdateInRealm:realm
                                   withValue:@[ @"pk", @[ @"str" ] ]];
...
- (void)testCreateOrUpdateWithMissingValuesAndNoExistingObject {
  ...
  RLMAssertThrowsWithReason(
      ...
      @"Invalid value '<null>' of type 'NSNull' for 'int' property "
      @"'PrimaryStringObject.intCol'");
  [realm cancelWriteTransaction];
}

- (void)
    testCreateOrUpdateOnManagedObjectInSameRealmReturnsExistingObjectInstance {
  auto realm = [RLMRealm defaultRealm];
  [realm beginWriteTransaction];
...
- (void)testCreateOrUpdateOnManagedObjectInDifferentRealmDeepCopies {
  ...
  auto links = [AllLinksWithPrimary
      createInRealm:realm
          withValue:@[ @"pk", so, pso, @[ io, io ], @[ pio, pio ] ]];
  auto copy = [AllLinksWithPrimary createOrUpdateInRealm:realm2
                                               withValue:links];
...
- (void)testCreateOrUpdateWithNilValues {
  auto now = [NSDate date];
  auto bytes = [NSData dataWithBytes:"a" length:1];
  auto nonnull = [[AllOptionalTypesPK alloc]
      initWithValue:@[ @0, @1, @2.2f, @3.3, @YES, @"a", bytes, now ]];
  ...
  [AllOptionalTypesPK createOrUpdateInRealm:realm
                                  withValue:@{
                                    @"pk" : @0,
                                    @"intObj" : NSNull.null,
                                    @"floatObj" : NSNull.null,
...
- (void)testCreateOrUpdateWithRenamedPrimaryKey {
  ...
  [RenamedPrimaryKey createOrUpdateInRealm:realm
                                 withValue:@{@"pk" : @1, @"value" : @4}];
...
- (void)testAddDuplicatePrimaryKey {
  ...
  RLMAssertThrowsWithReason(
      ([realm addObject:[[PrimaryStringObject alloc]
                            initWithValue:@[ @"pk", @1 ]]]),
...
- (void)testAddToDifferentRealmThrows {
  ...
  RLMAssertThrowsWithReason(
      [realm2 addObject:eo],
      @"Object is already managed by another WabiRealm. Use create instead to "
      @"copy it into this WabiRealm.");
  XCTAssertEqual(eo.realm, realm);
...
- (void)testAddObjectWithObserver {
  ...
  RLMAssertThrowsWithReason(
      [realm addObject:dog],
      @"Cannot add an object with observers to a WabiRealm");
  [realm cancelWriteTransaction];
...
- (void)testAddObjectWithNilValueForRequiredProperty {
  ...
  [realm beginWriteTransaction];
  RLMAssertThrowsWithReason(
      [realm addObject:[[RequiredPropertiesObject alloc] init]],
      @"Invalid value '<null>' of type 'NSNull' for 'string' property "
      @"'RequiredPropertiesObject.stringCol'.");
  [realm cancelWriteTransaction];
}
...
- (void)testAddOrUpdateWithNullPrimaryKey {
  ...
  [realm beginWriteTransaction];
  auto so1 =
      [[PrimaryNullableStringObject alloc] initWithValue:@{@"intCol" : @5}];
  auto so2 =
      [[PrimaryNullableStringObject alloc] initWithValue:@{@"intCol" : @7}];

  XCTAssertNil([PrimaryNullableStringObject objectInRealm:realm
                                            forPrimaryKey:NSNull.null]);
  XCTAssertNil([PrimaryNullableStringObject objectInRealm:realm
                                            forPrimaryKey:nil]);
  ...
  XCTAssertNil([PrimaryNullableIntObject objectInRealm:realm
                                         forPrimaryKey:NSNull.null]);
  XCTAssertNil([PrimaryNullableIntObject objectInRealm:realm
                                         forPrimaryKey:nil]);
...
- (void)
    testAddOrUpdateDoesNotHaveAnyConceptOfKeysNotPresentThatShouldBeLeftAlone {
  auto realm = [RLMRealm defaultRealm];
  [realm beginWriteTransaction];
...
- (void)testAddObjectWithNilValueForRequiredPropertyDoesNotUseExistingValue {
  ...
  RLMAssertThrowsWithReason(
      [realm addOrUpdateObject:[[PrimaryKeyAndRequiredString alloc] init]],
      @"Invalid value '<null>' of type 'NSNull' for 'string' property "
      @"'PrimaryKeyAndRequiredString.value'");

  [realm cancelWriteTransaction];
}

- (void)
    testAddOrUpdateWithDuplicateConflictingValuesForPrimaryKeyInArrayProperty {
  auto realm = [RLMRealm defaultRealm];
  [realm beginWriteTransaction];

  auto company = [[PrimaryCompanyObject alloc] init];
  [company.employees addObject:[[PrimaryEmployeeObject alloc]
                                   initWithValue:@[ @"a", @1, @NO ]]];
  [company.employees addObject:[[PrimaryEmployeeObject alloc]
                                   initWithValue:@[ @"a", @2, @NO ]]];
  [company.employeeSet addObject:[[PrimaryEmployeeObject alloc]
                                     initWithValue:@[ @"a", @1, @NO ]]];
  [company.employeeSet addObject:[[PrimaryEmployeeObject alloc]
                                     initWithValue:@[ @"a", @2, @NO ]]];
  ...
  XCTAssertEqualObjects(company.employeeSet.allObjects[0],
                        company.employeeSet.allObjects.lastObject);
}
...
- (void)testAddOrUpdateReplacesExistingArrayPropertiesAndDoesNotMergeThem {
  ...
  auto obj1 = [[AllLinksWithPrimary alloc] initWithValue:@[
    @"pk", @[ @"str" ], @[ @"str pk", @5 ], @[ @[ @1 ], @[ @2 ], @[ @3 ] ], @[],
    @[ @[ @1 ], @[ @2 ], @[ @3 ] ]
  ]];
  auto obj2 = [[AllLinksWithPrimary alloc] initWithValue:@[
    @"pk", @[ @"str" ], @[ @"str pk", @6 ], @[ @[ @4 ] ], @[], @[ @[ @4 ] ]
  ]];
  [realm addOrUpdateObject:obj1];
  [realm addOrUpdateObject:obj2];
...
- (void)testAddOrUpdateReusesExistingLinkedObjectsWithPrimaryKeys {
  ...
  auto obj1 = [[AllLinksWithPrimary alloc]
      initWithValue:@[ @"pk", NSNull.null, @[ @"str pk", @5 ] ]];
  auto obj2 = [[AllLinksWithPrimary alloc]
      initWithValue:@[ @"pk", NSNull.null, @{@"stringCol" : @"str pk"} ]];
...
- (void)testAddOrUpdateAddsNewLinkedObjectsWithoutPrimaryKeys {
  ...
  auto obj1 =
      [[AllLinksWithPrimary alloc] initWithValue:@[ @"pk", @[ @"str" ] ]];
  auto obj2 =
      [[AllLinksWithPrimary alloc] initWithValue:@[ @"pk", @[ @"str" ] ]];
  ...
  XCTAssertEqual(2U, [StringObject allObjectsInRealm:realm].count);
  XCTAssertFalse(
      [obj1.string isEqualToObject:[StringObject allObjectsInRealm:realm][0]]);
  XCTAssertTrue(
      [obj1.string isEqualToObject:[StringObject allObjectsInRealm:realm][1]]);
