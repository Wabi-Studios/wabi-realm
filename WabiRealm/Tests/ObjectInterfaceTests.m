...
- (void)testCustomAccessorsObject {
  ...
  CustomAccessorsObject *ca =
      [CustomAccessorsObject createInRealm:realm withValue:@[ @"name", @2 ]];
...
- (void)testRequiredNumberProperties {
  RLMRealm *realm = [RLMRealm defaultRealm];
  [realm beginWriteTransaction];
  RequiredNumberObject *obj =
      [RequiredNumberObject createInRealm:realm withValue:@[ @0, @0, @0, @0 ]];

  RLMAssertThrowsWithReason(obj.intObj = nil,
                            @"Invalid null value for non-nullable property "
                            @"'RequiredNumberObject.intObj'");
  RLMAssertThrowsWithReason(obj.floatObj = nil,
                            @"Invalid null value for non-nullable property "
                            @"'RequiredNumberObject.floatObj'");
  RLMAssertThrowsWithReason(obj.doubleObj = nil,
                            @"Invalid null value for non-nullable property "
                            @"'RequiredNumberObject.doubleObj'");
  RLMAssertThrowsWithReason(obj.boolObj = nil,
                            @"Invalid null value for non-nullable property "
                            @"'RequiredNumberObject.boolObj'");
...
- (void)testSettingNonOptionalPropertiesToNil {
  ...
  RLMAssertThrowsWithReasonMatching(
      ro.stringCol = nil, @"Invalid null value for non-nullable property "
                          @"'RequiredPropertiesObject.stringCol'.");
  RLMAssertThrowsWithReasonMatching(
      ro.binaryCol = nil, @"Invalid null value for non-nullable property "
                          @"'RequiredPropertiesObject.binaryCol'.");
  [realm cancelWriteTransaction];
}
...
- (void)testRenamedProperties {
  RenamedProperties1 *obj1 = [[RenamedProperties1 alloc]
      initWithValue:@{@"propA" : @5, @"propB" : @"a"}];
  ...
  RenamedProperties2 *obj2 =
      [RenamedProperties2 createInRealm:realm
                              withValue:@{@"propC" : @6, @"propD" : @"b"}];
  ...
  RLMResults<RenamedProperties1 *> *results1 =
      [RenamedProperties1 allObjectsInRealm:realm];
  RLMResults<RenamedProperties2 *> *results2 =
  ...
  LinkToRenamedProperties1 *link1 = [LinkToRenamedProperties1
      createInRealm:realm
          withValue:@[ obj1, obj2, @[ obj1, results1[1] ] ]];
  LinkToRenamedProperties2 *link2 = [LinkToRenamedProperties2
      createInRealm:realm
          withValue:@[ obj2, obj1, @[ obj2, results2[0] ] ]];
...
- (void)testAllMethodsCheckThread {
  ...
  NSArray<NSString *> *propertyNames =
      [obj.objectSchema.properties valueForKey:@"name"];
  [self dispatchAsyncAndWait:^{
    ...
    for (NSString *prop in propertyNames) {
      ...
      RLMAssertThrowsWithReasonMatching([obj setValue:values[prop] forKey:prop],
                                        @"thread");
    }
    ...
    RLMAssertThrowsWithReasonMatching(obj.objectCol = [StringObject new],
                                      @"thread");
...
- (void)testAllMethodsCheckForInvalidation {
  ...
  for (int i = 0; i < 2; ++i) {
    ...
    // Setters
    for (NSString *prop in propertyNames) {
      RLMAssertThrowsWithReasonMatching(obj[prop] = values[prop],
                                        @"invalidated");
      RLMAssertThrowsWithReasonMatching([obj setValue:values[prop] forKey:prop],
                                        @"invalidated");
    }
    ...
    RLMAssertThrowsWithReasonMatching(obj.objectCol = [StringObject new],
                                      @"invalidated");
    RLMAssertThrowsWithReasonMatching(obj.objectCol = stringObj,
                                      @"invalidated");
    [realm cancelWriteTransaction];
  }
}
