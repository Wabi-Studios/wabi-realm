...
- (void)testDeleteObjectsInRealm {
  RLMAssertThrowsWithReason([realm deleteObjects:$allSets],
...
- (void)testAddObject {
  % noany RLMAssertThrowsWithReason(
        [$set addObject:$wrong], ^n @"Invalid value '$wdesc' of type '" $wtype
...
- (void)testAddObjects {
  % noany RLMAssertThrowsWithReason([$set addObjects:@[ $wrong ]],
                                    ^n
                                    @"Invalid value '$wdesc' of type '" $wtype
                                     "' for expected type '$type'");
  % noany %
      r RLMAssertThrowsWithReason(
          [$set addObjects:@[ NSNull.null ]],
          ^n
          @"Invalid value '<null>' of type 'NSNull' for expected type '$type'");
...
- (void)testIndexOfObjectSorted {
  ...
  // 0 and 1
  % man %
      r uncheckedAssertTrue(
          [[$set sortedResultsUsingKeyPath:@"self"
                                 ascending:NO] indexOfObject:$v1] == 0U ||
          ^n [[$set sortedResultsUsingKeyPath:@"self"
                                    ascending:NO] indexOfObject:$v1] == 1U);
  % man %
      r uncheckedAssertTrue(
          [[$set sortedResultsUsingKeyPath:@"self"
                                 ascending:NO] indexOfObject:$v0] == 0U ||
          ^n [[$set sortedResultsUsingKeyPath:@"self"
                                    ascending:NO] indexOfObject:$v0] == 1U);

  % man %
      o uncheckedAssertTrue(
          [[$set sortedResultsUsingKeyPath:@"self"
                                 ascending:NO] indexOfObject:$v1] == 0U ||
          ^n [[$set sortedResultsUsingKeyPath:@"self"
                                    ascending:NO] indexOfObject:$v1] == 1U);
...
- (void)testIndexOfObjectDistinct {
  ...
  // 0 and 1
  % man %
      r uncheckedAssertTrue([[$set distinctResultsUsingKeyPaths:@[ @"self" ]]
                                indexOfObject:$v0] == 0U ||
                            ^n [[$set distinctResultsUsingKeyPaths:@[ @"self" ]]
                                indexOfObject:$v0] == 1U);
  % man %
      r uncheckedAssertTrue([[$set distinctResultsUsingKeyPaths:@[ @"self" ]]
                                indexOfObject:$v1] == 0U ||
  ...
  % man %
      o uncheckedAssertTrue([[$set distinctResultsUsingKeyPaths:@[ @"self" ]]
                                indexOfObject:$v0] == 0U ||
                            ^n [[$set distinctResultsUsingKeyPaths:@[ @"self" ]]
                                indexOfObject:$v0] == 1U);
  % man %
...
- (void)testSort {
  % unman RLMAssertThrowsWithReason(
        [$set sortedResultsUsingKeyPath:@"self" ascending:NO],
        ^n @"This method may only be called on RLMSet instances retrieved from "
           @"an RLMRealm");
  % unman RLMAssertThrowsWithReason([$set sortedResultsUsingDescriptors:@[]],
                                    ^n
                                    @"This method may only be called on RLMSet "
                                    @"instances retrieved from an RLMRealm");
  % man RLMAssertThrowsWithReason([$set sortedResultsUsingKeyPath:@"not self"
                                                        ascending:NO],
  ...
  % man %
      r uncheckedAssertEqualObjects(
          [NSSet setWithArray:[[[$set sortedResultsUsingDescriptors:@[]]
                                  valueForKey:@"self"] allObjects]],
          ^n([NSSet setWithArray:@[ $v0, $v1 ]]));
  % man %
  ...
  % man %
      r uncheckedAssertEqualObjects(
          [NSSet setWithArray:[[[$set sortedResultsUsingKeyPath:@"self"
                                                      ascending:NO]
                                  valueForKey:@"self"] allObjects]],
          ^n([NSSet setWithArray:@[ $v1, $v0 ]]));
  % man %
      o uncheckedAssertEqualObjects(
          [NSSet setWithArray:[[[$set sortedResultsUsingKeyPath:@"self"
                                                      ascending:NO]
  ...
  % man %
      o uncheckedAssertEqualObjects(
          [NSSet setWithArray:[[[$set sortedResultsUsingKeyPath:@"self"
                                                      ascending:YES]
                                  valueForKey:@"self"] allObjects]],
          ^n([NSSet setWithArray:@[ NSNull.null, $v1 ]]));
}

- (void)testFilter {
  % unman RLMAssertThrowsWithReason([$set objectsWhere:@"TRUEPREDICATE"],
                                    ^n
                                    @"This method may only be called on RLMSet "
                                    @"instances retrieved from an RLMRealm");
  % unman RLMAssertThrowsWithReason(
        [$set objectsWithPredicate:[NSPredicate predicateWithValue:YES]],
        ^n @"This method may only be called on RLMSet instances retrieved from "
           @"an RLMRealm");

  % man RLMAssertThrowsWithReason([$set objectsWhere:@"TRUEPREDICATE"],
                                  ^n @"implemented");
  ...
  % man RLMAssertThrowsWithReason(
        [[$set sortedResultsUsingKeyPath:@"self"
                               ascending:NO] ^ n objectsWhere:@"TRUEPREDICATE"],
        @"implemented");
  % man RLMAssertThrowsWithReason(
        [[$set sortedResultsUsingKeyPath:@"self" ascending:NO] ^ n
...
- (void)testSetSet {
  ...
  % unman % r %
      maxtwovalues uncheckedAssertEqualObjects($set.allObjects,
                                               (@[ $v0, $v1 ]));
  % unman % r % nomaxvalues uncheckedAssertEqual($set.count, 2U);
  % unman % r %
      nomaxvalues uncheckedAssertEqualObjects(
          [NSSet setWithArray:$set.allObjects],
          ([NSSet setWithArray:@[ $v0, $v4 ]]));
  % unman % o % maxtwovalues uncheckedAssertEqual($set.count, 3U);
  % unman % o %
      maxtwovalues uncheckedAssertEqualObjects(
          [NSSet setWithArray:$set.allObjects],
          ([NSSet setWithArray:@[ $v0, $v1, $v2 ]]));
  % unman % o % nomaxvalues uncheckedAssertEqual($set.count, 3U);
  % unman % o %
      nomaxvalues uncheckedAssertEqualObjects(
          [NSSet setWithArray:$set.allObjects],
          ([NSSet setWithArray:@[ $v0, $v3, $v4 ]]));
  % man % r % maxtwovalues uncheckedAssertEqual($set.count, 2U);
  % man % r %
      maxtwovalues uncheckedAssertEqualObjects(
          [NSSet setWithArray:$set.allObjects],
          ([NSSet setWithArray:@[ $v0, $v1 ]]));
  % man % r % nomaxvalues uncheckedAssertEqual($set.count, 2U);
  % man % r %
      nomaxvalues uncheckedAssertEqualObjects(
          [NSSet setWithArray:$set.allObjects],
          ([NSSet setWithArray:@[ $v1, $v4 ]]));
  ...
  % man % o %
      nomaxvalues uncheckedAssertEqualObjects(
          [NSSet setWithArray:$set.allObjects],
          ([NSSet setWithArray:@[ $v0, $v1, % v3, % v4 ]]));
}
...
- (void)testIntersect {
  ...
  % unman % r %
      nomaxvalues uncheckedAssertEqualObjects($set.allObjects, (@[ $v0 ]));
  ...
  % man % r %
      nomaxvalues uncheckedAssertEqualObjects($set.allObjects, (@[ $v1 ]));
...
- (void)testMin {
  % noany % nominmax %
      unman RLMAssertThrowsWithReason(
          [$set minOfProperty:@"self"],
          ^n @"minOfProperty: is not supported for $type set");
  % noany % nominmax %
      man RLMAssertThrowsWithReason(
          [$set minOfProperty:@"self"],
          ^n @"Operation 'min' not supported for $type set '$class.$prop'");
  ...
  % minmax % unman %
      r uncheckedAssertEqualObjects([$set minOfProperty:@"self"], $v0);
  % minmax % unman %
      o uncheckedAssertEqualObjects([$set minOfProperty:@"self"], $v1);
...
- (void)testMax {
  % noany % nominmax %
      unman RLMAssertThrowsWithReason(
          [$set maxOfProperty:@"self"],
          ^n @"maxOfProperty: is not supported for $type set");
  % noany % nominmax %
      man RLMAssertThrowsWithReason(
          [$set maxOfProperty:@"self"],
          ^n @"Operation 'max' not supported for $type set '$class.$prop'");
  ...
  % minmax % unman %
      r uncheckedAssertEqualObjects([$set maxOfProperty:@"self"], $v1);
  % minmax % unman %
      o uncheckedAssertEqualObjects([$set maxOfProperty:@"self"], $v2);
...
- (void)testSum {
  % noany % nosum %
      unman RLMAssertThrowsWithReason(
          [$set sumOfProperty:@"self"],
          ^n @"sumOfProperty: is not supported for $type set");
  % noany % nosum %
      man RLMAssertThrowsWithReason(
          [$set sumOfProperty:@"self"],
          ^n @"Operation 'sum' not supported for $type set '$class.$prop'");

  % sum uncheckedAssertEqualObjects([$set sumOfProperty:@"self"], @0);

  [self addObjects];

  % sum XCTAssertEqualWithAccuracy([$set sumOfProperty:@"self"].doubleValue,
                                   sum($values), .001);
}
...
- (void)testAverage {
  % noany % noavg %
      unman RLMAssertThrowsWithReason(
          [$set averageOfProperty:@"self"],
          ^n @"averageOfProperty: is not supported for $type set");
  % noany % noavg %
      man RLMAssertThrowsWithReason(
          [$set averageOfProperty:@"self"],
          ^n @"Operation 'average' not supported for $type set '$class.$prop'");

  % avg uncheckedAssertNil([$set averageOfProperty:@"self"]);

  [self addObjects];

  % avg XCTAssertEqualWithAccuracy([$set averageOfProperty:@"self"].doubleValue,
                                   average($values), .001);
}
...
- (void)testFastEnumeration {
  ...
  ^{
    ...
    ^nl for (id value in $set) {
      ^nl uncheckedAssertTrue(
          [[NSSet setWithArray:values] containsObject:value]);
      ^nl
    }
    ^nl
  }();
...
- (void)testValueForKeySelf {
  ...
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[$set valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:$values]));
}
...
- (void)testValueForKeyNumericAggregates {
  ...
  % minmax % unman %
      r uncheckedAssertEqualObjects([$set valueForKeyPath:@"@min.self"], $v0);
  % minmax % unman %
      o uncheckedAssertEqualObjects([$set valueForKeyPath:@"@max.self"], $v2);
  ...
  % sum XCTAssertEqualWithAccuracy(
        [[$set valueForKeyPath:@"@sum.self"] doubleValue], sum($values), .001);
  % avg XCTAssertEqualWithAccuracy(
        [[$set valueForKeyPath:@"@avg.self"] doubleValue], average($values),
        .001);
}
...
- (void)testValueForKeyLength {
  ...
  [self addObjects];
  % string uncheckedAssertEqualObjects(
        [$set valueForKey:@"length"],
        ([[NSSet setWithArray:$values] valueForKey:@"length"]));
}

- (void)testSetValueForKey {
  RLMAssertThrowsWithReason(
      [$allSets setValue:@0 forKey:@"not self"],
      ^n @"this class is not key value coding-compliant for the key not self.");
  % noany RLMAssertThrowsWithReason([$set setValue:$wrong forKey:@"self"],
                                    ^n
                                    @"Invalid value '$wdesc' of type '" $wtype
                                     "' for expected type '$type'");
  % noany %
      r RLMAssertThrowsWithReason(
          [$set setValue:NSNull.null forKey:@"self"],
          ^n
          @"Invalid value '<null>' of type 'NSNull' for expected type '$type'");
  ...
  RLMAssertThrowsWithReason($set.allObjects[1],
...
- (void)testAssignment {
  $set = (id) @[ $v1 ];
  ^nl uncheckedAssertEqualObjects($set.allObjects[0], $v1);

  // Should replace and not append
  $set = (id)$values;
  ^nl uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[$set valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:$values]));
  ^nl
...
- (void)testDynamicAssignment {
  $obj[@"$prop"] = (id) @[ $v1 ];
  ^nl uncheckedAssertEqualObjects(((RLMSet *)$obj[@"$prop"]).allObjects[0],
                                  $v1);

  // Should replace and not append
  $obj[@"$prop"] = (id)$values;
  ^nl uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[$obj[@"$prop"] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:$values]));
  ^nl
...
- (void)testQueryBetween {
  ...
  % r % man %
      minmax RLMAssertCount($class, 1, @"ANY $prop BETWEEN %@", @[ $v1, $v1 ]);
  % r % man %
      minmax RLMAssertCount($class, 1, @"ANY $prop BETWEEN %@", @[ $v0, $v1 ]);
  % r % man %
      minmax RLMAssertCount($class, 0, @"ANY $prop BETWEEN %@", @[ $v0, $v0 ]);

  % o % man %
      minmax RLMAssertCount($class, 1, @"ANY $prop BETWEEN %@", @[ $v1, $v1 ]);
  % o % man %
      minmax RLMAssertCount($class, 1, @"ANY $prop BETWEEN %@", @[ $v1, $v2 ]);
  % o % man %
      minmax RLMAssertCount($class, 0, @"ANY $prop BETWEEN %@", @[ $v3, $v3 ]);
}
...
- (void)testQueryMax {
  ...
  % noany % r % minmax %
      man RLMAssertCount($class, 1U, @"$prop.@max == %@", $v0);
  % noany % r % minmax %
      man RLMAssertCount($class, 2U, @"$prop.@max == %@", $v1);
...
- (void)testQueryBasicOperatorsOverLink {
  ...
  % man % minmax RLMAssertCount(LinkTo$class, 0, @"ANY link.$prop < %@", $v0);
  % r % man %
      minmax RLMAssertCount(LinkTo$class, 1, @"ANY link.$prop < %@", $v4);
  % o % man %
      minmax RLMAssertCount(LinkTo$class, 1, @"ANY link.$prop < %@", $v2);
