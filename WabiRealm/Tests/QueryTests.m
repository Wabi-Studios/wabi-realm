...
+ (NSDictionary *)linkingObjectsProperties {
  return @{
    @"prev" : [RLMPropertyDescriptor descriptorWithClass:LinkChain1.class
                                            propertyName:@"next"]
  };
}
@end
...
+ (NSDictionary *)linkingObjectsProperties {
  return @{
    @"prev" : [RLMPropertyDescriptor descriptorWithClass:LinkChain2.class
                                            propertyName:@"next"]
  };
}
@end
...
+ (NSArray *)requiredProperties {
  return @[
    @"string1", @"string2", @"data1", @"data2", @"objectId1", @"objectId2",
    @"decimal1", @"decimal2"
  ];
}
@end
...
#define RLMAssertCount(cls, expectedCount, ...)                                \
  XCTAssertEqual(expectedCount,                                                \
                 ([self evaluate:[cls objectsWhere:__VA_ARGS__]].count))
...
- (void)testDynamicQueryInvalidClass {
  ...
  XCTAssertThrows([realm objects:@"NonRealmPersonObject" where:@"age > 25"],
                  @"invalid object type");
  XCTAssertThrows([[realm objects:@"NonRealmPersonObject"
                            where:@"age > 25"] sortedResultsUsingKeyPath:@"age"
                                                               ascending:YES],
                  @"invalid object type");

  // empty string for class name
  XCTAssertThrows([realm objects:@"" where:@"age > 25"], @"missing class name");
  XCTAssertThrows([[realm objects:@""
                            where:@"age > 25"] sortedResultsUsingKeyPath:@"age"
                                                               ascending:YES],
                  @"missing class name");
...
#pragma clang diagnostic ignored "-Wnonnull"
  ...
  XCTAssertThrows([[realm objects:nil
                            where:@"age > 25"] sortedResultsUsingKeyPath:@"age"
                                                               ascending:YES],
                  @"nil class name");
...
- (void)testPredicateValidUse {
  ...
  // boolean false
  XCTAssertNoThrow([AllTypesObject objectsInRealm:realm where:@"boolCol == no"],
                   @"== no");
  XCTAssertNoThrow([AllTypesObject objectsInRealm:realm where:@"boolCol == No"],
                   @"== No");
  XCTAssertNoThrow([AllTypesObject objectsInRealm:realm where:@"boolCol == NO"],
                   @"== NO");
  XCTAssertNoThrow([AllTypesObject objectsInRealm:realm
                                            where:@"boolCol == false"],
                   @"== false");
  XCTAssertNoThrow([AllTypesObject objectsInRealm:realm
                                            where:@"boolCol == False"],
  ...
  XCTAssertNoThrow([AllTypesObject objectsInRealm:realm
                                            where:@"boolCol == FALSE"],
                   @"== FALSE");
  XCTAssertNoThrow([AllTypesObject objectsInRealm:realm where:@"boolCol == 0"],
                   @"== 0");

  // boolean true
  XCTAssertNoThrow(
      [AllTypesObject objectsInRealm:realm where:@"boolCol == yes"], @"== yes");
  XCTAssertNoThrow(
      [AllTypesObject objectsInRealm:realm where:@"boolCol == Yes"], @"== Yes");
  XCTAssertNoThrow(
      [AllTypesObject objectsInRealm:realm where:@"boolCol == YES"], @"== YES");
  ...
  XCTAssertNoThrow([AllTypesObject objectsInRealm:realm
                                            where:@"boolCol == TRUE"],
                   @"== TRUE");
  XCTAssertNoThrow([AllTypesObject objectsInRealm:realm where:@"boolCol == 1"],
                   @"== 1");
...
- (void)testPredicateNotSupported {
  ...
  RLMAssertThrowsWithReasonMatching(
      [PersonObject objectsWhere:@"ANY age > 5"],
      @"Aggregate operations can only.*collection property");
  RLMAssertThrowsWithReasonMatching([PersonObject objectsWhere:@"ALL age > 5"],
                                    @"ALL modifier not supported");
  RLMAssertThrowsWithReasonMatching(
      [PersonObject objectsWhere:@"SOME age > 5"],
      @"Aggregate operations can only.*collection property");
  RLMAssertThrowsWithReasonMatching(
      [PersonObject objectsWhere:@"NONE age > 5"],
      @"Aggregate operations can only.*collection property");
  RLMAssertThrowsWithReasonMatching(
      [PersonLinkObject objectsWhere:@"ANY person.age > 5"],
      @"Aggregate operations can only.*collection property");
  RLMAssertThrowsWithReasonMatching(
      [PersonLinkObject objectsWhere:@"ALL person.age > 5"],
      @"ALL modifier not supported");
  RLMAssertThrowsWithReasonMatching(
      [PersonLinkObject objectsWhere:@"SOME person.age > 5"],
      @"Aggregate operations can only.*collection property");
  RLMAssertThrowsWithReasonMatching(
      [PersonLinkObject objectsWhere:@"NONE person.age > 5"],
      @"Aggregate operations can only.*collection property");
  RLMAssertThrowsWithReason(
      [PersonObject objectsWhere:@"age.@count > 5"],
      @"Invalid keypath 'age.@count': Property 'PersonObject.age' is not a "
      @"link or collection and can only appear at the end of a keypath.");
  RLMAssertThrowsWithReason(
      [PersonObject objectsWhere:@"age.@sum > 5"],
      @"Invalid keypath 'age.@sum': Property 'PersonObject.age' is not a link "
      @"or collection and can only appear at the end of a keypath.");

  // comparing two constants
  RLMAssertThrowsWithReason([PersonObject objectsWhere:@"5 = 5"],
                            @"Predicate expressions must compare a keypath and "
                            @"another keypath or a constant value");
  ...
  RLMAssertThrowsWithReason(
      ([AllOptionalTypes objectsWhere:@"%@ CONTAINS data", [NSData data]]),
  ...
  RLMAssertThrowsWithReasonMatching(
      ([ArrayOfAllTypesObject objectsWhere:@"SUBQUERY(array, $obj, $obj.intCol "
                                           @"= 5).@count == array.@count"]),
      @"SUBQUERY.*compared with a constant number");
  RLMAssertThrowsWithReasonMatching(
      ([ArrayOfAllTypesObject
          objectsWhere:@"SUBQUERY(array, $obj, $obj.intCol = 5) == 0"]),
      @"SUBQUERY.*immediately followed by .@count");
  RLMAssertThrowsWithReasonMatching(
      ([ArrayOfAllTypesObject
          objectsWhere:@"SELF IN SUBQUERY(array, $obj, $obj.intCol = 5)"]),
      @"Predicate with IN operator must compare.*aggregate$");

  // Nonexistent aggregate operators
  RLMAssertThrowsWithReason(
      [PersonObject objectsWhere:@"children.@average.age == 5"],
      @"Unsupported collection operation '@average'");

  // block-based predicate
  NSPredicate *pred =
      [NSPredicate predicateWithBlock:^BOOL(__unused id obj,
...
- (void)testPredicateMisuse {
  ...
  RLMAssertThrowsWithReason(
      [PersonObject objectsWhere:@"height > 72"],
  ...
  RLMAssertThrowsWithReason([PersonObject objectsWhere:@"age != xyz"],
                            @"Invalid keypath 'xyz': Property 'xyz' not found "
                            @"in object of type 'PersonObject'");
  RLMAssertThrowsWithReason([PersonObject objectsWhere:@"name == 3"],
                            @"Cannot compare value '3' of type '__NSCFNumber' "
                            @"to property 'name' of type 'string'");
  RLMAssertThrowsWithReasonMatching(
      [PersonObject objectsWhere:@"age IN {'xyz'}"],
      @"Cannot compare value 'xyz' of type '.*String.*' to property 'age' of "
      @"type 'int'");
  XCTAssertThrows([PersonObject objectsWhere:@"name IN {3}"], @"asdf");

  // compare columns to incorrect type of constant value
  RLMAssertThrowsWithReasonMatching(
      [AllTypesObject objectsWhere:@"boolCol == 'Foo'"],
      @"Cannot compare value 'Foo' of type '.*String.*' to property 'boolCol' "
      @"of type 'bool'");
  RLMAssertThrowsWithReason([AllTypesObject objectsWhere:@"boolCol == 2"],
                            @"Cannot compare value '2' of type '__NSCFNumber' "
                            @"to property 'boolCol' of type 'bool'");
  RLMAssertThrowsWithReason([AllTypesObject objectsWhere:@"dateCol == 7"],
                            @"Cannot compare value '7' of type '__NSCFNumber' "
                            @"to property 'dateCol' of type 'date'");
  RLMAssertThrowsWithReasonMatching(
      [AllTypesObject objectsWhere:@"doubleCol == 'The'"],
      @"Cannot compare value 'The' of type '.*String.*' to property "
      @"'doubleCol' of type 'double'");
  RLMAssertThrowsWithReasonMatching(
      [AllTypesObject objectsWhere:@"floatCol == 'Bar'"],
      @"Cannot compare value 'Bar' of type '.*String.*' to property 'floatCol' "
      @"of type 'float'");
  RLMAssertThrowsWithReasonMatching(
      [AllTypesObject objectsWhere:@"intCol == 'Baz'"],
      @"Cannot compare value 'Baz' of type '.*String.*' to property 'intCol' "
      @"of type 'int'");

  // compare two constants
  XCTAssertThrows([PersonObject objectsWhere:@"3 == 3"],
  ...
  RLMAssertThrowsWithReason([PersonObject objectsWhere:@"@K == YES"],
                            @"Unsupported collection operation '@K'");
  ...
  RLMAssertThrowsWithReason([PersonObject objectsWhere:@"@count == 0"],
                            @"Invalid keypath '@count': collection operation "
                            @"'@count' must be applied to a collection");
      ...
      predicateWithLeftExpression:[NSExpression expressionForKeyPath:@"name.@"]
                  rightExpression:[NSExpression expressionForConstantValue:@0]
                         modifier:0
                          ...
                          options:0];
  RLMAssertThrowsWithReason(
      [PersonObject objectsWithPredicate:predicateWithKeyPath(@"children.@")],
      @"Unsupported collection operation '@'");
  RLMAssertThrowsWithReason(
      [PersonObject objectsWithPredicate:predicateWithKeyPath(@"children@")],
      @"Invalid keypath 'children@': Property 'children@' not found in object "
      @"of type 'PersonObject'");
  RLMAssertThrowsWithReason(
      [PersonObject objectsWithPredicate:predicateWithKeyPath(@"name@length")],
      @"Invalid keypath 'name@length': Property 'name@length' not found in "
      @"object of type 'PersonObject'");
  RLMAssertThrowsWithReason(
      [PersonObject objectsWithPredicate:predicateWithKeyPath(@".name")],
  ...
  // not a link column
  RLMAssertThrowsWithReason(
      [PersonObject objectsWhere:@"age.age == 25"],
      @"Invalid keypath 'age.age': Property 'PersonObject.age' is not a link "
      @"or collection and can only appear at the end of a keypath.");
  RLMAssertThrowsWithReason(
      [PersonObject objectsWhere:@"age.age.age == 25"],
      @"Invalid keypath 'age.age.age': Property 'PersonObject.age' is not a "
      @"link or collection and can only appear at the end of a keypath.");
  RLMAssertThrowsWithReason(
      [AllPrimitiveArrays objectsWhere:@"intObj.foo == 25"],
      @"Invalid keypath 'intObj.foo': RLMArray<int> property intObj can only "
      @"be followed by a collection operation");
  RLMAssertThrowsWithReason(
      [AllPrimitiveSets objectsWhere:@"intObj.foo == 25"],
      @"Invalid keypath 'intObj.foo': RLMSet<int> property intObj can only be "
      @"followed by a collection operation");
  RLMAssertThrowsWithReason(
      [AllPrimitiveDictionaries objectsWhere:@"intObj.foo == 25"],
      @"Invalid keypath 'intObj.foo': RLMDictionary<int> property intObj can "
      @"only be followed by a collection operation");

  // abuse of BETWEEN
  RLMAssertThrowsWithReason([PersonObject objectsWhere:@"age BETWEEN 25"],
                            @"type NSArray for BETWEEN");
  RLMAssertThrowsWithReason(
      [PersonObject objectsWhere:@"age BETWEEN Foo"],
      @"BETWEEN operator must compare a KeyPath with an aggregate");
  RLMAssertThrowsWithReason(
      [PersonObject objectsWhere:@"age BETWEEN {age, age}"],
      @"must be constant values");
  RLMAssertThrowsWithReason([PersonObject objectsWhere:@"age BETWEEN {age, 0}"],
                            @"must be constant values");
  RLMAssertThrowsWithReason([PersonObject objectsWhere:@"age BETWEEN {0, age}"],
                            @"must be constant values");
  RLMAssertThrowsWithReason(
      [PersonObject objectsWhere:@"age BETWEEN {0, {1, 10}}"],
      @"must be constant values");
  ...
  pred =
      [NSPredicate predicateWithFormat:@"age BETWEEN %@", @[ @"Foo", @"Bar" ]];
  RLMAssertThrowsWithReason([PersonObject objectsWithPredicate:pred],
                            @"type int for BETWEEN");
  ...
  pred =
      [NSPredicate predicateWithFormat:@"age BETWEEN %@", @[ @1, @[ @2, @3 ] ]];
  RLMAssertThrowsWithReason([PersonObject objectsWithPredicate:pred],
                            @"type int for BETWEEN");
  ...
  RLMAssertThrowsWithReason(
      [PersonObject objectsWithPredicate:pred],
      @"Property 'height' not found in object of type 'PersonObject'");

  // bad type in link IN
  RLMAssertThrowsWithReasonMatching(
      [PersonLinkObject objectsInRealm:realm where:@"person.age IN {'Tim'}"],
      @"Cannot compare value 'Tim' of type '.*String.*' to property 'age' of "
      @"type 'int'");
}
...
- (void)testStringUnsupportedOperations {
  ...
  XCTAssertThrows(
      [AllTypesObject objectsWhere:@"objectCol.stringCol MATCHES 'abc'"]);
  XCTAssertThrows(
      [AllTypesObject objectsWhere:@"objectCol.stringCol BETWEEN {'a', 'b'}"]);
...
- (void)testLinkQueryInvalid {
  XCTAssertThrows(
      [LinkToAllTypesObject objectsWhere:@"allTypesCol.binaryCol = 'a'"],
      @"Binary data not supported");
  XCTAssertThrows(
      [LinkToAllTypesObject objectsWhere:@"allTypesCol.invalidCol = 'a'"],
      @"Invalid column name should throw");

  XCTAssertThrows(
      [LinkToAllTypesObject objectsWhere:@"allTypesCol.longCol = 'a'"],
      @"Wrong data type should throw");

  RLMAssertThrowsWithReasonMatching(
      [ArrayPropertyObject objectsWhere:@"intArray.intCol > 5"],
      @"Key paths that include a collection property must use aggregate "
      @"operations");
  RLMAssertThrowsWithReasonMatching(
      [SetPropertyObject objectsWhere:@"intSet.intCol > 5"],
      @"Key paths that include a collection property must use aggregate "
      @"operations");
  RLMAssertThrowsWithReasonMatching(
      [LinkToCompanyObject objectsWhere:@"company.employees.age > 5"],
      @"Key paths that include a collection property must use aggregate "
      @"operations");

  RLMAssertThrowsWithReasonMatching(
      [LinkToAllTypesObject
          objectsWhere:@"allTypesCol.intCol = allTypesCol.doubleCol"],
      @"Property type mismatch");
}

- (void)testNumericOperatorsOnClass:(Class)class
...
- (void)testValidOperatorsInNumericComparison {
  [self testNumericOperatorsOnClass:[IntObject class]
                           property:@"intCol"
                              value:@0];
  [self testNumericOperatorsOnClass:[FloatObject class]
                           property:@"floatCol"
                              value:@0];
  [self testNumericOperatorsOnClass:[DoubleObject class]
                           property:@"doubleCol"
                              value:@0];
  [self testNumericOperatorsOnClass:[DateObject class]
                           property:@"dateCol"
                              value:NSDate.date];
  [self testNumericOperatorsOnClass:[DecimalObject class]
                           property:@"decimalCol"
                              value:[RLMDecimal128 decimalWithNumber:@0]];
  [self testNumericOperatorsOnClass:[MixedObject class]
                           property:@"anyCol"
                              value:@0];
}

- (void)testStringOperatorsOnClass:(Class)class
                          property:(NSString *)property
                             value:(id)value {
  NSArray *operators =
...
- (void)testInvalidOperatorsInNumericComparison {
  [self testStringOperatorsOnClass:[IntObject class]
                          property:@"intCol"
                             value:@0];
  [self testStringOperatorsOnClass:[FloatObject class]
                          property:@"floatCol"
                             value:@0];
  [self testStringOperatorsOnClass:[DoubleObject class]
                          property:@"doubleCol"
                             value:@0];
  [self testStringOperatorsOnClass:[DateObject class]
                          property:@"dateCol"
                             value:NSDate.date];
  [self testStringOperatorsOnClass:[DecimalObject class]
                          property:@"decimalCol"
                             value:[RLMDecimal128 decimalWithNumber:@0]];
}
@end
...
- (void)testBasicQuery {
  ...
  RLMResults *results = [[PersonObject objectsInRealm:realm where:@"age > 28"]
      sortedResultsUsingKeyPath:@"age"
                      ascending:YES];
  XCTAssertEqualObjects([results[0] name], @"Tim",
                        @"Tim should be first results");

  // query on sorted results
  results = [[[PersonObject allObjectsInRealm:realm]
      sortedResultsUsingKeyPath:@"age"
                      ascending:YES] objectsWhere:@"age > 28"];
  XCTAssertEqualObjects([results[0] name], @"Tim",
                        @"Tim should be first results");
}
...
- (void)testQueryBetween {
  ...
  [realm beginWriteTransaction];
  AllTypesObject *a =
      [AllTypesObject createInRealm:realm
                          withValue:[AllTypesObject values:1 stringObject:nil]];
  AllTypesObject *b =
      [AllTypesObject createInRealm:realm
                          withValue:[AllTypesObject values:2 stringObject:nil]];
  AllTypesObject *c =
      [AllTypesObject createInRealm:realm
                          withValue:[AllTypesObject values:3 stringObject:nil]];
  AllTypesObject *d =
      [AllTypesObject createInRealm:realm
                          withValue:[AllTypesObject values:4 stringObject:nil]];

  [ArrayOfAllTypesObject createInRealm:realm withValue:@[ @[ a, c ] ]];
  [ArrayOfAllTypesObject createInRealm:realm withValue:@[ @[ b, d ] ]];
  [DictionaryOfAllTypesObject createInRealm:realm
                                  withValue:@[ @{@"1" : a, @"3" : c} ]];
  [DictionaryOfAllTypesObject createInRealm:realm
                                  withValue:@[ @{@"2" : b, @"4" : d} ]];
  ...
  RLMAssertCount(AllTypesObject, 2U, @"intCol BETWEEN {2, 3}");
  RLMAssertCount(ArrayOfAllTypesObject, 1U, @"ANY array.intCol BETWEEN %@",
                 @[ @4, @5 ]);
  RLMAssertCount(SetOfAllTypesObject, 1U, @"ANY set.intCol BETWEEN %@",
                 @[ @4, @5 ]);
  RLMAssertCount(DictionaryOfAllTypesObject, 1U,
                 @"ANY dictionary.intCol BETWEEN %@", @[ @4, @5 ]);
  ...
  RLMAssertCount(ArrayOfAllTypesObject, 0U, @"ANY array.floatCol BETWEEN %@",
                 @[ @3.1, @3.2 ]);
  RLMAssertCount(SetOfAllTypesObject, 0U, @"ANY set.floatCol BETWEEN %@",
                 @[ @3.1, @3.2 ]);
  RLMAssertCount(DictionaryOfAllTypesObject, 0U,
                 @"ANY dictionary.floatCol BETWEEN %@", @[ @3.1, @3.2 ]);
  ...
  RLMAssertCount(ArrayOfAllTypesObject, 0U, @"ANY array.doubleCol BETWEEN %@",
                 @[ @3.1, @3.2 ]);
  RLMAssertCount(SetOfAllTypesObject, 0U, @"ANY set.doubleCol BETWEEN %@",
                 @[ @3.1, @3.2 ]);
  RLMAssertCount(DictionaryOfAllTypesObject, 0U,
                 @"ANY dictionary.doubleCol BETWEEN %@", @[ @3.1, @3.2 ]);

  RLMAssertCount(AllTypesObject, 2U, @"dateCol BETWEEN %@",
                 @[ [b dateCol], [c dateCol] ]);
  RLMAssertCount(ArrayOfAllTypesObject, 2U, @"ANY array.dateCol BETWEEN %@",
                 @[ [b dateCol], [c dateCol] ]);
  RLMAssertCount(SetOfAllTypesObject, 2U, @"ANY set.dateCol BETWEEN %@",
                 @[ [b dateCol], [c dateCol] ]);
  RLMAssertCount(DictionaryOfAllTypesObject, 2U,
                 @"ANY dictionary.dateCol BETWEEN %@",
                 @[ [b dateCol], [c dateCol] ]);

  RLMAssertCount(AllTypesObject, 1U, @"longCol BETWEEN %@",
                 @[ @5000000000LL, @7000000000LL ]);
  RLMAssertCount(AllTypesObject, 1U,
                 @"longCol BETWEEN {5000000000, 7000000000}");
  RLMAssertCount(ArrayOfAllTypesObject, 1U, @"ANY array.longCol BETWEEN %@",
                 @[ @5000000000LL, @7000000000LL ]);
  RLMAssertCount(SetOfAllTypesObject, 1U, @"ANY set.longCol BETWEEN %@",
                 @[ @5000000000LL, @7000000000LL ]);
  RLMAssertCount(DictionaryOfAllTypesObject, 1U,
                 @"ANY dictionary.longCol BETWEEN %@",
                 @[ @5000000000LL, @7000000000LL ]);

  RLMAssertCount(AllTypesObject, 4U, @"decimalCol BETWEEN %@", @[ @0, @5 ]);
  RLMAssertCount(AllTypesObject, 4U, @"decimalCol BETWEEN %@", @[
  ...
  RLMAssertCount(AllTypesObject, 2U, @"anyCol BETWEEN {2, 3}");
  RLMAssertCount(ArrayOfAllTypesObject, 2U, @"ANY array.anyCol BETWEEN %@",
                 @[ @4, @5 ]);
  RLMAssertCount(SetOfAllTypesObject, 2U, @"ANY set.anyCol BETWEEN %@",
                 @[ @4, @5 ]);
  RLMAssertCount(DictionaryOfAllTypesObject, 2U,
                 @"ANY dictionary.anyCol BETWEEN %@", @[ @4, @5 ]);

  RLMResults *allObjects = [AllTypesObject allObjectsInRealm:realm];
  RLMAssertThrowsWithReason(
      [allObjects objectsWhere:@"boolCol BETWEEN {true, false}"],
      @"Operator 'BETWEEN' not supported for type 'bool'");
  RLMAssertThrowsWithReason(
      [allObjects objectsWhere:@"stringCol BETWEEN {'', ''}"],
      @"Operator 'BETWEEN' not supported for type 'string'");
  RLMAssertThrowsWithReason(
      ([allObjects
          objectsWhere:@"binaryCol BETWEEN %@", @[ NSData.data, NSData.data ]]),
      @"Operator 'BETWEEN' not supported for type 'data'");
  RLMAssertThrowsWithReason(
      [allObjects objectsWhere:@"cBoolCol BETWEEN {true, false}"],
      @"Operator 'BETWEEN' not supported for type 'bool'");
  RLMAssertThrowsWithReason(
      ([allObjects
          objectsWhere:@"objectIdCol BETWEEN %@",
...
- (void)testQueryWithDates {
  ...
  NSArray<NSDate *> *dates =
      [[AllTypesObject allObjectsInRealm:realm] valueForKey:@"dateCol"];
...
- (void)testDefaultRealmQuery {
  ...
  // with order
  RLMResults *results =
      [[PersonObject objectsWhere:@"age > 28"] sortedResultsUsingKeyPath:@"age"
                                                               ascending:YES];
...
- (void)testUuidRealmQuery {
  ...
  [UuidObject
      createInRealm:realm
          withValue:@[
            [[NSUUID alloc]
                initWithUUIDString:@"137DECC8-B300-4954-A233-F89909F4FD89"]
          ]];
...
- (void)testRLMValueQuery {
  ...
  ArrayOfAllTypesObject *arrayOfAll = [ArrayOfAllTypesObject createInRealm:realm
                                                                 withValue:@{}];

  for (int i = 0; i < (int)allValues.count; i++) {
        AllTypesObject *obj = [AllTypesObject
            createInRealm:realm
                withValue:[AllTypesObject values:i stringObject:stringObj]];
  ...
  XCTAssertThrowsSpecificNamed(
      [AllTypesObject objectsWhere:@"anyCol BETWEEN TRUE"], NSException,
      @"Invalid value",
  ...
  XCTAssertThrowsSpecificNamed(
      [AllTypesObject objectsWhere:@"anyCol CONATINS 0"], NSException,
  ...
  RLMAssertCount(AllTypesObject, 1U, @"anyCol == %@",
                 [NSDate dateWithTimeIntervalSince1970:0]);
  RLMAssertCount(AllTypesObject, allValues.count, @"anyCol != %@",
                 [NSDate dateWithTimeIntervalSince1970:123]);

  RLMAssertCount(
      AllTypesObject, 1U, @"anyCol == %@",
      [[NSUUID alloc]
          initWithUUIDString:@"85d4fbee-6ec6-47df-bfa1-615931903d7e"]);
  RLMAssertCount(
      AllTypesObject, allValues.count - 1, @"anyCol != %@",
      [[NSUUID alloc]
          initWithUUIDString:@"85d4fbee-6ec6-47df-bfa1-615931903d7e"]);
  ...
  XCTAssertThrowsSpecificNamed(
      [AllTypesObject
          objectsWhere:
              @"anyCol BETWEEN '85d4fbee-6ec6-47df-bfa1-615931903d7e'"],
      NSException, @"Invalid value",
      @"object must be of type NSArray for BETWEEN operations");
...
- (void)verifySort:(RLMRealm *)realm
            column:(NSString *)column
         ascending:(BOOL)ascending
          expected:(id)val {
  RLMResults *results = [[AllTypesObject allObjectsInRealm:realm]
      sortedResultsUsingKeyPath:column
                      ascending:ascending];
  AllTypesObject *obj = results[0];
  XCTAssertEqualObjects(obj[column], val, @"%@", column);

  RLMArray *ar = [(ArrayPropertyObject *)[[ArrayOfAllTypesObject
...
- (void)testEmbeddedObjectQuery {
  RLMRealm *realm = [self realm];
  [realm beginWriteTransaction];
  EmbeddedIntParentObject *obj0 =
      [EmbeddedIntParentObject createInRealm:realm
                                   withValue:@[ @1, @[ @2 ], @[ @[ @3 ] ] ]];
  EmbeddedIntParentObject *obj1 =
      [EmbeddedIntParentObject createInRealm:realm
                                   withValue:@[ @4, @[ @5 ], @[ @[ @6 ] ] ]];
  EmbeddedIntParentObject *obj2 =
      [EmbeddedIntParentObject createInRealm:realm
                                   withValue:@[ @7, @[ @8 ], @[ @[ @9 ] ] ]];
  [realm commitWriteTransaction];
  ...
  RLMResults *r1 =
      [EmbeddedIntParentObject objectsWhere:@"ANY array.intCol > 4"];
  ...
  RLMResults *r2 = [EmbeddedIntParentObject
      objectsWhere:@"ANY array.intCol > 4 and object.intCol = 5"];
  XCTAssertEqualObjects(r2[0], obj1);
  XCTAssert(r2.count == 1);

  // Aggregate query on embedded object array, sort using embedded object key
  // path
  RLMResults *r3 =
      [[EmbeddedIntParentObject objectsWhere:@"array.@max.intCol < 9"]
          sortedResultsUsingKeyPath:@"object.intCol"
                          ascending:NO];
...
- (void)testQuerySorting {
  ...
  ArrayOfAllTypesObject *arrayOfAll = [ArrayOfAllTypesObject createInRealm:realm
                                                                 withValue:@{}];
  DictionaryOfAllTypesObject *dictionaryOfAll = [DictionaryOfAllTypesObject
      createInRealm:realm
          withValue:@{
            @"dictionary" : @{
  ...
  SetOfAllTypesObject *setOfAll = [SetOfAllTypesObject createInRealm:realm
                                                           withValue:@{}];
  ...
  arrayOfAll.array[3].anyCol = [[NSUUID alloc]
      initWithUUIDString:@"B9D325B0-3058-4838-8473-8F1AAAE410DB"];
  [realm commitWriteTransaction];
  ...
  //////////// sort by dateCol
  [self verifySort:realm
            column:@"dateCol"
         ascending:YES
          expected:arrayOfAll.array[0].dateCol];
  [self verifySort:realm
            column:@"dateCol"
         ascending:NO
          expected:arrayOfAll.array[3].dateCol];
  ...
  [self verifySort:realm
            column:@"decimalCol"
         ascending:YES
          expected:[RLMDecimal128 decimalWithNumber:@1]];
  [self verifySort:realm
            column:@"decimalCol"
         ascending:NO
          expected:[RLMDecimal128 decimalWithNumber:@4]];
  ...
  [self
      verifySort:realm
          column:@"uuidCol"
       ascending:YES
        expected:[[NSUUID alloc] initWithUUIDString:
  ...
  [self
      verifySort:realm
       ...
       ascending:NO
        expected:[[NSUUID alloc] initWithUUIDString:
                                     @"B9D325B0-3058-4838-8473-8F1AAAE410DB"]];

  //////////// sort by anyCol
  //////////// nulls < strings, binaries < numerics < timestamps < objectId <
  ///uuid.
  ...
  // sort invalid name
  RLMAssertThrowsWithReason([[AllTypesObject allObjects]
                                sortedResultsUsingKeyPath:@"invalidCol"
                                                ascending:YES],
                            @"Cannot sort on key path 'invalidCol': property "
                            @"'AllTypesObject.invalidCol' does not exist.");
  RLMAssertThrowsWithReason(
      [arrayOfAll.array sortedResultsUsingKeyPath:@"invalidCol" ascending:NO],
      @"Cannot sort on key path 'invalidCol': property "
      @"'AllTypesObject.invalidCol' does not exist.");
  RLMAssertThrowsWithReason(
      [setOfAll.set sortedResultsUsingKeyPath:@"invalidCol" ascending:NO],
      @"Cannot sort on key path 'invalidCol': property "
      @"'AllTypesObject.invalidCol' does not exist.");
  RLMAssertThrowsWithReason([dictionaryOfAll.dictionary
                                sortedResultsUsingKeyPath:@"invalidCol"
                                                ascending:NO],
                            @"Cannot sort on key path 'invalidCol': property "
                            @"'AllTypesObject.invalidCol' does not exist.");
...
- (void)testSortByNoColumns {
  ...
  RLMResults *notActuallySorted =
      [DogObject.allObjects sortedResultsUsingDescriptors:@[]];
...
- (void)testSortByMultipleColumns {
  ...
  bool (^checkOrder)(NSArray *, NSArray *, NSArray *) = ^bool(
      NSArray *properties, NSArray *ascending, NSArray *dogs) {
    NSArray *sort = @[
      [RLMSortDescriptor sortDescriptorWithKeyPath:properties[0]
                                         ascending:[ascending[0] boolValue]],
      [RLMSortDescriptor sortDescriptorWithKeyPath:properties[1]
                                         ascending:[ascending[1] boolValue]]
    ];
    RLMResults *actual =
        [DogObject.allObjects sortedResultsUsingDescriptors:sort];
  ...
  XCTAssertTrue(checkOrder(@[ @"dogName", @"age" ], @[ @YES, @YES ],
                           @[ a1, a2, b1, b2 ]));
  XCTAssertTrue(
      checkOrder(@[ @"dogName", @"age" ], @[ @YES, @NO ], @[ a2, a1, b2, b1 ]));
  XCTAssertTrue(
      checkOrder(@[ @"dogName", @"age" ], @[ @NO, @YES ], @[ b1, b2, a1, a2 ]));
  XCTAssertTrue(
      checkOrder(@[ @"dogName", @"age" ], @[ @NO, @NO ], @[ b2, b1, a2, a1 ]));
  XCTAssertTrue(checkOrder(@[ @"age", @"dogName" ], @[ @YES, @YES ],
                           @[ a1, b1, a2, b2 ]));
  XCTAssertTrue(
      checkOrder(@[ @"age", @"dogName" ], @[ @YES, @NO ], @[ b1, a1, b2, a2 ]));
  XCTAssertTrue(
      checkOrder(@[ @"age", @"dogName" ], @[ @NO, @YES ], @[ a2, b2, a1, b1 ]));
  XCTAssertTrue(
      checkOrder(@[ @"age", @"dogName" ], @[ @NO, @NO ], @[ b2, a2, b1, a1 ]));
}
...
- (void)testSortByKeyPath {
  ...
  DogObject *freyja =
      [DogObject createInDefaultRealmWithValue:@[ @"Freyja", @6 ]];
  DogObject *ziggy =
      [DogObject createInDefaultRealmWithValue:@[ @"Ziggy", @9 ]];

  OwnerObject *mark =
      [OwnerObject createInDefaultRealmWithValue:@[ @"Mark", freyja ]];
  OwnerObject *diane =
      [OwnerObject createInDefaultRealmWithValue:@[ @"Diane", lucy ]];
  OwnerObject *hannah =
      [OwnerObject createInDefaultRealmWithValue:@[ @"Hannah" ]];
  OwnerObject *don =
      [OwnerObject createInDefaultRealmWithValue:@[ @"Don", ziggy ]];
  OwnerObject *diane_sr =
      [OwnerObject createInDefaultRealmWithValue:@[ @"Diane Sr", ziggy ]];
  ...
  RLMResults *r1 = [OwnerObject.allObjects sortedResultsUsingKeyPath:@"dog.age"
                                                           ascending:YES];
  XCTAssertEqualObjects(asArray(r1), (@[ mark, diane, don, diane_sr, hannah ]));

  RLMResults *r2 = [OwnerObject.allObjects sortedResultsUsingKeyPath:@"dog.age"
                                                           ascending:NO];
...
- (void)testSortByUnspportedKeyPath {
  // Array property
  RLMAssertThrowsWithReason(
      [DogArrayObject.allObjects sortedResultsUsingKeyPath:@"dogs.age"
                                                 ascending:YES],
      @"Cannot sort on key path 'dogs.age': property 'DogArrayObject.dogs' is "
      @"of unsupported type 'array'.");

  // Backlinks property
  RLMAssertThrowsWithReason(
      [DogObject.allObjects sortedResultsUsingKeyPath:@"owners.name"
                                            ascending:YES],
      @"Cannot sort on key path 'owners.name': property 'DogObject.owners' is "
      @"of unsupported type 'linking objects'.");

  // Collection operator
  RLMAssertThrowsWithReason([DogArrayObject.allObjects
                                sortedResultsUsingKeyPath:@"dogs.@count"
                                                ascending:YES],
                            @"Cannot sort on key path 'dogs.@count': KVC "
                            @"collection operators are not supported.");
}
...
- (void)testSortedLinkViewWithDeletion {
  ...
  SetOfAllTypesObject *setOfAll = [SetOfAllTypesObject createInRealm:realm
                                                           withValue:@{}];
  DictionaryOfAllTypesObject *dictOfAll = [DictionaryOfAllTypesObject
      createInRealm:realm
          withValue:@{
            @"dictionary" : @{
              @"1" : [AllTypesObject values:1 stringObject:stringObj],
  ...
  RLMResults *results = [arrayOfAll.array sortedResultsUsingKeyPath:@"stringCol"
                                                          ascending:NO];
  XCTAssertEqualObjects([results[0] stringCol], @"d");

  RLMResults *results2 = [setOfAll.set sortedResultsUsingKeyPath:@"stringCol"
                                                       ascending:NO];
  XCTAssertEqualObjects([results2[0] stringCol], @"d");

  RLMResults *results3 =
      [dictOfAll.dictionary sortedResultsUsingKeyPath:@"stringCol"
                                            ascending:NO];
  ...
  [realm transactionWithBlock:^{
    ...
    [arrayOfAll.array
        addObject:(id)[AllTypesObject values:5 stringObject:stringObj]];
    [setOfAll.set
        addObject:(id)[AllTypesObject values:5 stringObject:stringObj]];
    dictOfAll.dictionary[@"5"] = [[AllTypesObject alloc]
        initWithValue:[AllTypesObject values:5 stringObject:stringObj]];
  }];
...
- (void)testQueryingSortedQueryPreservesOrder {
  ...
  ArrayPropertyObject *array = [ArrayPropertyObject
      createInRealm:realm
          withValue:@[ @"name", @[], [IntObject allObjects] ]];
  SetPropertyObject *set = [SetPropertyObject
      createInRealm:realm
          withValue:@[ @"name", @[], [IntObject allObjects] ]];
  ...
  RLMResults *asc = [IntObject.allObjects sortedResultsUsingKeyPath:@"intCol"
                                                          ascending:YES];
  RLMResults *desc = [IntObject.allObjects sortedResultsUsingKeyPath:@"intCol"
                                                           ascending:NO];
  ...
  XCTAssertEqual(3, [[[[desc objectsWhere:@"intCol >= 2"]
                        objectsWhere:@"intCol < 4"] firstObject] intCol]);
  ...
  asc = [dict.intObjDictionary sortedResultsUsingKeyPath:@"intCol"
                                               ascending:YES];
  desc = [dict.intObjDictionary sortedResultsUsingKeyPath:@"intCol"
                                                ascending:NO];
...
- (void)testTwoColumnComparison {
  ...
  QueryObject *first =
      [[self.queryObjectClass allObjectsInRealm:realm] firstObject];
  first.object1 = first;
  ...
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"int1 == float1"],
      @"Property type mismatch between int and float");
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"float2 >= double1"],
      @"Property type mismatch between float and double");
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"double2 <= int2"],
      @"Property type mismatch between double and int");
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"int2 != string1"],
      @"Property type mismatch between int and string");
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"float1 > string1"],
      @"Property type mismatch between float and string");
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"double1 < string1"],
      @"Property type mismatch between double and string");
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"double1 LIKE string1"],
      @"Property type mismatch between double and string");
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"string1 LIKE double1"],
...
- (void)testBooleanPredicate {
  ...
  XCTAssertThrowsSpecificNamed([BoolObject objectsWhere:@"boolCol >= TRUE"],
                               NSException, @"Invalid operator type",
...
- (void)testStringBeginsWith {
  ...
  void (^testBlock)(NSString *, NSString *, Class) =
      ^(NSString *objectCol, NSString *colName, Class cls) {
        ...
        RLMAssertCount(AllTypesObject, 1U, @"%K.%K BEGINSWITH 'a'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K BEGINSWITH 'c'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K BEGINSWITH 'A'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K BEGINSWITH ''", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 1U, @"%K.%K BEGINSWITH[c] 'a'",
                       objectCol, colName);
        RLMAssertCount(AllTypesObject, 1U, @"%K.%K BEGINSWITH[c] 'A'",
                       objectCol, colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K BEGINSWITH[c] ''", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K BEGINSWITH[d] ''", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K BEGINSWITH[cd] ''",
                       objectCol, colName);

        RLMAssertCount(AllTypesObject, 0U, @"%K.%K BEGINSWITH NULL", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K BEGINSWITH[c] NULL",
                       objectCol, colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K BEGINSWITH[d] NULL",
                       objectCol, colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K BEGINSWITH[cd] NULL",
                       objectCol, colName);
      };
...
- (void)testStringEndsWith {
  ...
  void (^testBlock)(NSString *, NSString *, Class) =
      ^(NSString *objectCol, NSString *colName, Class cls) {
        ...
        RLMAssertCount(AllTypesObject, 1U, @"%K.%K ENDSWITH 'c'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K ENDSWITH 'a'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K ENDSWITH 'C'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K ENDSWITH ''", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 1U, @"%K.%K ENDSWITH[c] 'c'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 1U, @"%K.%K ENDSWITH[c] 'C'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K ENDSWITH[c] ''", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K ENDSWITH[d] ''", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K ENDSWITH[cd] ''", objectCol,
                       colName);

        RLMAssertCount(AllTypesObject, 0U, @"%K.%K ENDSWITH NULL", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K ENDSWITH[c] NULL", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K ENDSWITH[d] NULL", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K ENDSWITH[cd] NULL",
                       objectCol, colName);
      };
  testBlock(@"objectCol", @"stringCol", [StringObject class]);
  testBlock(@"mixedObjectCol", @"anyCol", [MixedObject class]);
...
- (void)testStringContains {
  ...
  void (^testBlock)(NSString *, NSString *, Class) =
      ^(NSString *objectCol, NSString *colName, Class cls) {
        ...
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K CONTAINS 'd'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 1U, @"%K.%K CONTAINS 'c'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K CONTAINS 'C'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K CONTAINS ''", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 1U, @"%K.%K CONTAINS[c] 'c'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 1U, @"%K.%K CONTAINS[c] 'C'", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K CONTAINS[c] ''", objectCol,
        ...
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K CONTAINS[d] ''", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K CONTAINS[cd] ''", objectCol,
                       colName);

        RLMAssertCount(AllTypesObject, 0U, @"%K.%K CONTAINS NULL", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K CONTAINS[c] NULL", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K CONTAINS[d] NULL", objectCol,
                       colName);
        RLMAssertCount(AllTypesObject, 0U, @"%K.%K CONTAINS[cd] NULL",
                       objectCol, colName);
      };
...
- (void)testStringLike {
  ...
  void (^testBlock)(NSString *, NSString *, Class) = ^(
    ...
    RLMAssertCount(AllTypesObject, 1U, @"%K.%K LIKE[c] '*c*'", objectCol,
                   colName);
    RLMAssertCount(AllTypesObject, 1U, @"%K.%K LIKE[c] '*C*'", objectCol,
                   colName);

    RLMAssertThrowsWithReasonMatching(
        ([cls objectsWhere:@"%K LIKE[d] '*'", colName]),
        @"'LIKE' not supported .* diacritic-insensitive");
    RLMAssertThrowsWithReasonMatching(
        ([cls objectsWhere:@"%K LIKE[cd] '*'", colName]),
        @"'LIKE' not supported .* diacritic-insensitive");
  };
...
- (void)testStringEquality {
  ...
  void (^testBlock)(NSString *, NSString *, Class) = ^(
    ...
    RLMAssertCount(AllTypesObject, 1U, @"%K.%K ==[c] 'abc'", objectCol,
                   colName);
    RLMAssertCount(AllTypesObject, 1U, @"%K.%K ==[c] 'ABC'", objectCol,
                   colName);
...
- (void)testFloatQuery {
  ...
  XCTAssertThrows([FloatObject objectsInRealm:realm
                                        where:@"floatCol = 3.5e+38"],
...
- (void)testDecimalQuery {
  ...
  [DecimalObject createInRealm:realm withValue:@[ @"Inf" ]];
  [DecimalObject createInRealm:realm
                     withValue:@[ @"123456789.123456789e1234" ]];
  [realm commitWriteTransaction];
  ...
  RLMAssertCount(DecimalObject, 1U,
                 @"decimalCol >  '123456789.123456789e1234'");
  RLMAssertCount(DecimalObject, 2U,
                 @"decimalCol >= '123456789.123456789e1234'");
  RLMAssertCount(DecimalObject, 1U,
                 @"decimalCol == '123456789.123456789e1234'");
  RLMAssertCount(DecimalObject, 2U,
...
- (void)testLiveQueriesInsideTransaction {
  ...
  NSMutableArray *values = [@[
    @YES, @YES, @1, @2, @23.0f, @1.7f, @0.0, @5.55, @"", @"", data(""), data("")
  ] mutableCopy];

  [realm beginWriteTransaction];
  [self.queryObjectClass createInRealm:realm withValue:values];

  RLMResults *resultsQuery =
      [self.queryObjectClass objectsWhere:@"bool1 = YES"];
  RLMResults *resultsTableView =
      [self.queryObjectClass objectsWhere:@"bool1 = YES"];
  ...
  values[0] = @NO;
  QueryObject *q1 = [self.queryObjectClass createInRealm:realm
                                               withValue:values];
  XCTAssertEqual(resultsQuery.count, 0U);
  XCTAssertEqual(resultsTableView.count, 0U);
...
- (void)testLinkQueryDifferentRealmsThrows {
  ...
  XCTAssertThrows(([OwnerObject objectsInRealm:testRealm
                                         where:@"dog = %@", dog]));
}
...
- (void)testLinkQueryString {
  ...
  XCTAssertThrows([OwnerObject objectsInRealm:realm
                                        where:@"dog.dogName > 'Harvie'"],
...
- (void)testLinkQueryAllTypes {
  ...
  linkToAllTypes.allTypesCol = [[AllTypesObject alloc]
      initWithValue:[AllTypesObject values:1 stringObject:nil]];
  ...
  RLMAssertCount(LinkToAllTypesObject, 0U,
                 @"allTypesCol.longCol != 2147483648");

  RLMAssertCount(LinkToAllTypesObject, 1U, @"allTypesCol.dateCol = %@",
                 linkToAllTypes.allTypesCol.dateCol);
  RLMAssertCount(LinkToAllTypesObject, 0U, @"allTypesCol.dateCol != %@",
                 linkToAllTypes.allTypesCol.dateCol);
}
...
- (void)testLinkQueryManyDictionaries {
  ...
  RLMAssertCount(DictionaryPropertyObject, 0U,
                 @"ANY intObjDictionary.intCol > 10");
  RLMAssertCount(DictionaryPropertyObject, 1U,
                 @"ANY intObjDictionary.intCol > 5");
  RLMAssertCount(DictionaryPropertyObject, 1U,
                 @"ANY stringDictionary.stringCol = '1'");
  RLMAssertCount(DictionaryPropertyObject, 0U,
                 @"NONE intObjDictionary.intCol == 5");
  RLMAssertCount(DictionaryPropertyObject, 1U,
                 @"NONE intObjDictionary.intCol > 10");
  ...
  RLMAssertCount(DictionaryPropertyObject, 1U,
                 @"ANY intObjDictionary.intCol > 5");
  RLMAssertCount(DictionaryPropertyObject, 2U,
                 @"ANY intObjDictionary.intCol > 2");
  RLMAssertCount(DictionaryPropertyObject, 1U,
                 @"NONE intObjDictionary.intCol == 5");
  RLMAssertCount(DictionaryPropertyObject, 2U,
                 @"NONE intObjDictionary.intCol > 10");
...
- (void)testMultiLevelLinkQuery {
  ...
  for (int i = 0; i < 5; ++i) {
        circle = [CircleObject createInRealm:realm
                                   withValue:@{
                                     @"data" : @(i).stringValue,
  ...
  XCTAssertTrue([circle
      isEqualToObject:[CircleObject objectsInRealm:realm where:@"data = '4'"]
                          .firstObject]);
  XCTAssertTrue(
      [circle isEqualToObject:[CircleObject objectsInRealm:realm
                                                     where:@"next.data = '3'"]
                                  .firstObject]);
  XCTAssertTrue([circle
      isEqualToObject:[CircleObject objectsInRealm:realm
                                             where:@"next.next.data = '2'"]
                          .firstObject]);
  XCTAssertTrue([circle
      isEqualToObject:[CircleObject objectsInRealm:realm
                                             where:@"next.next.next.data = '1'"]
                          .firstObject]);
  XCTAssertTrue([circle
      isEqualToObject:[CircleObject
                          objectsInRealm:realm
                                   where:@"next.next.next.next.data = '0'"]
                          .firstObject]);
  XCTAssertTrue([circle.next
      isEqualToObject:[CircleObject objectsInRealm:realm
                                             where:@"next.next.next.data = '0'"]
                          .firstObject]);
  XCTAssertTrue([circle.next.next
      isEqualToObject:[CircleObject objectsInRealm:realm
                                             where:@"next.next.data = '0'"]
                          .firstObject]);

  XCTAssertNoThrow(([CircleObject objectsInRealm:realm
                                           where:@"next = %@", circle]));
  XCTAssertNoThrow(([CircleObject objectsInRealm:realm
                                           where:@"next.next = %@", circle]));
  XCTAssertTrue([circle.next.next.next.next
      isEqualToObject:[CircleObject objectsInRealm:realm where:@"next = nil"]
                          .firstObject]);
  XCTAssertTrue([circle.next.next.next
      isEqualToObject:[CircleObject
                          objectsInRealm:realm
                                   where:@"next != nil AND next.next = nil"]
                          .firstObject]);
  XCTAssertTrue([circle.next.next
      isEqualToObject:
          [CircleObject
              objectsInRealm:realm
                       where:@"next.next != nil AND next.next.next = nil"]
              .firstObject]);
}
...
- (void)testArrayMultiLevelLinkQuery {
  ...
  [CircleArrayObject createInRealm:realm
                         withValue:@[ [CircleObject allObjectsInRealm:realm] ]];
  [realm commitWriteTransaction];
  ...
  XCTAssertThrows([CircleArrayObject objectsInRealm:realm
                                              where:@"ANY data = '2'"]);
  XCTAssertThrows([CircleArrayObject objectsInRealm:realm
                                              where:@"ANY circles.next = '2'"]);
  XCTAssertThrows([CircleArrayObject objectsInRealm:realm
                                              where:@"ANY data.circles = '2'"]);
  XCTAssertThrows([CircleArrayObject objectsInRealm:realm
                                              where:@"circles.data = '2'"]);
  XCTAssertThrows([CircleArrayObject
      objectsInRealm:realm
               where:@"NONE data.circles = '2'"]);
}
...
- (void)testSetMultiLevelLinkQuery {
  ...
  [CircleSetObject createInRealm:realm
                       withValue:@[ [CircleObject allObjectsInRealm:realm] ]];
  [realm commitWriteTransaction];
  ...
  XCTAssertThrows([CircleSetObject objectsInRealm:realm
                                            where:@"ANY data = '2'"]);
  XCTAssertThrows([CircleSetObject objectsInRealm:realm
                                            where:@"ANY circles.next = '2'"]);
  XCTAssertThrows([CircleSetObject objectsInRealm:realm
...
- (void)testDictionaryMultiLevelLinkQuery {
  ...
  CircleDictionaryObject *cdo = [CircleDictionaryObject createInRealm:realm
                                                            withValue:@{}];
  ...
  RLMAssertCount(CircleDictionaryObject, 0U,
                 @"ANY circles.next.next.data = '3'");
  RLMAssertCount(CircleDictionaryObject, 1U,
                 @"ANY circles.next.next.data = '2'");
  ...
  RLMAssertCount(CircleDictionaryObject, 1U,
                 @"NONE circles.next.next.data = '3'");

  XCTAssertThrows([CircleDictionaryObject objectsInRealm:realm
                                                   where:@"ANY data = '2'"]);
  XCTAssertThrows([CircleDictionaryObject
      objectsInRealm:realm
               where:@"ANY circles.next = '2'"]);
  XCTAssertThrows([CircleDictionaryObject
      objectsInRealm:realm
...
- (void)testMultiLevelBackLinkQuery {
  ...
  [realm beginWriteTransaction];
  LinkChain1 *root1 =
      [LinkChain1 createInRealm:realm
                      withValue:@{@"value" : @1, @"next" : @[ @[] ]}];
  LinkChain1 *root2 =
      [LinkChain1 createInRealm:realm
                      withValue:@{@"value" : @2, @"next" : @[ @[] ]}];
  [realm commitWriteTransaction];

  RLMResults *results = [LinkChain3 objectsInRealm:realm
                                             where:@"ANY prev.prev.value = 1"];
...
- (void)testQueryWithObjects {
  ...
  StringObject *stringObj0 = [StringObject createInRealm:realm
                                               withValue:@[ @"string0" ]];
  StringObject *stringObj1 = [StringObject createInRealm:realm
                                               withValue:@[ @"string1" ]];
  StringObject *stringObj2 = [StringObject createInRealm:realm
                                               withValue:@[ @"string2" ]];

  AllTypesObject *obj0 = [AllTypesObject
      createInRealm:realm
          withValue:[AllTypesObject values:1 stringObject:stringObj0]];
  AllTypesObject *obj1 = [AllTypesObject
      createInRealm:realm
          withValue:[AllTypesObject values:2 stringObject:stringObj1]];
  AllTypesObject *obj2 = [AllTypesObject
      createInRealm:realm
          withValue:[AllTypesObject values:3 stringObject:stringObj0]];
  AllTypesObject *obj3 = [AllTypesObject
      createInRealm:realm
          withValue:[AllTypesObject values:4 stringObject:stringObj2]];
  AllTypesObject *obj4 =
      [AllTypesObject createInRealm:realm
                          withValue:[AllTypesObject values:5 stringObject:nil]];

  [ArrayOfAllTypesObject createInDefaultRealmWithValue:@[ @[ obj0, obj1 ] ]];
  [ArrayOfAllTypesObject createInDefaultRealmWithValue:@[ @[ obj1 ] ]];
  [ArrayOfAllTypesObject
      createInDefaultRealmWithValue:@[ @[ obj0, obj2, obj3 ] ]];
  ...
  [DictionaryOfAllTypesObject
      createInDefaultRealmWithValue:@[ @{@"0" : obj0, @"1" : obj1} ]];
  [DictionaryOfAllTypesObject
      createInDefaultRealmWithValue:@[ @{@"1" : obj1} ]];
  [DictionaryOfAllTypesObject createInDefaultRealmWithValue:@[
    @{@"0" : obj0, @"2" : obj2, @"3" : obj3}
  ]];
  [DictionaryOfAllTypesObject
      createInDefaultRealmWithValue:@[ @{@"4" : obj4} ]];
  ...
  XCTAssertThrows(
      ([ArrayOfAllTypesObject objectsWhere:@"array = %@", obj0].count));
  XCTAssertThrows(
      ([ArrayOfAllTypesObject objectsWhere:@"array != %@", obj0].count));
  ...
  XCTAssertThrows(
      ([SetOfAllTypesObject objectsWhere:@"set != %@", obj0].count));
  ...
  RLMAssertCount(DictionaryOfAllTypesObject, 1U, @"NONE dictionary != %@",
                 obj1);
  XCTAssertThrows(
      ([DictionaryOfAllTypesObject objectsWhere:@"dictionary = %@", obj0]
           .count));
  XCTAssertThrows(
      ([DictionaryOfAllTypesObject objectsWhere:@"dictionary != %@", obj0]
           .count));
...
- (void)testClass:(Class)class
  ...
  XCTAssertEqual(normalCount,
                 [[self evaluate:[class objectsWithPredicate:predicate]] count],
                 @"%@", predicateFormat);

  predicate = [NSCompoundPredicate notPredicateWithSubpredicate:predicate];
  XCTAssertEqual(notCount,
                 [[self evaluate:[class objectsWithPredicate:predicate]] count],
                 @"%@", predicateFormat);
}
...
- (void)testINPredicate {
  ...
  // BOOL
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"boolCol IN {NO}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"boolCol IN {YES}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"boolCol IN {NO, YES}"];

  // int
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"intCol IN {0, 2, 3}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"intCol IN {1}"];
  ...
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"floatCol IN {0, 2, 3}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"floatCol IN {1.1}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"floatCol IN {1.1, 2.2}"];

  // double
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"doubleCol IN {0, 2, 3}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"doubleCol IN {1.11}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"doubleCol IN {1.11, 2.22}"];

  // NSString
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"stringCol IN {'a'}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"stringCol IN {'b'}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"stringCol IN {'A'}"];
  ...
  // NSData
  // Can't represent NSData with NSPredicate literal. See format predicates
  // below

  // NSDate
  // Can't represent NSDate with NSPredicate literal. See format predicates
  // below
  ...
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"cBoolCol IN {NO}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"cBoolCol IN {YES}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"cBoolCol IN {NO, YES}"];

  // int64_t
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"longCol IN {0, 2, 3}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"longCol IN {2147483648}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"longCol IN {100, 2147483648}"];

  // string subobject
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"objectCol.stringCol IN {'abc'}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"objectCol.stringCol IN {'def'}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"objectCol.stringCol IN {'ABC'}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"objectCol.stringCol IN[c] {'abc'}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"objectCol.stringCol IN[c] {'ABC'}"];
  ...
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"decimalCol IN {0, 2, 3}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"decimalCol IN {1}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"decimalCol IN {1, 2}"];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"decimalCol IN {'1', '2'}"];
  ...
  // RLMObjectId
  // Can't represent RLMObjectId with NSPredicate literal. See format predicates
  // below
  ...
  [self testClass:[AllTypesObject class]
      withNormalCount:1U
             notCount:0U
                where:@"floatCol IN %@", @[ @1.1f ]];
  [self testClass:[AllTypesObject class]
      withNormalCount:1U
             notCount:0U
                where:@"floatCol IN %@", @[ @1.1f, @2 ]];
  ...
  [self testClass:[AllTypesObject class]
      withNormalCount:1U
             notCount:0U
                where:@"longCol IN %@", @[ @(INT_MAX + 1LL) ]];
  [self testClass:[AllTypesObject class]
      withNormalCount:1U
             notCount:0U
                where:@"longCol IN %@", @[ @(INT_MAX + 1LL), @2 ]];
  ...
  [self testClass:[AllTypesObject class]
      withNormalCount:0
             notCount:1
                where:@"objectIdCol IN %@", @[ otherId ]];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"objectIdCol IN %@", @[ objectId ]];
  [self testClass:[AllTypesObject class]
      withNormalCount:1
             notCount:0
                where:@"objectIdCol IN %@", @[ objectId, otherId ]];
...
- (void)testArrayIn {
  ...
  ArrayPropertyObject *arr =
      [ArrayPropertyObject createInRealm:realm
                               withValue:@[ @"name", @[], @[] ]];
  [arr.array addObject:[StringObject createInRealm:realm
                                         withValue:@[ @"value" ]]];
  StringObject *otherStringObject =
      [StringObject createInRealm:realm withValue:@[ @"some other value" ]];
  [realm commitWriteTransaction];

  RLMAssertCount(ArrayPropertyObject, 0U, @"ANY array.stringCol IN %@",
                 @[ @"missing" ]);
  RLMAssertCount(ArrayPropertyObject, 1U, @"ANY array.stringCol IN %@",
                 @[ @"value" ]);
  RLMAssertCount(ArrayPropertyObject, 1U, @"NONE array.stringCol IN %@",
                 @[ @"missing" ]);
  RLMAssertCount(ArrayPropertyObject, 0U, @"NONE array.stringCol IN %@",
                 @[ @"value" ]);

  RLMAssertCount(ArrayPropertyObject, 0U, @"ANY array IN %@",
                 [StringObject objectsWhere:@"stringCol = 'missing'"]);
  RLMAssertCount(ArrayPropertyObject, 1U, @"ANY array IN %@",
                 [StringObject objectsWhere:@"stringCol = 'value'"]);
  RLMAssertCount(ArrayPropertyObject, 1U, @"NONE array IN %@",
                 [StringObject objectsWhere:@"stringCol = 'missing'"]);
  RLMAssertCount(ArrayPropertyObject, 0U, @"NONE array IN %@",
                 [StringObject objectsWhere:@"stringCol = 'value'"]);

  StringObject *stringObject =
      [[StringObject allObjectsInRealm:realm] firstObject];
...
- (void)testSetIn {
  ...
  SetPropertyObject *s =
      [SetPropertyObject createInRealm:realm withValue:@[ @"name", @[], @[] ]];
  [s.set addObject:[StringObject createInRealm:realm withValue:@[ @"value" ]]];
  StringObject *otherStringObject =
      [StringObject createInRealm:realm withValue:@[ @"some other value" ]];
  [realm commitWriteTransaction];

  RLMAssertCount(SetPropertyObject, 0U, @"ANY set.stringCol IN %@",
                 @[ @"missing" ]);
  RLMAssertCount(SetPropertyObject, 1U, @"ANY set.stringCol IN %@",
                 @[ @"value" ]);
  RLMAssertCount(SetPropertyObject, 1U, @"NONE set.stringCol IN %@",
                 @[ @"missing" ]);
  RLMAssertCount(SetPropertyObject, 0U, @"NONE set.stringCol IN %@",
                 @[ @"value" ]);

  RLMAssertCount(SetPropertyObject, 0U, @"ANY set IN %@",
                 [StringObject objectsWhere:@"stringCol = 'missing'"]);
  RLMAssertCount(SetPropertyObject, 1U, @"ANY set IN %@",
                 [StringObject objectsWhere:@"stringCol = 'value'"]);
  RLMAssertCount(SetPropertyObject, 1U, @"NONE set IN %@",
                 [StringObject objectsWhere:@"stringCol = 'missing'"]);
  RLMAssertCount(SetPropertyObject, 0U, @"NONE set IN %@",
                 [StringObject objectsWhere:@"stringCol = 'value'"]);
...
- (void)testDictionaryIn {
  ...
  DictionaryPropertyObject *dict = [DictionaryPropertyObject createInRealm:realm
                                                                 withValue:@[]];
  dict.stringDictionary[@"value"] = [StringObject createInRealm:realm
                                                      withValue:@[ @"value" ]];
  StringObject *otherStringObject =
      [StringObject createInRealm:realm withValue:@[ @"some other value" ]];
  [realm commitWriteTransaction];
  ...
  RLMAssertCount(DictionaryPropertyObject, 0U,
                 @"ANY stringDictionary.stringCol IN %@", @[ @"missing" ]);
  RLMAssertCount(DictionaryPropertyObject, 1U,
                 @"ANY stringDictionary.stringCol IN %@", @[ @"value" ]);
  RLMAssertCount(DictionaryPropertyObject, 1U,
                 @"NONE stringDictionary.stringCol IN %@", @[ @"missing" ]);
  RLMAssertCount(DictionaryPropertyObject, 0U,
                 @"NONE stringDictionary.stringCol IN %@", @[ @"value" ]);

  RLMAssertCount(DictionaryPropertyObject, 0U, @"ANY stringDictionary IN %@",
                 [StringObject objectsWhere:@"stringCol = 'missing'"]);
  RLMAssertCount(DictionaryPropertyObject, 1U, @"ANY stringDictionary IN %@",
                 [StringObject objectsWhere:@"stringCol = 'value'"]);
  RLMAssertCount(DictionaryPropertyObject, 1U, @"NONE stringDictionary IN %@",
                 [StringObject objectsWhere:@"stringCol = 'missing'"]);
  RLMAssertCount(DictionaryPropertyObject, 0U, @"NONE stringDictionary IN %@",
                 [StringObject objectsWhere:@"stringCol = 'value'"]);

  StringObject *stringObject =
      [[StringObject allObjectsInRealm:realm] firstObject];
  RLMAssertCount(DictionaryPropertyObject, 1U, @"%@ IN stringDictionary",
                 stringObject);
  RLMAssertCount(DictionaryPropertyObject, 0U, @"%@ IN stringDictionary",
                 otherStringObject);
}
...
- (void)testQueryChaining {
  ...
  XCTAssertEqual(0U, [[[PersonObject objectsWhere:@"name == 'Ari'"]
                         objectsWhere:@"age == 29"] count]);
}
...
- (void)testLinkViewQuery {
  ...
  for (NSDictionary *eData in employees) {
        company.employeeDict[eData[@"name"]] =
            [[EmployeeObject alloc] initWithValue:eData];
  }
  [realm commitWriteTransaction];
  ...
  RLMAssertCount([ co.employees, 1U, @"hired = YES" ] objectsWhere
                 : @"name = 'Joe'");
  ...
  RLMAssertCount([ co.employeeSet, 1U, @"hired = YES" ] objectsWhere
                 : @"name = 'Joe'");
  ...
  RLMAssertCount([ co.employeeDict, 1U, @"hired = YES" ] objectsWhere
                 : @"name = 'Joe'");
}
...
- (void)testLinkViewQueryLifetime {
  ...
  [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"Joe", @"age" : @40, @"hired" : @YES}];
  [realm commitWriteTransaction];
  ...
  @autoreleasepool {
        __attribute((objc_precise_lifetime)) CompanyObject *co =
            [CompanyObject allObjects][0];
  ...
  @autoreleasepool {
        __attribute((objc_precise_lifetime)) CompanyObject *co =
            [CompanyObject allObjects][0];
        [co.employees addObject:[EmployeeObject createInRealm:realm
                                                    withValue:@{
                                                      @"name" : @"Joe",
                                                      @"age" : @40,
                                                      @"hired" : @YES
                                                    }]];
        [co.employeeSet addObject:[EmployeeObject createInRealm:realm
                                                      withValue:@{
                                                        @"name" : @"Joe",
                                                        @"age" : @40,
                                                        @"hired" : @YES
                                                      }]];
        co.employeeDict[@"Joe"] = [EmployeeObject
            createInRealm:realm
                withValue:@{@"name" : @"Joe", @"age" : @40, @"hired" : @YES}];
  }
  [realm commitWriteTransaction];
...
- (void)testLinkViewQueryLiveUpdate {
  ...
  EmployeeObject *eo = [EmployeeObject
      createInRealm:realm
          withValue:@{@"name" : @"Joe", @"age" : @40, @"hired" : @YES}];
  [realm commitWriteTransaction];
  ...
  RLMResults *sort = [co.employees sortedResultsUsingKeyPath:@"name"
                                                   ascending:YES];
  RLMResults *sortQuery =
      [[co.employees sortedResultsUsingKeyPath:@"name"
                                     ascending:YES] objectsWhere:@"age = 40"];
  RLMResults *querySort =
      [[co.employees objectsWhere:@"age = 40"] sortedResultsUsingKeyPath:@"name"
                                                               ascending:YES];
  RLMResults *basic2 = [co.employeeSet objectsWhere:@"age = 40"];
  RLMResults *sort2 = [co.employeeSet sortedResultsUsingKeyPath:@"name"
                                                      ascending:YES];
  RLMResults *sortQuery2 =
      [[co.employeeSet sortedResultsUsingKeyPath:@"name"
                                       ascending:YES] objectsWhere:@"age = 40"];
  RLMResults *querySort2 = [[co.employeeSet objectsWhere:@"age = 40"]
      sortedResultsUsingKeyPath:@"name"
                      ascending:YES];
  RLMResults *basic3 = [co.employeeDict objectsWhere:@"age = 40"];
  RLMResults *sort3 = [co.employeeDict sortedResultsUsingKeyPath:@"name"
                                                       ascending:YES];
  RLMResults *sortQuery3 = [[co.employeeDict sortedResultsUsingKeyPath:@"name"
                                                             ascending:YES]
      objectsWhere:@"age = 40"];
  RLMResults *querySort3 = [[co.employeeDict objectsWhere:@"age = 40"]
      sortedResultsUsingKeyPath:@"name"
                      ascending:YES];
...
- (void)testConstantPredicates {
  ...
  RLMResults *all =
      [PersonObject objectsWithPredicate:[NSPredicate predicateWithValue:YES]];
  XCTAssertEqual(all.count, 3U, @"Expecting 3 results");

  RLMResults *none =
      [PersonObject objectsWithPredicate:[NSPredicate predicateWithValue:NO]];
...
- (void)testEmptyCompoundPredicates {
  ...
  RLMResults *all = [PersonObject
      objectsWithPredicate:[NSCompoundPredicate
                               andPredicateWithSubpredicates:@[]]];
  XCTAssertEqual(all.count, 3U, @"Expecting 3 results");

  RLMResults *none =
      [PersonObject objectsWithPredicate:[NSCompoundPredicate
...
- (NSArray<NSArray *> *)queryObjectClassValues {
  ...
  return @[
    @[
      @YES, @YES, @1, @2, @23.0f, @1.7f, @0.0, @5.55, @"a", @"a", data("a"),
      data("a"), @1, @2, oid1, oid1, @YES, @NO
    ],
    @[
      @YES, @NO, @1, @3, @-5.3f, @4.21f, @1.0, @4.44, @"a", @"A", data("a"),
      data("A"), @1, @3, oid1, oid2, @1, @2
    ],
    @[
      @NO, @NO, @2, @2, @1.0f, @3.55f, @99.9, @6.66, @"a", @"ab", data("a"),
      data("ab"), @2, @2, oid2, oid2, @1.0f, @2.0f
    ],
    @[
      @NO, @YES, @3, @6, @4.21f, @1.0f, @1.0, @7.77, @"a", @"AB", data("a"),
      data("AB"), @3, @6, oid2, oid1, @"one", @"two"
    ],
    @[
      @YES, @YES, @4, @5, @23.0f, @23.0f, @7.4, @8.88, @"a", @"b", data("a"),
      data("b"), @4, @5, oid1, oid1, @"two", @"three"
    ],
    @[
      @YES, @NO, @15, @8, @1.0f, @66.0f, @1.01, @9.99, @"a", @"ba", data("a"),
      data("ba"), @15, @8, oid1, oid2, data("a"), data("b")
    ],
    @[
      @NO, @YES, @15, @15, @1.0f, @66.0f, @1.01, @9.99, @"a", @"BA", data("a"),
      data("BA"), @15, @15, oid2, oid1, oid1, oid2
    ],
  ];
}
...
- (void)testComparisonsWithKeyPathOnRHS {
  ...
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"'WabiRealm' CONTAINS string1"]
          .count,
      @"Operator 'CONTAINS' requires a keypath on the left side.");
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"'Amazon' BEGINSWITH string2"].count,
      @"Operator 'BEGINSWITH' requires a keypath on the left side.");
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"'Tuba' ENDSWITH string1"].count,
      @"Operator 'ENDSWITH' requires a keypath on the left side.");
  RLMAssertThrowsWithReasonMatching(
      [self.queryObjectClass objectsWhere:@"'Tuba' LIKE string1"].count,
...
- (void)testLinksToDeletedOrMovedObject {
  ...
  RLMResults *fidoQuery = [OwnerObject objectsInRealm:realm
                                                where:@"dog == %@", fido];
  RLMResults *rexQuery = [OwnerObject objectsInRealm:realm
                                               where:@"dog == %@", rex];
  RLMResults *spotQuery = [OwnerObject objectsInRealm:realm
                                                where:@"dog == %@", spot];
...
- (void)testQueryOnDeletedSetProperty {
  ...
  [realm beginWriteTransaction];
  IntObject *io = [IntObject createInRealm:realm withValue:@[ @0 ]];
  SetPropertyObject *set =
      [SetPropertyObject createInRealm:realm withValue:@[ @"", @[], @[ io ] ]];
  [realm commitWriteTransaction];
...
- (void)testQueryOnDeletedDictionaryProperty {
  ...
  DictionaryPropertyObject *dpo = [DictionaryPropertyObject
      createInRealm:realm
          withValue:@{@"intObjDictionary" : @{@"0" : io}}];
  [realm commitWriteTransaction];
...
- (void)testSubqueries {
  ...
  for (NSDictionary *eData in employees) {
        first.employeeDict[eData[@"name"]] =
            [[EmployeeObject alloc] initWithValue:eData];
  }
  CompanyObject *second = [CompanyObject
      createInRealm:realm
          withValue:@[ @"second company", employees2, employees2 ]];
  for (NSDictionary *eData in employees2) {
        second.employeeDict[eData[@"name"]] =
            [[EmployeeObject alloc] initWithValue:eData];
  }
  ...
  RLMAssertCount(CompanyObject, 1U,
                 @"SUBQUERY(employees, $employee, $employee.age > 30 AND "
                 @"$employee.hired = FALSE).@count > 0");
  RLMAssertCount(CompanyObject, 2U,
                 @"SUBQUERY(employees, $employee, $employee.age < 30 AND "
                 @"$employee.hired = TRUE).@count == 0");
  RLMAssertCount(CompanyObject, 1U,
                 @"SUBQUERY(employeeSet, $employee, $employee.age > 30 AND "
                 @"$employee.hired = FALSE).@count > 0");
  RLMAssertCount(CompanyObject, 2U,
                 @"SUBQUERY(employeeSet, $employee, $employee.age < 30 AND "
                 @"$employee.hired = TRUE).@count == 0");

  RLMAssertCount(LinkToCompanyObject, 1U,
                 @"SUBQUERY(company.employees, $employee, $employee.age > 30 "
                 @"AND $employee.hired = FALSE).@count > 0");
  RLMAssertCount(LinkToCompanyObject, 2U,
                 @"SUBQUERY(company.employees, $employee, $employee.age < 30 "
                 @"AND $employee.hired = TRUE).@count == 0");

  RLMAssertCount(LinkToCompanyObject, 1U,
                 @"SUBQUERY(company.employeeSet, $employee, $employee.age > 30 "
                 @"AND $employee.hired = FALSE).@count > 0");
  RLMAssertCount(LinkToCompanyObject, 2U,
                 @"SUBQUERY(company.employeeSet, $employee, $employee.age < 30 "
                 @"AND $employee.hired = TRUE).@count == 0");
  ...
  RLMAssertCount(LinkToCompanyObject, 1U,
                 @"SUBQUERY(company.employeeDict, $employee, $employee.age > "
                 @"30 AND $employee.hired = FALSE).@count > 0");
  RLMAssertCount(LinkToCompanyObject, 2U,
                 @"SUBQUERY(company.employeeDict, $employee, $employee.age < "
                 @"30 AND $employee.hired = TRUE).@count == 0");
}
...
- (void)testLinkingObjects {
  ...
  PersonObject *hannah = [PersonObject createInRealm:realm
                                           withValue:@[ @"Hannah", @0 ]];
  PersonObject *elijah = [PersonObject createInRealm:realm
                                           withValue:@[ @"Elijah", @3 ]];

  PersonObject *mark =
      [PersonObject createInRealm:realm
                        withValue:@[ @"Mark", @30, @[ hannah ] ]];
  PersonObject *jason =
      [PersonObject createInRealm:realm
                        withValue:@[ @"Jason", @31, @[ elijah ] ]];

  PersonObject *diane =
      [PersonObject createInRealm:realm
                        withValue:@[ @"Diane", @29, @[ hannah ] ]];
  PersonObject *carol = [PersonObject createInRealm:realm
                                          withValue:@[ @"Carol", @31 ]];

  PersonObject *michael =
      [PersonObject createInRealm:realm
                        withValue:@[ @"Michael", @57, @[ jason, mark ] ]];
  PersonObject *raewynne =
      [PersonObject createInRealm:realm
                        withValue:@[ @"Raewynne", @57, @[ jason, mark ] ]];

  PersonObject *don =
      [PersonObject createInRealm:realm
                        withValue:@[ @"Don", @64, @[ carol, diane ] ]];
  PersonObject *diane_sr =
      [PersonObject createInRealm:realm
                        withValue:@[ @"Diane", @60, @[ carol, diane ] ]];
  ...
  RLMResults *r1 =
      [PersonObject objectsWhere:@"ANY parents.name BEGINSWITH 'M'"];
  XCTAssertEqualObjects(asArray(r1), (@[ hannah, mark, jason ]));

  // People that have a grandparent with a name that starts with 'M'.
  RLMResults *r2 =
      [PersonObject objectsWhere:@"ANY parents.parents.name BEGINSWITH 'M'"];
  ...
  RLMResults *r4 =
      [PersonObject objectsWhere:@"ANY children.parents.parents.name == 'Don'"];
  ...
  RLMResults *r6 =
      [PersonObject objectsWhere:@"SUBQUERY(parents, $parent, "
                                 @"$parent.children.@count > 1).@count > 0"];
  ...
  RLMResults *r9 =
      [PersonObject objectsWhere:@"ANY parents.parents == %@", michael];
  XCTAssertEqualObjects(asArray(r9), (@[ hannah, elijah ]));

  // People that have Hannah as a grandchild.
  RLMResults *r10 =
      [PersonObject objectsWhere:@"ANY children.children == %@", hannah];
  ...
  RLMResults *r12 =
      [PersonObject objectsWhere:@"ANY parents == %@", [PersonObject new]];
  XCTAssertEqualObjects(asArray(r12), (@[]));

  // All links are not equal to a detached row accessor so this will match all
  // rows that are linked to.
  RLMResults *r13 =
      [PersonObject objectsWhere:@"ANY parents != %@", [PersonObject new]];
  XCTAssertEqualObjects(asArray(r13),
                        (@[ hannah, elijah, mark, jason, diane, carol ]));

  // Linking objects cannot contain null so their members cannot be compared
  // with null.
  XCTAssertThrows([PersonObject objectsWhere:@"ANY parents == NULL"]);

  // People that have a parent under the age of 31 where that parent has a
  // parent over the age of 35 whose name is Michael.
  RLMResults *r14 = [PersonObject
      objectsWhere:
          @"SUBQUERY(parents, $p1, $p1.age < 31 AND SUBQUERY($p1.parents, $p2, "
          @"$p2.age > 35 AND $p2.name == 'Michael').@count > 0).@count > 0"];
  ...
  [realm transactionWithBlock:^{
    mackenzie = [PersonObject createInRealm:realm
                                  withValue:@[ @"Mackenzie", @0 ]];
  ...
  // People whose parents have an average age of < 60.
  XCTAssertEqualObjects(asArray(r5),
                        (@[ hannah, elijah, mark, jason, mackenzie ]));

  // People that have at least one sibling.
  XCTAssertEqualObjects(asArray(r6),
                        (@[ elijah, mark, jason, diane, carol, mackenzie ]));
  ...
  XCTAssertEqualObjects(
      asArray(r13),
      (@[ hannah, elijah, mark, jason, diane, carol, mackenzie ]));
...
- (void)testCountOnArrayCollection {
  ...
  IntegerArrayPropertyObject *arr =
      [IntegerArrayPropertyObject createInRealm:realm withValue:@[ @1, @[] ]];
  ...
  RLMAssertThrowsWithReasonMatching(
      ([IntegerArrayPropertyObject
          objectsWhere:@"array.@count == array.@count"]),
      @"aggregate operations cannot be compared with other aggregate "
      @"operations");

  RLMAssertThrowsWithReason(
      ([IntegerArrayPropertyObject objectsWhere:@"array.@count.foo.bar != 0"]),
      @"Invalid keypath 'array.@count.foo.bar': @count must appear at the end "
      @"of a keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerArrayPropertyObject objectsWhere:@"array.@count.intCol > 0"]),
      @"Invalid keypath 'array.@count.intCol': @count must appear at the end "
      @"of a keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerArrayPropertyObject objectsWhere:@"array.@count != 'Hello'"]),
...
- (void)testCountOnSetCollection {
  ...
  IntegerSetPropertyObject *set =
      [IntegerSetPropertyObject createInRealm:realm withValue:@[ @1, @[] ]];
  ...
  // We do not yet handle collection operations on both sides of the comparison.
  RLMAssertThrowsWithReason(
      ([IntegerSetPropertyObject objectsWhere:@"set.@count == set.@count"]),
      @"aggregate operations cannot be compared with other aggregate "
      @"operations");

  RLMAssertThrowsWithReason(
      ([IntegerSetPropertyObject objectsWhere:@"set.@count.foo.bar != 0"]),
      @"Invalid keypath 'set.@count.foo.bar': @count must appear at the end of "
      @"a keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerSetPropertyObject objectsWhere:@"set.@count.intCol > 0"]),
      @"Invalid keypath 'set.@count.intCol': @count must appear at the end of "
      @"a keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerSetPropertyObject objectsWhere:@"set.@count != 'Hello'"]),
      @"@count can only be compared with a numeric value");
}
...
- (void)testCountOnDictionaryCollection {
  ...
  IntegerDictionaryPropertyObject *idpo =
      [IntegerDictionaryPropertyObject createInRealm:realm
                                           withValue:@[ @1, @[] ]];
  idpo.dictionary[@"456"] = [IntObject createInRealm:realm withValue:@[ @456 ]];

  idpo = [IntegerDictionaryPropertyObject createInRealm:realm
                                              withValue:@[ @2, @[] ]];
  ...
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@count == 3");
  ...
  RLMAssertCount(IntegerDictionaryPropertyObject, 2U,
  ...
  RLMAssertThrowsWithReason(
      ([IntegerDictionaryPropertyObject
          objectsWhere:@"dictionary.@count == dictionary.@count"]),
      @"aggregate operations cannot be compared with other aggregate "
      @"operations");

  RLMAssertThrowsWithReason(
      ([IntegerDictionaryPropertyObject
          objectsWhere:@"dictionary.@count.foo.bar != 0"]),
      @"Invalid keypath 'dictionary.@count.foo.bar': @count must appear at the "
      @"end of a keypath.");
  RLMAssertThrowsWithReason(([IntegerDictionaryPropertyObject
                                objectsWhere:@"dictionary.@count.intCol > 0"]),
                            @"Invalid keypath 'dictionary.@count.intCol': "
                            @"@count must appear at the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerDictionaryPropertyObject
          objectsWhere:@"dictionary.@count != 'Hello'"]),
      @"@count can only be compared with a numeric value");
}
...
- (void)testAggregateArrayCollectionOperators {
  ...
  IntegerArrayPropertyObject *arr =
      [IntegerArrayPropertyObject createInRealm:realm
                                      withValue:@[ @1111, @[] ]];
  ...
  arr = [IntegerArrayPropertyObject createInRealm:realm
                                        withValue:@[ @2222, @[] ]];
  ...
  RLMAssertCount(IntegerArrayPropertyObject, 1U,
                 @"array.@min.intCol == -12345");
  ...
  RLMAssertThrowsWithReason(
      ([IntegerArrayPropertyObject
          objectsWhere:@"array.@min.intCol == array.@min.intCol"]),
      @"aggregate operations cannot be compared with other aggregate "
      @"operations");

  RLMAssertThrowsWithReason(
      ([IntegerArrayPropertyObject
          objectsWhere:@"array.@min.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'array.@min.intCol.foo.bar': Property "
      @"'IntObject.intCol' is not a link or collection and can only appear at "
      @"the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerArrayPropertyObject
          objectsWhere:@"array.@max.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'array.@max.intCol.foo.bar': Property "
      @"'IntObject.intCol' is not a link or collection and can only appear at "
      @"the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerArrayPropertyObject
          objectsWhere:@"array.@sum.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'array.@sum.intCol.foo.bar': Property "
      @"'IntObject.intCol' is not a link or collection and can only appear at "
      @"the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerArrayPropertyObject
          objectsWhere:@"array.@avg.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'array.@avg.intCol.foo.bar': Property "
      @"'IntObject.intCol' is not a link or collection and can only appear at "
      @"the end of a keypath.");

  // Average is omitted from this test as its result is always a double.
  RLMAssertThrowsWithReasonMatching(
      ([IntegerArrayPropertyObject objectsWhere:@"array.@min.intCol == 1.23"]),
      @"@min.*type int cannot be compared");
  RLMAssertThrowsWithReasonMatching(
      ([IntegerArrayPropertyObject objectsWhere:@"array.@max.intCol == 1.23"]),
      @"@max.*type int cannot be compared");
  RLMAssertThrowsWithReasonMatching(
      ([IntegerArrayPropertyObject objectsWhere:@"array.@sum.intCol == 1.23"]),
...
- (void)testAggregateSetCollectionOperators {
  ...
  IntegerSetPropertyObject *set =
      [IntegerSetPropertyObject createInRealm:realm withValue:@[ @1111, @[] ]];
  ...
  set = [IntegerSetPropertyObject createInRealm:realm
                                      withValue:@[ @2222, @[] ]];
  ...
  // We do not yet handle collection operations on both sides of the comparison.
  RLMAssertThrowsWithReason(
      ([IntegerSetPropertyObject
          objectsWhere:@"set.@min.intCol == set.@min.intCol"]),
      @"aggregate operations cannot be compared with other aggregate "
      @"operations");

  RLMAssertThrowsWithReason(
      ([IntegerSetPropertyObject
          objectsWhere:@"set.@min.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'set.@min.intCol.foo.bar': Property 'IntObject.intCol' "
      @"is not a link or collection and can only appear at the end of a "
      @"keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerSetPropertyObject
          objectsWhere:@"set.@max.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'set.@max.intCol.foo.bar': Property 'IntObject.intCol' "
      @"is not a link or collection and can only appear at the end of a "
      @"keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerSetPropertyObject
          objectsWhere:@"set.@sum.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'set.@sum.intCol.foo.bar': Property 'IntObject.intCol' "
      @"is not a link or collection and can only appear at the end of a "
      @"keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerSetPropertyObject
          objectsWhere:@"set.@avg.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'set.@avg.intCol.foo.bar': Property 'IntObject.intCol' "
      @"is not a link or collection and can only appear at the end of a "
      @"keypath.");

  // Average is omitted from this test as its result is always a double.
  RLMAssertThrowsWithReasonMatching(
      ([IntegerSetPropertyObject objectsWhere:@"set.@min.intCol == 1.23"]),
      @"@min.*type int cannot be compared");
  RLMAssertThrowsWithReasonMatching(
      ([IntegerSetPropertyObject objectsWhere:@"set.@max.intCol == 1.23"]),
      @"@max.*type int cannot be compared");
  RLMAssertThrowsWithReasonMatching(
      ([IntegerSetPropertyObject objectsWhere:@"set.@sum.intCol == 1.23"]),
      @"@sum.*type int cannot be compared");
}
...
- (void)testAggregateDictionaryCollectionOperators {
  ...
  idpo.dictionary[@"2"] = [IntObject createInRealm:realm
                                         withValue:@[ @-12345 ]];
  ...
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@min.intCol == -12345");
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@min.intCol == 100");
  RLMAssertCount(IntegerDictionaryPropertyObject, 2U,
                 @"dictionary.@min.intCol < 1000");
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@min.intCol > -1000");

  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@max.intCol == 1234");
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@max.intCol == 100");
  RLMAssertCount(IntegerDictionaryPropertyObject, 2U,
                 @"dictionary.@max.intCol > -1000");
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@max.intCol > 1000");

  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@sum.intCol == 100");
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@sum.intCol == -11109");
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@sum.intCol == 0");
  RLMAssertCount(IntegerDictionaryPropertyObject, 2U,
                 @"dictionary.@sum.intCol > -50");
  RLMAssertCount(IntegerDictionaryPropertyObject, 2U,
                 @"dictionary.@sum.intCol < 50");

  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@avg.intCol == 100");
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@avg.intCol == -3703");
  RLMAssertCount(IntegerDictionaryPropertyObject, 0U,
                 @"dictionary.@avg.intCol == 0");
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@avg.intCol < -50");
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@avg.intCol > 50");

  RLMAssertCount(IntegerDictionaryPropertyObject, 2U,
                 @"dictionary.@min.intCol < number");
  RLMAssertCount(IntegerDictionaryPropertyObject, 2U,
                 @"number > dictionary.@min.intCol");

  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"dictionary.@max.intCol < number");
  RLMAssertCount(IntegerDictionaryPropertyObject, 1U,
                 @"number > dictionary.@max.intCol");

  RLMAssertCount(IntegerDictionaryPropertyObject, 2U,
                 @"dictionary.@avg.intCol < number");
  RLMAssertCount(IntegerDictionaryPropertyObject, 2U,
                 @"number > dictionary.@avg.intCol");

  // We do not yet handle collection operations on both sides of the comparison.
  RLMAssertThrowsWithReason(
      ([IntegerDictionaryPropertyObject
          objectsWhere:@"dictionary.@min.intCol == dictionary.@min.intCol"]),
      @"aggregate operations cannot be compared with other aggregate "
      @"operations");

  RLMAssertThrowsWithReason(
      ([IntegerDictionaryPropertyObject
          objectsWhere:@"dictionary.@min.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'dictionary.@min.intCol.foo.bar': Property "
      @"'IntObject.intCol' is not a link or collection and can only appear at "
      @"the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerDictionaryPropertyObject
          objectsWhere:@"dictionary.@max.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'dictionary.@max.intCol.foo.bar': Property "
      @"'IntObject.intCol' is not a link or collection and can only appear at "
      @"the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerDictionaryPropertyObject
          objectsWhere:@"dictionary.@sum.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'dictionary.@sum.intCol.foo.bar': Property "
      @"'IntObject.intCol' is not a link or collection and can only appear at "
      @"the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([IntegerDictionaryPropertyObject
          objectsWhere:@"dictionary.@avg.intCol.foo.bar == 1.23"]),
      @"Invalid keypath 'dictionary.@avg.intCol.foo.bar': Property "
      @"'IntObject.intCol' is not a link or collection and can only appear at "
      @"the end of a keypath.");
  ...
  RLMAssertThrowsWithReasonMatching(
      ([IntegerDictionaryPropertyObject
          objectsWhere:@"dictionary.@min.intCol == 1.23"]),
      @"@min.*type int cannot be compared");
  RLMAssertThrowsWithReasonMatching(
      ([IntegerDictionaryPropertyObject
          objectsWhere:@"dictionary.@max.intCol == 1.23"]),
      @"@max.*type int cannot be compared");
  RLMAssertThrowsWithReasonMatching(
      ([IntegerDictionaryPropertyObject
          objectsWhere:@"dictionary.@sum.intCol == 1.23"]),
      @"@sum.*type int cannot be compared");
}
...
- (void)testDictionaryQueryAllKeys {
  void (^test)(NSString *, id) = ^(NSString *property, id value) {
    RLMRealm *realm = [self realm];
    [realm beginWriteTransaction];
    [AllDictionariesObject createInRealm:realm
                               withValue:@{property : @{@"key1" : value}}];
    [AllDictionariesObject createInRealm:realm
                               withValue:@{property : @{@"key2" : value}}];
    [AllDictionariesObject createInRealm:realm
                               withValue:@{property : @{@"key3" : value}}];
    [AllDictionariesObject createInRealm:realm
                               withValue:@{property : @{@"key1" : value}}];
    [AllDictionariesObject createInRealm:realm
                               withValue:@{property : @{@"KEY3" : value}}];
    [AllDictionariesObject createInRealm:realm
                               withValue:@{property : @{@"kêÿ2" : value}}];
    [AllDictionariesObject createInRealm:realm
                               withValue:@{property : @{@"KEY2" : value}}];
    [AllDictionariesObject createInRealm:realm
                               withValue:@{property : @{@"lock1" : value}}];
    [realm commitWriteTransaction];

    RLMAssertCount(AllDictionariesObject, 0U, @"ANY %K.@allKeys = 'key'",
                   property);
    RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allKeys = 'key1'",
                   property);
    RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allKeys = 'key3'",
                   property);
    RLMAssertCount(AllDictionariesObject, 7U, @"ANY %K.@allKeys != 'key3'",
                   property);
    RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allKeys =[c] 'key3'",
                   property);
    RLMAssertCount(AllDictionariesObject, 6U, @"ANY %K.@allKeys !=[c] 'key3'",
                   property);
    RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allKeys =[cd] 'key3'",
                   property);
    RLMAssertCount(AllDictionariesObject, 6U, @"ANY %K.@allKeys !=[cd] 'key3'",
                   property);
    RLMAssertCount(AllDictionariesObject, 2U,
                   @"NOT ANY %K.@allKeys !=[cd] 'key3'", property);
    // BEGINSWITH
    RLMAssertCount(AllDictionariesObject, 4U,
                   @"ANY %K.@allKeys BEGINSWITH 'ke'", property);
    RLMAssertCount(AllDictionariesObject, 4U,
                   @"NOT ANY %K.@allKeys BEGINSWITH 'ke'", property);
    RLMAssertCount(AllDictionariesObject, 6U,
                   @"ANY %K.@allKeys BEGINSWITH[c] 'ke'", property);
    RLMAssertCount(AllDictionariesObject, 7U,
                   @"ANY %K.@allKeys BEGINSWITH[cd] 'ke'", property);
    RLMAssertCount(AllDictionariesObject, 0U,
                   @"ANY %K.@allKeys BEGINSWITH NULL", property);
    // CONTAINS
    RLMAssertCount(AllDictionariesObject, 4U, @"ANY %K.@allKeys CONTAINS 'ey'",
                   property);
    RLMAssertCount(AllDictionariesObject, 6U,
                   @"ANY %K.@allKeys CONTAINS[c] 'ey'", property);
    RLMAssertCount(AllDictionariesObject, 7U,
                   @"ANY %K.@allKeys CONTAINS[cd] 'ey'", property);
    RLMAssertCount(AllDictionariesObject, 0U, @"ANY %K.@allKeys CONTAINS NULL",
                   property);
    // ENDSWITH
    RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allKeys ENDSWITH 'y2'",
                   property);
    RLMAssertCount(AllDictionariesObject, 2U,
                   @"ANY %K.@allKeys ENDSWITH[c] 'y2'", property);
    RLMAssertCount(AllDictionariesObject, 3U,
                   @"ANY %K.@allKeys ENDSWITH[cd] 'y2'", property);
    RLMAssertCount(AllDictionariesObject, 0U, @"ANY %K.@allKeys ENDSWITH NULL",
                   property);
    // LIKE
    RLMAssertCount(AllDictionariesObject, 4U, @"ANY %K.@allKeys LIKE 'key*'",
                   property);
    RLMAssertCount(AllDictionariesObject, 6U, @"ANY %K.@allKeys LIKE[c] 'key*'",
                   property);
    RLMAssertCount(AllDictionariesObject, 0U, @"ANY %K.@allKeys LIKE NULL",
                   property);
    RLMAssertCount(AllDictionariesObject, 4U,
                   @"NOT ANY %K.@allKeys LIKE 'key*'", property);
    RLMAssertCount(AllDictionariesObject, 2U,
                   @"NOT ANY %K.@allKeys LIKE[c] 'key*'", property);
    RLMAssertCount(AllDictionariesObject, 8U, @"NOT ANY %K.@allKeys LIKE NULL",
                   property);
    RLMAssertThrowsWithReason(
        ([AllDictionariesObject
            objectsInRealm:realm
                     where:@"ANY %K.@allKeys LIKE[cd] 'key*'", property]),
...
- (void)testDictionaryQueryAllValues_RLMObject {
  ...
  [realm beginWriteTransaction];
  [AllDictionariesObject createInRealm:realm
                             withValue:@{property : @{@"aKey" : values[0]}}];
  [AllDictionariesObject createInRealm:realm
                             withValue:@{property : @{@"aKey2" : values[1]}}];
  [AllDictionariesObject createInRealm:realm
                             withValue:@{property : @{@"aKey3" : values[2]}}];
  [realm commitWriteTransaction];

  StringObject *obj = [[StringObject
      objectsInRealm:realm
               where:@"stringCol = %@", [values[0] stringCol]] firstObject];
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues = %@", property,
                 obj);
  RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allValues != %@",
                 property, obj);
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues IN %@",
                 property, @[ obj ]);
  RLMAssertCount(AllDictionariesObject, 0U, @"ANY %K.@allValues IN %@",
                 property, @[]);

  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.stringCol = %@", property,
                 obj.stringCol);
  RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.stringCol != %@", property,
                 obj.stringCol);
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.stringCol BEGINSWITH %@",
                 property, @"h");
  RLMAssertCount(AllDictionariesObject, 3U,
                 @"ANY %K.stringCol BEGINSWITH[c] %@", property, @"h");
  RLMAssertCount(AllDictionariesObject, 2U,
                 @"ANY %K.stringCol BEGINSWITH[c] %@", property, @"he");
  RLMAssertCount(AllDictionariesObject, 3U,
                 @"ANY %K.stringCol BEGINSWITH[cd] %@", property, @"he");

  RLMAssertThrowsWithReason(
      ([AllDictionariesObject objectsInRealm:realm
                                       where:@"ANY %K.@allValues BETWEEN %@",
                                             property, @[ obj, obj ]]),
      @"Operator 'BETWEEN' not supported for type 'object'");
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject
          objectsInRealm:realm
                   where:@"ANY %K.@allValues BEGINSWITH %@", property, obj]),
      @"Operator 'BEGINSWITH' not supported for type 'object'");
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject
          objectsInRealm:realm
                   where:@"ANY %K.@allValues CONTAINS %@", property, obj]),
      @"Operator 'CONTAINS' not supported for type 'object'");
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject
          objectsInRealm:realm
                   where:@"ANY %K.@allValues ENDSWITH %@", property, obj]),
      @"Operator 'ENDSWITH' not supported for type 'object'");
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject
          objectsInRealm:realm
                   where:@"ANY %K.@allValues LIKE %@", property, obj]),
...
- (void)testDictionaryQueryAllValues_NSString {
  ...
  RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allValues != %@",
                 property, values[0]);
  RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allValues =[c] %@",
                 property, values[0]);
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues !=[c] %@",
                 property, values[0]);
  RLMAssertCount(AllDictionariesObject, 3U, @"ANY %K.@allValues =[cd] %@",
                 property, values[0]);
  RLMAssertCount(AllDictionariesObject, 0U, @"ANY %K.@allValues !=[cd] %@",
                 property, values[0]);
  // BEGINSWITH
  RLMAssertCount(AllDictionariesObject, 1U,
                 @"ANY %K.@allValues BEGINSWITH 'he'", property);
  RLMAssertCount(AllDictionariesObject, 2U,
                 @"NOT ANY %K.@allValues BEGINSWITH 'he'", property);
  RLMAssertCount(AllDictionariesObject, 2U,
                 @"ANY %K.@allValues BEGINSWITH[c] 'he'", property);
  RLMAssertCount(AllDictionariesObject, 3U,
                 @"ANY %K.@allValues BEGINSWITH[cd] 'he'", property);
  RLMAssertCount(AllDictionariesObject, 0U,
                 @"ANY %K.@allValues BEGINSWITH NULL", property);
  // CONTAINS
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues CONTAINS 'el'",
                 property);
  RLMAssertCount(AllDictionariesObject, 2U,
                 @"ANY %K.@allValues CONTAINS[c] 'el'", property);
  RLMAssertCount(AllDictionariesObject, 3U,
                 @"ANY %K.@allValues CONTAINS[cd] 'el'", property);
  RLMAssertCount(AllDictionariesObject, 0U, @"ANY %K.@allValues CONTAINS NULL",
                 property);
  // ENDSWITH
  RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allValues ENDSWITH 'lo'",
                 property);
  RLMAssertCount(AllDictionariesObject, 3U,
                 @"ANY %K.@allValues ENDSWITH[c] 'lo'", property);
  RLMAssertCount(AllDictionariesObject, 3U,
                 @"ANY %K.@allValues ENDSWITH[cd] 'lo'", property);
  RLMAssertCount(AllDictionariesObject, 0U, @"ANY %K.@allValues ENDSWITH NULL",
                 property);
  // LIKE
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues LIKE 'hel*'",
                 property);
  RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allValues LIKE[c] 'hel*'",
                 property);
  RLMAssertCount(AllDictionariesObject, 0U, @"ANY %K.@allValues LIKE NULL",
                 property);
  RLMAssertCount(AllDictionariesObject, 2U,
                 @"NOT ANY %K.@allValues LIKE 'hel*'", property);
  RLMAssertCount(AllDictionariesObject, 1U,
                 @"NOT ANY %K.@allValues LIKE[c] 'hel*'", property);
  RLMAssertCount(AllDictionariesObject, 3U, @"NOT ANY %K.@allValues LIKE NULL",
                 property);
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject
          objectsInRealm:realm
                   where:@"ANY %K.@allValues LIKE[cd] 'hel*'", property]),
      @"Operator 'LIKE' not supported with diacritic-insensitive modifier.");
}
...
- (void)testDictionaryQueryAllValues_ObjectId {
  ...
  NSArray *values = @[
    [[RLMObjectId alloc] initWithString:@"60425fff91d7a195d5ddac1b" error:nil],
  ...
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues =[c] %@",
                 property, values[0]);
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues =[cd] %@",
                 property, values[0]);
  ...
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject
          objectsInRealm:realm
                   where:@"ANY %K.@allValues > %@", property, values[0]]),
  ...
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject
          objectsInRealm:realm
                   where:@"ANY %K.@allValues LIKE %@", property, values[0]]),
      @"Operator 'LIKE' not supported for type 'object id'");
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject objectsInRealm:realm
                                       where:@"ANY %K.@allValues BEGINSWITH %@",
                                             property, values[0]]),
      @"Operator 'BEGINSWITH' not supported for type 'object id'");
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject objectsInRealm:realm
                                       where:@"ANY %K.@allValues CONTAINS %@",
                                             property, values[0]]),
      @"Operator 'CONTAINS' not supported for type 'object id'");
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject objectsInRealm:realm
                                       where:@"ANY %K.@allValues ENDSWITH %@",
                                             property, values[0]]),
      @"Operator 'ENDSWITH' not supported for type 'object id'");
}
...
- (void)testDictionaryQueryAllValues_UUID {
  ...
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues =[cd] %@",
                 property, values[0]);
  RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allValues !=[cd] %@",
                 property, values[0]);
  ...
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject
          objectsInRealm:realm
                   where:@"ANY %K.@allValues LIKE %@", property, values[0]]),
      @"Operator 'LIKE' not supported for type 'uuid'");
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject objectsInRealm:realm
                                       where:@"ANY %K.@allValues BEGINSWITH %@",
                                             property, values[0]]),
      @"Operator 'BEGINSWITH' not supported for type 'uuid'");
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject objectsInRealm:realm
                                       where:@"ANY %K.@allValues CONTAINS %@",
                                             property, values[0]]),
      @"Operator 'CONTAINS' not supported for type 'uuid'");
  RLMAssertThrowsWithReason(
      ([AllDictionariesObject objectsInRealm:realm
                                       where:@"ANY %K.@allValues ENDSWITH %@",
                                             property, values[0]]),
      @"Operator 'ENDSWITH' not supported for type 'uuid'");
}

- (void)testDictionaryQueryAllValues_Data {
  NSString *property = @"dataDict";
  NSArray *values = @[
    [NSData dataWithBytes:"hey" length:3], [NSData dataWithBytes:"hi" length:2],
  ...
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues LIKE %@",
                 property, [NSData dataWithBytes:"hello" length:5]);
  RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allValues LIKE %@",
                 property, [NSData dataWithBytes:"he*" length:3]);
  RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allValues BEGINSWITH %@",
                 property, [NSData dataWithBytes:"he" length:2]);
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues CONTAINS %@",
                 property, [NSData dataWithBytes:"ell" length:3]);
  RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues ENDSWITH %@",
                 property, [NSData dataWithBytes:"lo" length:2]);
...
- (void)testDictionaryQueryAllValues {
  void (^test)(NSString *, NSArray *) = ^(NSString *property, NSArray *values) {
    ...
    if ([property isEqualToString:@"boolDict"]) {
      RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allValues = %@",
                     property, values[0]);
      RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues != %@",
                     property, values[0]);
      RLMAssertCount(AllDictionariesObject, 2U, @"ANY %K.@allValues =[c] %@",
                     property, values[0]);
      RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues !=[c] %@",
      ...
      RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues > %@",
                     property, values[0]);
      RLMAssertCount(AllDictionariesObject, 2U, @"NOT ANY %K.@allValues > %@",
                     property, values[0]);
      RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues >[c] %@",
                     property, values[0]);
      RLMAssertCount(AllDictionariesObject, 1U, @"ANY %K.@allValues >[cd] %@",
  ...
  test(@"decimalDict", @[
    [RLMDecimal128 decimalWithNumber:@456.123],
    [RLMDecimal128 decimalWithNumber:@123.123],
    [RLMDecimal128 decimalWithNumber:@789.123]
  ]);
  test(@"dateDict", @[
    [NSDate dateWithTimeIntervalSince1970:4000],
    [NSDate dateWithTimeIntervalSince1970:2000],
    [NSDate dateWithTimeIntervalSince1970:8000]
  ]);
}

- (void)testDictionaryQueryKeySubscript {
  void (^test)(NSString *, NSArray *,
               BOOL) = ^(NSString *property, NSArray *values, BOOL isNumeric) {
    RLMRealm *realm = [self realm];
    [realm beginWriteTransaction];
    [AllDictionariesObject createInRealm:realm
                               withValue:@{property : @{@"aKey" : values[0]}}];
    ...
    RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] = %@", property,
                   values[0]);
    RLMAssertCount(AllDictionariesObject, 2U, @"%K['aKey'] != %@", property,
                   values[0]);
    RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] =[c] %@", property,
                   values[0]);
    RLMAssertCount(AllDictionariesObject, 2U, @"%K['aKey'] !=[c] %@", property,
                   values[0]);
    RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] =[cd] %@", property,
                   values[0]);

    if (isNumeric) {
      RLMAssertCount(AllDictionariesObject, 0U, @"%K['aKey'] > %@", property,
                     values[0]);
      RLMAssertCount(AllDictionariesObject, 3U, @"NOT %K['aKey'] > %@",
                     property, values[0]);
      RLMAssertCount(AllDictionariesObject, 0U, @"%K['aKey'] >[c] %@", property,
                     values[0]);
      RLMAssertCount(AllDictionariesObject, 0U, @"%K['aKey'] >[cd] %@",
                     property, values[0]);
      ...
      RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] =[c] %@", property,
                     values[0]);
      RLMAssertCount(AllDictionariesObject, 2U, @"%K['aKey'] !=[c] %@",
                     property, values[0]);
      RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] =[cd] %@",
                     property, values[0]);
      RLMAssertCount(AllDictionariesObject, 2U, @"%K['aKey'] !=[cd] %@",
                     property, values[0]);
      // BEGINSWITH
      RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] BEGINSWITH 'he'",
                     property);
      RLMAssertCount(AllDictionariesObject, 2U,
                     @"NOT %K['aKey'] BEGINSWITH 'he'", property);
      RLMAssertCount(AllDictionariesObject, 1U,
                     @"%K['aKey'] BEGINSWITH[c] 'he'", property);
      RLMAssertCount(AllDictionariesObject, 1U,
                     @"%K['aKey'] BEGINSWITH[cd] 'he'", property);
      RLMAssertCount(AllDictionariesObject, 0U, @"%K['aKey'] BEGINSWITH NULL",
                     property);
      // CONTAINS
      RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] CONTAINS 'el'",
                     property);
      RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] CONTAINS[c] 'el'",
                     property);
      RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] CONTAINS[cd] 'el'",
                     property);
      RLMAssertCount(AllDictionariesObject, 0U, @"%K['aKey'] CONTAINS NULL",
                     property);
      // ENDSWITH
      RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] ENDSWITH 'lo'",
                     property);
      RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] ENDSWITH[c] 'lo'",
                     property);
      RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] ENDSWITH[cd] 'lo'",
                     property);
      RLMAssertCount(AllDictionariesObject, 0U, @"%K['aKey'] ENDSWITH NULL",
                     property);
      // LIKE
      RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] LIKE 'hel*'",
                     property);
      RLMAssertCount(AllDictionariesObject, 1U, @"%K['aKey'] LIKE[c] 'hel*'",
                     property);
      RLMAssertCount(AllDictionariesObject, 2U, @"%K['aKey'] LIKE NULL",
                     property);
      RLMAssertCount(AllDictionariesObject, 2U, @"NOT %K['aKey'] LIKE 'hel*'",
                     property);
      RLMAssertCount(AllDictionariesObject, 2U,
                     @"NOT %K['aKey'] LIKE[c] 'hel*'", property);
      RLMAssertCount(AllDictionariesObject, 1U, @"NOT %K['aKey'] LIKE NULL",
                     property);
      RLMAssertThrowsWithReasonMatching(
          ([AllDictionariesObject
              objectsInRealm:realm
                       where:@"%K['aKey'] LIKE[cd] 'hel*'", property]),
          @"not supported");
    }
  ...
  test(@"objectIdDict",
       @[
         [[RLMObjectId alloc] initWithString:@"60425fff91d7a195d5ddac1b"
                                       error:nil],
         [[RLMObjectId alloc] initWithString:@"60425fff91d7a195d5ddac1a"
                                       error:nil],
         [[RLMObjectId alloc] initWithString:@"60425fff91d7a195d5ddac1c"
                                       error:nil]
       ],
       YES);
...
- (void)testDictionaryQueryKeySubscriptWithObjectCol {
  RLMRealm *realm = [self realm];
  [realm beginWriteTransaction];
  [DictionaryParentObject
      createInRealm:realm
          withValue:@{@"objectCol" : @{@"stringDict" : @{@"aKey" : @"blah"}}}];
  [realm commitWriteTransaction];
  // This test checks that we can use a link col keypath to the dictionary and
  // subscript it.
  RLMAssertCount(DictionaryParentObject, 1U, @"%K['aKey'] = %@",
                 @"objectCol.stringDict", @"blah");
}

- (void)testDictionarySubscriptThrowsException {
  RLMRealm *realm = [self realm];
  RLMAssertThrowsWithReason(([realm objects:@"ArrayPropertyObject"
                                      where:@"array['invalid'] = NULL"]),
                            @"Invalid keypath 'array[\"invalid\"]': only "
                            @"dictionaries support subscript predicates.");
  RLMAssertThrowsWithReason(([realm objects:@"SetPropertyObject"
                                      where:@"set['invalid'] = NULL"]),
                            @"Invalid keypath 'set[\"invalid\"]': only "
                            @"dictionaries support subscript predicates.");
  RLMAssertThrowsWithReason(([realm objects:@"OwnerObject"
                                      where:@"dog['dogName'] = NULL"]),
                            @"Aggregate operations can only be used on key "
                            @"paths that include an collection property");
}

- (void)testCollectionsQueryAllValuesAllKeys {
  RLMRealm *realm = [self realm];
  [realm beginWriteTransaction];
  StringObject *so1 = [StringObject createInRealm:realm
                                        withValue:@[ @"value1" ]];
  RLMAssertThrowsWithReason(([realm objects:@"ArrayPropertyObject"
                                      where:@"ANY array.@allValues = %@", so1]),
                            @"Invalid keypath 'array.@allValues': @allValues "
                            @"must follow a dictionary property.");
  RLMAssertThrowsWithReason(([realm objects:@"ArrayPropertyObject"
                                      where:@"ANY array.@allKeys = %@", so1]),
                            @"Invalid keypath 'array.@allKeys': @allKeys must "
                            @"follow a dictionary property.");
  RLMAssertThrowsWithReason(([realm objects:@"SetPropertyObject"
                                      where:@"ANY set.@allValues = %@", so1]),
                            @"Invalid keypath 'set.@allValues': @allValues "
                            @"must follow a dictionary property.");
  RLMAssertThrowsWithReason(([realm objects:@"SetPropertyObject"
                                      where:@"ANY set.@allKeys = %@", so1]),
                            @"Invalid keypath 'set.@allKeys': @allKeys must "
                            @"follow a dictionary property.");
...
- (void)testDictionaryKeyComparedToColumn {
  ...
  [CompanyObject
      createInRealm:realm
          withValue:@{@"name" : @"a", @"employeeDict" : @{@"a" : eo}}];
  [CompanyObject
      createInRealm:realm
          withValue:@{@"name" : @"a", @"employeeDict" : @{@"aa" : eo}}];
  [CompanyObject
      createInRealm:realm
          withValue:@{@"name" : @"a", @"employeeDict" : @{@"A" : eo}}];
  [CompanyObject
  ...
  RLMAssertCount(CompanyObject, 2U, @"ANY employeeDict.@allKeys !=[c] name");
  RLMAssertCount(CompanyObject, 2U,
                 @"ANY employeeDict.@allKeys BEGINSWITH name");
  RLMAssertCount(CompanyObject, 4U,
                 @"ANY employeeDict.@allKeys BEGINSWITH[c] name");
  RLMAssertCount(CompanyObject, 2U, @"ANY employeeDict.@allKeys ENDSWITH name");
  RLMAssertCount(CompanyObject, 4U,
                 @"ANY employeeDict.@allKeys ENDSWITH[c] name");
  RLMAssertCount(CompanyObject, 2U, @"ANY employeeDict.@allKeys CONTAINS name");
  RLMAssertCount(CompanyObject, 4U,
                 @"ANY employeeDict.@allKeys CONTAINS[c] name");

  RLMAssertThrowsWithReason(
      ([CompanyObject objectsInRealm:realm
                               where:@"ANY employeeDict.@allKeys = 1"]),
      @"@allKeys can only be compared with a string value.");
  RLMAssertThrowsWithReason(
      ([IntegerDictionaryPropertyObject
          objectsInRealm:realm
                   where:@"ANY dictionary.@allKeys = number"]),
      @"@allKeys can only be compared with a string value.");
}
...
- (void)testQueryOnNullableStringColumn {
  void (^testWithStringClass)(Class) = ^(Class stringObjectClass) {
    ...
    RLMResults *nilStrings =
        [stringObjectClass objectsInRealm:realm where:@"stringCol = NULL"];
    XCTAssertEqual(2U, nilStrings.count);
    XCTAssertEqualObjects((@[ NSNull.null, NSNull.null ]),
                          [nilStrings valueForKey:@"stringCol"]);

    RLMResults *nilLikeStrings =
        [stringObjectClass objectsInRealm:realm where:@"stringCol LIKE NULL"];
    XCTAssertEqual(2U, nilLikeStrings.count);
    XCTAssertEqualObjects((@[ NSNull.null, NSNull.null ]),
                          [nilLikeStrings valueForKey:@"stringCol"]);

    RLMResults *nonNilStrings =
        [stringObjectClass objectsInRealm:realm where:@"stringCol != NULL"];
    XCTAssertEqual(3U, nonNilStrings.count);
    XCTAssertEqualObjects((@[ @"a", @"b", @"" ]),
                          [nonNilStrings valueForKey:@"stringCol"]);

    RLMResults *nonNilLikeStrings =
        [stringObjectClass objectsInRealm:realm
                                    where:@"NOT stringCol LIKE NULL"];
    XCTAssertEqual(3U, nonNilLikeStrings.count);
    XCTAssertEqualObjects((@[ @"a", @"b", @"" ]),
                          [nonNilLikeStrings valueForKey:@"stringCol"]);
    ...
    RLMResults *sorted = [[stringObjectClass allObjectsInRealm:realm]
        sortedResultsUsingKeyPath:@"stringCol"
                        ascending:YES];
    XCTAssertEqualObjects((@[ NSNull.null, NSNull.null, @"", @"a", @"b" ]),
                          [sorted valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        (@[ @"b", @"a", @"", NSNull.null, NSNull.null ]),
        [[sorted sortedResultsUsingKeyPath:@"stringCol"
                                 ascending:NO] valueForKey:@"stringCol"]);

    [realm transactionWithBlock:^{
      [realm
          deleteObject:[stringObjectClass allObjectsInRealm:realm].firstObject];
    }];
    ...
    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol CONTAINS ''"]
                 valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol BEGINSWITH ''"]
                 valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol ENDSWITH ''"]
                 valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        [nonNilStrings valueForKey:@"stringCol"],
        [[stringObjectClass objectsInRealm:realm where:@"stringCol LIKE '*'"]
            valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol CONTAINS[c] ''"]
                 valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol BEGINSWITH[c] ''"]
                 valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol ENDSWITH[c] ''"]
                 valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        [nonNilStrings valueForKey:@"stringCol"],
        [[stringObjectClass objectsInRealm:realm where:@"stringCol LIKE[c] '*'"]
            valueForKey:@"stringCol"]);

    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol CONTAINS[d] ''"]
                 valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol BEGINSWITH[d] ''"]
                 valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol ENDSWITH[d] ''"]
                 valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol CONTAINS[cd] ''"]
                 valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol BEGINSWITH[cd] ''"]
                 valueForKey:@"stringCol"]);
    XCTAssertEqualObjects(
        @[], [[stringObjectClass objectsInRealm:realm
                                          where:@"stringCol ENDSWITH[cd] ''"]
                 valueForKey:@"stringCol"]);
    ...
    XCTAssertEqualObjects(
        @[], ([[stringObjectClass objectsInRealm:realm
                                           where:@"stringCol CONTAINS NULL"]
                 valueForKey:@"stringCol"]));
    XCTAssertEqualObjects(
        @[], ([[stringObjectClass objectsInRealm:realm
                                           where:@"stringCol CONTAINS[c] NULL"]
                 valueForKey:@"stringCol"]));
    XCTAssertEqualObjects(
        @[], ([[stringObjectClass objectsInRealm:realm
                                           where:@"stringCol CONTAINS[d] NULL"]
                 valueForKey:@"stringCol"]));
    XCTAssertEqualObjects(
        @[], ([[stringObjectClass objectsInRealm:realm
                                           where:@"stringCol CONTAINS[cd] NULL"]
                 valueForKey:@"stringCol"]));
  };
...
- (void)testQueryingOnLinkToNullableStringColumn {
  void (^testWithStringClass)(Class, Class) = ^(Class stringLinkClass,
                                                Class stringObjectClass) {
    RLMRealm *realm = [self realm];
    [realm transactionWithBlock:^{
      [stringLinkClass
          createInRealm:realm
              withValue:@[ [stringObjectClass createInRealm:realm
                                                  withValue:@[ @"a" ]] ]];
      [stringLinkClass createInRealm:realm
                           withValue:@[ [stringObjectClass
                                         createInRealm:realm
    ...
    RLMResults *nilStrings =
        [stringLinkClass objectsInRealm:realm
                                  where:@"objectCol.stringCol = NULL"];
    XCTAssertEqual(2U, nilStrings.count);
    XCTAssertEqualObjects((@[ NSNull.null, NSNull.null ]),
                          [nilStrings valueForKeyPath:@"objectCol.stringCol"]);

    RLMResults *nilLikeStrings =
        [stringLinkClass objectsInRealm:realm
                                  where:@"objectCol.stringCol LIKE NULL"];
    XCTAssertEqual(2U, nilLikeStrings.count);
    XCTAssertEqualObjects(
        (@[ NSNull.null, NSNull.null ]),
        [nilLikeStrings valueForKeyPath:@"objectCol.stringCol"]);
    ...
    XCTAssertEqualObjects(
        (@[ @"a", @"b", @"" ]),
        [nonNilStrings valueForKeyPath:@"objectCol.stringCol"]);

    RLMResults *nonNilLikeStrings =
        [stringLinkClass objectsInRealm:realm
                                  where:@"NOT objectCol.stringCol LIKE NULL"];
    XCTAssertEqual(3U, nonNilLikeStrings.count);
    XCTAssertEqualObjects(
        (@[ @"a", @"b", @"" ]),
        [nonNilLikeStrings valueForKeyPath:@"objectCol.stringCol"]);
  ...
  testWithStringClass([LinkIndexedStringObject class],
                      [IndexedStringObject class]);
}
...
- (void)testSortingColumnsWithNull {
  ...
  {
        NumberObject *no1 =
            [NumberObject createInRealm:realm
                              withValue:@[ @1, @1.1f, @1.1, @YES ]];
        NumberObject *noNull = [NumberObject
            createInRealm:realm
                withValue:@[
        ...
        NumberObject *no0 =
            [NumberObject createInRealm:realm
                              withValue:@[ @0, @0.0f, @0.0, @NO ]];
        for (RLMProperty *property in [[NumberObject alloc] init]
                 .objectSchema.properties) {
          NSString *name = property.name;
          RLMResults *ascending = [[NumberObject allObjectsInRealm:realm]
              sortedResultsUsingKeyPath:name
                              ascending:YES];
          XCTAssertEqualObjects([ascending valueForKey:name],
                                ([@[ noNull, no0, no1 ] valueForKey:name]));

          RLMResults *descending = [[NumberObject allObjectsInRealm:realm]
              sortedResultsUsingKeyPath:name
                              ascending:NO];
          XCTAssertEqualObjects([descending valueForKey:name],
                                ([@[ no1, no0, noNull ] valueForKey:name]));
        }
  }

  {
        DateObject *doPositive = [DateObject
            createInRealm:realm
                withValue:@[ [NSDate dateWithTimeIntervalSince1970:100] ]];
        DateObject *doNegative = [DateObject
            createInRealm:realm
                withValue:@[ [NSDate dateWithTimeIntervalSince1970:-100] ]];
        DateObject *doZero = [DateObject
            createInRealm:realm
                withValue:@[ [NSDate dateWithTimeIntervalSince1970:0] ]];
        DateObject *doNull = [DateObject createInRealm:realm
                                             withValue:@[ NSNull.null ]];

        RLMResults *ascending = [[DateObject allObjectsInRealm:realm]
            sortedResultsUsingKeyPath:@"dateCol"
                            ascending:YES];
        XCTAssertEqualObjects([ascending valueForKey:@"dateCol"],
                              ([@[ doNull, doNegative, doZero, doPositive ]
                                  valueForKey:@"dateCol"]));

        RLMResults *descending = [[DateObject allObjectsInRealm:realm]
            sortedResultsUsingKeyPath:@"dateCol"
                            ascending:NO];
        XCTAssertEqualObjects([descending valueForKey:@"dateCol"],
                              ([@[ doPositive, doZero, doNegative, doNull ]
                                  valueForKey:@"dateCol"]));
  }

  {
        StringObject *soA = [StringObject createInRealm:realm
                                              withValue:@[ @"A" ]];
        StringObject *soEmpty = [StringObject createInRealm:realm
                                                  withValue:@[ @"" ]];
        StringObject *soB = [StringObject createInRealm:realm
                                              withValue:@[ @"B" ]];
        StringObject *soNull = [StringObject createInRealm:realm
                                                 withValue:@[ NSNull.null ]];
        StringObject *soAB = [StringObject createInRealm:realm
                                               withValue:@[ @"AB" ]];

        RLMResults *ascending = [[StringObject allObjectsInRealm:realm]
            sortedResultsUsingKeyPath:@"stringCol"
                            ascending:YES];
        XCTAssertEqualObjects(
            [ascending valueForKey:@"stringCol"],
            ([@[ soNull, soEmpty, soA, soAB, soB ] valueForKey:@"stringCol"]));

        RLMResults *descending = [[StringObject allObjectsInRealm:realm]
            sortedResultsUsingKeyPath:@"stringCol"
                            ascending:NO];
        XCTAssertEqualObjects(
            [descending valueForKey:@"stringCol"],
            ([@[ soB, soAB, soA, soEmpty, soNull ] valueForKey:@"stringCol"]));
  }
...
- (void)testPrimitiveOperatorsOnAllNullablePropertyTypes {
  ...
  // These need to be stored in variables because the struct does not retain
  // them
...
#define RLMAssertCountWithString(expectedCount, op, prop, value)               \
  do {                                                                         \
        NSString *queryStr =                                                   \
            [NSString stringWithFormat:@"%@ " #op " %@", prop, value];         \
        NSUInteger actual = [AllOptionalTypes objectsWhere:queryStr].count;    \
        XCTAssertEqual(expectedCount, actual, @"%@: expected %@, got %@",      \
                       queryStr, @(expectedCount), @(actual));                 \
  } while (0)
...
#define RLMAssertCountWithPredicate(expectedCount, op, prop, value)            \
  do {                                                                         \
        NSPredicate *query =                                                   \
            [NSPredicate predicateWithFormat:@"%K " #op " %@", prop, value];   \
        NSUInteger actual =                                                    \
            [AllOptionalTypes objectsWithPredicate:query].count;               \
        XCTAssertEqual(expectedCount, actual,                                  \
                       @"%@ " #op " %@: expected %@, got %@", prop, value,     \
...
#define RLMAssertOperator(op, matchingCount, notMatchingCount, nilCount)       \
  do {                                                                         \
        if (d.matchingStr) {                                                   \
          RLMAssertCountWithString(matchingCount, op, d.propertyName,          \
                                   d.matchingStr);                             \
          RLMAssertCountWithString(notMatchingCount, op, d.propertyName,       \
                                   d.nonMatchingStr);                          \
        }                                                                      \
        RLMAssertCountWithString(nilCount, op, d.propertyName, nil);           \
                                                                               \
        RLMAssertCountWithPredicate(matchingCount, op, d.propertyName,         \
                                    d.matchingValue);                          \
        RLMAssertCountWithPredicate(notMatchingCount, op, d.propertyName,      \
                                    d.nonMatchingValue);                       \
  ...
  [realm beginWriteTransaction];
  [AllOptionalTypes createInRealm:realm
                        withValue:@[
                          @NO, @0, @0, @0, @"", matchingData, matchingDate,
                          matchingDecimal, matchingObjectId
                        ]];
  [realm commitWriteTransaction];
...
#define RLMAssertCountWithString(expectedCount, op, prop, value)               \
  do {                                                                         \
        NSString *queryStr =                                                   \
            [NSString stringWithFormat:@"%@ " #op " %@", value, prop];         \
        NSUInteger actual = [AllOptionalTypes objectsWhere:queryStr].count;    \
        XCTAssertEqual(expectedCount, actual, @"%@: expected %@, got %@",      \
                       queryStr, @(expectedCount), @(actual));                 \
...
#define RLMAssertCountWithPredicate(expectedCount, op, prop, value)            \
  do {                                                                         \
        NSPredicate *query =                                                   \
            [NSPredicate predicateWithFormat:@ "%@ " #op " %K", value, prop];   \
        NSUInteger actual =                                                    \
            [AllOptionalTypes objectsWithPredicate:query].count;               \
        XCTAssertEqual(expectedCount, actual,                                  \
                       @"%@ " #op " %@: expected %@, got %@", prop, value,     \
...
- (void)testINPredicateOnNullWithNonNullValues {
  ...
  [AllOptionalTypes createInRealm:realm
                        withValue:@[
                          @YES, @1, @1, @1, @"abc",
                          [@"a" dataUsingEncoding:NSUTF8StringEncoding],
                          [NSDate dateWithTimeIntervalSince1970:1], @1, objectId
                        ]];
  [realm commitWriteTransaction];
  ...
  // BOOL
  [self testClass:[AllOptionalTypes class]
      withNormalCount:0
             notCount:1
                where:@"boolObj IN {NULL}"];
  [self testClass:[AllOptionalTypes class]
      withNormalCount:1
             notCount:0
                where:@"boolObj IN {YES}"];

  // int
  [self testClass:[AllOptionalTypes class]
      withNormalCount:0
             notCount:1
                where:@"intObj IN {NULL}"];
  [self testClass:[AllOptionalTypes class]
      withNormalCount:1
             notCount:0
                where:@"intObj IN {1}"];
  ...
  [self testClass:[AllOptionalTypes class]
      withNormalCount:0
             notCount:1
                where:@"doubleObj IN {NULL}"];
  [self testClass:[AllOptionalTypes class]
      withNormalCount:1
             notCount:0
                where:@"doubleObj IN {1}"];

  // NSString
  [self testClass:[AllOptionalTypes class]
      withNormalCount:0
             notCount:1
                where:@"string IN {NULL}"];
  [self testClass:[AllOptionalTypes class]
      withNormalCount:1
             notCount:0
                where:@"string IN {'abc'}"];
  ...
  [self testClass:[AllOptionalTypes class]
      withNormalCount:0U
             notCount:1U
                where:@"doubleObj IN %@", @[ NSNull.null ]];
  [self testClass:[AllOptionalTypes class]
      withNormalCount:1U
             notCount:0U
                where:@"doubleObj IN %@", @[ @1 ]];
  ...
  [self testClass:[AllOptionalTypes class]
      withNormalCount:0U
             notCount:1U
                where:@"string IN %@", @[ NSNull.null ]];

  // NSData
  [self testClass:[AllOptionalTypes class]
      withNormalCount:0U
             notCount:1U
                where:@"data IN %@", @[ NSNull.null ]];
  [self testClass:[AllOptionalTypes class]
      withNormalCount:1U
             notCount:0U
                where:@"data IN %@",
...
- (void)testINPredicateOnNullWithNullValues {
  ...
  [self testClass:[AllOptionalTypes class]
      withNormalCount:0
             notCount:1
                where:@"objectId IN %@", @[ RLMObjectId.objectId ]];
}
...
- (void)testQueryOnRenamedProperties {
  ...
  [self testClass:[RenamedProperties1 class]
      withNormalCount:2
             notCount:0
                where:@"propA != 0"];
  [self testClass:[RenamedProperties1 class]
  ...
  [self testClass:[RenamedProperties2 class]
      withNormalCount:2
             notCount:0
                where:@"propC != 0"];
  [self testClass:[RenamedProperties2 class]
...
- (void)testQueryOverRenamedLinks {
  ...
  [LinkToRenamedProperties1
      createInRealm:realm
          withValue:@[ obj1, NSNull.null, @[ obj1 ], @[ obj1 ] ]];
  [LinkToRenamedProperties2
      createInRealm:realm
          withValue:@[ obj2, NSNull.null, @[ obj2 ], @[ obj2 ] ]];
  [realm commitWriteTransaction];

  [self testClass:[LinkToRenamedProperties1 class]
      withNormalCount:2
             notCount:0
                where:@"linkA.propA != 0"];
  [self testClass:[LinkToRenamedProperties1 class]
  ...
  [self testClass:[LinkToRenamedProperties2 class]
      withNormalCount:2
             notCount:0
                where:@"linkC.propC != 0"];
  [self testClass:[LinkToRenamedProperties2 class]
  ...
  [self testClass:[LinkToRenamedProperties1 class]
      withNormalCount:2
             notCount:0
                where:@"ANY array.propA != 0"];
  [self testClass:[LinkToRenamedProperties1 class]
      withNormalCount:1
             notCount:1
                where:@"ANY array.propA = 1"];
  [self testClass:[LinkToRenamedProperties1 class]
      withNormalCount:1
             notCount:1
                where:@"ANY array.propA = 2"];
  [self testClass:[LinkToRenamedProperties1 class]
      withNormalCount:0
             notCount:2
                where:@"ANY array.propA = 3"];

  [self testClass:[LinkToRenamedProperties2 class]
      withNormalCount:2
             notCount:0
                where:@"ANY array.propC != 0"];
  [self testClass:[LinkToRenamedProperties2 class]
      withNormalCount:1
             notCount:1
                where:@"ANY array.propC = 1"];
  [self testClass:[LinkToRenamedProperties2 class]
      withNormalCount:1
             notCount:1
                where:@"ANY array.propC = 2"];
  [self testClass:[LinkToRenamedProperties2 class]
      withNormalCount:0
             notCount:2
                where:@"ANY array.propC = 3"];

  [self testClass:[LinkToRenamedProperties1 class]
      withNormalCount:2
             notCount:0
                where:@"ANY set.propA != 0"];
  [self testClass:[LinkToRenamedProperties1 class]
      withNormalCount:1
             notCount:1
                where:@"ANY set.propA = 1"];
  [self testClass:[LinkToRenamedProperties1 class]
      withNormalCount:1
             notCount:1
                where:@"ANY set.propA = 2"];
  [self testClass:[LinkToRenamedProperties1 class]
      withNormalCount:0
             notCount:2
                where:@"ANY set.propA = 3"];

  [self testClass:[LinkToRenamedProperties2 class]
      withNormalCount:2
             notCount:0
                where:@"ANY set.propC != 0"];
  [self testClass:[LinkToRenamedProperties2 class]
      withNormalCount:1
             notCount:1
                where:@"ANY set.propC = 1"];
  [self testClass:[LinkToRenamedProperties2 class]
      withNormalCount:1
             notCount:1
                where:@"ANY set.propC = 2"];
  [self testClass:[LinkToRenamedProperties2 class]
      withNormalCount:0
             notCount:2
                where:@"ANY set.propC = 3"];
}
...
- (void)testQueryOverRenamedBacklinks {
  ...
  id obj1 = [RenamedProperties1 createInRealm:realm withValue:@[ @1, @"a" ]];
  id obj2 = [RenamedProperties2 createInRealm:realm withValue:@[ @2, @"b" ]];
  [LinkToRenamedProperties1 createInRealm:realm
                                withValue:@[ obj1, NSNull.null, @[ obj1 ] ]];
  [LinkToRenamedProperties2 createInRealm:realm
                                withValue:@[ obj2, NSNull.null, @[ obj2 ] ]];
  [realm commitWriteTransaction];

  [self testClass:[RenamedProperties1 class]
      withNormalCount:2
             notCount:0
                where:@"ANY linking1.linkA.propA != 0"];
  [self testClass:[RenamedProperties1 class]
      withNormalCount:1
             notCount:1
                where:@"ANY linking1.linkA.propA = 1"];
  [self testClass:[RenamedProperties1 class]
      withNormalCount:1
             notCount:1
                where:@"ANY linking1.linkA.propA = 2"];
  [self testClass:[RenamedProperties1 class]
      withNormalCount:0
             notCount:2
                where:@"ANY linking1.linkA.propA = 3"];
}
...
- (RLMResults *)evaluate:(RLMResults *)results {
  id token = [results
      addNotificationBlock:^(
          RLMResults *r, __unused RLMCollectionChange *changed, NSError *e) {
        XCTAssertNil(e);
        XCTAssertNotNil(r);
...
- (RLMRealm *)realm {
  @autoreleasepool {
        NSSet *classNames = [NSSet setWithArray:@[
          @"AllTypesObject", @"QueryObject", @"PersonObject", @"DogObject",
...
- (RLMObjectSchema *)reverseProperties:(RLMObjectSchema *)source {
  ...
  objectSchema.properties =
      objectSchema.properties.reverseObjectEnumerator.allObjects;
  return objectSchema;
}
@end
