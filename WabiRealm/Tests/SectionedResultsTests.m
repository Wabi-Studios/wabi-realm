  ...
  [realm transactionWithBlock:^{
    ...
    [AllTypesObject createInRealm:realm
                        withValue:[AllTypesObject values:1
                                            stringObject:strObj5]];
    [AllTypesObject createInRealm:realm
                        withValue:[AllTypesObject values:2
                                            stringObject:strObj4]];
    [AllTypesObject createInRealm:realm
                        withValue:[AllTypesObject values:2
                                            stringObject:strObj4]];
    [AllTypesObject createInRealm:realm
                        withValue:[AllTypesObject values:2
                                            stringObject:strObj3]];
    [AllTypesObject createInRealm:realm
                        withValue:[AllTypesObject values:3
                                            stringObject:strObj2]];
    [AllTypesObject createInRealm:realm
                        withValue:[AllTypesObject values:3
                                            stringObject:strObj1]];
    [AllTypesObject createInRealm:realm
                        withValue:[AllTypesObject values:3
                                            stringObject:strObj1]];
  }];
...
- (void)testCreationFromResults {
  ...
  RLMResults<AllTypesObject *> *results =
      [AllTypesObject allObjectsInRealm:realm];
  RLMSectionedResults<NSString *, AllTypesObject *> *sr = [results
      sectionedResultsSortedUsingKeyPath:@"objectCol.stringCol"
                               ascending:YES
                                keyBlock:^id<RLMValue>(AllTypesObject *value) {
                                  return [value.objectCol.stringCol
                                      substringToIndex:1];
                                }];
...
- (void)testCreationFromPrimitiveResults {
  ...
  RLMSectionedResults *sr = [obj.stringObj
      sectionedResultsSortedUsingKeyPath:@"self"
                               ascending:YES
...
- (NSDictionary *)keyPathsAndValues {
  return @{
    @"intCol" : @{@1 : @[ @1, @1, @1, @3, @3, @3 ], @0 : @[ @2, @2, @2 ]},
    @"longCol" : @{
      @0 : @[
        @((long long)1 * INT_MAX + 1), @((long long)1 * INT_MAX + 1),
        @((long long)1 * INT_MAX + 1), @((long long)3 * INT_MAX + 1),
        @((long long)3 * INT_MAX + 1), @((long long)3 * INT_MAX + 1)
      ],
      @-1 : @[
        @((long long)2 * INT_MAX + 1), @((long long)2 * INT_MAX + 1),
    ...
    @"floatCol" : @{
      ...
      @(2.2f) : @[
        @(1.1f * 2), @(1.1f * 2), @(1.1f * 2), @(1.1f * 3), @(1.1f * 3),
        @(1.1f * 3)
      ]
    },
    @"doubleCol" : @{
      ...
      @(2.2) : @[
        @(1.11 * 2), @(1.11 * 2), @(1.11 * 2), @(1.11 * 3), @(1.11 * 3),
        @(1.11 * 3)
      ]
    },
    @"stringCol" : @{
    ...
    @"decimalCol" : @{
      ...
      @"two" : @[
        [[RLMDecimal128 alloc] initWithNumber:@(2)],
        [[RLMDecimal128 alloc] initWithNumber:@(2)],
        [[RLMDecimal128 alloc] initWithNumber:@(2)]
      ],
      @"three" : @[
        [[RLMDecimal128 alloc] initWithNumber:@(3)],
        [[RLMDecimal128 alloc] initWithNumber:@(3)],
        [[RLMDecimal128 alloc] initWithNumber:@(3)]
      ]
    },
    @"uuidCol" : @{
      ...
      @"c" : @[
        [[NSUUID alloc]
            initWithUUIDString:@"b84e8912-a7c2-41cd-8385-86d200d7b31e"],
        [[NSUUID alloc]
            initWithUUIDString:@"b84e8912-a7c2-41cd-8385-86d200d7b31e"],
        [[NSUUID alloc]
            initWithUUIDString:@"b84e8912-a7c2-41cd-8385-86d200d7b31e"]
...
- (id<RLMValue>)sectionKeyForValue:(id<RLMValue>)value {
  ...
  case RLMPropertyTypeUUID:
    if ([(NSUUID *)value
      ...
      return @"a";
    } else if ([(NSUUID *)value
                   isEqual:[[NSUUID alloc]
                               initWithUUIDString:
                                   @"137DECC8-B300-4954-A233-F89909F4FD89"]]) {
      return @"b";
    } else if ([(NSUUID *)value
                   isEqual:[[NSUUID alloc]
                               initWithUUIDString:
                                   @"b84e8912-a7c2-41cd-8385-86d200d7b31e"]]) {
      return @"c";
    }
...
- (void)testAllSupportedTypes {
  ...
  void (^testBlock)(NSString *) = ^(NSString *keyPath) {
    ...
    RLMSectionedResults<id<RLMValue>, AllTypesObject *> *sr = [results
        sectionedResultsSortedUsingKeyPath:keyPath
                                 ascending:YES
                                  keyBlock:^id<RLMValue>(id value) {
                                    algoRunCount++;
                                    return [self
                                        sectionKeyForValue:
                                            [value valueForKeyPath:keyPath]];
                                  }];
...
- (void)testAllSupportedOptionalTypes {
  ...
  RLMResults<AllOptionalTypes *> *results =
      [AllOptionalTypes allObjectsInRealm:realm];

  void (^testBlock)(NSString *) = ^(NSString *keyPath) {
    __block int algoRunCount = 0;
    RLMSectionedResults<id<RLMValue>, AllOptionalTypes *> *sr = [results
        sectionedResultsSortedUsingKeyPath:keyPath
                                 ascending:YES
                                  keyBlock:^id<RLMValue>(
                                      AllOptionalTypes *value) {
                                    algoRunCount++;
    ...
    XCTAssertEqualObjects([nonNullSection[0] valueForKeyPath:keyPath],
                          values[keyPath]);
...
- (void)testObjectIdCol {
  ...
  RLMResults<AllTypesObject *> *results =
      [AllTypesObject allObjectsInRealm:realm];
  RLMResults<AllOptionalTypes *> *resultsOpt =
      [AllOptionalTypes allObjectsInRealm:realm];
  __block int sectionAlgoCount = 0;

  RLMSectionedResults<NSString *, AllTypesObject *> *sr = [results
      sectionedResultsSortedUsingKeyPath:@"objectIdCol"
                               ascending:YES
                                keyBlock:^id<RLMValue>(id value) {
                                  id v = [value valueForKeyPath:@"objectIdCol"];
                                  sectionAlgoCount++;
                                  return [((RLMObjectId *)v) isEqual:oid1]
                                             ? @"a"
                                             : @"b";
                                }];
  ...
  sectionAlgoCount = 0;
  RLMSectionedResults<NSString *, AllOptionalTypes *> *srOpt = [resultsOpt
      sectionedResultsSortedUsingKeyPath:@"objectId"
                               ascending:YES
                                keyBlock:^id<RLMValue>(id value) {
                                  sectionAlgoCount++;
...
- (void)testBinaryCol {
  ...
  RLMSectionedResults<NSString *, AllTypesObject *> *sr = [results
      sectionedResultsSortedUsingKeyPath:@"intCol"
                               ascending:YES
                                keyBlock:^id<RLMValue>(id value) {
                                  id v = [value valueForKeyPath:@"binaryCol"];
                                  sectionAlgoCount++;
                                  return [((NSData *)v) isEqual:d1] ? @"a"
                                                                    : @"b";
                                }];
  ...
  sectionAlgoCount = 0;
  RLMSectionedResults<NSString *, AllOptionalTypes *> *srOpt = [resultsOpt
      sectionedResultsSortedUsingKeyPath:@"intObj"
                               ascending:YES
                                keyBlock:^id<RLMValue>(id value) {
                                  sectionAlgoCount++;
...
- (void)testAllKeys {
  ...
  RLMSectionedResults<NSString *, AllTypesObject *> *sr = [results
      sectionedResultsSortedUsingKeyPath:@"stringCol"
                               ascending:YES
...
static RLMSectionedResultsChange *getChange(SectionedResultsTests *self,
                                            void (^block)(RLMRealm *)) {
  __block RLMSectionedResultsChange *changes;
  RLMRealm *realm = [RLMRealm defaultRealm];
  RLMResults<StringObject *> *results = [StringObject allObjectsInRealm:realm];
  RLMSectionedResults<NSString *, StringObject *> *sr = [results
      sectionedResultsSortedUsingKeyPath:@"stringCol"
                               ascending:YES
                                keyBlock:^id<RLMValue>(StringObject *value) {
                                  return value.firstLetter;
...
static void ExpectChange(id self, NSArray<NSIndexPath *> *insertions,
  ...
  for (NSIndexPath *insertion in insertions) {
    NSArray *filtered = [insertions
        filteredArrayUsingPredicate:[NSPredicate
                                        predicateWithFormat:@"section == %d",
                                                            insertion.section]];
    XCTAssertEqualObjects(filtered,
                          [changes insertionsInSection:insertion.section]);
  }

  for (NSIndexPath *deletion in deletions) {
    NSArray *filtered = [deletions
        filteredArrayUsingPredicate:[NSPredicate
                                        predicateWithFormat:@"section == %d",
                                                            deletion.section]];
    XCTAssertEqualObjects(filtered,
                          [changes deletionsInSection:deletion.section]);
  }

  for (NSIndexPath *modification in modifications) {
    NSArray *filtered = [modifications
        filteredArrayUsingPredicate:[NSPredicate
                                        predicateWithFormat:@"section == %d",
                                                            modification
                                                                .section]];
    XCTAssertEqualObjects(
        filtered, [changes modificationsInSection:modification.section]);
  }

  for (NSNumber *i in sectionsToInsert) {
    XCTAssertTrue(
        [changes.sectionsToInsert containsIndex:i.unsignedIntegerValue]);
  }
  for (NSNumber *i in sectionsToRemove) {
    XCTAssertTrue(
        [changes.sectionsToRemove containsIndex:i.unsignedIntegerValue]);
  }
}
...
- (void)testNotifications {
  ...
  ExpectChange(self, @[ [NSIndexPath indexPathForItem:1 inSection:1] ], @[],
               @[], @[], @[], ^(RLMRealm *realm) {
                 [realm addObject:o6];
               });

  // Deletions
  ExpectChange(self, @[], @[ [NSIndexPath indexPathForItem:0 inSection:1] ],
               @[], @[], @[], ^(RLMRealm *realm) {
                 StringObject *o = [[[StringObject allObjectsInRealm:realm]
                     objectsWhere:@"stringCol = 'banana'"] firstObject];
                 [realm deleteObject:o]; // o5 will now be invalidated.
               });

  // Modifications
  ExpectChange(self, @[], @[], @[ [NSIndexPath indexPathForItem:0
                                                      inSection:1] ],
               @[], @[], ^(RLMRealm *realm) {
                 StringObject *o = [[[StringObject allObjectsInRealm:realm]
                     objectsWhere:@"stringCol = 'beans'"] firstObject];
                 o.stringCol = @"breakfast";
               });

  // Move object from one section to another
  ExpectChange(self, @[ [NSIndexPath indexPathForItem:0 inSection:0] ], @[],
               @[], @[], @[ @1 ], ^(RLMRealm *realm) {
                 StringObject *o = [[[StringObject allObjectsInRealm:realm]
                     objectsWhere:@"stringCol = 'breakfast'"] firstObject];
                 o.stringCol = @"all";
               });
  ...
  ExpectChange(self,
               ...
               @[], @[], @[ @0 ], @[ @0 ], ^(RLMRealm *realm) {
                 RLMResults<StringObject *> *objs =
                     [[StringObject allObjectsInRealm:realm]
                         objectsWhere:@"stringCol BEGINSWITH 'a'"];
...
- (void)testNotificationsOnSection {
  ...
  RLMNotificationToken *token = [section
      addNotificationBlock:^(RLMSection *r, RLMSectionedResultsChange *c) {
        changes = c;
        XCTAssertNotNil(r);
        CFRunLoopStop(CFRunLoopGetCurrent());
      }
  ...
  [self waitForNotification:RLMRealmDidChangeNotification
                      ...
                      block:^{
                        ...
                        [r transactionWithBlock:^{
                          StringObject *o =
                              [StringObject allObjectsInRealm:r][0];
                          o.stringCol = @"app";
                        }];
                      }];
...
static RLMSectionedResultsChange *
getChangePrimitive(SectionedResultsTests *self, void (^block)(RLMRealm *)) {
  __block RLMSectionedResultsChange *changes;
  RLMRealm *realm = [RLMRealm defaultRealm];
...
static void ExpectChangePrimitive(id self, NSArray<NSIndexPath *> *insertions,
                                  NSArray<NSIndexPath *> *deletions,
                                  NSArray<NSIndexPath *> *modifications,
                                  NSArray<NSNumber *> *sectionsToInsert,
                                  NSArray<NSNumber *> *sectionsToRemove,
...
- (void)testNotificationsPrimitive {
  ...
  // Deletions
  ExpectChangePrimitive(self, @[], @[], @[], @[], @[ @0 ], ^(RLMRealm *r) {
    AllPrimitiveArrays *o = [AllPrimitiveArrays allObjectsInRealm:r][0];
    [o.stringObj removeObjectAtIndex:0];
  });

  // Modifications
  ExpectChangePrimitive(self, @[], @[], @[ [NSIndexPath indexPathForItem:0
                                                               inSection:0] ],
                        @[], @[], ^(RLMRealm *r) {
                          AllPrimitiveArrays *o =
                              [AllPrimitiveArrays allObjectsInRealm:r][0];
                          o.stringObj[0] = @"box"; // banana -> box
                        });

  // Remove elements from one section, insert into another.
  ExpectChangePrimitive(self, @[ [NSIndexPath indexPathForItem:0 inSection:1] ],
                        @[], @[], @[ @1 ], @[ @0 ], ^(RLMRealm *r) {
                          AllPrimitiveArrays *o =
                              [AllPrimitiveArrays allObjectsInRealm:r][0];
...
- (void)testSortDescriptors {
  ...
  [sortDescriptors
      addObject:[RLMSortDescriptor sortDescriptorWithKeyPath:@"intCol"
                                                   ascending:YES]];
  [sortDescriptors
      addObject:[RLMSortDescriptor sortDescriptorWithKeyPath:@"anyCol"
                                                   ascending:NO]];

  AggregateArrayObject *arrayObj =
      [AggregateArrayObject allObjectsInRealm:realm][0];
  ...
  void (^run)(id<RLMCollection> collection) = ^(id<RLMCollection> collection) {
    RLMSectionedResults<NSNumber *, AggregateObject *> *sr =
        [collection sectionedResultsUsingSortDescriptors:sortDescriptors
                                                keyBlock:^id<RLMValue>(
                                                    AggregateObject *value) {
                                                  return @(value.intCol);
                                                }];
...
- (void)testFrozenFromResults {
  ...
  RLMResults<AllTypesObject *> *results =
      [[AllTypesObject allObjectsInRealm:realm] freeze];
  RLMSectionedResults<NSString *, AllTypesObject *> *sr = [results
      sectionedResultsSortedUsingKeyPath:@"objectCol.stringCol"
                               ascending:YES
                                keyBlock:^id<RLMValue>(AllTypesObject *value) {
...
- (void)testInitFromRLMArray {
  RLMRealm *realm = self.realmWithTestPath;
  [realm transactionWithBlock:^{
    [MixedObject createInRealm:realm
                     withValue:@[ NSNull.null, @[ @5, @3, @2, @4 ] ]];
  }];

  MixedObject *obj = [MixedObject allObjectsInRealm:realm][0];
  RLMSectionedResults<NSNumber *, MixedObject *> *sr = [obj.anyArray
      sectionedResultsSortedUsingKeyPath:@"self"
                               ascending:YES
...
- (void)testInitFromRLMSet {
  ...
  RLMSectionedResults<NSNumber *, AllPrimitiveSets *> *sr = [obj.intObj
      sectionedResultsSortedUsingKeyPath:@"self"
                               ascending:YES
                                keyBlock:^id<RLMValue>(id<RLMValue> value) {
                                  return @(((NSNumber *)value).intValue % 2);
