...
- (void)setUp {
  ...
  optManaged = [AllOptionalPrimitiveDictionaries createInRealm:realm
                                                     withValue:@[]];
  allDictionaries = @[
    unmanaged.boolObj,        optUnmanaged.boolObj,   managed.boolObj,
    optManaged.boolObj,       unmanaged.intObj,       optUnmanaged.intObj,
    managed.intObj,           optManaged.intObj,      unmanaged.stringObj,
    optUnmanaged.stringObj,   managed.stringObj,      optManaged.stringObj,
    unmanaged.dateObj,        optUnmanaged.dateObj,   managed.dateObj,
    optManaged.dateObj,       unmanaged.floatObj,     optUnmanaged.floatObj,
    managed.floatObj,         optManaged.floatObj,    unmanaged.doubleObj,
    optUnmanaged.doubleObj,   managed.doubleObj,      optManaged.doubleObj,
    unmanaged.dataObj,        optUnmanaged.dataObj,   managed.dataObj,
    optManaged.dataObj,       unmanaged.decimalObj,   optUnmanaged.decimalObj,
    managed.decimalObj,       optManaged.decimalObj,  unmanaged.objectIdObj,
    optUnmanaged.objectIdObj, managed.objectIdObj,    optManaged.objectIdObj,
    unmanaged.uuidObj,        optUnmanaged.uuidObj,   managed.uuidObj,
    optManaged.uuidObj,       unmanaged.anyBoolObj,   unmanaged.anyIntObj,
    ...
    unmanaged.anyObjectIdObj, unmanaged.anyUUIDObj,   managed.anyBoolObj,
    managed.anyIntObj,        managed.anyFloatObj,    managed.anyDoubleObj,
    managed.anyStringObj,     managed.anyDataObj,     managed.anyDateObj,
    managed.anyDecimalObj,    managed.anyObjectIdObj, managed.anyUUIDObj,
  ];
}
...
- (void)addObjects {
  ...
  [optUnmanaged.boolObj
      addEntriesFromDictionary:@{@"key1" : @NO, @"key2" : NSNull.null}];
  [managed.boolObj addEntriesFromDictionary:@{@"key1" : @NO, @"key2" : @YES}];
  [optManaged.boolObj
      addEntriesFromDictionary:@{@"key1" : @NO, @"key2" : NSNull.null}];
  [unmanaged.intObj addEntriesFromDictionary:@{@"key1" : @2, @"key2" : @3}];
  [optUnmanaged.intObj
      addEntriesFromDictionary:@{@"key1" : @2, @"key2" : NSNull.null}];
  [managed.intObj addEntriesFromDictionary:@{@"key1" : @2, @"key2" : @3}];
  [optManaged.intObj
      addEntriesFromDictionary:@{@"key1" : @2, @"key2" : NSNull.null}];
  [unmanaged.stringObj
      addEntriesFromDictionary:@{@"key1" : @"bar", @"key2" : @"foo"}];
  [optUnmanaged.stringObj
      addEntriesFromDictionary:@{@"key1" : @"bar", @"key2" : NSNull.null}];
  [managed.stringObj
      addEntriesFromDictionary:@{@"key1" : @"bar", @"key2" : @"foo"}];
  [optManaged.stringObj
      addEntriesFromDictionary:@{@"key1" : @"bar", @"key2" : NSNull.null}];
  [unmanaged.dateObj
      addEntriesFromDictionary:@{@"key1" : date(1), @"key2" : date(2)}];
  [optUnmanaged.dateObj
      addEntriesFromDictionary:@{@"key1" : date(1), @"key2" : NSNull.null}];
  [managed.dateObj
      addEntriesFromDictionary:@{@"key1" : date(1), @"key2" : date(2)}];
  [optManaged.dateObj
      addEntriesFromDictionary:@{@"key1" : date(1), @"key2" : NSNull.null}];
  [unmanaged.floatObj
      addEntriesFromDictionary:@{@"key1" : @2.2f, @"key2" : @3.3f}];
  [optUnmanaged.floatObj
      addEntriesFromDictionary:@{@"key1" : @2.2f, @"key2" : NSNull.null}];
  [managed.floatObj
      addEntriesFromDictionary:@{@"key1" : @2.2f, @"key2" : @3.3f}];
  [optManaged.floatObj
      addEntriesFromDictionary:@{@"key1" : @2.2f, @"key2" : NSNull.null}];
  [unmanaged.doubleObj
      addEntriesFromDictionary:@{@"key1" : @2.2, @"key2" : @3.3}];
  [optUnmanaged.doubleObj
      addEntriesFromDictionary:@{@"key1" : @2.2, @"key2" : NSNull.null}];
  [managed.doubleObj
      addEntriesFromDictionary:@{@"key1" : @2.2, @"key2" : @3.3}];
  [optManaged.doubleObj
      addEntriesFromDictionary:@{@"key1" : @2.2, @"key2" : NSNull.null}];
  [unmanaged.dataObj
      addEntriesFromDictionary:@{@"key1" : data(1), @"key2" : data(2)}];
  [optUnmanaged.dataObj
      addEntriesFromDictionary:@{@"key1" : data(1), @"key2" : NSNull.null}];
  [managed.dataObj
      addEntriesFromDictionary:@{@"key1" : data(1), @"key2" : data(2)}];
  [optManaged.dataObj
      addEntriesFromDictionary:@{@"key1" : data(1), @"key2" : NSNull.null}];
  [unmanaged.decimalObj addEntriesFromDictionary:@{
    @"key1" : decimal128(2),
    @"key2" : decimal128(3)
  }];
  [optUnmanaged.decimalObj addEntriesFromDictionary:@{
    @"key1" : decimal128(2),
    @"key2" : NSNull.null
  }];
  [managed.decimalObj addEntriesFromDictionary:@{
    @"key1" : decimal128(2),
    @"key2" : decimal128(3)
  }];
  [optManaged.decimalObj addEntriesFromDictionary:@{
    @"key1" : decimal128(2),
    @"key2" : NSNull.null
  }];
  [unmanaged.objectIdObj
      addEntriesFromDictionary:@{@"key1" : objectId(1), @"key2" : objectId(2)}];
  [optUnmanaged.objectIdObj
      addEntriesFromDictionary:@{@"key1" : objectId(1), @"key2" : NSNull.null}];
  [managed.objectIdObj
      addEntriesFromDictionary:@{@"key1" : objectId(1), @"key2" : objectId(2)}];
  [optManaged.objectIdObj
      addEntriesFromDictionary:@{@"key1" : objectId(1), @"key2" : NSNull.null}];
  [unmanaged.uuidObj addEntriesFromDictionary:@{
    @"key1" : uuid(@"00000000-0000-0000-0000-000000000000"),
    @"key2" : uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  }];
  [optUnmanaged.uuidObj addEntriesFromDictionary:@{
    @"key1" : uuid(@"00000000-0000-0000-0000-000000000000"),
    @"key2" : NSNull.null
  }];
  [managed.uuidObj addEntriesFromDictionary:@{
    @"key1" : uuid(@"00000000-0000-0000-0000-000000000000"),
    @"key2" : uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  }];
  [optManaged.uuidObj addEntriesFromDictionary:@{
    @"key1" : uuid(@"00000000-0000-0000-0000-000000000000"),
    @"key2" : NSNull.null
  }];
  [unmanaged.anyBoolObj
      addEntriesFromDictionary:@{@"key1" : @NO, @"key2" : @YES}];
  ...
  [unmanaged.anyStringObj
      addEntriesFromDictionary:@{@"key1" : @"a", @"key2" : @"b"}];
  [unmanaged.anyDataObj
      addEntriesFromDictionary:@{@"key1" : data(1), @"key2" : data(2)}];
  [unmanaged.anyDateObj
      addEntriesFromDictionary:@{@"key1" : date(1), @"key2" : date(2)}];
  [unmanaged.anyDecimalObj addEntriesFromDictionary:@{
    @"key1" : decimal128(2),
    @"key2" : decimal128(3)
  }];
  [unmanaged.anyObjectIdObj
      addEntriesFromDictionary:@{@"key1" : objectId(1), @"key2" : objectId(2)}];
  [unmanaged.anyUUIDObj addEntriesFromDictionary:@{
    @"key1" : uuid(@"00000000-0000-0000-0000-000000000000"),
    @"key2" : uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  }];
  [managed.anyBoolObj
  ...
  [managed.anyDateObj
      addEntriesFromDictionary:@{@"key1" : date(1), @"key2" : date(2)}];
  [managed.anyDecimalObj addEntriesFromDictionary:@{
    @"key1" : decimal128(2),
    @"key2" : decimal128(3)
  }];
  [managed.anyObjectIdObj
      addEntriesFromDictionary:@{@"key1" : objectId(1), @"key2" : objectId(2)}];
  [managed.anyUUIDObj addEntriesFromDictionary:@{
    @"key1" : uuid(@"00000000-0000-0000-0000-000000000000"),
    @"key2" : uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  }];
}
...
- (void)testDeleteObjectsInRealm {
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.boolObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:optUnmanaged.boolObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.intObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:optUnmanaged.intObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.stringObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:optUnmanaged.stringObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.dateObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:optUnmanaged.dateObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.floatObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:optUnmanaged.floatObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.doubleObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:optUnmanaged.doubleObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.dataObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:optUnmanaged.dataObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.decimalObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:optUnmanaged.decimalObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.objectIdObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:optUnmanaged.objectIdObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.uuidObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:optUnmanaged.uuidObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.anyBoolObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.anyIntObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.anyFloatObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.anyDoubleObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.anyStringObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.anyDataObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.anyDateObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.anyDecimalObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.anyObjectIdObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason([realm deleteObjects:unmanaged.anyUUIDObj],
                            @"Cannot delete objects from RLMDictionary");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.boolObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, bool>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:optManaged.boolObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, bool?>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.intObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, int>: only "
      @"RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:optManaged.intObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, int?>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.stringObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, string>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:optManaged.stringObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, string?>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.dateObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, date>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:optManaged.dateObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, date?>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.anyBoolObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, mixed>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.anyIntObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, mixed>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.anyFloatObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, mixed>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.anyDoubleObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, mixed>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.anyStringObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, mixed>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.anyDataObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, mixed>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.anyDateObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, mixed>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.anyDecimalObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, mixed>: "
      @"only RLMObjects can be deleted.");
  RLMAssertThrowsWithReason(
      [realm deleteObjects:managed.anyUUIDObj],
      @"Cannot delete objects from RLMManagedDictionary<RLMString, mixed>: "
      @"only RLMObjects can be deleted.");
}
...
- (void)testSetObject {
  ...
  XCTAssertNoThrow(managed.anyUUIDObj[@"key1"] =
  ...
  uncheckedAssertEqualObjects(managed.anyUUIDObj[@"key1"],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  RLMAssertThrowsWithReason(
      managed.boolObj[@"key1"] = (id)NSNull.null,
      @"Invalid value '<null>' of type 'NSNull' for expected type 'bool'.");
  RLMAssertThrowsWithReason(
      managed.intObj[@"key1"] = (id)NSNull.null,
      @"Invalid value '<null>' of type 'NSNull' for expected type 'int'.");
  RLMAssertThrowsWithReason(
      managed.stringObj[@"key1"] = (id)NSNull.null,
      @"Invalid value '<null>' of type 'NSNull' for expected type 'string'.");
  RLMAssertThrowsWithReason(
      managed.dateObj[@"key1"] = (id)NSNull.null,
  ...
  XCTAssertNoThrow(unmanaged.uuidObj[@"key1"] =
                       uuid(@"00000000-0000-0000-0000-000000000000"));
  ...
  XCTAssertNoThrow(unmanaged.anyUUIDObj[@"key1"] =
                       uuid(@"00000000-0000-0000-0000-000000000000"));
  ...
  uncheckedAssertEqualObjects(unmanaged.uuidObj[@"key1"],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  ...
  uncheckedAssertEqualObjects(unmanaged.anyUUIDObj[@"key1"],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  RLMAssertThrowsWithReason(
      unmanaged.boolObj[@"key1"] = (id)NSNull.null,
      @"Invalid value '<null>' of type 'NSNull' for expected type 'bool'.");
  RLMAssertThrowsWithReason(
      unmanaged.intObj[@"key1"] = (id)NSNull.null,
      @"Invalid value '<null>' of type 'NSNull' for expected type 'int'.");
  RLMAssertThrowsWithReason(
      unmanaged.stringObj[@"key1"] = (id)NSNull.null,
      @"Invalid value '<null>' of type 'NSNull' for expected type 'string'.");
  RLMAssertThrowsWithReason(
      unmanaged.dateObj[@"key1"] = (id)NSNull.null,
      @"Invalid value '<null>' of type 'NSNull' for expected type 'date'.");
  RLMAssertThrowsWithReason(
      unmanaged.floatObj[@"key1"] = (id)NSNull.null,
      @"Invalid value '<null>' of type 'NSNull' for expected type 'float'.");
  RLMAssertThrowsWithReason(
      unmanaged.doubleObj[@"key1"] = (id)NSNull.null,
      @"Invalid value '<null>' of type 'NSNull' for expected type 'double'.");
  RLMAssertThrowsWithReason(
      unmanaged.dataObj[@"key1"] = (id)NSNull.null,
      @"Invalid value '<null>' of type 'NSNull' for expected type 'data'.");
  RLMAssertThrowsWithReason(unmanaged.decimalObj[@"key1"] = (id)NSNull.null,
                            @"Invalid value '<null>' of type 'NSNull' for "
                            @"expected type 'decimal128'.");
  RLMAssertThrowsWithReason(unmanaged.objectIdObj[@"key1"] = (id)NSNull.null,
                            @"Invalid value '<null>' of type 'NSNull' for "
                            @"expected type 'object id'.");
  RLMAssertThrowsWithReason(
      unmanaged.uuidObj[@"key1"] = (id)NSNull.null,
  ...
  XCTAssertNoThrow(optUnmanaged.uuidObj[@"key1"] =
                       uuid(@"00000000-0000-0000-0000-000000000000"));
  ...
  uncheckedAssertEqualObjects(optUnmanaged.uuidObj[@"key1"],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  ...
  // Fail with nil key
  RLMAssertThrowsWithReason(
      [unmanaged.boolObj setObject:@NO forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.boolObj setObject:@NO forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.boolObj setObject:@NO forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optManaged.boolObj setObject:@NO forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.intObj setObject:@2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.intObj setObject:@2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.intObj setObject:@2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optManaged.intObj setObject:@2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj setObject:@"bar" forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.stringObj setObject:@"bar" forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.stringObj setObject:@"bar" forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj setObject:@"bar" forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.dateObj setObject:date(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.dateObj setObject:date(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.dateObj setObject:date(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optManaged.dateObj setObject:date(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.floatObj setObject:@2.2f forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.floatObj setObject:@2.2f forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.floatObj setObject:@2.2f forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optManaged.floatObj setObject:@2.2f forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.doubleObj setObject:@2.2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.doubleObj setObject:@2.2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.doubleObj setObject:@2.2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optManaged.doubleObj setObject:@2.2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.dataObj setObject:data(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.dataObj setObject:data(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.dataObj setObject:data(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optManaged.dataObj setObject:data(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.decimalObj setObject:decimal128(2) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.decimalObj setObject:decimal128(2) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.decimalObj setObject:decimal128(2) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optManaged.decimalObj setObject:decimal128(2) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.objectIdObj setObject:objectId(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.objectIdObj setObject:objectId(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.objectIdObj setObject:objectId(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optManaged.objectIdObj setObject:objectId(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.uuidObj setObject:uuid(@"00000000-0000-0000-0000-000000000000")
                            forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.uuidObj
          setObject:uuid(@"00000000-0000-0000-0000-000000000000")
             forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.uuidObj setObject:uuid(@"00000000-0000-0000-0000-000000000000")
                          forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [optManaged.uuidObj
      ...
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.anyBoolObj setObject:@NO forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.anyIntObj setObject:@2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.anyFloatObj setObject:@2.2f forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.anyDoubleObj setObject:@2.2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.anyStringObj setObject:@"a" forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.anyDataObj setObject:data(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.anyDateObj setObject:date(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.anyDecimalObj setObject:decimal128(2) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [unmanaged.anyObjectIdObj setObject:objectId(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      ...
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.anyBoolObj setObject:@NO forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.anyIntObj setObject:@2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.anyFloatObj setObject:@2.2f forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.anyDoubleObj setObject:@2.2 forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.anyStringObj setObject:@"a" forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.anyDataObj setObject:data(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.anyDateObj setObject:date(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.anyDecimalObj setObject:decimal128(2) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.anyObjectIdObj setObject:objectId(1) forKey:nil],
      @"Invalid nil key for dictionary expecting key of type 'string'.");
  RLMAssertThrowsWithReason(
      [managed.anyUUIDObj
          setObject:uuid(@"00000000-0000-0000-0000-000000000000")
  ...
  RLMAssertThrowsWithReason(
      [unmanaged.boolObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'bool'");
  RLMAssertThrowsWithReason(
      [managed.boolObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'bool'");
  RLMAssertThrowsWithReason(
      [unmanaged.intObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'int'");
  RLMAssertThrowsWithReason(
      [managed.intObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'int'");
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'string'");
  RLMAssertThrowsWithReason(
      [managed.stringObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'string'");
  RLMAssertThrowsWithReason(
      [unmanaged.dateObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'date'");
  RLMAssertThrowsWithReason(
      [managed.dateObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'date'");
  RLMAssertThrowsWithReason(
      [unmanaged.floatObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'float'");
  RLMAssertThrowsWithReason(
      [managed.floatObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'float'");
  RLMAssertThrowsWithReason(
      [unmanaged.doubleObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'double'");
  RLMAssertThrowsWithReason(
      [managed.doubleObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'double'");
  RLMAssertThrowsWithReason(
      [unmanaged.dataObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'data'");
  RLMAssertThrowsWithReason(
      [managed.dataObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'data'");
  RLMAssertThrowsWithReason([unmanaged.decimalObj setObject:(id)NSNull.null
                                                     forKey:@"key1"],
                            @"Invalid value '<null>' of type 'NSNull' for "
                            @"expected type 'decimal128'");
  RLMAssertThrowsWithReason([managed.decimalObj setObject:(id)NSNull.null
                                                   forKey:@"key1"],
                            @"Invalid value '<null>' of type 'NSNull' for "
                            @"expected type 'decimal128'");
  RLMAssertThrowsWithReason(
      [unmanaged.objectIdObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'object id'");
  RLMAssertThrowsWithReason(
      [managed.objectIdObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'object id'");
  RLMAssertThrowsWithReason(
      [unmanaged.uuidObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'uuid'");
  RLMAssertThrowsWithReason(
      [managed.uuidObj setObject:(id)NSNull.null forKey:@"key1"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'uuid'");

  RLMAssertThrowsWithReason([unmanaged.boolObj setObject:(id) @"a"
                                                  forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'bool'");
  RLMAssertThrowsWithReason([optUnmanaged.boolObj setObject:(id) @"a"
                                                     forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'bool?'");
  RLMAssertThrowsWithReason([managed.boolObj setObject:(id) @"a"
                                                forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'bool'");
  RLMAssertThrowsWithReason([optManaged.boolObj setObject:(id) @"a"
                                                   forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'bool?'");
  RLMAssertThrowsWithReason([unmanaged.intObj setObject:(id) @"a"
                                                 forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'int'");
  RLMAssertThrowsWithReason([optUnmanaged.intObj setObject:(id) @"a"
                                                    forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'int?'");
  RLMAssertThrowsWithReason([managed.intObj setObject:(id) @"a" forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'int'");
  RLMAssertThrowsWithReason([optManaged.intObj setObject:(id) @"a"
                                                  forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'int?'");
  RLMAssertThrowsWithReason([unmanaged.stringObj setObject:(id) @2
                                                    forKey:@"key1"],
                            @"Invalid value '2' of type '" RLMConstantInt
                             "' for expected type 'string'");
  RLMAssertThrowsWithReason([optUnmanaged.stringObj setObject:(id) @2
                                                       forKey:@"key1"],
                            @"Invalid value '2' of type '" RLMConstantInt
                             "' for expected type 'string?'");
  RLMAssertThrowsWithReason([managed.stringObj setObject:(id) @2
                                                  forKey:@"key1"],
                            @"Invalid value '2' of type '" RLMConstantInt
                             "' for expected type 'string'");
  RLMAssertThrowsWithReason([optManaged.stringObj setObject:(id) @2
                                                     forKey:@"key1"],
                            @"Invalid value '2' of type '" RLMConstantInt
                             "' for expected type 'string?'");
  RLMAssertThrowsWithReason([unmanaged.dateObj setObject:(id) @"a"
                                                  forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'date'");
  RLMAssertThrowsWithReason([optUnmanaged.dateObj setObject:(id) @"a"
                                                     forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'date?'");
  RLMAssertThrowsWithReason([managed.dateObj setObject:(id) @"a"
                                                forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'date'");
  RLMAssertThrowsWithReason([optManaged.dateObj setObject:(id) @"a"
                                                   forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'date?'");
  RLMAssertThrowsWithReason([unmanaged.floatObj setObject:(id) @"a"
                                                   forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'float'");
  RLMAssertThrowsWithReason([optUnmanaged.floatObj setObject:(id) @"a"
                                                      forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'float?'");
  RLMAssertThrowsWithReason([managed.floatObj setObject:(id) @"a"
                                                 forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'float'");
  RLMAssertThrowsWithReason([optManaged.floatObj setObject:(id) @"a"
                                                    forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'float?'");
  RLMAssertThrowsWithReason([unmanaged.doubleObj setObject:(id) @"a"
                                                    forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'double'");
  RLMAssertThrowsWithReason([optUnmanaged.doubleObj setObject:(id) @"a"
                                                       forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'double?'");
  RLMAssertThrowsWithReason([managed.doubleObj setObject:(id) @"a"
                                                  forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'double'");
  RLMAssertThrowsWithReason([optManaged.doubleObj setObject:(id) @"a"
                                                     forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'double?'");
  RLMAssertThrowsWithReason([unmanaged.dataObj setObject:(id) @"a"
                                                  forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'data'");
  RLMAssertThrowsWithReason([optUnmanaged.dataObj setObject:(id) @"a"
                                                     forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'data?'");
  RLMAssertThrowsWithReason([managed.dataObj setObject:(id) @"a"
                                                forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'data'");
  RLMAssertThrowsWithReason([optManaged.dataObj setObject:(id) @"a"
                                                   forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'data?'");
  RLMAssertThrowsWithReason([unmanaged.decimalObj setObject:(id) @"a"
                                                     forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'decimal128'");
  RLMAssertThrowsWithReason([optUnmanaged.decimalObj setObject:(id) @"a"
                                                        forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'decimal128?'");
  RLMAssertThrowsWithReason([managed.decimalObj setObject:(id) @"a"
                                                   forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'decimal128'");
  RLMAssertThrowsWithReason([optManaged.decimalObj setObject:(id) @"a"
                                                      forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'decimal128?'");
  RLMAssertThrowsWithReason([unmanaged.objectIdObj setObject:(id) @"a"
                                                      forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'object id'");
  RLMAssertThrowsWithReason([optUnmanaged.objectIdObj setObject:(id) @"a"
                                                         forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'object id?'");
  RLMAssertThrowsWithReason([managed.objectIdObj setObject:(id) @"a"
                                                    forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'object id'");
  RLMAssertThrowsWithReason([optManaged.objectIdObj setObject:(id) @"a"
                                                       forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'object id?'");
  RLMAssertThrowsWithReason([unmanaged.uuidObj setObject:(id) @"a"
                                                  forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'uuid'");
  RLMAssertThrowsWithReason([optUnmanaged.uuidObj setObject:(id) @"a"
                                                     forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'uuid?'");
  RLMAssertThrowsWithReason([managed.uuidObj setObject:(id) @"a"
                                                forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'uuid'");
  RLMAssertThrowsWithReason([optManaged.uuidObj setObject:(id) @"a"
                                                   forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'uuid?'");
  RLMAssertThrowsWithReason(
  ...
  uncheckedAssertEqualObjects(optUnmanaged.uuidObj[@"key1"],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  uncheckedAssertEqualObjects(managed.uuidObj[@"key1"],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  uncheckedAssertEqualObjects(optManaged.uuidObj[@"key1"],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  uncheckedAssertEqualObjects(unmanaged.anyBoolObj[@"key1"], @NO);
  uncheckedAssertEqualObjects(unmanaged.anyIntObj[@"key1"], @2);
  uncheckedAssertEqualObjects(unmanaged.anyFloatObj[@"key1"], @2.2f);
  ...
  uncheckedAssertEqualObjects(optUnmanaged.decimalObj[@"key1"],
                              (id)NSNull.null);
  uncheckedAssertEqualObjects(optManaged.decimalObj[@"key1"], (id)NSNull.null);
  uncheckedAssertEqualObjects(optUnmanaged.objectIdObj[@"key1"],
                              (id)NSNull.null);
...
- (void)testAddObjects {
  RLMAssertThrowsWithReason(
      [unmanaged.boolObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'bool'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.boolObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'bool?'");
  RLMAssertThrowsWithReason(
      [managed.boolObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'bool'");
  RLMAssertThrowsWithReason(
      [optManaged.boolObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'bool?'");
  RLMAssertThrowsWithReason(
      [unmanaged.intObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'int'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.intObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'int?'");
  RLMAssertThrowsWithReason(
      [managed.intObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'int'");
  RLMAssertThrowsWithReason(
      [optManaged.intObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'int?'");
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj addEntriesFromDictionary:@{@"key1" : @2}],
      @"Invalid value '2' of type '" RLMConstantInt
       "' for expected type 'string'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.stringObj addEntriesFromDictionary:@{@"key1" : @2}],
      @"Invalid value '2' of type '" RLMConstantInt
       "' for expected type 'string?'");
  RLMAssertThrowsWithReason(
      [managed.stringObj addEntriesFromDictionary:@{@"key1" : @2}],
      @"Invalid value '2' of type '" RLMConstantInt
       "' for expected type 'string'");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj addEntriesFromDictionary:@{@"key1" : @2}],
      @"Invalid value '2' of type '" RLMConstantInt
       "' for expected type 'string?'");
  RLMAssertThrowsWithReason(
      [unmanaged.dateObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'date'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.dateObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'date?'");
  RLMAssertThrowsWithReason(
      [managed.dateObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'date'");
  RLMAssertThrowsWithReason(
      [optManaged.dateObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'date?'");
  RLMAssertThrowsWithReason(
      [unmanaged.floatObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'float'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.floatObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'float?'");
  RLMAssertThrowsWithReason(
      [managed.floatObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'float'");
  RLMAssertThrowsWithReason(
      [optManaged.floatObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'float?'");
  RLMAssertThrowsWithReason(
      [unmanaged.doubleObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'double'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.doubleObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [managed.doubleObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'double'");
  RLMAssertThrowsWithReason(
      [optManaged.doubleObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [unmanaged.dataObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'data'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.dataObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'data?'");
  RLMAssertThrowsWithReason(
      [managed.dataObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'data'");
  RLMAssertThrowsWithReason(
      [optManaged.dataObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'data?'");
  RLMAssertThrowsWithReason(
      [unmanaged.decimalObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'decimal128'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.decimalObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'decimal128?'");
  RLMAssertThrowsWithReason(
      [managed.decimalObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'decimal128'");
  RLMAssertThrowsWithReason(
      [optManaged.decimalObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'decimal128?'");
  RLMAssertThrowsWithReason(
      [unmanaged.objectIdObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'object id'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.objectIdObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'object id?'");
  RLMAssertThrowsWithReason(
      [managed.objectIdObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'object id'");
  RLMAssertThrowsWithReason(
      [optManaged.objectIdObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'object id?'");
  RLMAssertThrowsWithReason(
      [unmanaged.uuidObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'uuid'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.uuidObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'uuid?'");
  RLMAssertThrowsWithReason(
      [managed.uuidObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'uuid'");
  RLMAssertThrowsWithReason(
      [optManaged.uuidObj addEntriesFromDictionary:@{@"key1" : @"a"}],
      @"Invalid value 'a' of type '" RLMConstantString
       "' for expected type 'uuid?'");
  RLMAssertThrowsWithReason(
      [unmanaged.boolObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'bool'");
  RLMAssertThrowsWithReason(
      [managed.boolObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'bool'");
  RLMAssertThrowsWithReason(
      [unmanaged.intObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'int'");
  RLMAssertThrowsWithReason(
      [managed.intObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'int'");
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj
          addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'string'");
  RLMAssertThrowsWithReason(
      [managed.stringObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'string'");
  RLMAssertThrowsWithReason(
      [unmanaged.dateObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'date'");
  RLMAssertThrowsWithReason(
      [managed.dateObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'date'");
  RLMAssertThrowsWithReason(
      [unmanaged.floatObj
          addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'float'");
  RLMAssertThrowsWithReason(
      [managed.floatObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'float'");
  RLMAssertThrowsWithReason(
      [unmanaged.doubleObj
          addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'double'");
  RLMAssertThrowsWithReason(
      [managed.doubleObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'double'");
  RLMAssertThrowsWithReason(
      [unmanaged.dataObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'data'");
  RLMAssertThrowsWithReason(
      [managed.dataObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'data'");
  RLMAssertThrowsWithReason(
  ...
  RLMAssertThrowsWithReason(
      ...
      @"Invalid value '<null>' of type 'NSNull' for expected type 'object id'");
  RLMAssertThrowsWithReason(
      [unmanaged.uuidObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'uuid'");
  RLMAssertThrowsWithReason(
      [managed.uuidObj addEntriesFromDictionary:@{@"key1" : (id)NSNull.null}],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'uuid'");
  ...
  uncheckedAssertEqualObjects(unmanaged.anyUUIDObj[@"key2"],
                              uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  ...
  uncheckedAssertEqualObjects(managed.anyUUIDObj[@"key2"],
                              uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  ...
  uncheckedAssertEqualObjects(optUnmanaged.decimalObj[@"key2"],
                              (id)NSNull.null);
  uncheckedAssertEqualObjects(optManaged.decimalObj[@"key2"], (id)NSNull.null);
  uncheckedAssertEqualObjects(optUnmanaged.objectIdObj[@"key2"],
                              (id)NSNull.null);
...
- (void)testUpdateObjects {
  ...
  uncheckedAssertEqualObjects(unmanaged.uuidObj[@"key2"],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  uncheckedAssertEqualObjects(optUnmanaged.uuidObj[@"key2"],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  uncheckedAssertEqualObjects(managed.uuidObj[@"key2"],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  uncheckedAssertEqualObjects(optManaged.uuidObj[@"key2"],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
...
- (void)testIndexOfObjectSorted {
  ...
  uncheckedAssertEqual(
      1U, [[optManaged.boolObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:(id)NSNull.null]);
  uncheckedAssertEqual(1U, [[optManaged.intObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                               indexOfObject:(id)NSNull.null]);
  uncheckedAssertEqual(
      1U, [[optManaged.stringObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:(id)NSNull.null]);
  uncheckedAssertEqual(
      1U, [[optManaged.dateObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:(id)NSNull.null]);
  uncheckedAssertEqual(
      1U, [[managed.boolObj sortedResultsUsingKeyPath:@"self"
                                            ascending:NO] indexOfObject:@NO]);
  uncheckedAssertEqual(
      1U, [[managed.intObj sortedResultsUsingKeyPath:@"self"
                                           ascending:NO] indexOfObject:@2]);
  uncheckedAssertEqual(1U, [[managed.stringObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                               indexOfObject:@"bar"]);
  uncheckedAssertEqual(1U, [[managed.dateObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                               indexOfObject:date(1)]);
  uncheckedAssertEqual(
      1U, [[managed.anyBoolObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:@NO]);
  uncheckedAssertEqual(
      1U, [[managed.anyIntObj sortedResultsUsingKeyPath:@"self"
                                              ascending:NO] indexOfObject:@2]);
  uncheckedAssertEqual(
      1U, [[managed.anyFloatObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:@2.2f]);
  uncheckedAssertEqual(
      1U, [[managed.anyDoubleObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:@2.2]);
  uncheckedAssertEqual(
      1U, [[managed.anyStringObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:@"a"]);
  uncheckedAssertEqual(
      1U, [[managed.anyDataObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:data(1)]);
  uncheckedAssertEqual(
      1U, [[managed.anyDateObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:date(1)]);
  ...
  uncheckedAssertEqual(
      1U, [[managed.anyUUIDObj sortedResultsUsingKeyPath:@"self" ascending:NO]
  ...
  uncheckedAssertEqual(
      0U, [[managed.anyBoolObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:@YES]);
  uncheckedAssertEqual(
      0U, [[managed.anyIntObj sortedResultsUsingKeyPath:@"self"
                                              ascending:NO] indexOfObject:@3]);
  uncheckedAssertEqual(
      0U, [[managed.anyFloatObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:@3.3f]);
  uncheckedAssertEqual(
      0U, [[managed.anyDoubleObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:@3.3]);
  uncheckedAssertEqual(
      0U, [[managed.anyStringObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:@"b"]);
  uncheckedAssertEqual(
      0U, [[managed.anyDataObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:data(2)]);
  uncheckedAssertEqual(
      0U, [[managed.anyDateObj sortedResultsUsingKeyPath:@"self" ascending:NO]
              indexOfObject:date(2)]);
  ...
  uncheckedAssertEqual(
      0U, [[managed.anyUUIDObj sortedResultsUsingKeyPath:@"self" ascending:NO]
...
- (void)testIndexOfObjectDistinct {
  ...
  uncheckedAssertEqual(
      0U, [[managed.dateObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:date(1)]);
  uncheckedAssertEqual(
      0U, [[managed.anyBoolObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:@NO]);
  uncheckedAssertEqual(
      0U, [[managed.anyIntObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:@2]);
  uncheckedAssertEqual(
      0U, [[managed.anyFloatObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:@2.2f]);
  uncheckedAssertEqual(
      0U, [[managed.anyDoubleObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:@2.2]);
  uncheckedAssertEqual(
      0U, [[managed.anyStringObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:@"a"]);
  uncheckedAssertEqual(
      0U, [[managed.anyDataObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:data(1)]);
  uncheckedAssertEqual(
      0U, [[managed.anyDateObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:date(1)]);
  uncheckedAssertEqual(
      0U, [[managed.anyDecimalObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:decimal128(2)]);
  uncheckedAssertEqual(
      0U, [[managed.anyUUIDObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:uuid(@"00000000-0000-0000-0000-000000000000")]);
  uncheckedAssertEqual(
  ...
  uncheckedAssertEqual(
      1U, [[managed.dateObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:date(2)]);
  uncheckedAssertEqual(
      1U, [[managed.anyBoolObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:@YES]);
  uncheckedAssertEqual(
      1U, [[managed.anyIntObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:@3]);
  uncheckedAssertEqual(
      1U, [[managed.anyFloatObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:@3.3f]);
  uncheckedAssertEqual(
      1U, [[managed.anyDoubleObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:@3.3]);
  uncheckedAssertEqual(
      1U, [[managed.anyStringObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:@"b"]);
  uncheckedAssertEqual(
      1U, [[managed.anyDataObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:data(2)]);
  uncheckedAssertEqual(
      1U, [[managed.anyDateObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:date(2)]);
  uncheckedAssertEqual(
      1U, [[managed.anyDecimalObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:decimal128(3)]);
  uncheckedAssertEqual(
      1U, [[managed.anyUUIDObj distinctResultsUsingKeyPaths:@[ @"self" ]]
              indexOfObject:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
...
- (void)testSort {
  RLMAssertThrowsWithReason([unmanaged.boolObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO],
                            @"This method may only be called on RLMDictionary "
  ...
  uncheckedAssertEqualObjects(
      ...
      (@[ date(1), NSNull.null ]));
  uncheckedAssertEqualObjects(
      [[managed.anyBoolObj sortedResultsUsingDescriptors:@[]]
          valueForKey:@"self"],
      (@[ @NO, @YES ]));
  uncheckedAssertEqualObjects(
      [[managed.anyIntObj sortedResultsUsingDescriptors:@[]]
          valueForKey:@"self"],
      (@[ @2, @3 ]));
  uncheckedAssertEqualObjects(
      [[managed.anyFloatObj sortedResultsUsingDescriptors:@[]]
          valueForKey:@"self"],
      (@[ @2.2f, @3.3f ]));
  uncheckedAssertEqualObjects(
      ...
      (@[ @2.2, @3.3 ]));
  uncheckedAssertEqualObjects(
      [[managed.anyStringObj sortedResultsUsingDescriptors:@[]]
          valueForKey:@"self"],
      (@[ @"a", @"b" ]));
  uncheckedAssertEqualObjects(
      [[managed.anyDataObj sortedResultsUsingDescriptors:@[]]
          valueForKey:@"self"],
      (@[ data(1), data(2) ]));
  uncheckedAssertEqualObjects(
      [[managed.anyDateObj sortedResultsUsingDescriptors:@[]]
          valueForKey:@"self"],
      (@[ date(1), date(2) ]));
  uncheckedAssertEqualObjects(
      [[managed.anyDecimalObj sortedResultsUsingDescriptors:@[]]
          valueForKey:@"self"],
      (@[ decimal128(2), decimal128(3) ]));
  uncheckedAssertEqualObjects(
      [[managed.anyUUIDObj sortedResultsUsingDescriptors:@[]]
          valueForKey:@"self"],
      (@[
        uuid(@"00000000-0000-0000-0000-000000000000"),
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  ...
  uncheckedAssertEqualObjects(
      [[managed.anyUUIDObj sortedResultsUsingKeyPath:@"self"
                                           ascending:NO] valueForKey:@"self"],
      (@[
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
        uuid(@"00000000-0000-0000-0000-000000000000")
  ...
  uncheckedAssertEqualObjects(
      ...
      (@[ @2.2f, @3.3f ]));
  uncheckedAssertEqualObjects(
      [[managed.anyDoubleObj sortedResultsUsingKeyPath:@"self" ascending:YES]
          valueForKey:@"self"],
      (@[ @2.2, @3.3 ]));
  uncheckedAssertEqualObjects(
      [[managed.anyStringObj sortedResultsUsingKeyPath:@"self" ascending:YES]
          valueForKey:@"self"],
      (@[ @"a", @"b" ]));
  uncheckedAssertEqualObjects(
      [[managed.anyDataObj sortedResultsUsingKeyPath:@"self"
  ...
  uncheckedAssertEqualObjects(
      ...
      (@[ date(1), date(2) ]));
  uncheckedAssertEqualObjects(
      [[managed.anyDecimalObj sortedResultsUsingKeyPath:@"self" ascending:YES]
          valueForKey:@"self"],
      (@[ decimal128(2), decimal128(3) ]));
  uncheckedAssertEqualObjects(
      [[managed.anyUUIDObj sortedResultsUsingKeyPath:@"self"
...
- (void)testMin {
  RLMAssertThrowsWithReason(
      [unmanaged.boolObj minOfProperty:@"self"],
      @"minOfProperty: is not supported for bool dictionary");
  RLMAssertThrowsWithReason(
      [optUnmanaged.boolObj minOfProperty:@"self"],
      @"minOfProperty: is not supported for bool? dictionary");
  RLMAssertThrowsWithReason(
  ...
  RLMAssertThrowsWithReason(
      ...
      @"minOfProperty: is not supported for string? dictionary");
  RLMAssertThrowsWithReason(
      [unmanaged.dataObj minOfProperty:@"self"],
      @"minOfProperty: is not supported for data dictionary");
  RLMAssertThrowsWithReason(
      [optUnmanaged.dataObj minOfProperty:@"self"],
      @"minOfProperty: is not supported for data? dictionary");
  RLMAssertThrowsWithReason(
  ...
  RLMAssertThrowsWithReason(
      ...
      @"minOfProperty: is not supported for object id? dictionary");
  RLMAssertThrowsWithReason(
      [unmanaged.uuidObj minOfProperty:@"self"],
      @"minOfProperty: is not supported for uuid dictionary");
  RLMAssertThrowsWithReason(
      [optUnmanaged.uuidObj minOfProperty:@"self"],
      @"minOfProperty: is not supported for uuid? dictionary");
  RLMAssertThrowsWithReason([managed.boolObj minOfProperty:@"self"],
                            @"Operation 'min' not supported for bool "
                            @"dictionary 'AllPrimitiveDictionaries.boolObj'");
  RLMAssertThrowsWithReason(
      [optManaged.boolObj minOfProperty:@"self"],
      @"Operation 'min' not supported for bool? dictionary "
      @"'AllOptionalPrimitiveDictionaries.boolObj'");
  RLMAssertThrowsWithReason([managed.stringObj minOfProperty:@"self"],
                            @"Operation 'min' not supported for string "
                            @"dictionary 'AllPrimitiveDictionaries.stringObj'");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj minOfProperty:@"self"],
      @"Operation 'min' not supported for string? dictionary "
      @"'AllOptionalPrimitiveDictionaries.stringObj'");
...
- (void)testMax {
  RLMAssertThrowsWithReason(
      [unmanaged.boolObj maxOfProperty:@"self"],
      @"maxOfProperty: is not supported for bool dictionary");
  RLMAssertThrowsWithReason(
      [optUnmanaged.boolObj maxOfProperty:@"self"],
      @"maxOfProperty: is not supported for bool? dictionary");
  RLMAssertThrowsWithReason(
  ...
  RLMAssertThrowsWithReason(
      ...
      @"maxOfProperty: is not supported for string? dictionary");
  RLMAssertThrowsWithReason(
      [unmanaged.dataObj maxOfProperty:@"self"],
      @"maxOfProperty: is not supported for data dictionary");
  RLMAssertThrowsWithReason(
      [optUnmanaged.dataObj maxOfProperty:@"self"],
      @"maxOfProperty: is not supported for data? dictionary");
  RLMAssertThrowsWithReason(
  ...
  RLMAssertThrowsWithReason(
      ...
      @"maxOfProperty: is not supported for object id? dictionary");
  RLMAssertThrowsWithReason(
      [unmanaged.uuidObj maxOfProperty:@"self"],
      @"maxOfProperty: is not supported for uuid dictionary");
  RLMAssertThrowsWithReason(
      [optUnmanaged.uuidObj maxOfProperty:@"self"],
      @"maxOfProperty: is not supported for uuid? dictionary");
  RLMAssertThrowsWithReason([managed.boolObj maxOfProperty:@"self"],
                            @"Operation 'max' not supported for bool "
                            @"dictionary 'AllPrimitiveDictionaries.boolObj'");
  RLMAssertThrowsWithReason(
      [optManaged.boolObj maxOfProperty:@"self"],
      @"Operation 'max' not supported for bool? dictionary "
      @"'AllOptionalPrimitiveDictionaries.boolObj'");
  RLMAssertThrowsWithReason([managed.stringObj maxOfProperty:@"self"],
                            @"Operation 'max' not supported for string "
                            @"dictionary 'AllPrimitiveDictionaries.stringObj'");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj maxOfProperty:@"self"],
      @"Operation 'max' not supported for string? dictionary "
      @"'AllOptionalPrimitiveDictionaries.stringObj'");
...
- (void)testSum {
  RLMAssertThrowsWithReason(
      [unmanaged.boolObj sumOfProperty:@"self"],
      @"sumOfProperty: is not supported for bool dictionary");
  RLMAssertThrowsWithReason(
      [optUnmanaged.boolObj sumOfProperty:@"self"],
      @"sumOfProperty: is not supported for bool? dictionary");
  RLMAssertThrowsWithReason(
  ...
  RLMAssertThrowsWithReason(
      ...
      @"sumOfProperty: is not supported for string? dictionary");
  RLMAssertThrowsWithReason(
      [unmanaged.dateObj sumOfProperty:@"self"],
      @"sumOfProperty: is not supported for date dictionary");
  RLMAssertThrowsWithReason(
      [optUnmanaged.dateObj sumOfProperty:@"self"],
      @"sumOfProperty: is not supported for date? dictionary");
  RLMAssertThrowsWithReason(
      [unmanaged.dataObj sumOfProperty:@"self"],
      @"sumOfProperty: is not supported for data dictionary");
  RLMAssertThrowsWithReason(
      [optUnmanaged.dataObj sumOfProperty:@"self"],
      @"sumOfProperty: is not supported for data? dictionary");
  RLMAssertThrowsWithReason(
  ...
  RLMAssertThrowsWithReason(
      ...
      @"sumOfProperty: is not supported for object id? dictionary");
  RLMAssertThrowsWithReason(
      [unmanaged.uuidObj sumOfProperty:@"self"],
      @"sumOfProperty: is not supported for uuid dictionary");
  RLMAssertThrowsWithReason(
      [optUnmanaged.uuidObj sumOfProperty:@"self"],
      @"sumOfProperty: is not supported for uuid? dictionary");
  RLMAssertThrowsWithReason([managed.boolObj sumOfProperty:@"self"],
                            @"Operation 'sum' not supported for bool "
                            @"dictionary 'AllPrimitiveDictionaries.boolObj'");
  RLMAssertThrowsWithReason(
      [optManaged.boolObj sumOfProperty:@"self"],
      @"Operation 'sum' not supported for bool? dictionary "
      @"'AllOptionalPrimitiveDictionaries.boolObj'");
  RLMAssertThrowsWithReason([managed.stringObj sumOfProperty:@"self"],
                            @"Operation 'sum' not supported for string "
                            @"dictionary 'AllPrimitiveDictionaries.stringObj'");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj sumOfProperty:@"self"],
      @"Operation 'sum' not supported for string? dictionary "
      @"'AllOptionalPrimitiveDictionaries.stringObj'");
  RLMAssertThrowsWithReason([managed.dateObj sumOfProperty:@"self"],
                            @"Operation 'sum' not supported for date "
                            @"dictionary 'AllPrimitiveDictionaries.dateObj'");
  RLMAssertThrowsWithReason(
      [optManaged.dateObj sumOfProperty:@"self"],
      @"Operation 'sum' not supported for date? dictionary "
      @"'AllOptionalPrimitiveDictionaries.dateObj'");
  ...
  XCTAssertEqualWithAccuracy(
      [unmanaged.intObj sumOfProperty:@"self"].doubleValue,
      sum(@{@"key1" : @2, @"key2" : @3}), .001);
  XCTAssertEqualWithAccuracy(
      [optUnmanaged.intObj sumOfProperty:@"self"].doubleValue,
      sum(@{@"key1" : @2, @"key2" : NSNull.null}), .001);
  ...
  XCTAssertEqualWithAccuracy(
      ...
      sum(@{@"key1" : @2.2f, @"key2" : @3.3f}), .001);
  XCTAssertEqualWithAccuracy(
      [optUnmanaged.floatObj sumOfProperty:@"self"].doubleValue,
      sum(@{@"key1" : @2.2f, @"key2" : NSNull.null}), .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      sum(@{@"key1" : @2.2, @"key2" : @3.3}), .001);
  XCTAssertEqualWithAccuracy(
      [optUnmanaged.doubleObj sumOfProperty:@"self"].doubleValue,
      sum(@{@"key1" : @2.2, @"key2" : NSNull.null}), .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      sum(@{@"key1" : decimal128(2), @"key2" : decimal128(3)}), .001);
  XCTAssertEqualWithAccuracy(
      [optUnmanaged.decimalObj sumOfProperty:@"self"].doubleValue,
      sum(@{@"key1" : decimal128(2), @"key2" : NSNull.null}), .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      sum(@{@"key1" : decimal128(2), @"key2" : NSNull.null}), .001);
  XCTAssertEqualWithAccuracy(
      [unmanaged.anyIntObj sumOfProperty:@"self"].doubleValue,
      sum(@{@"key1" : @2, @"key2" : @3}), .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      sum(@{@"key1" : decimal128(2), @"key2" : decimal128(3)}), .001);
  XCTAssertEqualWithAccuracy(
      [managed.anyIntObj sumOfProperty:@"self"].doubleValue,
      sum(@{@"key1" : @2, @"key2" : @3}), .001);
  XCTAssertEqualWithAccuracy(
...
- (void)testAverage {
  ...
  RLMAssertThrowsWithReason([managed.boolObj averageOfProperty:@"self"],
                            @"Operation 'average' not supported for bool "
                            @"dictionary 'AllPrimitiveDictionaries.boolObj'");
  RLMAssertThrowsWithReason(
      [optManaged.boolObj averageOfProperty:@"self"],
      @"Operation 'average' not supported for bool? dictionary "
      @"'AllOptionalPrimitiveDictionaries.boolObj'");
  RLMAssertThrowsWithReason([managed.stringObj averageOfProperty:@"self"],
                            @"Operation 'average' not supported for string "
                            @"dictionary 'AllPrimitiveDictionaries.stringObj'");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj averageOfProperty:@"self"],
      @"Operation 'average' not supported for string? dictionary "
      @"'AllOptionalPrimitiveDictionaries.stringObj'");
  RLMAssertThrowsWithReason([managed.dateObj averageOfProperty:@"self"],
                            @"Operation 'average' not supported for date "
                            @"dictionary 'AllPrimitiveDictionaries.dateObj'");
  RLMAssertThrowsWithReason(
      [optManaged.dateObj averageOfProperty:@"self"],
      @"Operation 'average' not supported for date? dictionary "
      @"'AllOptionalPrimitiveDictionaries.dateObj'");
  ...
  XCTAssertEqualWithAccuracy(
      ...
      average(@{@"key1" : @2, @"key2" : @3}), .001);
  XCTAssertEqualWithAccuracy(
      [optUnmanaged.intObj averageOfProperty:@"self"].doubleValue,
      average(@{@"key1" : @2, @"key2" : NSNull.null}), .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      average(@{@"key1" : @2.2f, @"key2" : @3.3f}), .001);
  XCTAssertEqualWithAccuracy(
      [optUnmanaged.floatObj averageOfProperty:@"self"].doubleValue,
      average(@{@"key1" : @2.2f, @"key2" : NSNull.null}), .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      average(@{@"key1" : @2.2, @"key2" : @3.3}), .001);
  XCTAssertEqualWithAccuracy(
      [optUnmanaged.doubleObj averageOfProperty:@"self"].doubleValue,
      average(@{@"key1" : @2.2, @"key2" : NSNull.null}), .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      average(@{@"key1" : decimal128(2), @"key2" : decimal128(3)}), .001);
  XCTAssertEqualWithAccuracy(
      [optUnmanaged.decimalObj averageOfProperty:@"self"].doubleValue,
      average(@{@"key1" : decimal128(2), @"key2" : NSNull.null}), .001);
  XCTAssertEqualWithAccuracy(
...
- (void)testValueForKeyNumericAggregates {
  ...
  uncheckedAssertEqualObjects(
      [optUnmanaged.intObj valueForKeyPath:@"@max.self"], @2);
  uncheckedAssertEqualObjects([optManaged.intObj valueForKeyPath:@"@max.self"],
                              @2);
  uncheckedAssertEqualObjects(
      [optUnmanaged.dateObj valueForKeyPath:@"@max.self"], date(1));
  uncheckedAssertEqualObjects([optManaged.dateObj valueForKeyPath:@"@max.self"],
                              date(1));
  uncheckedAssertEqualObjects(
      [optUnmanaged.floatObj valueForKeyPath:@"@max.self"], @2.2f);
  uncheckedAssertEqualObjects(
      [optManaged.floatObj valueForKeyPath:@"@max.self"], @2.2f);
  uncheckedAssertEqualObjects(
      [optUnmanaged.doubleObj valueForKeyPath:@"@max.self"], @2.2);
  uncheckedAssertEqualObjects(
      [optManaged.doubleObj valueForKeyPath:@"@max.self"], @2.2);
  uncheckedAssertEqualObjects(
...
- (void)testSetValueForKey {
  ...
  RLMAssertThrowsWithReason([optManaged.uuidObj setValue:@"a" forKey:@"key1"],
                            @"Invalid value 'a' of type '" RLMConstantString
                             "' for expected type 'uuid?'");
  RLMAssertThrowsWithReason(
      [unmanaged.boolObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'bool'");
  RLMAssertThrowsWithReason(
      [managed.boolObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'bool'");
  RLMAssertThrowsWithReason(
      [unmanaged.intObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'int'");
  RLMAssertThrowsWithReason(
      [managed.intObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'int'");
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'string'");
  RLMAssertThrowsWithReason(
      [managed.stringObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'string'");
  RLMAssertThrowsWithReason(
      [unmanaged.dateObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'date'");
  RLMAssertThrowsWithReason(
      [managed.dateObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'date'");
  RLMAssertThrowsWithReason(
      [unmanaged.floatObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'float'");
  RLMAssertThrowsWithReason(
      [managed.floatObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'float'");
  RLMAssertThrowsWithReason(
      [unmanaged.doubleObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'double'");
  RLMAssertThrowsWithReason(
      [managed.doubleObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'double'");
  RLMAssertThrowsWithReason(
      [unmanaged.dataObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'data'");
  RLMAssertThrowsWithReason(
      [managed.dataObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'data'");
  RLMAssertThrowsWithReason([unmanaged.decimalObj setValue:(id)NSNull.null
                                                    forKey:@"self"],
                            @"Invalid value '<null>' of type 'NSNull' for "
                            @"expected type 'decimal128'");
  RLMAssertThrowsWithReason([managed.decimalObj setValue:(id)NSNull.null
                                                  forKey:@"self"],
                            @"Invalid value '<null>' of type 'NSNull' for "
                            @"expected type 'decimal128'");
  RLMAssertThrowsWithReason(
      [unmanaged.objectIdObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'object id'");
  RLMAssertThrowsWithReason(
      [managed.objectIdObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'object id'");
  RLMAssertThrowsWithReason(
      [unmanaged.uuidObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'uuid'");
  RLMAssertThrowsWithReason(
      [managed.uuidObj setValue:(id)NSNull.null forKey:@"self"],
      @"Invalid value '<null>' of type 'NSNull' for expected type 'uuid'");
...
- (void)testAssignment {
  ...
  uncheckedAssertEqualObjects(optManaged.objectIdObj[@"key2"], NSNull.null);
  unmanaged.uuidObj =
      (id) @{@"key2" : uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")};
  uncheckedAssertEqualObjects(unmanaged.uuidObj[@"key2"],
                              uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  ...
  uncheckedAssertEqualObjects(unmanaged.intObj.allValues,
                              managed.intObj.allValues);

  [managed.intObj removeAllObjects];
  managed.intObj = unmanaged.intObj;

  uncheckedAssertEqual(managed.intObj.count, 1);
  uncheckedAssertEqualObjects(managed.intObj.allValues,
                              unmanaged.intObj.allValues);
}

- (void)testInvalidAssignment {
  RLMAssertThrowsWithReason(
      unmanaged.intObj = (id) @{@"0" : (id)NSNull.null},
      @"Invalid value '<null>' of type 'NSNull' for 'int' dictionary property "
      @"'AllPrimitiveDictionaries.intObj'.");
  RLMAssertThrowsWithReason(
      unmanaged.intObj = (id) @{@"0" : @"a"},
      @"Invalid value 'a' of type '__NSCFConstantString' for 'int' dictionary "
      @"property 'AllPrimitiveDictionaries.intObj'.");
  RLMAssertThrowsWithReason(
      unmanaged.intObj = (id)(@{@"0" : @1, @"1" : @"a"}),
      @"Invalid value 'a' of type '__NSCFConstantString' for 'int' dictionary "
      @"property 'AllPrimitiveDictionaries.intObj'.");
  RLMAssertThrowsWithReason(
      unmanaged.intObj = (id)unmanaged.floatObj,
      @"RLMDictionary<string, float> does not match expected type 'int' for "
      @"property 'AllPrimitiveDictionaries.intObj'.");
  RLMAssertThrowsWithReason(
      unmanaged.intObj = (id)optUnmanaged.intObj,
      @"RLMDictionary<string, int?> does not match expected type 'int' for "
      @"property 'AllPrimitiveDictionaries.intObj'.");
  RLMAssertThrowsWithReason(
      unmanaged[@"intObj"] = unmanaged[@"floatObj"],
      @"RLMDictionary<string, float> does not match expected type 'int' for "
      @"property 'AllPrimitiveDictionaries.intObj'.");
  RLMAssertThrowsWithReason(
      unmanaged[@"intObj"] = optUnmanaged[@"intObj"],
      @"RLMDictionary<string, int?> does not match expected type 'int' for "
      @"property 'AllPrimitiveDictionaries.intObj'.");

  RLMAssertThrowsWithReason(
      managed.intObj = (id) @{@"0" : (id)NSNull.null},
      @"Invalid value '<null>' of type 'NSNull' for 'int' dictionary property "
      @"'AllPrimitiveDictionaries.intObj'.");
  RLMAssertThrowsWithReason(
      managed.intObj = (id) @{@"0" : @"a"},
      @"Invalid value 'a' of type '__NSCFConstantString' for 'int' dictionary "
      @"property 'AllPrimitiveDictionaries.intObj'.");
  RLMAssertThrowsWithReason(
      managed.intObj = (id)(@{@"0" : @1, @"1" : @"a"}),
      @"Invalid value 'a' of type '__NSCFConstantString' for 'int' dictionary "
      @"property 'AllPrimitiveDictionaries.intObj'.");
  RLMAssertThrowsWithReason(
      managed.intObj = (id)managed.floatObj,
      @"RLMDictionary<string, float> does not match expected type 'int' for "
      @"property 'AllPrimitiveDictionaries.intObj'.");
  RLMAssertThrowsWithReason(
      managed.intObj = (id)optManaged.intObj,
      @"RLMDictionary<string, int?> does not match expected type 'int' for "
      @"property 'AllPrimitiveDictionaries.intObj'.");
  RLMAssertThrowsWithReason(
      managed[@"intObj"] = (id)managed[@"floatObj"],
...
- (void)testAllMethodsCheckThread {
  ...
  [self dispatchAsyncAndWait:^{
    ...
    RLMAssertThrowsWithReason([dictionary setObject:@0 forKey:@"thread"],
                              @"thread");
    RLMAssertThrowsWithReason([dictionary addEntriesFromDictionary:@{
                                @"thread" : @0
                              }],
                              @"thread");
    RLMAssertThrowsWithReason([dictionary removeObjectForKey:@"thread"],
                              @"thread");
    RLMAssertThrowsWithReason(
        [dictionary removeObjectsForKeys:(id) @[ @"thread" ]], @"thread");
    RLMAssertThrowsWithReason([dictionary removeAllObjects], @"thread");
    RLMAssertThrowsWithReason([optManaged.intObj setObject:(id)NSNull.null
                                                    forKey:@"thread"],
                              @"thread");

    RLMAssertThrowsWithReason([dictionary sortedResultsUsingKeyPath:@"self"
                                                          ascending:YES],
                              @"thread");
    RLMAssertThrowsWithReason(
        [dictionary sortedResultsUsingDescriptors:@[
    ...
    RLMAssertThrowsWithReason([dictionary setValue:@1 forKey:@"self"],
                              @"thread");
    RLMAssertThrowsWithReason(({
                                for (__unused id obj in dictionary)
                                  ;
                              }),
                              @"thread");
  }];
...
- (void)testAllMethodsCheckForInvalidation {
  ...
  RLMAssertThrowsWithReason([dictionary setObject:@0 forKey:@"thread"],
                            @"invalidated");
  RLMAssertThrowsWithReason(
      [dictionary addEntriesFromDictionary:@{@"invalidated" : @0}],
      @"invalidated");
  RLMAssertThrowsWithReason([dictionary removeObjectForKey:@"invalidated"],
                            @"invalidated");
  RLMAssertThrowsWithReason(
      [dictionary removeObjectsForKeys:(id) @[ @"invalidated" ]],
      @"invalidated");
...
- (void)testMutatingMethodsCheckForWriteTransaction {
  ...
  XCTAssertNoThrow([dictionary sortedResultsUsingKeyPath:@"self"
                                               ascending:YES]);
  XCTAssertNoThrow([dictionary sortedResultsUsingDescriptors:@[
    [RLMSortDescriptor sortDescriptorWithKeyPath:@"self" ascending:YES]
  ]]);
  XCTAssertNoThrow(dictionary[@"0"]);
  ...
  RLMAssertThrowsWithReason([dictionary setObject:@0 forKey:@"testKey"],
                            @"write transaction");
  RLMAssertThrowsWithReason(
      [dictionary addEntriesFromDictionary:@{@"testKey" : @0}],
      @"write transaction");
  RLMAssertThrowsWithReason([dictionary removeObjectForKey:@"testKey"],
                            @"write transaction");
  RLMAssertThrowsWithReason(
      [dictionary removeObjectsForKeys:(id) @[ @"testKey" ]],
      @"write transaction");
  RLMAssertThrowsWithReason([dictionary removeAllObjects],
                            @"write transaction");
  RLMAssertThrowsWithReason([optManaged.intObj setObject:(id)NSNull.null
                                                  forKey:@"testKey"],
                            @"write transaction");
...
- (void)testNotificationSentInitially {
  ...
  id token = [managed.intObj
      addNotificationBlock:^(RLMDictionary *dictionary,
                             RLMDictionaryChange *change, NSError *error) {
...
- (void)testNotificationSentAfterCommit {
  ...
  [self dispatchAsyncAndWait:^{
    ...
    [r transactionWithBlock:^{
      RLMDictionary *dictionary =
          [(AllPrimitiveDictionaries *)[AllPrimitiveDictionaries
               allObjectsInRealm:r]
                  .firstObject intObj];
...
- (void)testNotificationNotSentForUnrelatedChange {
  ...
  id expectation = [self expectationWithDescription:@""];
  id token = [managed.intObj
      addNotificationBlock:^(__unused RLMDictionary *dictionary,
  ...
  [self waitForNotification:RLMRealmDidChangeNotification
                      ...
                      block:^{
                        [self dispatchAsyncAndWait:^{
                          RLMRealm *r = [RLMRealm defaultRealm];
                          [r transactionWithBlock:^{
                            [AllPrimitiveDictionaries createInRealm:r
                                                          withValue:@[]];
                          }];
                        }];
                      }];
...
- (void)createObject {
  ...
  id obj = [AllPrimitiveDictionaries createInRealm:realm
                                         withValue:@{
                                           @"boolObj" : boolObj,
                                           @"intObj" : intObj,
                                           @"stringObj" : stringObj,
  ...
  obj = [AllOptionalPrimitiveDictionaries createInRealm:realm
                                              withValue:@{
                                                @"boolObj" : boolObj,
                                                @"intObj" : intObj,
                                                @"stringObj" : stringObj,
  ...
  [LinkToAllOptionalPrimitiveDictionaries createInRealm:realm
                                              withValue:@[ obj ]];
}
...
- (void)testQueryBasicOperators {
  ...
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY stringObj = %@",
                 @"bar");
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY dateObj = %@", date(1));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY dateObj = %@",
                 date(1));
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyDecimalObj = %@",
                 decimal128(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyUUIDObj = %@",
                 uuid(@"00000000-0000-0000-0000-000000000000"));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY boolObj != %@", @NO);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY boolObj != %@",
                 @NO);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY intObj != %@", @2);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY intObj != %@", @2);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY stringObj != %@", @"bar");
  ...
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY intObj = %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"ANY stringObj = %@",
                 @"bar");
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY dateObj = %@", date(1));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"ANY dateObj = %@",
                 date(1));
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyDecimalObj = %@",
                 decimal128(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyUUIDObj = %@",
                 uuid(@"00000000-0000-0000-0000-000000000000"));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY boolObj != %@", @NO);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY boolObj != %@",
                 @NO);
  ...
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"ANY boolObj != %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY intObj != %@", @3);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"ANY intObj != %@",
                 NSNull.null);
  ...
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries objectsInRealm:realm
                                          where:@"ANY boolObj > %@", @NO]),
      @"Operator '>' not supported for type 'bool'");
  RLMAssertThrowsWithReason(([AllOptionalPrimitiveDictionaries
                                objectsInRealm:realm
                                         where:@"ANY boolObj > %@", @NO]),
                            @"Operator '>' not supported for type 'bool'");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries objectsInRealm:realm
                                          where:@"ANY stringObj > %@", @"bar"]),
...
- (void)testQueryBetween {
  ...
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"ANY boolObj BETWEEN %@", @[ @NO, NSNull.null ]]),
      @"Operator 'BETWEEN' not supported for type 'bool'");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"ANY stringObj BETWEEN %@", @[ @"bar", @"foo" ]]),
      @"Operator 'BETWEEN' not supported for type 'string'");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"ANY stringObj BETWEEN %@",
                         @[ @"bar", NSNull.null ]]),
      @"Operator 'BETWEEN' not supported for type 'string'");

  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY intObj BETWEEN %@",
                 @[ @2, @3 ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY intObj BETWEEN %@",
                 @[ @2, NSNull.null ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY dateObj BETWEEN %@",
                 @[ date(1), date(2) ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY dateObj BETWEEN %@",
                 @[ date(1), NSNull.null ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyFloatObj BETWEEN %@",
                 @[ @2.2f, @3.3f ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyDoubleObj BETWEEN %@",
                 @[ @2.2, @3.3 ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyDecimalObj BETWEEN %@",
                 @[ decimal128(2), decimal128(3) ]);

  [self createObject];

  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY intObj BETWEEN %@",
                 @[ @2, @2 ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY dateObj BETWEEN %@",
                 @[ date(1), date(1) ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyFloatObj BETWEEN %@",
                 @[ @2.2f, @2.2f ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyDoubleObj BETWEEN %@",
                 @[ @2.2, @2.2 ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyDecimalObj BETWEEN %@",
  ...
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"ANY intObj BETWEEN %@",
                 @[ @2, @2 ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"ANY dateObj BETWEEN %@",
                 @[ date(1), date(1) ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY intObj BETWEEN %@",
                 @[ @2, NSNull.null ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY dateObj BETWEEN %@",
...
- (void)testQueryIn {
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY boolObj IN %@",
                 @[ @NO, @YES ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY boolObj IN %@",
                 @[ @NO, NSNull.null ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY intObj IN %@", @[ @2, @3 ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY intObj IN %@",
                 @[ @2, NSNull.null ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY stringObj IN %@",
                 @[ @"bar", @"foo" ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY stringObj IN %@",
                 @[ @"bar", NSNull.null ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY dateObj IN %@",
                 @[ date(1), date(2) ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"ANY dateObj IN %@",
                 @[ date(1), NSNull.null ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyBoolObj IN %@",
                 @[ @NO, @YES ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyIntObj IN %@",
                 @[ @2, @3 ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyFloatObj IN %@",
                 @[ @2.2f, @3.3f ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyDoubleObj IN %@",
                 @[ @2.2, @3.3 ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyStringObj IN %@",
                 @[ @"a", @"b" ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyDataObj IN %@",
                 @[ data(1), data(2) ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyDateObj IN %@",
                 @[ date(1), date(2) ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyDecimalObj IN %@",
                 @[ decimal128(2), decimal128(3) ]);
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyUUIDObj IN %@", @[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  ]);
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"ANY anyUUIDObj IN %@",
                 @[ uuid(@"137DECC8-B300-4954-A233-F89909F4FD89") ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY boolObj IN %@",
                 @[ @NO, @YES ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"ANY boolObj IN %@",
                 @[ @NO, NSNull.null ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY intObj IN %@", @[ @2, @3 ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"ANY intObj IN %@",
                 @[ @2, NSNull.null ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY stringObj IN %@",
                 @[ @"bar", @"foo" ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"ANY stringObj IN %@",
                 @[ @"bar", NSNull.null ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY dateObj IN %@",
                 @[ date(1), date(2) ]);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"ANY dateObj IN %@",
                 @[ date(1), NSNull.null ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyBoolObj IN %@",
                 @[ @NO, @YES ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyIntObj IN %@",
                 @[ @2, @3 ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyFloatObj IN %@",
                 @[ @2.2f, @3.3f ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyDoubleObj IN %@",
                 @[ @2.2, @3.3 ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyStringObj IN %@",
                 @[ @"a", @"b" ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyDataObj IN %@",
                 @[ data(1), data(2) ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyDateObj IN %@",
                 @[ date(1), date(2) ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyDecimalObj IN %@",
                 @[ decimal128(2), decimal128(3) ]);
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"ANY anyUUIDObj IN %@", @[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  ]);
}
...
- (void)testQueryCount {
  ...
  [AllPrimitiveDictionaries
      createInRealm:realm
          withValue:@{
            ...
            @"anyDecimalObj" :
                @{@"key1" : decimal128(2), @"key2" : decimal128(3)},
            @"anyUUIDObj" : @{
              @"key1" : uuid(@"00000000-0000-0000-0000-000000000000"),
              @"key2" : uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
            },
  ...
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"boolObj.@count == %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"intObj.@count == %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"intObj.@count == %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"stringObj.@count == %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U,
                 @"stringObj.@count == %@", @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"dateObj.@count == %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"dateObj.@count == %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyBoolObj.@count == %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyIntObj.@count == %@", @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyFloatObj.@count == %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDoubleObj.@count == %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyStringObj.@count == %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDataObj.@count == %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDateObj.@count == %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDecimalObj.@count == %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyUUIDObj.@count == %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"boolObj.@count != %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0U, @"boolObj.@count != %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"intObj.@count != %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0U, @"intObj.@count != %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"stringObj.@count != %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0U,
                 @"stringObj.@count != %@", @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"dateObj.@count != %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0U, @"dateObj.@count != %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyBoolObj.@count != %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyIntObj.@count != %@", @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyFloatObj.@count != %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyDoubleObj.@count != %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyStringObj.@count != %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyDataObj.@count != %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyDateObj.@count != %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyDecimalObj.@count != %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyUUIDObj.@count != %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"boolObj.@count > %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"boolObj.@count > %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"intObj.@count > %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"intObj.@count > %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"stringObj.@count > %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"stringObj.@count > %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"dateObj.@count > %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0, @"dateObj.@count > %@",
                 @(2));
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"anyDoubleObj.@count > %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"anyStringObj.@count > %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"anyDataObj.@count > %@", @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"anyDateObj.@count > %@", @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"anyDecimalObj.@count > %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 0, @"anyUUIDObj.@count > %@", @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"boolObj.@count >= %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"boolObj.@count >= %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"intObj.@count >= %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"intObj.@count >= %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"stringObj.@count >= %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"stringObj.@count >= %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"dateObj.@count >= %@", @(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1, @"dateObj.@count >= %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"anyBoolObj.@count >= %@", @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"anyIntObj.@count >= %@", @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"anyFloatObj.@count >= %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"anyDoubleObj.@count >= %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"anyStringObj.@count >= %@",
                 @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"anyDataObj.@count >= %@", @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"anyDateObj.@count >= %@", @(2));
  RLMAssertCount(AllPrimitiveDictionaries, 1, @"anyDecimalObj.@count >= %@",
                 @(2));
...
- (void)testQuerySum {
  ...
  RLMAssertThrowsWithReason(([AllOptionalPrimitiveDictionaries
                                objectsInRealm:realm
                                         where:@"boolObj.@sum = %@", @NO]),
                            @"Invalid keypath 'boolObj.@sum': @sum can only be "
                            @"applied to a collection of numeric values.");
  RLMAssertThrowsWithReason(([AllPrimitiveDictionaries
                                objectsInRealm:realm
                                         where:@"stringObj.@sum = %@", @"bar"]),
  ...
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyIntObj.@sum.prop = %@", @"a"]),
      @"Invalid keypath 'anyIntObj.@sum.prop': @sum on a collection of values "
      @"must appear at the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyFloatObj.@sum.prop = %@", @"a"]),
      @"Invalid keypath 'anyFloatObj.@sum.prop': @sum on a collection of "
      @"values must appear at the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyDoubleObj.@sum.prop = %@", @"a"]),
      @"Invalid keypath 'anyDoubleObj.@sum.prop': @sum on a collection of "
      @"values must appear at the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyDecimalObj.@sum.prop = %@", @"a"]),
      @"Invalid keypath 'anyDecimalObj.@sum.prop': @sum on a collection of "
      @"values must appear at the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"intObj.@sum = %@", (id)NSNull.null]),
  ...
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyIntObj.@sum = %@", (id)NSNull.null]),
      @"@sum on a property of type mixed cannot be compared with '<null>'");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyFloatObj.@sum = %@", (id)NSNull.null]),
      @"@sum on a property of type mixed cannot be compared with '<null>'");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyDoubleObj.@sum = %@", (id)NSNull.null]),
      @"@sum on a property of type mixed cannot be compared with '<null>'");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyDecimalObj.@sum = %@", (id)NSNull.null]),
      @"@sum on a property of type mixed cannot be compared with '<null>'");

  [AllPrimitiveDictionaries createInRealm:realm
                                withValue:@{
                                  @"intObj" : @{},
                                  @"anyIntObj" : @{},
                                  @"anyFloatObj" : @{},
  ...
  [AllOptionalPrimitiveDictionaries createInRealm:realm
                                        withValue:@{
                                          @"intObj" : @{},
                                        }];
  [AllPrimitiveDictionaries createInRealm:realm
  ...
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"intObj.@sum == %@",
                 @0);
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyFloatObj.@sum == %@",
                 @2.2f);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDoubleObj.@sum == %@",
                 @2.2);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDecimalObj.@sum == %@",
                 decimal128(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 3U, @"intObj.@sum == %@",
                 @2);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"intObj.@sum != %@", @2);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"anyIntObj.@sum != %@", @2);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"anyFloatObj.@sum != %@",
                 @2.2f);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"anyDoubleObj.@sum != %@",
                 @2.2);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"anyDecimalObj.@sum != %@",
                 decimal128(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"intObj.@sum != %@",
                 @2);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"intObj.@sum >= %@", @2);
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 2U, @"anyDecimalObj.@sum > %@",
                 decimal128(2));
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 2U, @"intObj.@sum <= %@", @3);
  RLMAssertCount(AllPrimitiveDictionaries, 2U, @"anyIntObj.@sum <= %@", @3);
  RLMAssertCount(AllPrimitiveDictionaries, 2U, @"anyFloatObj.@sum <= %@",
                 @3.3f);
  RLMAssertCount(AllPrimitiveDictionaries, 2U, @"anyDoubleObj.@sum <= %@",
                 @3.3);
  RLMAssertCount(AllPrimitiveDictionaries, 2U, @"anyDecimalObj.@sum <= %@",
                 decimal128(3));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 4U, @"intObj.@sum <= %@",
                 @2);
}
...
- (void)testQueryAverage {
  ...
  RLMAssertThrowsWithReason(([AllOptionalPrimitiveDictionaries
                                objectsInRealm:realm
                                         where:@"boolObj.@avg = %@", @NO]),
                            @"Invalid keypath 'boolObj.@avg': @avg can only be "
                            @"applied to a collection of numeric values.");
  RLMAssertThrowsWithReason(([AllPrimitiveDictionaries
                                objectsInRealm:realm
                                         where:@"stringObj.@avg = %@", @"bar"]),
  ...
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyIntObj.@avg.prop = %@", @"a"]),
      @"Invalid keypath 'anyIntObj.@avg.prop': @avg on a collection of values "
      @"must appear at the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyFloatObj.@avg.prop = %@", @"a"]),
      @"Invalid keypath 'anyFloatObj.@avg.prop': @avg on a collection of "
      @"values must appear at the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyDoubleObj.@avg.prop = %@", @"a"]),
      @"Invalid keypath 'anyDoubleObj.@avg.prop': @avg on a collection of "
      @"values must appear at the end of a keypath.");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"anyDecimalObj.@avg.prop = %@", @"a"]),
      @"Invalid keypath 'anyDecimalObj.@avg.prop': @avg on a collection of "
      @"values must appear at the end of a keypath.");
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"intObj.@avg == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"intObj.@avg == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyIntObj.@avg == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyFloatObj.@avg == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDoubleObj.@avg == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDecimalObj.@avg == %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDecimalObj.@avg == %@",
                 decimal128(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 3U, @"intObj.@avg == %@",
                 @2);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"intObj.@avg != %@", @2);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"anyIntObj.@avg != %@", @2);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"anyFloatObj.@avg != %@",
                 @2.2f);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"anyDoubleObj.@avg != %@",
                 @2.2);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"anyDecimalObj.@avg != %@",
                 decimal128(2));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"intObj.@avg != %@",
                 @2);
  RLMAssertCount(AllPrimitiveDictionaries, 3U, @"intObj.@avg >= %@", @2);
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 2U, @"anyDecimalObj.@avg > %@",
                 decimal128(2));
...
- (void)testQueryMin {
  ...
  RLMAssertThrowsWithReason(([AllOptionalPrimitiveDictionaries
                                objectsInRealm:realm
                                         where:@"boolObj.@min = %@", @NO]),
                            @"Invalid keypath 'boolObj.@min': @min can only be "
                            @"applied to a collection of numeric values.");
  RLMAssertThrowsWithReason(([AllPrimitiveDictionaries
                                objectsInRealm:realm
                                         where:@"stringObj.@min = %@", @"bar"]),
  ...
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0U, @"intObj.@min == %@",
                 @2);
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"dateObj.@min == %@", date(1));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0U, @"dateObj.@min == %@",
                 date(1));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyFloatObj.@min == %@",
                 @2.2f);
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyDoubleObj.@min == %@",
                 @2.2);
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyDecimalObj.@min == %@",
                 decimal128(2));
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyDecimalObj.@min == %@",
                 decimal128(3));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"intObj.@min == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"dateObj.@min == %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"intObj.@min == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"intObj.@min == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"dateObj.@min == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"dateObj.@min == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyFloatObj.@min == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDoubleObj.@min == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDecimalObj.@min == %@",
                 NSNull.null);
...
- (void)testQueryMax {
  ...
  RLMAssertThrowsWithReason(([AllOptionalPrimitiveDictionaries
                                objectsInRealm:realm
                                         where:@"boolObj.@max = %@", @NO]),
                            @"Invalid keypath 'boolObj.@max': @max can only be "
                            @"applied to a collection of numeric values.");
  RLMAssertThrowsWithReason(([AllPrimitiveDictionaries
                                objectsInRealm:realm
                                         where:@"stringObj.@max = %@", @"bar"]),
  ...
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0U, @"intObj.@max == %@",
                 @2);
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"dateObj.@max == %@", date(1));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0U, @"dateObj.@max == %@",
                 date(1));
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyFloatObj.@max == %@",
                 @2.2f);
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyDoubleObj.@max == %@",
                 @2.2);
  RLMAssertCount(AllPrimitiveDictionaries, 0U, @"anyDecimalObj.@max == %@",
                 decimal128(2));
  ...
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 0U, @"dateObj.@max == %@",
                 date(1));
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"intObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"dateObj.@max == %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"intObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"intObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"dateObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveDictionaries, 1U, @"dateObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyFloatObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDoubleObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveDictionaries, 1U, @"anyDecimalObj.@max == %@",
                 NSNull.null);
...
- (void)testQueryBasicOperatorsOverLink {
  ...
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.boolObj = %@",
                 @NO);
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 0,
                 @"ANY link.boolObj = %@", @NO);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.intObj = %@",
                 @2);
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 0,
                 @"ANY link.intObj = %@", @2);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.stringObj = %@",
                 @"bar");
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 0,
                 @"ANY link.stringObj = %@", @"bar");
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.dateObj = %@",
                 date(1));
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 0,
                 @"ANY link.dateObj = %@", date(1));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.anyBoolObj = %@",
                 @NO);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.anyIntObj = %@",
                 @2);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyFloatObj = %@", @2.2f);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyDoubleObj = %@", @2.2);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyStringObj = %@", @"a");
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.anyDataObj = %@",
                 data(1));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.anyDateObj = %@",
                 date(1));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyDecimalObj = %@", decimal128(2));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.anyUUIDObj = %@",
                 uuid(@"00000000-0000-0000-0000-000000000000"));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.boolObj != %@",
                 @NO);
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 0,
  ...
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyStringObj != %@", @"a");
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyDataObj != %@", data(1));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyDateObj != %@", date(1));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyDecimalObj != %@", decimal128(2));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyUUIDObj != %@",
  ...
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.boolObj = %@",
                 @YES);
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 0,
                 @"ANY link.boolObj = %@", NSNull.null);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.intObj = %@",
                 @3);
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 0,
                 @"ANY link.intObj = %@", NSNull.null);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.stringObj = %@",
                 @"foo");
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 0,
                 @"ANY link.stringObj = %@", NSNull.null);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.dateObj = %@",
                 date(2));
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 0,
                 @"ANY link.dateObj = %@", NSNull.null);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.anyBoolObj = %@",
                 @YES);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.anyIntObj = %@",
                 @3);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyFloatObj = %@", @3.3f);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyDoubleObj = %@", @3.3);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyStringObj = %@", @"b");
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.anyDataObj = %@",
                 data(2));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.anyDateObj = %@",
                 date(2));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0,
                 @"ANY link.anyDecimalObj = %@", decimal128(3));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.anyUUIDObj = %@",
                 uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1, @"ANY link.boolObj = %@",
                 @NO);
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 1,
                 @"ANY link.boolObj = %@", @NO);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1, @"ANY link.intObj = %@",
                 @2);
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 1,
                 @"ANY link.intObj = %@", @2);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1, @"ANY link.stringObj = %@",
                 @"bar");
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 1,
                 @"ANY link.stringObj = %@", @"bar");
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1, @"ANY link.dateObj = %@",
                 date(1));
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 1,
                 @"ANY link.dateObj = %@", date(1));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1, @"ANY link.anyBoolObj = %@",
                 @NO);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1, @"ANY link.anyIntObj = %@",
                 @2);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1,
                 @"ANY link.anyFloatObj = %@", @2.2f);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1,
                 @"ANY link.anyDoubleObj = %@", @2.2);
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1,
                 @"ANY link.anyStringObj = %@", @"a");
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1, @"ANY link.anyDataObj = %@",
                 data(1));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1, @"ANY link.anyDateObj = %@",
                 date(1));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1,
                 @"ANY link.anyDecimalObj = %@", decimal128(2));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1, @"ANY link.anyUUIDObj = %@",
                 uuid(@"00000000-0000-0000-0000-000000000000"));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 0, @"ANY link.boolObj != %@",
                 @NO);
  RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, 0,
  ...
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1,
                 @"ANY link.anyStringObj != %@", @"b");
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1,
                 @"ANY link.anyDataObj != %@", data(2));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1,
                 @"ANY link.anyDateObj != %@", date(2));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1,
                 @"ANY link.anyDecimalObj != %@", decimal128(3));
  RLMAssertCount(LinkToAllPrimitiveDictionaries, 1,
                 @"ANY link.anyUUIDObj != %@",
  ...
  RLMAssertThrowsWithReason(([LinkToAllPrimitiveDictionaries
                                objectsInRealm:realm
                                         where:@"ANY link.boolObj > %@", @NO]),
                            @"Operator '>' not supported for type 'bool'");
  RLMAssertThrowsWithReason(([LinkToAllOptionalPrimitiveDictionaries
                                objectsInRealm:realm
                                         where:@"ANY link.boolObj > %@", @NO]),
                            @"Operator '>' not supported for type 'bool'");
  RLMAssertThrowsWithReason(
      ([LinkToAllPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"ANY link.stringObj > %@", @"bar"]),
      @"Operator '>' not supported for string queries on Dictionary.");
  RLMAssertThrowsWithReason(
      ([LinkToAllOptionalPrimitiveDictionaries
          objectsInRealm:realm
                   where:@"ANY link.stringObj > %@", @"bar"]),
      @"Operator '>' not supported for string queries on Dictionary.");
  RLMAssertThrowsWithReason(
...
- (void)testSubstringQueries {
  ...
  void (^create)(NSString *) = ^(NSString *value) {
    id obj = [AllPrimitiveDictionaries
        createInRealm:realm
            withValue:@{
              @"stringObj" : @{@"key" : value},
              @"dataObj" :
    ...
    [LinkToAllPrimitiveDictionaries createInRealm:realm withValue:@[ obj ]];
    obj = [AllOptionalPrimitiveDictionaries
        createInRealm:realm
            withValue:@{
              @"stringObj" : @{@"key" : value},
              @"dataObj" :
  ...
  void (^test)(NSString *, id, NSUInteger) =
      ^(NSString *operator, NSString * value, NSUInteger count) {
        ...
        RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, count, query,
                       value);
        RLMAssertCount(LinkToAllPrimitiveDictionaries, count, query, value);
  ...
  void (^testNull)(NSString *, NSUInteger) =
      ^(NSString *operator, NSUInteger count) {
        ...
        RLMAssertThrowsWithReason(
            [AllPrimitiveDictionaries objectsInRealm:realm where:query],
            @"Cannot compare value '(null)' of type '(null)' to property "
            @"'stringObj' of type 'string'");
        RLMAssertCount(AllOptionalPrimitiveDictionaries, count, query,
                       NSNull.null);
        query = [NSString stringWithFormat:@"ANY link.stringObj %@ nil", operator];
        RLMAssertThrowsWithReason(
            [LinkToAllPrimitiveDictionaries objectsInRealm:realm where:query],
            @"Cannot compare value '(null)' of type '(null)' to property "
            @"'stringObj' of type 'string'");
        RLMAssertCount(LinkToAllOptionalPrimitiveDictionaries, count, query,
                       NSNull.null);
