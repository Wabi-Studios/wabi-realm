...
static void RLMAssertRealmSchemaMatchesTable(id self, RLMRealm *realm) {
  for (RLMObjectSchema *objectSchema in realm.schema.objectSchema) {
    ...
    TableRef table = ObjectStore::table_for_object_type(
        realm.group, objectSchema.objectStoreName);
    for (RLMProperty *property in objectSchema.properties) {
      auto column = info.tableColumn(property);
      XCTAssertEqual(column, table->get_column_key(RLMStringDataWithNSString(
                                 property.columnName)));
...
@property RLMDictionary<NSString *, MigrationTestObject *>
    <RLMString, MigrationTestObject> *dictionary;
@end
...
- (RLMRealm *)realmWithSingleObject:(RLMObjectSchema *)objectSchema {
  return [self
      realmWithTestPathAndSchema:[self schemaWithObjects:@[ objectSchema ]]];
}
...
- (RLMRealmConfiguration *)config {
  ...
  config.encryptionKey =
      RLMRealmConfiguration.rawDefaultConfiguration.encryptionKey;
  return config;
}

- (void)createTestRealmWithClasses:(NSArray *)classes
                             block:(void (^)(RLMRealm *realm))block {
  NSMutableArray *objectSchema =
      [NSMutableArray arrayWithCapacity:classes.count];
...
- (void)createTestRealmWithSchema:(NSArray *)objectSchema
                            block:(void (^)(RLMRealm *realm))block {
  @autoreleasepool {
...
- (RLMRealm *)migrateTestRealmWithBlock:(RLMMigrationBlock)block
    NS_RETURNS_RETAINED {
  @autoreleasepool {
    RLMRealmConfiguration *config = self.config;
...
- (void)failToMigrateTestRealmWithBlock:(RLMMigrationBlock)block {
  @autoreleasepool {
    ...
    config.schemaVersion = 1;
    config.migrationBlock = block;
    XCTAssertFalse([RLMRealm performMigrationForConfiguration:config
                                                        error:nil]);
  }
}
...
- (void)assertMigrationRequiredForChangeFrom:(NSArray *)from to:(NSArray *)to {
  ...
  config.migrationBlock =
      ^(__unused RLMMigration *migration, __unused uint64_t oldSchemaVersion) {
  ...
  RLMAssertRealmSchemaMatchesTable(self, [RLMRealm realmWithConfiguration:config
                                                                    error:nil]);
}

- (void)assertNoMigrationRequiredForChangeFrom:(NSArray *)from
                                            to:(NSArray *)to {
  RLMRealmConfiguration *config = self.config;
  config.customSchema = [self schemaWithObjects:from];
  @autoreleasepool {
...
- (RLMRealmConfiguration *)
    renameConfigurationWithObjectSchemas:(NSArray *)objectSchemas
                          migrationBlock:(RLMMigrationBlock)block {
...
- (RLMRealmConfiguration *)
  ...
  return [self
      renameConfigurationWithObjectSchemas:objectSchemas
                            migrationBlock:^(RLMMigration *migration,
                                             uint64_t) {
                              [migration renamePropertyForClass:className
                                                        oldName:oldName
                                                        newName:newName];
                              [migration
                                  enumerateObjects:AllTypesObject.className
...
- (void)assertPropertyRenameError:(NSString *)errorMessage
                    objectSchemas:(NSArray *)objectSchemas
                        className:(NSString *)className
                          oldName:(NSString *)oldName
                          newName:(NSString *)newName {
  RLMRealmConfiguration *config =
      [self renameConfigurationWithObjectSchemas:objectSchemas
                                       className:className
                                         oldName:oldName
                                         newName:newName];
  NSError *error;
  ...
  XCTAssertTrue(
      [error.localizedDescription rangeOfString:errorMessage].location !=
          NSNotFound,
      @"\"%@\" should contain \"%@\"", error.localizedDescription,
      errorMessage);
}

- (void)assertPropertyRenameError:(NSString *)errorMessage
             firstSchemaTransform:(void (^)(RLMObjectSchema *, RLMProperty *,
                                            RLMProperty *))transform1
            secondSchemaTransform:(void (^)(RLMObjectSchema *, RLMProperty *,
                                            RLMProperty *))transform2 {
  ...
  RLMProperty *beforeProperty =
      [afterProperty copyWithNewName:@"before_stringCol"];
  schema.properties = @[ beforeProperty ];
  if (transform1) {
    transform1(schema, beforeProperty, afterProperty);
  }

  [self createTestRealmWithSchema:@[ schema ]
  ...
  auto config =
      [self renameConfigurationWithObjectSchemas:@[ schema ]
  ...
  if (errorMessage) {
    ...
    XCTAssertEqualObjects(
        @"0", [[[StringObject
                  allObjectsInRealm:[RLMRealm realmWithConfiguration:config
                                                               error:nil]]
                  firstObject] stringCol]);
  }
}
...
- (void)testGetSchemaVersion {
  XCTAssertEqual(RLMNotVersioned,
                 [RLMRealm schemaVersionAtURL:RLMDefaultRealmURL()
                                encryptionKey:nil
                                        error:nil]);
  NSError *error;
  XCTAssertEqual(RLMNotVersioned,
  ...
  RLMValidateRealmError(error, RLMErrorInvalidDatabase,
                        @"WabiRealm at path '%@' has not been initialized.",
  ...
  XCTAssertEqual(0U, [RLMRealm schemaVersionAtURL:config.fileURL
                                    encryptionKey:nil
                                            error:nil]);

  config.schemaVersion = 1;
  config.migrationBlock =
      ^(__unused RLMMigration *migration, uint64_t oldSchemaVersion) {
  ...
  XCTAssertEqual(1U, [RLMRealm schemaVersionAtURL:config.fileURL
                                    encryptionKey:nil
                                            error:nil]);
}
...
- (void)testSchemaVersionCannotGoDown {
  ...
  XCTAssertEqual(10U, [RLMRealm schemaVersionAtURL:config.fileURL
...
- (void)testDifferentSchemaVersionsAtDifferentPaths {
  ...
  @autoreleasepool {
    [RLMRealm realmWithConfiguration:config2 error:nil];
  }
  XCTAssertEqual(5U, [RLMRealm schemaVersionAtURL:config2.fileURL
                                    encryptionKey:config.encryptionKey
                                            error:nil]);
...
- (void)testAddingClassDoesNotRequireMigration {
  ...
  config.objectClasses =
      @[ MigrationTestObject.class, ThreeFieldMigrationTestObject.class ];
  XCTAssertNoThrow([RLMRealm realmWithConfiguration:config error:nil]);
}
...
- (void)testChangingLinkTargetRequiresMigration {
  NSArray *linkTargets = @[
    [RLMObjectSchema schemaForObjectClass:MigrationTestObject.class],
    [RLMObjectSchema schemaForObjectClass:MigrationTwoStringObject.class]
  ];
  RLMObjectSchema *from =
      [RLMObjectSchema schemaForObjectClass:MigrationLinkObject.class];

  RLMObjectSchema *to =
      [RLMObjectSchema schemaForObjectClass:MigrationLinkObject.class];
  [to.properties[0] setObjectClassName:@"MigrationTwoStringObject"];

  [self assertMigrationRequiredForChangeFrom:[linkTargets
                                                 arrayByAddingObject:from]
                                          to:[linkTargets
                                                 arrayByAddingObject:to]];
}
...
- (void)testDeleteRealmIfMigrationNeeded {
  for (uint64_t targetSchemaVersion = 1; targetSchemaVersion < 2;
       targetSchemaVersion++) {
    ...
    @autoreleasepool {
      [[NSFileManager defaultManager] removeItemAtURL:configuration.fileURL
                                                error:nil];
    ...
    @autoreleasepool {
      XCTAssertThrows([RLMRealm realmWithConfiguration:configuration
                                                 error:nil]);
      RLMRealmConfiguration *dynamicConfiguration =
          [RLMRealmConfiguration defaultConfiguration];
      dynamicConfiguration.dynamic = YES;
      XCTAssertFalse([[RLMRealm realmWithConfiguration:dynamicConfiguration
                                                 error:nil] isEmpty]);
    }

    configuration.schemaVersion = targetSchemaVersion;
    configuration.migrationBlock = ^(__unused RLMMigration *migration,
...
- (void)testMismatchedIndexAllowedForReadOnly {
  ...
  [self createTestRealmWithSchema:@[ objectSchema ]
                            block:^(RLMRealm *){
                            }];
  ...
  XCTAssertTrue(info.table()->has_search_index(
      info.tableColumn(objectSchema.properties[0].name)));
}
...
- (void)testRearrangeProperties {
  ...
  objectSchema.properties =
      @[ objectSchema.properties[1], objectSchema.properties[0] ];

  RLMRealm *realm = [self realmWithTestPathAndSchema:schema];
  [realm beginWriteTransaction];

  // -createObject:withValue: takes values in the order the properties appear in
  // the array
  [realm createObject:CircleObject.className
            withValue:@[ NSNull.null, @"data" ]];
  RLMAssertThrowsWithReasonMatching(
      ([realm createObject:CircleObject.className
                 withValue:@[ @"data", NSNull.null ]]),
  ...
  // open the default WabiRealm and make sure accessors with alternate ordering
  // work
...
- (void)testAsyncMigration {
  ...
  c.schemaVersion = 1;
  @autoreleasepool {
    XCTAssertNoThrow([RLMRealm realmWithConfiguration:c error:nil]);
  }
...
- (void)testRemovingSubclass {
  RLMProperty *prop = [[RLMProperty alloc] initWithName:@"id"
                                 ...
                                 linkOriginPropertyName:nil
                                               ...
                                               optional:NO];
  RLMObjectSchema *objectSchema =
      [[RLMObjectSchema alloc] initWithClassName:@"DeletedClass"
                                     objectClass:RLMObject.class
                                      properties:@[ prop ]];
  [self createTestRealmWithSchema:@[ objectSchema ]
                            block:^(RLMRealm *realm) {
                              [realm createObject:@"DeletedClass"
                                        withValue:@[ @0 ]];
                            }];

  // apply migration
  RLMRealm *realm = [self migrateTestRealmWithBlock:^(
                              RLMMigration *migration,
  ...
  XCTAssertFalse(
      ObjectStore::table_for_object_type(realm.group, "DeletedClass"),
      @"The deleted class should not have a table.");
...
- (void)testAddingPropertyAtEnd {
  ...
  [self createTestRealmWithSchema:@[ objectSchema ]
                            block:^(RLMRealm *realm) {
                              [realm createObject:MigrationTestObject.className
                                        withValue:@[ @1 ]];
                              [realm createObject:MigrationTestObject.className
                                        withValue:@[ @2 ]];
                            }];
  ...
  // apply migration
  RLMRealm *realm =
      [self migrateTestRealmWithBlock:^(RLMMigration *migration,
                                        uint64_t oldSchemaVersion) {
        XCTAssertEqual(oldSchemaVersion, 0U,
                       @"Initial schema version should be 0");
        [migration
            enumerateObjects:MigrationTestObject.className
                       block:^(RLMObject *oldObject, RLMObject *newObject) {
                         XCTAssertThrows(
                             oldObject[@"stringCol"],
                             @"stringCol should not exist on old object");
                         NSNumber *intObj;
                         XCTAssertNoThrow(
                             intObj = oldObject[@"intCol"],
                             @"Should be able to access intCol on oldObject");
                         XCTAssertEqualObjects(newObject[@"intCol"],
                                               oldObject[@"intCol"]);
                         NSString *stringObj =
                             [NSString stringWithFormat:@"%@", intObj];
                         XCTAssertNoThrow(newObject[@"stringCol"] = stringObj,
                                          @"Should be able to set stringCol");
                       }];
      }];
  ...
  XCTAssertEqualObjects(mig1.stringCol, @"2",
                        @"String column should be populated");
}

- (void)testAddingPropertyAtBeginningPreservesData {
  // create schema to migrate from with the second and third columns from the
  // final data
  RLMObjectSchema *objectSchema = [RLMObjectSchema
      schemaForObjectClass:ThreeFieldMigrationTestObject.class];
  objectSchema.properties =
      @[ objectSchema.properties[1], objectSchema.properties[2] ];

  [self createTestRealmWithSchema:@[ objectSchema ]
                            block:^(RLMRealm *realm) {
                              [realm createObject:ThreeFieldMigrationTestObject
                                                      .className
                                        withValue:@[ @1, @2 ]];
                            }];

  RLMRealm *realm = [self migrateTestRealmWithBlock:^(RLMMigration *migration,
                                                      uint64_t) {
    [migration enumerateObjects:ThreeFieldMigrationTestObject.className
                          block:^(RLMObject *oldObject, RLMObject *newObject) {
                            XCTAssertThrows(oldObject[@"col1"]);
                            XCTAssertEqualObjects(oldObject[@"col2"],
                                                  newObject[@"col2"]);
                            XCTAssertEqualObjects(oldObject[@"col3"],
                                                  newObject[@"col3"]);
                          }];
  }];

  // verify migration
  ThreeFieldMigrationTestObject *mig =
      [ThreeFieldMigrationTestObject allObjectsInRealm:realm][0];
...
- (void)testRemoveProperty {
  ...
  RLMObjectSchema *objectSchema =
      [RLMObjectSchema schemaForObjectClass:MigrationTestObject.class];
  RLMProperty *thirdProperty =
      [[RLMProperty alloc] initWithName:@"deletedCol"
                 ...
                 linkOriginPropertyName:nil
                               ...
                               optional:NO];
  objectSchema.properties =
      [objectSchema.properties arrayByAddingObject:thirdProperty];
  ...
  RLMRealm *realm = [self migrateTestRealmWithBlock:^(
    ...
    [migration
        enumerateObjects:MigrationTestObject.className
                   block:^(RLMObject *oldObject, RLMObject *newObject) {
                     XCTAssertNoThrow(
                         oldObject[@"deletedCol"],
                         @"Deleted column should be accessible on old object.");
                     XCTAssertThrows(newObject[@"deletedCol"],
                                     @"Deleted column should not be accessible "
                                     @"on new object.");

                     XCTAssertEqualObjects(newObject[@"intCol"],
                                           oldObject[@"intCol"]);
                     XCTAssertEqualObjects(newObject[@"stringCol"],
                                           oldObject[@"stringCol"]);
                   }];
  }];
  ...
  // verify migration
  MigrationTestObject *mig1 = [MigrationTestObject allObjectsInRealm:realm][1];
  XCTAssertThrows(mig1[@"deletedCol"],
                  @"Deleted column should no longer be accessible.");
}
...
- (void)testRemoveAndAddProperty {
  ...
  void (^migrateObjectBlock)(RLMObject *, RLMObject *) =
      ^(RLMObject *oldObject, RLMObject *newObject) {
        XCTAssertNoThrow(oldObject[@"oldIntCol"],
                         @"Deleted column should be accessible on old object.");
        XCTAssertThrows(oldObject[@"intCol"],
                        @"New column should not be accessible on old object.");
        XCTAssertEqual([oldObject[@"oldIntCol"] intValue], 1,
                       @"Deleted column value is correct.");
        XCTAssertNoThrow(newObject[@"intCol"],
                         @"New column is accessible on new object.");
        XCTAssertThrows(newObject[@"oldIntCol"],
                        @"Old column should not be accessible on old object.");
        XCTAssertEqual([newObject[@"intCol"] intValue], 0,
                       @"New column value is uninitialized.");
      };
  ...
  RLMRealm *realm =
      [self migrateTestRealmWithBlock:^(RLMMigration *migration,
        ...
        [migration enumerateObjects:MigrationTestObject.className
                              block:migrateObjectBlock];
      }];

  // verify migration
  MigrationTestObject *mig1 = [MigrationTestObject allObjectsInRealm:realm][1];
  XCTAssertThrows(mig1[@"oldIntCol"],
                  @"Deleted column should no longer be accessible.");
}
...
- (void)testChangePropertyType {
  ...
  RLMRealm *realm = [self migrateTestRealmWithBlock:^(
    ...
    [migration enumerateObjects:MigrationTestObject.className
                          block:^(RLMObject *oldObject, RLMObject *newObject) {
                            ...
                            XCTAssert([intObj isKindOfClass:NSNumber.class],
                                      @"Old stringCol should be int");
  ...
  MigrationTestObject *mig1 = [MigrationTestObject allObjectsInRealm:realm][1];
  XCTAssertEqualObjects(mig1[@"stringCol"], @"2",
                        @"stringCol should be string after migration.");
}

- (void)testChangeObjectLinkType {
  // create realm with old schema and populate
  [self createTestRealmWithSchema:RLMSchema.sharedSchema.objectSchema
                            block:^(RLMRealm *realm) {
                              id obj = [realm
                                  createObject:MigrationTestObject.className
                                     withValue:@[ @1, @"1" ]];
                              [realm createObject:MigrationLinkObject.className
                                        withValue:@[ obj, @[ obj ], @[ obj ] ]];
                            }];
  ...
  config.customSchema = [self schemaWithObjects:@[
    objectSchema,
    [RLMObjectSchema schemaForObjectClass:MigrationTestObject.class]
  ]];
  ...
  // Apply migration
  config.schemaVersion = 1;
  config.migrationBlock = ^(RLMMigration *migration,
                            uint64_t oldSchemaVersion) {
    XCTAssertEqual(oldSchemaVersion, 0U, @"Initial schema version should be 0");
...
- (void)testMakingPropertyPrimaryPreservesValues {
  RLMObjectSchema *objectSchema = [RLMObjectSchema
      schemaForObjectClass:MigrationStringPrimaryKeyObject.class];
  objectSchema.primaryKeyProperty = nil;

  [self
      createTestRealmWithSchema:@[ objectSchema ]
                          block:^(RLMRealm *realm) {
                            [realm createObject:MigrationStringPrimaryKeyObject
                                                    .className
                                      withValue:@[ @"1" ]];
                            [realm createObject:MigrationStringPrimaryKeyObject
                                                    .className
  ...
  RLMResults *objects =
      [MigrationStringPrimaryKeyObject allObjectsInRealm:realm];
...
- (void)testAddingPrimaryKeyShouldRejectDuplicateValues {
  ...
  RLMObjectSchema *objectSchema =
      [RLMObjectSchema schemaForObjectClass:MigrationPrimaryKeyObject.class];
  objectSchema.primaryKeyProperty = nil;
  [self
      createTestRealmWithSchema:@[ objectSchema ]
                          block:^(RLMRealm *realm) {
                            // populate with values that will be invalid when
                            // the property is made primary
                            [realm
                                createObject:MigrationPrimaryKeyObject.className
                                   withValue:@[ @1 ]];
                            [realm
                                createObject:MigrationPrimaryKeyObject.className
                                   withValue:@[ @1 ]];
  ...
  RLMRealm *realm = [self migrateTestRealmWithBlock:^(RLMMigration *migration,
    ...
    [migration enumerateObjects:@"MigrationPrimaryKeyObject"
                          block:^(__unused RLMObject *oldObject,
                                  RLMObject *newObject) {
  ...
  XCTAssertEqual(1U,
                 [[MigrationPrimaryKeyObject allObjectsInRealm:realm] count]);
}
...
- (void)testAddObjectDuringMigration {
  ...
  RLMRealm *realm =
      [self migrateTestRealmWithBlock:^(RLMMigration *migration, uint64_t) {
        [migration createObject:StringObject.className
                      withValue:@[ @"string" ]];
      }];
...
- (void)testEnumeratedObjectsDuringMigration {
  [self
      createTestRealmWithClasses:@[
        StringObject.class, ArrayPropertyObject.class, SetPropertyObject.class,
        IntObject.class
      ]
                           block:^(RLMRealm *realm) {
                             [StringObject createInRealm:realm
  ...
  RLMRealm *realm = [self migrateTestRealmWithBlock:^(RLMMigration *migration,
                                                      uint64_t) {
    [migration
        enumerateObjects:StringObject.className
                   block:^(RLMObject *oldObject, RLMObject *newObject) {
                     XCTAssertEqualObjects([oldObject valueForKey:@"stringCol"],
                                           oldObject[@"stringCol"]);
                     [newObject setValue:@"otherString" forKey:@"stringCol"];
                     XCTAssertEqualObjects([oldObject valueForKey:@"realm"],
                                           oldObject.realm);
                     XCTAssertThrows([oldObject valueForKey:@"noSuchKey"]);
                     XCTAssertThrows([newObject setValue:@1
                                                  forKey:@"noSuchKey"]);
                   }];

    [migration
        enumerateObjects:ArrayPropertyObject.className
                   block:^(RLMObject *oldObject, RLMObject *newObject) {
                     XCTAssertEqual(RLMDynamicObject.class, newObject.class);
                     XCTAssertEqual(RLMDynamicObject.class, oldObject.class);
                     XCTAssertEqual(RLMDynamicObject.class,
                                    [[oldObject[@"array"] firstObject] class]);
                     XCTAssertEqual(RLMDynamicObject.class,
                                    [[newObject[@"array"] firstObject] class]);
                   }];

    [migration
        enumerateObjects:SetPropertyObject.className
                   block:^(RLMObject *oldObject, RLMObject *newObject) {
                     XCTAssertEqual(RLMDynamicObject.class, newObject.class);
                     XCTAssertEqual(RLMDynamicObject.class, oldObject.class);
                     XCTAssertEqual(RLMDynamicObject.class,
                                    [[oldObject[@"set"] allObjects][0] class]);
                     XCTAssertEqual(RLMDynamicObject.class,
                                    [[newObject[@"set"] allObjects][0] class]);
                   }];
  }];
...
- (void)testEnumerateObjectsAfterDeleteObjects {
  [self
      createTestRealmWithClasses:
          @[ StringObject.class, IntObject.class, BoolObject.class ]
                           block:^(RLMRealm *realm) {
                             [StringObject createInRealm:realm
                                               withValue:@[ @"1" ]];
                             [StringObject createInRealm:realm
                             ...
                             [BoolObject createInRealm:realm
                                             withValue:@[ @YES ]];
                             [BoolObject createInRealm:realm
                                             withValue:@[ @NO ]];
                             [BoolObject createInRealm:realm
  ...
  [self migrateTestRealmWithBlock:^(RLMMigration *migration, uint64_t) {
    ...
    [migration
        enumerateObjects:StringObject.className
                   block:^(RLMObject *oldObject, RLMObject *newObject) {
                     XCTAssertEqualObjects(oldObject[@"stringCol"],
                                           newObject[@"stringCol"]);
                     if ([oldObject[@"stringCol"] isEqualToString:@"2"]) {
                       [migration deleteObject:newObject];
                     }
                   }];
    [migration enumerateObjects:StringObject.className
                          block:^(RLMObject *oldObject, RLMObject *newObject) {
                            XCTAssertEqualObjects(oldObject[@"stringCol"],
                                                  newObject[@"stringCol"]);
                            count++;
    ...
    count = 0;
    [migration enumerateObjects:IntObject.className
                          block:^(RLMObject *oldObject, RLMObject *newObject) {
                            XCTAssertEqualObjects(oldObject[@"intCol"],
                                                  newObject[@"intCol"]);
    ...
    [migration enumerateObjects:BoolObject.className
                          block:^(RLMObject *oldObject, RLMObject *newObject) {
                            XCTAssertEqualObjects(oldObject[@"boolCol"],
                                                  newObject[@"boolCol"]);
                            [migration deleteObject:newObject];
                          }];
    [migration enumerateObjects:BoolObject.className
                          block:^(__unused RLMObject *oldObject,
                                  __unused RLMObject *newObject) {
                            XCTFail(@"This line should not executed since all "
    ...
    [migration enumerateObjects:IntObject.className
                          block:^(RLMObject *oldObject, RLMObject *newObject) {
                            ...
                            if ([newObject[@"intCol"] isEqualToNumber:@1]) {
                              [migration deleteObject:newObject];
                              [migration createObject:IntObject.className
                                            withValue:@[ @0 ]];
                            }
                          }];
    [migration enumerateObjects:IntObject.className
    ...
    [migration enumerateObjects:BoolObject.className
                          block:^(RLMObject *oldObject, RLMObject *newObject) {
                            XCTAssertEqualObjects(oldObject[@"boolCol"],
                                                  newObject[@"boolCol"]);
                            [migration deleteObject:newObject];
                            [migration createObject:BoolObject.className
                                          withValue:@[ @NO ]];
                          }];
    [migration enumerateObjects:BoolObject.className
                          block:^(__unused RLMObject *oldObject,
...
- (void)testEnumerateObjectTypeRemovedFromSchema {
  [self
      createTestRealmWithClasses:@[ IntObject.class ]
                           block:^(RLMRealm *realm) {
                             [IntObject createInRealm:realm withValue:@[ @1 ]];
                             [IntObject createInRealm:realm withValue:@[ @2 ]];
                           }];
  ...
  config.migrationBlock = ^(RLMMigration *migration, uint64_t) {
    [migration
        enumerateObjects:IntObject.className
                   block:^(RLMObject *oldObject, RLMObject *newObject) {
...
- (void)testDeleteSomeObjectsWithinMigration {
  ...
  [self migrateTestRealmWithBlock:^(RLMMigration *migration, uint64_t) {
    [migration enumerateObjects:IntObject.className
                          block:^(RLMObject *, RLMObject *newObject) {
  ...
  XCTAssertEqualObjects(
      [[self objectsOfType:IntObject.class] valueForKey:@"intCol"], (@[ @2 ]));
}
...
- (void)testDeleteAndRecreateObjectsWithinMigration {
  [self
      createTestRealmWithClasses:@[ IntObject.class, PrimaryIntObject.class ]
                           block:^(RLMRealm *realm) {
                             [IntObject createInRealm:realm withValue:@[ @1 ]];
                             [IntObject createInRealm:realm withValue:@[ @2 ]];
                             [PrimaryIntObject createInRealm:realm
                                                   withValue:@[ @1 ]];
                             [PrimaryIntObject createInRealm:realm
                                                   withValue:@[ @2 ]];
                           }];
  ...
  [self migrateTestRealmWithBlock:^(RLMMigration *migration, uint64_t) {
    ...
    [migration enumerateObjects:PrimaryIntObject.className
                          block:^(RLMObject *, RLMObject *newObject) {
                            [migration deleteObject:newObject];
                          }];
  ...
  XCTAssertEqualObjects(
      [[self objectsOfType:IntObject.class] valueForKey:@"intCol"],
      (@[ @2, @4 ]));
  XCTAssertEqualObjects(
      [[self objectsOfType:PrimaryIntObject.class] valueForKey:@"intCol"],
      (@[ @2, @4 ]));
}
...
- (void)testRequiredToNullableAutoMigration {
  RLMObjectSchema *objectSchema =
      [RLMObjectSchema schemaForObjectClass:AllOptionalTypes.class];
  ...
  XCTAssertEqualObjects([@"data" dataUsingEncoding:NSUTF8StringEncoding],
                        obj.data);
  ...
  XCTAssertEqualObjects([@"data2" dataUsingEncoding:NSUTF8StringEncoding],
                        obj.data);
...
- (void)testMigrationAfterReorderingProperties {
  RLMObjectSchema *objectSchema =
      [RLMObjectSchema schemaForObjectClass:RequiredPropertiesObject.class];
  // Create a table where the order of columns does not match the order the
  // properties are declared in the class.
  objectSchema.properties = @[
    objectSchema.properties[2], objectSchema.properties[0],
    objectSchema.properties[1]
  ];

  [self createTestRealmWithSchema:@[ objectSchema ]
                            block:^(RLMRealm *realm) {
                              // We use a dictionary here to ensure that the
                              // test reaches the migration case below, even if
                              // the non-migration case doesn't handle the
                              // ordering correctly. The non-migration case is
                              // tested in testRearrangeProperties.
  ...
  config.schemaVersion = 1;
  config.migrationBlock = ^(RLMMigration *migration, uint64_t) {
    [migration createObject:RequiredPropertiesObject.className
                  withValue:@[ @"World", [NSData data], [NSDate date] ]];
  };
...
- (void)testModifyPrimaryKeyInMigration {
  ...
  auto realm = [self migrateTestRealmWithBlock:^(RLMMigration *migration,
                                                 uint64_t) {
    [migration enumerateObjects:@"PrimaryStringObject"
                          block:^(RLMObject *oldObject, RLMObject *newObject) {
                            newObject[@"stringCol"] =
                                [oldObject[@"intCol"] stringValue];
                          }];
  }];

  for (int i = 10; i < 20; ++i) {
    auto obj = [PrimaryStringObject objectInRealm:realm
                                    forPrimaryKey:@(i).stringValue];
    XCTAssertNotNil(obj);
...
- (void)testChangeEmptyTableFromTopLevelToEmbedded {
  RLMObjectSchema *fromChild =
      [RLMObjectSchema schemaForObjectClass:EmbeddedIntObject.class];
  fromChild.isEmbedded = false;
  RLMObjectSchema *fromParent =
      [RLMObjectSchema schemaForObjectClass:EmbeddedIntParentObject.class];

  RLMObjectSchema *toChild =
      [RLMObjectSchema schemaForObjectClass:EmbeddedIntObject.class];
  RLMObjectSchema *toParent =
      [RLMObjectSchema schemaForObjectClass:EmbeddedIntParentObject.class];

  [self assertMigrationRequiredForChangeFrom:@[ fromChild, fromParent ]
                                          to:@[ toChild, toParent ]];
}
...
- (void)testChangeToEmbeddedRequiresMigration {
  ...
  [self createTestRealmWithSchema:@[ fromChild, fromParent ]
                            block:^(RLMRealm *realm) {
                              EmbeddedIntObject *childObject =
                                  (EmbeddedIntObject *)[realm
                                      createObject:EmbeddedIntObject.className
                                         withValue:@[ @42 ]];
                              [realm
                                  createObject:EmbeddedIntParentObject.className
                                     withValue:@[
                                       @42, childObject, NSNull.null
                                     ]];
                              [realm
                                  createObject:EmbeddedIntParentObject.className
                                     withValue:@[
                                       @43, childObject, NSNull.null
                                     ]];
                            }];
...
- (void)testChangeTableToEmbeddedWithOnlyOneLinkPerObject {
  ...
  [self createTestRealmWithSchema:@[ fromChild, fromParent ]
                            block:^(RLMRealm *realm) {
                              EmbeddedIntObject *childObject1 =
                                  (EmbeddedIntObject *)[realm
                                      createObject:EmbeddedIntObject.className
                                         withValue:@[ @42 ]];
                              [realm
                                  createObject:EmbeddedIntParentObject.className
                                     withValue:@[
                                       @42, childObject1, NSNull.null
                                     ]];
                              EmbeddedIntObject *childObject2 =
                                  (EmbeddedIntObject *)[realm
                                      createObject:EmbeddedIntObject.className
                                         withValue:@[ @43 ]];
                              [realm
  ...
  RLMRealm *realm = [self migrateTestRealmWithBlock:^(RLMMigration *migration,
                                                      uint64_t) {
    [migration
        enumerateObjects:EmbeddedIntParentObject.className
                   block:^(RLMObject *oldObject, RLMObject *newObject) {
                     parentEnumerateCalls++;
                     XCTAssertNotNil(oldObject);
                     XCTAssertNotNil(newObject);
                     NSNumber *newIntProperty = newObject[@"object"][@"intCol"];
                     XCTAssertEqualObjects(oldObject[@"object"][@"intCol"],
                                           newIntProperty);
                     XCTAssert([newIntProperty isEqual:@42] ||
                               [newIntProperty isEqual:@43]);
                   }];
    [migration enumerateObjects:EmbeddedIntObject.className
                          block:^(RLMObject *oldObject, RLMObject *newObject) {
                            childEnumerateCalls++;
                            XCTAssertNotNil(oldObject);
                            XCTAssertNotNil(newObject);
  ...
  RLMResults<EmbeddedIntParentObject *> *parentObjects =
      RLMGetObjects(realm, EmbeddedIntParentObject.className, nil);
...
- (void)testChangeToEmbeddedWithMultipleBacklinksHandledAutomatically {
  ...
  RLMResults<EmbeddedIntParentObject *> *parents =
      [EmbeddedIntParentObject allObjectsInRealm:realm];
...
- (void)testConvertToEmbeddedWithMultipleIncomingLinksResolvedInMigrationBlock {
  ...
  RLMRealm *realm = [self migrateTestRealmWithBlock:^(RLMMigration *migration,
                                                      uint64_t) {
    [migration enumerateObjects:EmbeddedIntParentObject.className
                          block:^(RLMObject *oldObject, RLMObject *newObject) {
                            parentEnumerateCalls++;
                            XCTAssertNotNil(oldObject);
                            XCTAssertNotNil(newObject);
  ...
  RLMResults<EmbeddedIntObject *> *childObjects =
      RLMGetObjects(realm, EmbeddedIntObject.className, nil);
    ...
    [migration
        enumerateObjects:EmbeddedIntParentObject.className
                   block:^(RLMObject *oldObject, RLMObject *newObject) {
                     ...
                     [migration
                         createObject:EmbeddedIntParentObject.className
                            withValue:@[ @43, childObject, NSNull.null ]];
                   }];
  }];
  XCTAssertEqual(parentEnumerateCalls, 2);
}
...
- (void)testMigrationRenameProperty {
  RLMObjectSchema *objectSchema =
      [RLMObjectSchema schemaForObjectClass:AllTypesObject.class];
  RLMObjectSchema *stringObjectSchema =
      [RLMObjectSchema schemaForObjectClass:StringObject.class];
  RLMObjectSchema *mixedObjectSchema =
      [RLMObjectSchema schemaForObjectClass:MixedObject.class];
  RLMObjectSchema *linkingObjectsSchema =
      [RLMObjectSchema schemaForObjectClass:LinkToAllTypesObject.class];
  NSMutableArray *beforeProperties =
      [NSMutableArray arrayWithCapacity:objectSchema.properties.count];
  for (RLMProperty *property in objectSchema.properties) {
    [beforeProperties
        addObject:[property
                      copyWithNewName:[NSString
                                          stringWithFormat:@"before_%@",
                                                           property.name]]];
  }
  NSArray *afterProperties = objectSchema.properties;
  objectSchema.properties = beforeProperties;

  NSDictionary *valueDictionary = [AllTypesObject values:1
                                            stringObject:(id) @[ @"a" ]
                                             mixedObject:(id) @[ @"a" ]];
  NSMutableArray *inputValue =
      [NSMutableArray arrayWithCapacity:valueDictionary.count];
  for (NSString *key in [afterProperties valueForKey:@"name"]) {
    [inputValue addObject:valueDictionary[key]];
  }

  [self createTestRealmWithSchema:@[
    objectSchema, stringObjectSchema, mixedObjectSchema, linkingObjectsSchema
  ]
                            block:^(RLMRealm *realm) {
  ...
  RLMRealmConfiguration *config = [self
      renameConfigurationWithObjectSchemas:@[
        objectSchema, stringObjectSchema, mixedObjectSchema,
        linkingObjectsSchema
      ]
                            migrationBlock:^(
                                RLMMigration *migration,
                                __unused uint64_t oldSchemaVersion) {
                              [afterProperties enumerateObjectsUsingBlock:^(
                                                   RLMProperty *property,
                                                   NSUInteger idx,
                                                   __unused BOOL *stop) {
                                [migration
                                    renamePropertyForClass:AllTypesObject
                                                               .className
                                                   oldName:[beforeProperties
                                                                   [idx] name]
                              ...
                              [migration
                                  enumerateObjects:AllTypesObject.className
                                             block:^(RLMObject *oldObject,
                                               ...
                                               NSString *oldDescription = [oldObject
                                                                               .description
                                                   stringByReplacingOccurrencesOfString:
                                                       @"before_"
                                                                             withString:
                                               ...
                                               oldDescription =
                                                   regexReplace(oldDescription);
                                               newDescription =
                                                   regexReplace(newDescription);
...
- (void)testMultipleMigrationRenameProperty {
  RLMObjectSchema *schema =
      [RLMObjectSchema schemaForObjectClass:StringObject.class];
  schema.properties =
      @[ [schema.properties.firstObject copyWithNewName:@"stringCol0"] ];
  ...
  schema.properties =
      @[ [schema.properties.firstObject copyWithNewName:@"stringCol"] ];
  ...
  config.migrationBlock = ^(RLMMigration *migration, uint64_t oldVersion) {
    ...
    if (oldVersion < 1) {
      [migration renamePropertyForClass:StringObject.className
                                oldName:@"stringCol0"
                                newName:@"stringCol1"];
      [migration
          enumerateObjects:StringObject.className
                     block:^(RLMObject *oldObject, RLMObject *newObject) {
                       ...
                       RLMAssertThrowsWithReasonMatching(
                           newObject[@"stringCol0"], @"Invalid property name");
                       RLMAssertThrowsWithReasonMatching(
                           newObject[@"stringCol1"], @"Invalid property name");
                     }];
    }
    if (oldVersion < 2) {
      [migration renamePropertyForClass:StringObject.className
      ...
      [migration
          enumerateObjects:StringObject.className
                     block:^(RLMObject *oldObject, RLMObject *newObject) {
                       XCTAssertEqualObjects(oldObject[@"stringCol0"],
                                             oldValue);
  ...
  XCTAssertEqualObjects(
      @"0",
      [[[StringObject allObjectsInRealm:[RLMRealm realmWithConfiguration:config
                                                                   error:nil]]
          firstObject] stringCol]);
}

- (void)testMigrationRenamePropertyPrimaryKeyBoth {
  [self assertPropertyRenameError:nil
      firstSchemaTransform:^(RLMObjectSchema *schema,
                             RLMProperty *beforeProperty,
                             __unused RLMProperty *afterProperty) {
        schema.primaryKeyProperty = beforeProperty;
      }
      secondSchemaTransform:^(RLMObjectSchema *schema,
                              __unused RLMProperty *beforeProperty,
                              RLMProperty *afterProperty) {
...
- (void)testMigrationRenamePropertySetPrimaryKey {
  [self assertPropertyRenameError:nil
             firstSchemaTransform:nil
            secondSchemaTransform:^(RLMObjectSchema *schema, RLMProperty *,
                                    RLMProperty *afterProperty) {
              schema.primaryKeyProperty = afterProperty;
            }];
}
...
- (void)testMigrationRenamePropertyIndexBoth {
  [self assertPropertyRenameError:nil
             firstSchemaTransform:^(__unused RLMObjectSchema *schema,
                                    RLMProperty *beforeProperty,
                                    __unused RLMProperty *afterProperty) {
...
- (void)testMigrationRenamePropertySetRequired {
  [self assertPropertyRenameError:
            @"Cannot rename property 'StringObject.before_stringCol' to "
            @"'stringCol' because it would change from optional to required."
             firstSchemaTransform:^(__unused RLMObjectSchema *schema,
                                    __unused RLMProperty *beforeProperty,
                                    RLMProperty *afterProperty) {
...
- (void)testMigrationRenamePropertyTypeMismatch {
  [self
      assertPropertyRenameError:
          @"Cannot rename property 'StringObject.before_stringCol' to "
          @"'stringCol' because it would change from type 'int' to 'string'."
           firstSchemaTransform:^(RLMObjectSchema *,
                                  RLMProperty *beforeProperty, RLMProperty *) {
...
- (void)testMigrationRenamePropertyObjectTypeMismatch {
  ...
  [self assertPropertyRenameError:
            @"Cannot rename property 'MigrationLinkObject.before_object' to "
            @"'object' because it would change from type "
            @"'<MigrationLinkObject>' to '<MigrationTestObject>'."
  ...
  [self assertPropertyRenameError:
            @"Cannot rename property 'MigrationLinkObject.before_array' to "
            @"'array' because it would change from type "
            @"'array<MigrationLinkObject>' to 'array<MigrationTestObject>'."
                    objectSchemas:@[ objectSchema, migrationObjectSchema ]
                        className:MigrationLinkObject.className
...
- (void)testMigrationRenameMissingPropertiesAndClasses {
  ...
  [self assertPropertyRenameError:
            @"Cannot rename property 'StringObject.nonExistentProperty1' "
            @"because it does not exist."
                    objectSchemas:@[ objectSchema ]
                        className:StringObject.className
                          oldName:@"nonExistentProperty1"
                          newName:@"nonExistentProperty2"];
  ...
  [self
      assertPropertyRenameError:
          @"Renamed property 'StringObject.nonExistentProperty' does not exist."
                  objectSchemas:@[ renamedProperty ]
                      className:StringObject.className
                        oldName:@"stringCol"
                        newName:@"nonExistentProperty"];

  // Removed Class
  [self assertPropertyRenameError:
            @"Cannot rename properties for type 'StringObject' because it has "
            @"been removed from the WabiRealm."
                    objectSchemas:@[ [RLMObjectSchema
                                      schemaForObjectClass:IntObject.class] ]
                        className:StringObject.className
                          oldName:@"stringCol"
                          newName:@"stringCol2"];

  // Without Removing Old Property
  RLMProperty *secondProperty =
      [objectSchema.properties.firstObject copyWithNewName:@"stringCol2"];
  objectSchema.properties =
      [objectSchema.properties arrayByAddingObject:secondProperty];
  [self assertPropertyRenameError:
            @"Cannot rename property 'StringObject.stringCol' to 'stringCol2' "
            @"because the source property still exists."
                    objectSchemas:@[ objectSchema ]
                        className:StringObject.className
                          oldName:@"stringCol"
                          newName:@"stringCol2"];
