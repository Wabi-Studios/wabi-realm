...
- (void)addObjects {
  ...
  [optUnmanaged.decimalObj
      addObjects:@[ NSNull.null, decimal128(1), decimal128(2) ]];
  [optUnmanaged.objectIdObj
      addObjects:@[ NSNull.null, objectId(1), objectId(2) ]];
  [optUnmanaged.uuidObj addObjects:@[
    NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
    uuid(@"00000000-0000-0000-0000-000000000000")
  ]];
...
- (void)testDeleteObjectsInRealm {
  for (RLMSet *set in allSets) {
    RLMAssertThrowsWithReason([realm deleteObjects:set],
                              @"Cannot delete objects from RLMSet");
  }
}
...
- (void)testContainsObject {
  ...
  uncheckedAssertFalse([unmanaged.uuidObj
      containsObject:uuid(@"00000000-0000-0000-0000-000000000000")]);
  ...
  uncheckedAssertFalse([unmanaged.anyUUIDObj
      containsObject:uuid(@"00000000-0000-0000-0000-000000000000")]);
  ...
  uncheckedAssertFalse([managed.uuidObj
      containsObject:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  ...
  uncheckedAssertFalse([managed.anyUUIDObj
      containsObject:uuid(@"00000000-0000-0000-0000-000000000000")]);
  ...
  uncheckedAssertTrue([unmanaged.uuidObj
      containsObject:uuid(@"00000000-0000-0000-0000-000000000000")]);
  ...
  uncheckedAssertTrue([unmanaged.anyUUIDObj
      containsObject:uuid(@"00000000-0000-0000-0000-000000000000")]);
  ...
  uncheckedAssertTrue([managed.uuidObj
      containsObject:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  ...
  uncheckedAssertTrue([managed.anyUUIDObj
      containsObject:uuid(@"00000000-0000-0000-0000-000000000000")]);
...
- (void)testAddObjects {
  ...
  uncheckedAssertTrue([optUnmanaged.uuidObj
      containsObject:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
  ...
  uncheckedAssertTrue([optManaged.uuidObj
      containsObject:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]);
...
- (void)testIndexOfObjectSorted {
  ...
  [optManaged.boolObj
      addObjects:@[ NSNull.null, @NO, NSNull.null, @NO, NSNull.null ]];
  [optManaged.intObj
      addObjects:@[ NSNull.null, @2, NSNull.null, @2, NSNull.null ]];
  [optManaged.floatObj
      addObjects:@[ NSNull.null, @2.2f, NSNull.null, @2.2f, NSNull.null ]];
  [optManaged.doubleObj
      addObjects:@[ NSNull.null, @2.2, NSNull.null, @2.2, NSNull.null ]];
  [optManaged.stringObj
      addObjects:@[ NSNull.null, @"a", NSNull.null, @"a", NSNull.null ]];
  [optManaged.dataObj
      addObjects:@[ NSNull.null, data(1), NSNull.null, data(1), NSNull.null ]];
  [optManaged.dateObj
      addObjects:@[ NSNull.null, date(1), NSNull.null, date(1), NSNull.null ]];
  [optManaged.decimalObj addObjects:@[
    NSNull.null, decimal128(1), NSNull.null, decimal128(1), NSNull.null
  ]];
  [optManaged.objectIdObj addObjects:@[
    NSNull.null, objectId(1), NSNull.null, objectId(1), NSNull.null
  ]];
  [optManaged.uuidObj addObjects:@[
    NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"), NSNull.null,
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"), NSNull.null
  ]];
  // ordering can't be guaranteed in set, so just verify the indexes are between
  // 0 and 1
  uncheckedAssertTrue([[managed.boolObj sortedResultsUsingKeyPath:@"self"
                                                        ascending:NO]
                          indexOfObject:@YES] == 0U ||
                      [[managed.boolObj sortedResultsUsingKeyPath:@"self"
                                                        ascending:NO]
                          indexOfObject:@YES] == 1U);
  uncheckedAssertTrue(
      [[managed.intObj sortedResultsUsingKeyPath:@"self"
                                       ascending:NO] indexOfObject:@3] == 0U ||
      [[managed.intObj sortedResultsUsingKeyPath:@"self"
                                       ascending:NO] indexOfObject:@3] == 1U);
  uncheckedAssertTrue([[managed.floatObj sortedResultsUsingKeyPath:@"self"
                                                         ascending:NO]
                          indexOfObject:@3.3f] == 0U ||
                      [[managed.floatObj sortedResultsUsingKeyPath:@"self"
                                                         ascending:NO]
                          indexOfObject:@3.3f] == 1U);
  uncheckedAssertTrue([[managed.doubleObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:@3.3] == 0U ||
                      [[managed.doubleObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:@3.3] == 1U);
  uncheckedAssertTrue([[managed.stringObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:@"bc"] == 0U ||
                      [[managed.stringObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:@"bc"] == 1U);
  uncheckedAssertTrue([[managed.dataObj sortedResultsUsingKeyPath:@"self"
                                                        ascending:NO]
                          indexOfObject:data(2)] == 0U ||
                      [[managed.dataObj sortedResultsUsingKeyPath:@"self"
                                                        ascending:NO]
                          indexOfObject:data(2)] == 1U);
  uncheckedAssertTrue([[managed.dateObj sortedResultsUsingKeyPath:@"self"
                                                        ascending:NO]
                          indexOfObject:date(2)] == 0U ||
                      [[managed.dateObj sortedResultsUsingKeyPath:@"self"
                                                        ascending:NO]
                          indexOfObject:date(2)] == 1U);
  uncheckedAssertTrue([[managed.decimalObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:decimal128(2)] == 0U ||
                      [[managed.decimalObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:decimal128(2)] == 1U);
  uncheckedAssertTrue([[managed.objectIdObj sortedResultsUsingKeyPath:@"self"
                                                            ascending:NO]
                          indexOfObject:objectId(2)] == 0U ||
                      [[managed.objectIdObj sortedResultsUsingKeyPath:@"self"
                                                            ascending:NO]
                          indexOfObject:objectId(2)] == 1U);
  uncheckedAssertTrue(
      [[managed.uuidObj sortedResultsUsingKeyPath:@"self" ascending:NO]
          indexOfObject:uuid(@"00000000-0000-0000-0000-000000000000")] == 0U ||
      [[managed.uuidObj sortedResultsUsingKeyPath:@"self" ascending:NO]
          indexOfObject:uuid(@"00000000-0000-0000-0000-000000000000")] == 1U);
  uncheckedAssertTrue([[managed.anyBoolObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:@YES] == 0U ||
                      [[managed.anyBoolObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:@YES] == 1U);
  uncheckedAssertTrue([[managed.anyIntObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:@3] == 0U ||
                      [[managed.anyIntObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:@3] == 1U);
  uncheckedAssertTrue([[managed.anyFloatObj sortedResultsUsingKeyPath:@"self"
                                                            ascending:NO]
                          indexOfObject:@3.3f] == 0U ||
                      [[managed.anyFloatObj sortedResultsUsingKeyPath:@"self"
                                                            ascending:NO]
                          indexOfObject:@3.3f] == 1U);
  uncheckedAssertTrue([[managed.anyDoubleObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                          indexOfObject:@3.3] == 0U ||
                      [[managed.anyDoubleObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                          indexOfObject:@3.3] == 1U);
  uncheckedAssertTrue([[managed.anyStringObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                          indexOfObject:@"b"] == 0U ||
                      [[managed.anyStringObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                          indexOfObject:@"b"] == 1U);
  uncheckedAssertTrue([[managed.anyDataObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:data(2)] == 0U ||
                      [[managed.anyDataObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:data(2)] == 1U);
  uncheckedAssertTrue([[managed.anyDateObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:date(2)] == 0U ||
                      [[managed.anyDateObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:date(2)] == 1U);
  uncheckedAssertTrue([[managed.anyDecimalObj sortedResultsUsingKeyPath:@"self"
                                                              ascending:NO]
                          indexOfObject:decimal128(2)] == 0U ||
                      [[managed.anyDecimalObj sortedResultsUsingKeyPath:@"self"
                                                              ascending:NO]
                          indexOfObject:decimal128(2)] == 1U);
  uncheckedAssertTrue([[managed.anyObjectIdObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                          indexOfObject:objectId(2)] == 0U ||
                      [[managed.anyObjectIdObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                          indexOfObject:objectId(2)] == 1U);
  uncheckedAssertTrue(
      [[managed.anyUUIDObj sortedResultsUsingKeyPath:@"self" ascending:NO]
          indexOfObject:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")] == 0U ||
      [[managed.anyUUIDObj sortedResultsUsingKeyPath:@"self" ascending:NO]
          indexOfObject:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")] == 1U);
  uncheckedAssertTrue(
      [[managed.boolObj sortedResultsUsingKeyPath:@"self" ascending:NO]
          indexOfObject:@NO] == 0U ||
      [[managed.boolObj sortedResultsUsingKeyPath:@"self"
                                        ascending:NO] indexOfObject:@NO] == 1U);
  uncheckedAssertTrue(
      [[managed.intObj sortedResultsUsingKeyPath:@"self"
                                       ascending:NO] indexOfObject:@2] == 0U ||
      [[managed.intObj sortedResultsUsingKeyPath:@"self"
                                       ascending:NO] indexOfObject:@2] == 1U);
  uncheckedAssertTrue([[managed.floatObj sortedResultsUsingKeyPath:@"self"
                                                         ascending:NO]
                          indexOfObject:@2.2f] == 0U ||
                      [[managed.floatObj sortedResultsUsingKeyPath:@"self"
                                                         ascending:NO]
                          indexOfObject:@2.2f] == 1U);
  uncheckedAssertTrue([[managed.doubleObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:@2.2] == 0U ||
                      [[managed.doubleObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:@2.2] == 1U);
  uncheckedAssertTrue([[managed.stringObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:@"a"] == 0U ||
                      [[managed.stringObj sortedResultsUsingKeyPath:@"self"
  ...
  uncheckedAssertTrue([[managed.dataObj sortedResultsUsingKeyPath:@"self"
                                                        ascending:NO]
                          indexOfObject:data(1)] == 0U ||
                      [[managed.dataObj sortedResultsUsingKeyPath:@"self"
                                                        ascending:NO]
                          indexOfObject:data(1)] == 1U);
  uncheckedAssertTrue([[managed.dateObj sortedResultsUsingKeyPath:@"self"
                                                        ascending:NO]
                          indexOfObject:date(1)] == 0U ||
                      [[managed.dateObj sortedResultsUsingKeyPath:@"self"
                                                        ascending:NO]
                          indexOfObject:date(1)] == 1U);
  uncheckedAssertTrue([[managed.decimalObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:decimal128(1)] == 0U ||
                      [[managed.decimalObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:decimal128(1)] == 1U);
  uncheckedAssertTrue([[managed.objectIdObj sortedResultsUsingKeyPath:@"self"
                                                            ascending:NO]
                          indexOfObject:objectId(1)] == 0U ||
                      [[managed.objectIdObj sortedResultsUsingKeyPath:@"self"
                                                            ascending:NO]
                          indexOfObject:objectId(1)] == 1U);
  uncheckedAssertTrue(
      [[managed.uuidObj sortedResultsUsingKeyPath:@"self" ascending:NO]
          indexOfObject:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")] == 0U ||
      [[managed.uuidObj sortedResultsUsingKeyPath:@"self" ascending:NO]
  ...
  uncheckedAssertTrue([[optManaged.boolObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:@NO] == 0U ||
                      [[optManaged.boolObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:@NO] == 1U);
  uncheckedAssertTrue([[optManaged.intObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:@2] == 0U ||
                      [[optManaged.intObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:@2] == 1U);
  uncheckedAssertTrue([[optManaged.floatObj sortedResultsUsingKeyPath:@"self"
                                                            ascending:NO]
                          indexOfObject:@2.2f] == 0U ||
                      [[optManaged.floatObj sortedResultsUsingKeyPath:@"self"
                                                            ascending:NO]
                          indexOfObject:@2.2f] == 1U);
  uncheckedAssertTrue([[optManaged.doubleObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                          indexOfObject:@2.2] == 0U ||
                      [[optManaged.doubleObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                          indexOfObject:@2.2] == 1U);
  uncheckedAssertTrue([[optManaged.stringObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                          indexOfObject:@"a"] == 0U ||
                      [[optManaged.stringObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                          indexOfObject:@"a"] == 1U);
  uncheckedAssertTrue([[optManaged.dataObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:data(1)] == 0U ||
                      [[optManaged.dataObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:data(1)] == 1U);
  uncheckedAssertTrue([[optManaged.dateObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:date(1)] == 0U ||
                      [[optManaged.dateObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:date(1)] == 1U);
  uncheckedAssertTrue([[optManaged.decimalObj sortedResultsUsingKeyPath:@"self"
                                                              ascending:NO]
                          indexOfObject:decimal128(1)] == 0U ||
                      [[optManaged.decimalObj sortedResultsUsingKeyPath:@"self"
                                                              ascending:NO]
                          indexOfObject:decimal128(1)] == 1U);
  uncheckedAssertTrue([[optManaged.objectIdObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                          indexOfObject:objectId(1)] == 0U ||
                      [[optManaged.objectIdObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                          indexOfObject:objectId(1)] == 1U);
  uncheckedAssertTrue(
  ...
  uncheckedAssertTrue([[optManaged.boolObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:NSNull.null] == 0U ||
                      [[optManaged.boolObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue([[optManaged.intObj sortedResultsUsingKeyPath:@"self"
                                                          ascending:NO]
                          indexOfObject:NSNull.null] == 0U ||
                      [[optManaged.intObj sortedResultsUsingKeyPath:@"self"
  ...
  uncheckedAssertTrue([[optManaged.objectIdObj sortedResultsUsingKeyPath:@"self"
                      ...
                      [[optManaged.objectIdObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue([[optManaged.uuidObj sortedResultsUsingKeyPath:@"self"
                                                           ascending:NO]
                          indexOfObject:NSNull.null] == 0U ||
...
- (void)testIndexOfObjectDistinct {
  ...
  [managed.decimalObj
      addObjects:@[ decimal128(1), decimal128(1), decimal128(2) ]];
  ...
  [managed.anyDecimalObj
      addObjects:@[ decimal128(1), decimal128(1), decimal128(2) ]];
  [managed.anyObjectIdObj
      addObjects:@[ objectId(1), objectId(1), objectId(2) ]];
  [managed.anyUUIDObj addObjects:@[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  ...
  [optManaged.boolObj
      addObjects:@[ NSNull.null, NSNull.null, NSNull.null, @NO, NSNull.null ]];
  [optManaged.intObj
      addObjects:@[ NSNull.null, NSNull.null, NSNull.null, @2, NSNull.null ]];
  [optManaged.floatObj addObjects:@[
    NSNull.null, NSNull.null, NSNull.null, @2.2f, NSNull.null
  ]];
  [optManaged.doubleObj
      addObjects:@[ NSNull.null, NSNull.null, NSNull.null, @2.2, NSNull.null ]];
  [optManaged.stringObj
      addObjects:@[ NSNull.null, NSNull.null, NSNull.null, @"a", NSNull.null ]];
  [optManaged.dataObj addObjects:@[
    NSNull.null, NSNull.null, NSNull.null, data(1), NSNull.null
  ]];
  [optManaged.dateObj addObjects:@[
    NSNull.null, NSNull.null, NSNull.null, date(1), NSNull.null
  ]];
  [optManaged.decimalObj addObjects:@[
    NSNull.null, NSNull.null, NSNull.null, decimal128(1), NSNull.null
  ]];
  [optManaged.objectIdObj addObjects:@[
    NSNull.null, NSNull.null, NSNull.null, objectId(1), NSNull.null
  ]];
  [optManaged.uuidObj addObjects:@[
  ...
  // 0 and 1
  uncheckedAssertTrue(
      [[managed.boolObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@NO] == 0U ||
      [[managed.boolObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@NO] == 1U);
  uncheckedAssertTrue(
      [[managed.intObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2] == 0U ||
      [[managed.intObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2] == 1U);
  uncheckedAssertTrue(
      [[managed.floatObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2.2f] == 0U ||
      [[managed.floatObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2.2f] == 1U);
  uncheckedAssertTrue(
      [[managed.doubleObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2.2] == 0U ||
      [[managed.doubleObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2.2] == 1U);
  uncheckedAssertTrue(
      [[managed.stringObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@"a"] == 0U ||
      [[managed.stringObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@"a"] == 1U);
  uncheckedAssertTrue(
      [[managed.dataObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:data(1)] == 0U ||
      [[managed.dataObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:data(1)] == 1U);
  uncheckedAssertTrue(
      [[managed.dateObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:date(1)] == 0U ||
      [[managed.dateObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:date(1)] == 1U);
  uncheckedAssertTrue(
      [[managed.decimalObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:decimal128(1)] == 0U ||
      [[managed.decimalObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:decimal128(1)] == 1U);
  uncheckedAssertTrue(
      [[managed.objectIdObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:objectId(1)] == 0U ||
      [[managed.objectIdObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:objectId(1)] == 1U);
  uncheckedAssertTrue(
      [[managed.uuidObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")] == 0U ||
      [[managed.uuidObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")] == 1U);
  uncheckedAssertTrue(
      [[managed.anyBoolObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@NO] == 0U ||
      [[managed.anyBoolObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@NO] == 1U);
  uncheckedAssertTrue(
      [[managed.anyIntObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2] == 0U ||
      [[managed.anyIntObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2] == 1U);
  uncheckedAssertTrue(
      [[managed.anyFloatObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2.2f] == 0U ||
      [[managed.anyFloatObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2.2f] == 1U);
  uncheckedAssertTrue(
      [[managed.anyDoubleObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2.2] == 0U ||
      [[managed.anyDoubleObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@2.2] == 1U);
  uncheckedAssertTrue(
      [[managed.anyStringObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@"a"] == 0U ||
      [[managed.anyStringObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:@"a"] == 1U);
  uncheckedAssertTrue(
      [[managed.anyDataObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:data(1)] == 0U ||
      [[managed.anyDataObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:data(1)] == 1U);
  uncheckedAssertTrue(
      [[managed.anyDateObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:date(1)] == 0U ||
      [[managed.anyDateObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:date(1)] == 1U);
  uncheckedAssertTrue(
      [[managed.anyDecimalObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:decimal128(1)] == 0U ||
      [[managed.anyDecimalObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:decimal128(1)] == 1U);
  uncheckedAssertTrue(
      [[managed.anyObjectIdObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:objectId(1)] == 0U ||
      [[managed.anyObjectIdObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:objectId(1)] == 1U);
  uncheckedAssertTrue(
      [[managed.anyUUIDObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:uuid(@"00000000-0000-0000-0000-000000000000")] == 0U ||
      [[managed.anyUUIDObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:uuid(@"00000000-0000-0000-0000-000000000000")] == 1U);
  uncheckedAssertTrue(
  ...
  uncheckedAssertTrue(
      [[optManaged.boolObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 0U ||
      [[optManaged.boolObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue(
      [[optManaged.intObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 0U ||
      [[optManaged.intObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue(
      [[optManaged.floatObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 0U ||
      [[optManaged.floatObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue(
      [[optManaged.doubleObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 0U ||
      [[optManaged.doubleObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue(
      [[optManaged.stringObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 0U ||
      [[optManaged.stringObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue(
      [[optManaged.dataObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 0U ||
      [[optManaged.dataObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue(
      [[optManaged.dateObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 0U ||
      [[optManaged.dateObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue(
      [[optManaged.decimalObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 0U ||
      [[optManaged.decimalObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue(
      [[optManaged.objectIdObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 0U ||
      [[optManaged.objectIdObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue(
      [[optManaged.uuidObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 0U ||
      [[optManaged.uuidObj distinctResultsUsingKeyPaths:@[ @"self" ]]
          indexOfObject:NSNull.null] == 1U);
  uncheckedAssertTrue(
...
- (void)testSort {
  RLMAssertThrowsWithReason([unmanaged.boolObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO],
                            @"This method may only be called on RLMSet "
  ...
  RLMAssertThrowsWithReason(
      ...
      @"This method may only be called on RLMSet instances retrieved from an "
      @"RLMRealm");
  RLMAssertThrowsWithReason(
  ...
  [managed.decimalObj
      addObjects:@[ decimal128(1), decimal128(2), decimal128(1) ]];
  ...
  [managed.anyDecimalObj
      addObjects:@[ decimal128(1), decimal128(2), decimal128(1) ]];
  [managed.anyObjectIdObj
      addObjects:@[ objectId(1), objectId(2), objectId(1) ]];
  [managed.anyUUIDObj addObjects:@[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
    uuid(@"00000000-0000-0000-0000-000000000000")
  ...
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.boolObj sortedResultsUsingDescriptors:@[]]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @NO, @YES ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.intObj sortedResultsUsingDescriptors:@[]]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2, @3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.floatObj sortedResultsUsingDescriptors:@[]]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2f, @3.3f ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.doubleObj sortedResultsUsingDescriptors:@[
             ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2, @3.3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.stringObj sortedResultsUsingDescriptors:@[
             ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @"a", @"bc" ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.dataObj sortedResultsUsingDescriptors:@[]]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ data(1), data(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.dateObj sortedResultsUsingDescriptors:@[]]
                              valueForKey:@"self"] allObjects]],
  ...
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.objectIdObj sortedResultsUsingDescriptors:@[]]
                           valueForKey:@"self"] allObjects]],
  ...
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.anyBoolObj sortedResultsUsingDescriptors:@[
             ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @NO, @YES ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.anyIntObj sortedResultsUsingDescriptors:@[
             ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2, @3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.anyFloatObj sortedResultsUsingDescriptors:@[]]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2f, @3.3f ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.anyDoubleObj sortedResultsUsingDescriptors:@[
          ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2, @3.3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.anyStringObj sortedResultsUsingDescriptors:@[
          ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @"a", @"b" ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.anyDataObj sortedResultsUsingDescriptors:@[
             ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ data(1), data(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.anyDateObj sortedResultsUsingDescriptors:@[
             ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ date(1), date(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.anyDecimalObj sortedResultsUsingDescriptors:@[
          ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ decimal128(1), decimal128(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.anyObjectIdObj
  ...
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[optManaged.boolObj sortedResultsUsingDescriptors:@[
             ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @NO ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[optManaged.intObj sortedResultsUsingDescriptors:@[
             ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[optManaged.floatObj sortedResultsUsingDescriptors:@[]]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2.2f ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[optManaged.doubleObj sortedResultsUsingDescriptors:@[
          ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2.2 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[optManaged.stringObj sortedResultsUsingDescriptors:@[
          ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @"a" ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[optManaged.dataObj sortedResultsUsingDescriptors:@[
             ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, data(1) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[optManaged.dateObj sortedResultsUsingDescriptors:@[
             ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, date(1) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[optManaged.decimalObj sortedResultsUsingDescriptors:@[
          ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, decimal128(1) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[optManaged.objectIdObj
                              sortedResultsUsingDescriptors:@[]]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, objectId(1) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[optManaged.uuidObj sortedResultsUsingDescriptors:@[
             ]] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[
        NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
      ]]));
  ...
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.boolObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @YES, @NO ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.intObj sortedResultsUsingKeyPath:@"self"
                                                            ascending:NO]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @3, @2 ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.floatObj sortedResultsUsingKeyPath:@"self"
                                                              ascending:NO]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @3.3f, @2.2f ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.doubleObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @3.3, @2.2 ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.stringObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @"bc", @"a" ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.dataObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ data(2), data(1) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.dateObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ date(2), date(1) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.decimalObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ decimal128(2), decimal128(1) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.objectIdObj sortedResultsUsingKeyPath:@"self"
                                                              ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ objectId(2), objectId(1) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.uuidObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[
        uuid(@"00000000-0000-0000-0000-000000000000"),
  ...
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.anyBoolObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @YES, @NO ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.anyIntObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @3, @2 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.anyFloatObj sortedResultsUsingKeyPath:@"self"
                                                              ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @3.3f, @2.2f ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.anyDoubleObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @3.3, @2.2 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.anyStringObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @"b", @"a" ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.anyDataObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ data(2), data(1) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.anyDateObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ date(2), date(1) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[managed.anyDecimalObj
                              sortedResultsUsingKeyPath:@"self"
  ...
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[managed.anyUUIDObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
  ...
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[optManaged.boolObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @NO, NSNull.null ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[optManaged.intObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                              valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2, NSNull.null ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[optManaged.floatObj sortedResultsUsingKeyPath:@"self"
                                                              ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2f, NSNull.null ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[optManaged.doubleObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2, NSNull.null ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[optManaged.stringObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @"a", NSNull.null ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[optManaged.dataObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ data(1), NSNull.null ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[optManaged.dateObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ date(1), NSNull.null ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[[optManaged.decimalObj
                              sortedResultsUsingKeyPath:@"self"
                                              ascending:NO] valueForKey:@"self"]
                              allObjects]],
  ...
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[[optManaged.uuidObj sortedResultsUsingKeyPath:@"self"
                                                             ascending:NO]
                           valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"), NSNull.null
...
- (void)testSetSet {
  ...
  [optManaged.decimalObj
      addObjects:@[ NSNull.null, decimal128(1), NSNull.null ]];
  [optManaged.objectIdObj
      addObjects:@[ NSNull.null, objectId(1), NSNull.null ]];
  [optManaged.uuidObj addObjects:@[
    NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"), NSNull.null
  ]];
  ...
  [managed.uuidObj2 addObjects:@[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"123DECC8-B300-4954-A233-F89909F4FD89")
  ]];
  ...
  [managed.anyUUIDObj2 addObjects:@[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"123DECC8-B300-4954-A233-F89909F4FD89")
  ]];
  ...
  [optManaged.decimalObj2
      addObjects:@[ decimal128(2), decimal128(3), NSNull.null ]];
  [optManaged.objectIdObj2
      addObjects:@[ objectId(2), objectId(3), NSNull.null ]];
  [optManaged.uuidObj2 addObjects:@[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"123DECC8-B300-4954-A233-F89909F4FD89"), NSNull.null
  ]];
  ...
  [unmanaged.anyUUIDObj2 addObjects:@[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"123DECC8-B300-4954-A233-F89909F4FD89")
  ]];
  ...
  [optUnmanaged.decimalObj2
      addObjects:@[ decimal128(2), decimal128(4), NSNull.null ]];
  [optUnmanaged.objectIdObj2
      addObjects:@[ objectId(2), objectId(4), NSNull.null ]];
  [optUnmanaged.uuidObj2 addObjects:@[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"123DECC8-B300-4954-A233-F89909F4FD89"), NSNull.null
  ]];
  ...
  uncheckedAssertEqual(managed.boolObj.count, 2U);
  uncheckedAssertEqualObjects([NSSet setWithArray:managed.boolObj.allObjects],
                              ([NSSet setWithArray:@[ @NO, @YES ]]));
  uncheckedAssertEqual(optManaged.boolObj.count, 3U);
}
...
- (void)testUnion {
  ...
  uncheckedAssertEqual(unmanaged.boolObj.count, 2U);
  uncheckedAssertEqualObjects([NSSet setWithArray:unmanaged.boolObj.allObjects],
                              ([NSSet setWithArray:@[ @NO, @YES ]]));
  uncheckedAssertEqual(managed.boolObj.count, 2U);
  uncheckedAssertEqualObjects([NSSet setWithArray:managed.boolObj.allObjects],
                              ([NSSet setWithArray:@[ @NO, @YES ]]));
...
- (void)testIntersect {
  ...
  uncheckedAssertTrue(
      [managed.anyDoubleObj intersectsSet:managed.anyDoubleObj2]);
  uncheckedAssertTrue(
      [managed.anyStringObj intersectsSet:managed.anyStringObj2]);
  ...
  uncheckedAssertTrue(
      [managed.anyDecimalObj intersectsSet:managed.anyDecimalObj2]);
  uncheckedAssertTrue(
      [managed.anyObjectIdObj intersectsSet:managed.anyObjectIdObj2]);
  ...
  uncheckedAssertTrue(
      [optManaged.doubleObj intersectsSet:optManaged.doubleObj2]);
  uncheckedAssertTrue(
      [optManaged.stringObj intersectsSet:optManaged.stringObj2]);
  ...
  uncheckedAssertTrue(
      [optManaged.decimalObj intersectsSet:optManaged.decimalObj2]);
  uncheckedAssertTrue(
      [optManaged.objectIdObj intersectsSet:optManaged.objectIdObj2]);
  ...
  uncheckedAssertTrue(
      [unmanaged.decimalObj intersectsSet:unmanaged.decimalObj2]);
  uncheckedAssertTrue(
      [unmanaged.objectIdObj intersectsSet:unmanaged.objectIdObj2]);
  uncheckedAssertTrue([unmanaged.uuidObj intersectsSet:unmanaged.uuidObj2]);
  uncheckedAssertTrue(
      [unmanaged.anyBoolObj intersectsSet:unmanaged.anyBoolObj2]);
  uncheckedAssertTrue([unmanaged.anyIntObj intersectsSet:unmanaged.anyIntObj2]);
  uncheckedAssertTrue(
      [unmanaged.anyFloatObj intersectsSet:unmanaged.anyFloatObj2]);
  uncheckedAssertTrue(
      [unmanaged.anyDoubleObj intersectsSet:unmanaged.anyDoubleObj2]);
  uncheckedAssertTrue(
      [unmanaged.anyStringObj intersectsSet:unmanaged.anyStringObj2]);
  uncheckedAssertTrue(
      [unmanaged.anyDataObj intersectsSet:unmanaged.anyDataObj2]);
  uncheckedAssertTrue(
      [unmanaged.anyDateObj intersectsSet:unmanaged.anyDateObj2]);
  uncheckedAssertTrue(
      [unmanaged.anyDecimalObj intersectsSet:unmanaged.anyDecimalObj2]);
  uncheckedAssertTrue(
      [unmanaged.anyObjectIdObj intersectsSet:unmanaged.anyObjectIdObj2]);
  uncheckedAssertTrue(
      [unmanaged.anyUUIDObj intersectsSet:unmanaged.anyUUIDObj2]);
  uncheckedAssertTrue([optUnmanaged.intObj intersectsSet:optUnmanaged.intObj2]);
  uncheckedAssertTrue(
      [optUnmanaged.floatObj intersectsSet:optUnmanaged.floatObj2]);
  uncheckedAssertTrue(
      [optUnmanaged.doubleObj intersectsSet:optUnmanaged.doubleObj2]);
  uncheckedAssertTrue(
      [optUnmanaged.stringObj intersectsSet:optUnmanaged.stringObj2]);
  uncheckedAssertTrue(
      [optUnmanaged.dataObj intersectsSet:optUnmanaged.dataObj2]);
  uncheckedAssertTrue(
      [optUnmanaged.dateObj intersectsSet:optUnmanaged.dateObj2]);
  uncheckedAssertTrue(
      [optUnmanaged.decimalObj intersectsSet:optUnmanaged.decimalObj2]);
  uncheckedAssertTrue(
      [optUnmanaged.objectIdObj intersectsSet:optUnmanaged.objectIdObj2]);
  uncheckedAssertTrue(
      [optUnmanaged.uuidObj intersectsSet:optUnmanaged.uuidObj2]);
  ...
  uncheckedAssertEqual(optManaged.boolObj.count, 2U);
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:optManaged.boolObj.allObjects],
      ([NSSet setWithArray:@[ NSNull.null, @NO ]]));
}
...
- (void)testIsSubsetOfSet {
  ...
  [managed.decimalObj2 addObjects:@[
    decimal128(1), decimal128(2), decimal128(2), decimal128(3)
  ]];
  [managed.objectIdObj2
      addObjects:@[ objectId(1), objectId(2), objectId(2), objectId(3) ]];
  [managed.uuidObj2 addObjects:@[
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"00000000-0000-0000-0000-000000000000"),
  ...
  [managed.anyDecimalObj2 addObjects:@[
    decimal128(1), decimal128(2), decimal128(1), decimal128(3)
  ]];
  [managed.anyObjectIdObj2
      addObjects:@[ objectId(1), objectId(2), objectId(1), objectId(3) ]];
  [managed.anyUUIDObj2 addObjects:@[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
    uuid(@"00000000-0000-0000-0000-000000000000"),
  ...
  [optManaged.boolObj2
      addObjects:@[ NSNull.null, @NO, @YES, @NO, NSNull.null ]];
  [optManaged.intObj2 addObjects:@[ NSNull.null, @2, @3, @4, NSNull.null ]];
  [optManaged.floatObj2
      addObjects:@[ NSNull.null, @2.2f, @3.3f, @4.4f, NSNull.null ]];
  [optManaged.doubleObj2
      addObjects:@[ NSNull.null, @2.2, @3.3, @4.4, NSNull.null ]];
  [optManaged.stringObj2
      addObjects:@[ NSNull.null, @"a", @"bc", @"de", NSNull.null ]];
  [optManaged.dataObj2
      addObjects:@[ NSNull.null, data(1), data(2), data(3), NSNull.null ]];
  [optManaged.dateObj2
      addObjects:@[ NSNull.null, date(1), date(2), date(3), NSNull.null ]];
  [optManaged.decimalObj2 addObjects:@[
    NSNull.null, decimal128(1), decimal128(2), decimal128(3), NSNull.null
  ]];
  [optManaged.objectIdObj2 addObjects:@[
    NSNull.null, objectId(1), objectId(2), objectId(3), NSNull.null
  ]];
  [optManaged.uuidObj2 addObjects:@[
    NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
    uuid(@"00000000-0000-0000-0000-000000000000"),
  ...
  [unmanaged.decimalObj2 addObjects:@[
    decimal128(1), decimal128(2), decimal128(1), decimal128(3)
  ]];
  [unmanaged.objectIdObj2
      addObjects:@[ objectId(1), objectId(2), objectId(1), objectId(3) ]];
  [unmanaged.uuidObj2 addObjects:@[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
  ...
  [unmanaged.anyDecimalObj2 addObjects:@[
    decimal128(1), decimal128(2), decimal128(1), decimal128(3)
  ]];
  [unmanaged.anyObjectIdObj2
      addObjects:@[ objectId(1), objectId(2), objectId(1), objectId(3) ]];
  [unmanaged.anyUUIDObj2 addObjects:@[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
  ...
  [optUnmanaged.floatObj2
      addObjects:@[ NSNull.null, @2.2f, @3.3f, @4.4f, NSNull.null ]];
  [optUnmanaged.doubleObj2
      addObjects:@[ NSNull.null, @2.2, @3.3, @4.4, NSNull.null ]];
  [optUnmanaged.stringObj2
      addObjects:@[ NSNull.null, @"a", @"bc", @"de", NSNull.null ]];
  [optUnmanaged.dataObj2
      addObjects:@[ NSNull.null, data(1), data(2), data(3), NSNull.null ]];
  [optUnmanaged.dateObj2
      addObjects:@[ NSNull.null, date(1), date(2), date(3), NSNull.null ]];
  [optUnmanaged.decimalObj2 addObjects:@[
    NSNull.null, decimal128(1), decimal128(2), decimal128(4), NSNull.null
  ]];
  [optUnmanaged.objectIdObj2 addObjects:@[
    NSNull.null, objectId(1), objectId(2), objectId(4), NSNull.null
  ]];
  [optUnmanaged.uuidObj2 addObjects:@[
    NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
    uuid(@"00000000-0000-0000-0000-000000000000"),
...
- (void)testMin {
  ...
  RLMAssertThrowsWithReason([optUnmanaged.uuidObj minOfProperty:@"self"],
                            @"minOfProperty: is not supported for uuid? set");
  RLMAssertThrowsWithReason(
      [managed.boolObj minOfProperty:@"self"],
  ...
  RLMAssertThrowsWithReason([managed.stringObj minOfProperty:@"self"],
                            @"Operation 'min' not supported for string set "
                            @"'AllPrimitiveSets.stringObj'");
  RLMAssertThrowsWithReason(
      [managed.dataObj minOfProperty:@"self"],
  ...
  RLMAssertThrowsWithReason([managed.objectIdObj minOfProperty:@"self"],
                            @"Operation 'min' not supported for object id set "
                            @"'AllPrimitiveSets.objectIdObj'");
  RLMAssertThrowsWithReason(
      [managed.uuidObj minOfProperty:@"self"],
  ...
  RLMAssertThrowsWithReason([optManaged.boolObj minOfProperty:@"self"],
                            @"Operation 'min' not supported for bool? set "
                            @"'AllOptionalPrimitiveSets.boolObj'");
  RLMAssertThrowsWithReason([optManaged.stringObj minOfProperty:@"self"],
                            @"Operation 'min' not supported for string? set "
                            @"'AllOptionalPrimitiveSets.stringObj'");
  RLMAssertThrowsWithReason([optManaged.dataObj minOfProperty:@"self"],
                            @"Operation 'min' not supported for data? set "
                            @"'AllOptionalPrimitiveSets.dataObj'");
  RLMAssertThrowsWithReason([optManaged.objectIdObj minOfProperty:@"self"],
                            @"Operation 'min' not supported for object id? set "
                            @"'AllOptionalPrimitiveSets.objectIdObj'");
  RLMAssertThrowsWithReason([optManaged.uuidObj minOfProperty:@"self"],
                            @"Operation 'min' not supported for uuid? set "
                            @"'AllOptionalPrimitiveSets.uuidObj'");
...
- (void)testMax {
  ...
  RLMAssertThrowsWithReason([optUnmanaged.uuidObj maxOfProperty:@"self"],
                            @"maxOfProperty: is not supported for uuid? set");
  RLMAssertThrowsWithReason(
      [managed.boolObj maxOfProperty:@"self"],
  ...
  RLMAssertThrowsWithReason([managed.stringObj maxOfProperty:@"self"],
                            @"Operation 'max' not supported for string set "
                            @"'AllPrimitiveSets.stringObj'");
  RLMAssertThrowsWithReason(
      [managed.dataObj maxOfProperty:@"self"],
  ...
  RLMAssertThrowsWithReason([managed.objectIdObj maxOfProperty:@"self"],
                            @"Operation 'max' not supported for object id set "
                            @"'AllPrimitiveSets.objectIdObj'");
  RLMAssertThrowsWithReason(
      [managed.uuidObj maxOfProperty:@"self"],
  ...
  RLMAssertThrowsWithReason([optManaged.boolObj maxOfProperty:@"self"],
                            @"Operation 'max' not supported for bool? set "
                            @"'AllOptionalPrimitiveSets.boolObj'");
  ...
  RLMAssertThrowsWithReason([optManaged.dataObj maxOfProperty:@"self"],
                            @"Operation 'max' not supported for data? set "
                            @"'AllOptionalPrimitiveSets.dataObj'");
  ...
  RLMAssertThrowsWithReason([optManaged.uuidObj maxOfProperty:@"self"],
                            @"Operation 'max' not supported for uuid? set "
                            @"'AllOptionalPrimitiveSets.uuidObj'");
...
- (void)testSum {
  ...
  RLMAssertThrowsWithReason([optUnmanaged.uuidObj sumOfProperty:@"self"],
                            @"sumOfProperty: is not supported for uuid? set");
  RLMAssertThrowsWithReason(
      [managed.boolObj sumOfProperty:@"self"],
  ...
  RLMAssertThrowsWithReason([managed.stringObj sumOfProperty:@"self"],
                            @"Operation 'sum' not supported for string set "
                            @"'AllPrimitiveSets.stringObj'");
  RLMAssertThrowsWithReason(
      [managed.dataObj sumOfProperty:@"self"],
      @"Operation 'sum' not supported for data set 'AllPrimitiveSets.dataObj'");
  RLMAssertThrowsWithReason(
      [managed.dateObj sumOfProperty:@"self"],
  ...
  RLMAssertThrowsWithReason([managed.objectIdObj sumOfProperty:@"self"],
                            @"Operation 'sum' not supported for object id set "
                            @"'AllPrimitiveSets.objectIdObj'");
  RLMAssertThrowsWithReason(
      [managed.uuidObj sumOfProperty:@"self"],
  ...
  RLMAssertThrowsWithReason([optManaged.boolObj sumOfProperty:@"self"],
                            @"Operation 'sum' not supported for bool? set "
                            @"'AllOptionalPrimitiveSets.boolObj'");
  ...
  RLMAssertThrowsWithReason([optManaged.dataObj sumOfProperty:@"self"],
                            @"Operation 'sum' not supported for data? set "
                            @"'AllOptionalPrimitiveSets.dataObj'");
  RLMAssertThrowsWithReason([optManaged.dateObj sumOfProperty:@"self"],
                            @"Operation 'sum' not supported for date? set "
                            @"'AllOptionalPrimitiveSets.dateObj'");
  ...
  RLMAssertThrowsWithReason([optManaged.uuidObj sumOfProperty:@"self"],
                            @"Operation 'sum' not supported for uuid? set "
                            @"'AllOptionalPrimitiveSets.uuidObj'");
  ...
  XCTAssertEqualWithAccuracy(
      ...
      sum(@[ decimal128(1), decimal128(2) ]), .001);
  XCTAssertEqualWithAccuracy(
...
- (void)testAverage {
  ...
  RLMAssertThrowsWithReason([optManaged.stringObj averageOfProperty:@"self"],
                            ...
                            @"set 'AllOptionalPrimitiveSets.stringObj'");
  ...
  RLMAssertThrowsWithReason([optManaged.objectIdObj averageOfProperty:@"self"],
                            @"Operation 'average' not supported for object id? "
                            @"set 'AllOptionalPrimitiveSets.objectIdObj'");
  ...
  XCTAssertEqualWithAccuracy(
      ...
      average(@[ decimal128(1), decimal128(2) ]), .001);
  XCTAssertEqualWithAccuracy(
...
- (void)testValueForKeySelf {
  ...
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged.boolObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @NO, @YES ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged.intObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2, @3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[unmanaged.floatObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2f, @3.3f ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[unmanaged.doubleObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2, @3.3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[unmanaged.stringObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @"a", @"bc" ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged.dataObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ data(1), data(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged.dateObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ date(1), date(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[unmanaged.decimalObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ decimal128(1), decimal128(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged.objectIdObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ objectId(1), objectId(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged.uuidObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[
        uuid(@"00000000-0000-0000-0000-000000000000"),
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
      ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[unmanaged.anyBoolObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @NO, @YES ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[unmanaged.anyIntObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2, @3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged.anyFloatObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @2.2f, @3.3f ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged.anyDoubleObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @2.2, @3.3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged.anyStringObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @"a", @"b" ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[unmanaged.anyDataObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ data(1), data(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[unmanaged.anyDateObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ date(1), date(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged.anyDecimalObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ decimal128(1), decimal128(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged.anyObjectIdObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ objectId(1), objectId(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[unmanaged.anyUUIDObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[
        uuid(@"00000000-0000-0000-0000-000000000000"),
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
      ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optUnmanaged.boolObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @NO, @YES ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optUnmanaged.intObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2, @3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged.floatObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2.2f, @3.3f ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged.doubleObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2.2, @3.3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged.stringObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @"a", @"bc" ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optUnmanaged.dataObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, data(1), data(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optUnmanaged.dateObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, date(1), date(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged.decimalObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, decimal128(1), decimal128(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged.objectIdObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, objectId(1), objectId(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optUnmanaged.uuidObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[
        NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
        uuid(@"00000000-0000-0000-0000-000000000000")
      ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed.boolObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @NO, @YES ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed.intObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2, @3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed.floatObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2f, @3.3f ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed.doubleObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2, @3.3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed.stringObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @"a", @"bc" ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed.dataObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ data(1), data(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed.dateObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ date(1), date(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed.decimalObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ decimal128(1), decimal128(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed.objectIdObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ objectId(1), objectId(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed.uuidObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
        uuid(@"00000000-0000-0000-0000-000000000000")
      ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed.anyBoolObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @NO, @YES ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed.anyIntObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2, @3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed.anyFloatObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2f, @3.3f ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed.anyDoubleObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2, @3.3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed.anyStringObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @"a", @"b" ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed.anyDataObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ data(1), data(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed.anyDateObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ date(1), date(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed.anyDecimalObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ decimal128(1), decimal128(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed.anyObjectIdObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ objectId(1), objectId(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed.anyUUIDObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[
        uuid(@"00000000-0000-0000-0000-000000000000"),
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
      ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optManaged.boolObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @NO, @YES ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optManaged.intObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2, @3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optManaged.floatObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2.2f, @3.3f ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optManaged.doubleObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2.2, @3.3 ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optManaged.stringObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @"a", @"bc" ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optManaged.dataObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, data(1), data(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optManaged.dateObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, date(1), date(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optManaged.decimalObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, decimal128(1), decimal128(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optManaged.objectIdObj valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, objectId(1), objectId(2) ]]));
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[optManaged.uuidObj valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[
        NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
        uuid(@"00000000-0000-0000-0000-000000000000")
      ]]));
...
- (void)testValueForKeyNumericAggregates {
  ...
  uncheckedAssertEqualObjects(
      [unmanaged.anyIntObj valueForKeyPath:@"@sum.self"], @0);
  uncheckedAssertEqualObjects(
      [unmanaged.anyFloatObj valueForKeyPath:@"@sum.self"], @0);
  uncheckedAssertEqualObjects(
      [unmanaged.anyDoubleObj valueForKeyPath:@"@sum.self"], @0);
  uncheckedAssertEqualObjects(
      [unmanaged.anyDecimalObj valueForKeyPath:@"@sum.self"], @0);
  uncheckedAssertEqualObjects(
  ...
  uncheckedAssertEqualObjects([managed.decimalObj valueForKeyPath:@"@sum.self"],
                              @0);
  uncheckedAssertEqualObjects([managed.anyIntObj valueForKeyPath:@"@sum.self"],
                              @0);
  uncheckedAssertEqualObjects(
      [managed.anyFloatObj valueForKeyPath:@"@sum.self"], @0);
  uncheckedAssertEqualObjects(
      [managed.anyDoubleObj valueForKeyPath:@"@sum.self"], @0);
  uncheckedAssertEqualObjects(
      [managed.anyDecimalObj valueForKeyPath:@"@sum.self"], @0);
  ...
  uncheckedAssertEqualObjects([unmanaged.dateObj valueForKeyPath:@"@min.self"],
                              date(1));
  uncheckedAssertEqualObjects(
      [unmanaged.decimalObj valueForKeyPath:@"@min.self"], decimal128(1));
  uncheckedAssertEqualObjects(
  ...
  uncheckedAssertEqualObjects(
      [unmanaged.anyDecimalObj valueForKeyPath:@"@min.self"], decimal128(1));
  uncheckedAssertEqualObjects(
  ...
  uncheckedAssertEqualObjects(
      [optUnmanaged.decimalObj valueForKeyPath:@"@max.self"], decimal128(2));
  ...
  uncheckedAssertEqualObjects([managed.anyDateObj valueForKeyPath:@"@min.self"],
                              date(1));
  uncheckedAssertEqualObjects(
      [managed.anyDecimalObj valueForKeyPath:@"@min.self"], decimal128(1));
  ...
  uncheckedAssertEqualObjects([optManaged.dateObj valueForKeyPath:@"@max.self"],
                              date(2));
  uncheckedAssertEqualObjects(
      [optManaged.decimalObj valueForKeyPath:@"@max.self"], decimal128(2));
  ...
  XCTAssertEqualWithAccuracy(
      ...
      sum(@[ decimal128(1), decimal128(2) ]), .001);
  XCTAssertEqualWithAccuracy(
      [[unmanaged.anyIntObj valueForKeyPath:@"@sum.self"] doubleValue],
      sum(@[ @2, @3 ]), .001);
  XCTAssertEqualWithAccuracy(
      [[unmanaged.anyFloatObj valueForKeyPath:@"@sum.self"] doubleValue],
      sum(@[ @2.2f, @3.3f ]), .001);
  XCTAssertEqualWithAccuracy(
      [[unmanaged.anyDoubleObj valueForKeyPath:@"@sum.self"] doubleValue],
      sum(@[ @2.2, @3.3 ]), .001);
  XCTAssertEqualWithAccuracy(
      [[unmanaged.anyDecimalObj valueForKeyPath:@"@sum.self"] doubleValue],
      sum(@[ decimal128(1), decimal128(2) ]), .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      sum(@[ decimal128(1), decimal128(2) ]), .001);
  XCTAssertEqualWithAccuracy(
      [[managed.anyIntObj valueForKeyPath:@"@sum.self"] doubleValue],
      sum(@[ @2, @3 ]), .001);
  XCTAssertEqualWithAccuracy(
      [[managed.anyFloatObj valueForKeyPath:@"@sum.self"] doubleValue],
      sum(@[ @2.2f, @3.3f ]), .001);
  XCTAssertEqualWithAccuracy(
      [[managed.anyDoubleObj valueForKeyPath:@"@sum.self"] doubleValue],
      sum(@[ @2.2, @3.3 ]), .001);
  XCTAssertEqualWithAccuracy(
      [[managed.anyDecimalObj valueForKeyPath:@"@sum.self"] doubleValue],
      sum(@[ decimal128(1), decimal128(2) ]), .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      average(@[ decimal128(1), decimal128(2) ]), .001);
  XCTAssertEqualWithAccuracy(
      [[unmanaged.anyIntObj valueForKeyPath:@"@avg.self"] doubleValue],
      average(@[ @2, @3 ]), .001);
  XCTAssertEqualWithAccuracy(
      [[unmanaged.anyFloatObj valueForKeyPath:@"@avg.self"] doubleValue],
      average(@[ @2.2f, @3.3f ]), .001);
  XCTAssertEqualWithAccuracy(
      [[unmanaged.anyDoubleObj valueForKeyPath:@"@avg.self"] doubleValue],
      average(@[ @2.2, @3.3 ]), .001);
  XCTAssertEqualWithAccuracy(
      [[unmanaged.anyDecimalObj valueForKeyPath:@"@avg.self"] doubleValue],
      average(@[ decimal128(1), decimal128(2) ]), .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      average(@[ decimal128(1), decimal128(2) ]), .001);
  XCTAssertEqualWithAccuracy(
      [[managed.anyIntObj valueForKeyPath:@"@avg.self"] doubleValue],
      average(@[ @2, @3 ]), .001);
  XCTAssertEqualWithAccuracy(
      [[managed.anyFloatObj valueForKeyPath:@"@avg.self"] doubleValue],
      average(@[ @2.2f, @3.3f ]), .001);
  XCTAssertEqualWithAccuracy(
      [[managed.anyDoubleObj valueForKeyPath:@"@avg.self"] doubleValue],
      average(@[ @2.2, @3.3 ]), .001);
  XCTAssertEqualWithAccuracy(
      [[managed.anyDecimalObj valueForKeyPath:@"@avg.self"] doubleValue],
      average(@[ decimal128(1), decimal128(2) ]), .001);
  XCTAssertEqualWithAccuracy(
...
- (void)testValueForKeyLength {
  ...
  [self addObjects];
  uncheckedAssertEqualObjects(
      [unmanaged.stringObj valueForKey:@"length"],
      ([[NSSet setWithArray:@[ @"a", @"bc" ]] valueForKey:@"length"]));
  uncheckedAssertEqualObjects(
      [unmanaged.anyStringObj valueForKey:@"length"],
      ([[NSSet setWithArray:@[ @"a", @"b" ]] valueForKey:@"length"]));
  uncheckedAssertEqualObjects(
      [optUnmanaged.stringObj valueForKey:@"length"],
      ([[NSSet setWithArray:@[ NSNull.null, @"a", @"bc" ]]
          valueForKey:@"length"]));
  uncheckedAssertEqualObjects(
      [managed.stringObj valueForKey:@"length"],
      ([[NSSet setWithArray:@[ @"a", @"bc" ]] valueForKey:@"length"]));
  uncheckedAssertEqualObjects(
      [managed.anyStringObj valueForKey:@"length"],
      ([[NSSet setWithArray:@[ @"a", @"b" ]] valueForKey:@"length"]));
  uncheckedAssertEqualObjects(
...
- (void)testSetValueForKey {
  for (RLMSet *set in allSets) {
    RLMAssertThrowsWithReason(
        [set setValue:@0 forKey:@"not self"],
  ...
  [managed.uuidObj setValue:uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
                     forKey:@"self"];
  ...
  RLMAssertThrowsWithReason(unmanaged.boolObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.intObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.floatObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.doubleObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.stringObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.dataObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.dateObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.decimalObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.objectIdObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.uuidObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.anyBoolObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.anyIntObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.anyFloatObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.anyDoubleObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.anyStringObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.anyDataObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.anyDateObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.anyDecimalObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.anyObjectIdObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(unmanaged.anyUUIDObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optUnmanaged.boolObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optUnmanaged.intObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optUnmanaged.floatObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optUnmanaged.doubleObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optUnmanaged.stringObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optUnmanaged.dataObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optUnmanaged.dateObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optUnmanaged.decimalObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optUnmanaged.objectIdObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optUnmanaged.uuidObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.boolObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.intObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.floatObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.doubleObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.stringObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.dataObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.dateObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.decimalObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.objectIdObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.uuidObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.anyBoolObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.anyIntObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.anyFloatObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.anyDoubleObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.anyStringObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.anyDataObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.anyDateObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.anyDecimalObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.anyObjectIdObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(managed.anyUUIDObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optManaged.boolObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optManaged.intObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optManaged.floatObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optManaged.doubleObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optManaged.stringObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optManaged.dataObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optManaged.dateObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optManaged.decimalObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optManaged.objectIdObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  RLMAssertThrowsWithReason(optManaged.uuidObj.allObjects[1],
                            @"index 1 beyond bounds [0 .. 0]");
  ...
  uncheckedAssertEqualObjects(unmanaged.decimalObj.allObjects[0],
                              decimal128(1));
  uncheckedAssertEqualObjects(unmanaged.objectIdObj.allObjects[0], objectId(1));
  uncheckedAssertEqualObjects(unmanaged.uuidObj.allObjects[0],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  ...
  uncheckedAssertEqualObjects(unmanaged.anyDecimalObj.allObjects[0],
                              decimal128(1));
  uncheckedAssertEqualObjects(unmanaged.anyObjectIdObj.allObjects[0],
                              objectId(1));
  uncheckedAssertEqualObjects(unmanaged.anyUUIDObj.allObjects[0],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  ...
  uncheckedAssertEqualObjects(optUnmanaged.doubleObj.allObjects[0],
                              NSNull.null);
  uncheckedAssertEqualObjects(optUnmanaged.stringObj.allObjects[0],
                              NSNull.null);
  ...
  uncheckedAssertEqualObjects(optUnmanaged.decimalObj.allObjects[0],
                              NSNull.null);
  uncheckedAssertEqualObjects(optUnmanaged.objectIdObj.allObjects[0],
                              NSNull.null);
  ...
  uncheckedAssertEqualObjects(managed.uuidObj.allObjects[0],
                              uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  ...
  uncheckedAssertEqualObjects(managed.anyDecimalObj.allObjects[0],
                              decimal128(1));
  uncheckedAssertEqualObjects(managed.anyObjectIdObj.allObjects[0],
                              objectId(1));
  uncheckedAssertEqualObjects(managed.anyUUIDObj.allObjects[0],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  ...
  uncheckedAssertEqualObjects(optManaged.objectIdObj.allObjects[0],
                              NSNull.null);
...
- (void)testAssignment {
  ...
  optUnmanaged.uuidObj =
      (id) @[ uuid(@"137DECC8-B300-4954-A233-F89909F4FD89") ];
  uncheckedAssertEqualObjects(optUnmanaged.uuidObj.allObjects[0],
                              uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  ...
  uncheckedAssertEqualObjects(optManaged.decimalObj.allObjects[0],
                              decimal128(1));
  optManaged.objectIdObj = (id) @[ objectId(1) ];
  uncheckedAssertEqualObjects(optManaged.objectIdObj.allObjects[0],
                              objectId(1));
  optManaged.uuidObj = (id) @[ uuid(@"137DECC8-B300-4954-A233-F89909F4FD89") ];
  uncheckedAssertEqualObjects(optManaged.uuidObj.allObjects[0],
                              uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
...
- (void)testDynamicAssignment {
  unmanaged[@"boolObj"] = (id) @[ @YES ];
  uncheckedAssertEqualObjects(((RLMSet *)unmanaged[@"boolObj"]).allObjects[0],
                              @YES);
  unmanaged[@"intObj"] = (id) @[ @3 ];
  uncheckedAssertEqualObjects(((RLMSet *)unmanaged[@"intObj"]).allObjects[0],
                              @3);
  unmanaged[@"floatObj"] = (id) @[ @3.3f ];
  uncheckedAssertEqualObjects(((RLMSet *)unmanaged[@"floatObj"]).allObjects[0],
                              @3.3f);
  unmanaged[@"doubleObj"] = (id) @[ @3.3 ];
  uncheckedAssertEqualObjects(((RLMSet *)unmanaged[@"doubleObj"]).allObjects[0],
                              @3.3);
  unmanaged[@"stringObj"] = (id) @[ @"bc" ];
  uncheckedAssertEqualObjects(((RLMSet *)unmanaged[@"stringObj"]).allObjects[0],
                              @"bc");
  unmanaged[@"dataObj"] = (id) @[ data(2) ];
  uncheckedAssertEqualObjects(((RLMSet *)unmanaged[@"dataObj"]).allObjects[0],
                              data(2));
  unmanaged[@"dateObj"] = (id) @[ date(2) ];
  uncheckedAssertEqualObjects(((RLMSet *)unmanaged[@"dateObj"]).allObjects[0],
                              date(2));
  unmanaged[@"decimalObj"] = (id) @[ decimal128(2) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)unmanaged[@"decimalObj"]).allObjects[0], decimal128(2));
  unmanaged[@"objectIdObj"] = (id) @[ objectId(2) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)unmanaged[@"objectIdObj"]).allObjects[0], objectId(2));
  unmanaged[@"uuidObj"] =
      (id) @[ uuid(@"137DECC8-B300-4954-A233-F89909F4FD89") ];
  uncheckedAssertEqualObjects(((RLMSet *)unmanaged[@"uuidObj"]).allObjects[0],
                              uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  unmanaged[@"anyBoolObj"] = (id) @[ @YES ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)unmanaged[@"anyBoolObj"]).allObjects[0], @YES);
  unmanaged[@"anyIntObj"] = (id) @[ @3 ];
  uncheckedAssertEqualObjects(((RLMSet *)unmanaged[@"anyIntObj"]).allObjects[0],
                              @3);
  unmanaged[@"anyFloatObj"] = (id) @[ @3.3f ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)unmanaged[@"anyFloatObj"]).allObjects[0], @3.3f);
  unmanaged[@"anyDoubleObj"] = (id) @[ @3.3 ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)unmanaged[@"anyDoubleObj"]).allObjects[0], @3.3);
  unmanaged[@"anyStringObj"] = (id) @[ @"b" ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)unmanaged[@"anyStringObj"]).allObjects[0], @"b");
  unmanaged[@"anyDataObj"] = (id) @[ data(2) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)unmanaged[@"anyDataObj"]).allObjects[0], data(2));
  unmanaged[@"anyDateObj"] = (id) @[ date(2) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)unmanaged[@"anyDateObj"]).allObjects[0], date(2));
  unmanaged[@"anyDecimalObj"] = (id) @[ decimal128(2) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)unmanaged[@"anyDecimalObj"]).allObjects[0], decimal128(2));
  unmanaged[@"anyObjectIdObj"] = (id) @[ objectId(2) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)unmanaged[@"anyObjectIdObj"]).allObjects[0], objectId(2));
  unmanaged[@"anyUUIDObj"] =
      (id) @[ uuid(@"137DECC8-B300-4954-A233-F89909F4FD89") ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)unmanaged[@"anyUUIDObj"]).allObjects[0],
      uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  optUnmanaged[@"boolObj"] = (id) @[ @NO ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optUnmanaged[@"boolObj"]).allObjects[0], @NO);
  optUnmanaged[@"intObj"] = (id) @[ @2 ];
  uncheckedAssertEqualObjects(((RLMSet *)optUnmanaged[@"intObj"]).allObjects[0],
                              @2);
  optUnmanaged[@"floatObj"] = (id) @[ @2.2f ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optUnmanaged[@"floatObj"]).allObjects[0], @2.2f);
  optUnmanaged[@"doubleObj"] = (id) @[ @2.2 ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optUnmanaged[@"doubleObj"]).allObjects[0], @2.2);
  optUnmanaged[@"stringObj"] = (id) @[ @"a" ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optUnmanaged[@"stringObj"]).allObjects[0], @"a");
  optUnmanaged[@"dataObj"] = (id) @[ data(1) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optUnmanaged[@"dataObj"]).allObjects[0], data(1));
  optUnmanaged[@"dateObj"] = (id) @[ date(1) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optUnmanaged[@"dateObj"]).allObjects[0], date(1));
  optUnmanaged[@"decimalObj"] = (id) @[ decimal128(1) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optUnmanaged[@"decimalObj"]).allObjects[0], decimal128(1));
  optUnmanaged[@"objectIdObj"] = (id) @[ objectId(1) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optUnmanaged[@"objectIdObj"]).allObjects[0], objectId(1));
  optUnmanaged[@"uuidObj"] =
      (id) @[ uuid(@"137DECC8-B300-4954-A233-F89909F4FD89") ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optUnmanaged[@"uuidObj"]).allObjects[0],
      uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  managed[@"boolObj"] = (id) @[ @YES ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"boolObj"]).allObjects[0],
                              @YES);
  managed[@"intObj"] = (id) @[ @3 ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"intObj"]).allObjects[0], @3);
  managed[@"floatObj"] = (id) @[ @3.3f ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"floatObj"]).allObjects[0],
                              @3.3f);
  managed[@"doubleObj"] = (id) @[ @3.3 ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"doubleObj"]).allObjects[0],
                              @3.3);
  managed[@"stringObj"] = (id) @[ @"bc" ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"stringObj"]).allObjects[0],
                              @"bc");
  managed[@"dataObj"] = (id) @[ data(2) ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"dataObj"]).allObjects[0],
                              data(2));
  managed[@"dateObj"] = (id) @[ date(2) ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"dateObj"]).allObjects[0],
                              date(2));
  managed[@"decimalObj"] = (id) @[ decimal128(2) ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"decimalObj"]).allObjects[0],
                              decimal128(2));
  managed[@"objectIdObj"] = (id) @[ objectId(2) ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"objectIdObj"]).allObjects[0],
                              objectId(2));
  managed[@"uuidObj"] = (id) @[ uuid(@"00000000-0000-0000-0000-000000000000") ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"uuidObj"]).allObjects[0],
                              uuid(@"00000000-0000-0000-0000-000000000000"));
  managed[@"anyBoolObj"] = (id) @[ @YES ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"anyBoolObj"]).allObjects[0],
                              @YES);
  managed[@"anyIntObj"] = (id) @[ @3 ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"anyIntObj"]).allObjects[0],
                              @3);
  managed[@"anyFloatObj"] = (id) @[ @3.3f ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"anyFloatObj"]).allObjects[0],
                              @3.3f);
  managed[@"anyDoubleObj"] = (id) @[ @3.3 ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)managed[@"anyDoubleObj"]).allObjects[0], @3.3);
  managed[@"anyStringObj"] = (id) @[ @"b" ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)managed[@"anyStringObj"]).allObjects[0], @"b");
  managed[@"anyDataObj"] = (id) @[ data(2) ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"anyDataObj"]).allObjects[0],
                              data(2));
  managed[@"anyDateObj"] = (id) @[ date(2) ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"anyDateObj"]).allObjects[0],
                              date(2));
  managed[@"anyDecimalObj"] = (id) @[ decimal128(2) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)managed[@"anyDecimalObj"]).allObjects[0], decimal128(2));
  managed[@"anyObjectIdObj"] = (id) @[ objectId(2) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)managed[@"anyObjectIdObj"]).allObjects[0], objectId(2));
  managed[@"anyUUIDObj"] =
      (id) @[ uuid(@"137DECC8-B300-4954-A233-F89909F4FD89") ];
  uncheckedAssertEqualObjects(((RLMSet *)managed[@"anyUUIDObj"]).allObjects[0],
                              uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  optManaged[@"boolObj"] = (id) @[ @NO ];
  uncheckedAssertEqualObjects(((RLMSet *)optManaged[@"boolObj"]).allObjects[0],
                              @NO);
  optManaged[@"intObj"] = (id) @[ @2 ];
  uncheckedAssertEqualObjects(((RLMSet *)optManaged[@"intObj"]).allObjects[0],
                              @2);
  optManaged[@"floatObj"] = (id) @[ @2.2f ];
  uncheckedAssertEqualObjects(((RLMSet *)optManaged[@"floatObj"]).allObjects[0],
                              @2.2f);
  optManaged[@"doubleObj"] = (id) @[ @2.2 ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optManaged[@"doubleObj"]).allObjects[0], @2.2);
  optManaged[@"stringObj"] = (id) @[ @"a" ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optManaged[@"stringObj"]).allObjects[0], @"a");
  optManaged[@"dataObj"] = (id) @[ data(1) ];
  uncheckedAssertEqualObjects(((RLMSet *)optManaged[@"dataObj"]).allObjects[0],
                              data(1));
  optManaged[@"dateObj"] = (id) @[ date(1) ];
  uncheckedAssertEqualObjects(((RLMSet *)optManaged[@"dateObj"]).allObjects[0],
                              date(1));
  optManaged[@"decimalObj"] = (id) @[ decimal128(1) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optManaged[@"decimalObj"]).allObjects[0], decimal128(1));
  optManaged[@"objectIdObj"] = (id) @[ objectId(1) ];
  uncheckedAssertEqualObjects(
      ((RLMSet *)optManaged[@"objectIdObj"]).allObjects[0], objectId(1));
  optManaged[@"uuidObj"] =
      (id) @[ uuid(@"137DECC8-B300-4954-A233-F89909F4FD89") ];
  uncheckedAssertEqualObjects(((RLMSet *)optManaged[@"uuidObj"]).allObjects[0],
                              uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));

  // Should replace and not append
  unmanaged[@"boolObj"] = (id) @[ @NO, @YES ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"boolObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @NO, @YES ]]));
  ...
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[unmanaged[@"intObj"] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2, @3 ]]));

  unmanaged[@"floatObj"] = (id) @[ @2.2f, @3.3f ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"floatObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @2.2f, @3.3f ]]));

  unmanaged[@"doubleObj"] = (id) @[ @2.2, @3.3 ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"doubleObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @2.2, @3.3 ]]));

  unmanaged[@"stringObj"] = (id) @[ @"a", @"bc" ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"stringObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @"a", @"bc" ]]));

  unmanaged[@"dataObj"] = (id) @[ data(1), data(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"dataObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ data(1), data(2) ]]));

  unmanaged[@"dateObj"] = (id) @[ date(1), date(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"dateObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ date(1), date(2) ]]));

  unmanaged[@"decimalObj"] = (id) @[ decimal128(1), decimal128(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"decimalObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ decimal128(1), decimal128(2) ]]));
  ...
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"uuidObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[
        uuid(@"00000000-0000-0000-0000-000000000000"),
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  ...
  unmanaged[@"anyBoolObj"] = (id) @[ @NO, @YES ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"anyBoolObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @NO, @YES ]]));

  unmanaged[@"anyIntObj"] = (id) @[ @2, @3 ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"anyIntObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @2, @3 ]]));
  ...
  unmanaged[@"anyDataObj"] = (id) @[ data(1), data(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"anyDataObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ data(1), data(2) ]]));

  unmanaged[@"anyDateObj"] = (id) @[ date(1), date(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"anyDateObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ date(1), date(2) ]]));
  ...
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[unmanaged[@"anyUUIDObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[
        uuid(@"00000000-0000-0000-0000-000000000000"),
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  ...
  optUnmanaged[@"boolObj"] = (id) @[ NSNull.null, @NO, @YES ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged[@"boolObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @NO, @YES ]]));

  optUnmanaged[@"intObj"] = (id) @[ NSNull.null, @2, @3 ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged[@"intObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2, @3 ]]));
  ...
  optUnmanaged[@"dataObj"] = (id) @[ NSNull.null, data(1), data(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged[@"dataObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, data(1), data(2) ]]));

  optUnmanaged[@"dateObj"] = (id) @[ NSNull.null, date(1), date(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged[@"dateObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, date(1), date(2) ]]));

  optUnmanaged[@"decimalObj"] =
      (id) @[ NSNull.null, decimal128(1), decimal128(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged[@"decimalObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, decimal128(1), decimal128(2) ]]));
  ...
  optUnmanaged[@"objectIdObj"] =
      (id) @[ NSNull.null, objectId(1), objectId(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged[@"objectIdObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, objectId(1), objectId(2) ]]));
  ...
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optUnmanaged[@"uuidObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[
        NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
        uuid(@"00000000-0000-0000-0000-000000000000")
  ...
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed[@"boolObj"] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @NO, @YES ]]));

  managed[@"intObj"] = (id) @[ @2, @3 ];
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed[@"intObj"] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2, @3 ]]));

  managed[@"floatObj"] = (id) @[ @2.2f, @3.3f ];
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed[@"floatObj"] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ @2.2f, @3.3f ]]));

  managed[@"doubleObj"] = (id) @[ @2.2, @3.3 ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"doubleObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @2.2, @3.3 ]]));

  managed[@"stringObj"] = (id) @[ @"a", @"bc" ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"stringObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @"a", @"bc" ]]));
  ...
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed[@"dataObj"] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ data(1), data(2) ]]));

  managed[@"dateObj"] = (id) @[ date(1), date(2) ];
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed[@"dateObj"] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[ date(1), date(2) ]]));

  managed[@"decimalObj"] = (id) @[ decimal128(1), decimal128(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"decimalObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ decimal128(1), decimal128(2) ]]));

  managed[@"objectIdObj"] = (id) @[ objectId(1), objectId(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"objectIdObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ objectId(1), objectId(2) ]]));
  ...
  uncheckedAssertEqualObjects(
      [NSSet
          setWithArray:[[managed[@"uuidObj"] valueForKey:@"self"] allObjects]],
      ([NSSet setWithArray:@[
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
        uuid(@"00000000-0000-0000-0000-000000000000")
      ]]));
  ...
  managed[@"anyBoolObj"] = (id) @[ @NO, @YES ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"anyBoolObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @NO, @YES ]]));

  managed[@"anyIntObj"] = (id) @[ @2, @3 ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"anyIntObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @2, @3 ]]));

  managed[@"anyFloatObj"] = (id) @[ @2.2f, @3.3f ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"anyFloatObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @2.2f, @3.3f ]]));

  managed[@"anyDoubleObj"] = (id) @[ @2.2, @3.3 ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"anyDoubleObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @2.2, @3.3 ]]));

  managed[@"anyStringObj"] = (id) @[ @"a", @"b" ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"anyStringObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ @"a", @"b" ]]));

  managed[@"anyDataObj"] = (id) @[ data(1), data(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"anyDataObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ data(1), data(2) ]]));

  managed[@"anyDateObj"] = (id) @[ date(1), date(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"anyDateObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ date(1), date(2) ]]));
  ...
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[managed[@"anyUUIDObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[
        uuid(@"00000000-0000-0000-0000-000000000000"),
        uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  ...
  optManaged[@"boolObj"] = (id) @[ NSNull.null, @NO, @YES ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optManaged[@"boolObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @NO, @YES ]]));

  optManaged[@"intObj"] = (id) @[ NSNull.null, @2, @3 ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optManaged[@"intObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2, @3 ]]));

  optManaged[@"floatObj"] = (id) @[ NSNull.null, @2.2f, @3.3f ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optManaged[@"floatObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2.2f, @3.3f ]]));

  optManaged[@"doubleObj"] = (id) @[ NSNull.null, @2.2, @3.3 ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optManaged[@"doubleObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @2.2, @3.3 ]]));

  optManaged[@"stringObj"] = (id) @[ NSNull.null, @"a", @"bc" ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optManaged[@"stringObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, @"a", @"bc" ]]));

  optManaged[@"dataObj"] = (id) @[ NSNull.null, data(1), data(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optManaged[@"dataObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, data(1), data(2) ]]));

  optManaged[@"dateObj"] = (id) @[ NSNull.null, date(1), date(2) ];
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optManaged[@"dateObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[ NSNull.null, date(1), date(2) ]]));
  ...
  uncheckedAssertEqualObjects(
      [NSSet setWithArray:[[optManaged[@"uuidObj"] valueForKey:@"self"]
                              allObjects]],
      ([NSSet setWithArray:@[
        NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
        uuid(@"00000000-0000-0000-0000-000000000000")
...
- (void)testInvalidAssignment {
  RLMAssertThrowsWithReason(unmanaged.intObj = (id) @[ NSNull.null ],
                            @"Invalid value '<null>' of type 'NSNull' for "
                            @"'int' set property 'AllPrimitiveSets.intObj'.");
  RLMAssertThrowsWithReason(
      unmanaged.intObj = (id) @[ @"a" ],
      @"Invalid value 'a' of type '__NSCFConstantString' for 'int' set "
      @"property 'AllPrimitiveSets.intObj'.");
  RLMAssertThrowsWithReason(
      unmanaged.intObj = (id)(@[ @1, @"a" ]),
      @"Invalid value 'a' of type '__NSCFConstantString' for 'int' set "
      @"property 'AllPrimitiveSets.intObj'.");
  RLMAssertThrowsWithReason(unmanaged.intObj = (id)unmanaged.floatObj,
                            @"RLMSet<float> does not match expected type 'int' "
                            @"for property 'AllPrimitiveSets.intObj'.");
  RLMAssertThrowsWithReason(unmanaged.intObj = (id)optUnmanaged.intObj,
                            @"RLMSet<int?> does not match expected type 'int' "
                            @"for property 'AllPrimitiveSets.intObj'.");
...
- (void)testAllMethodsCheckThread {
  ...
  [self dispatchAsyncAndWait:^{
    ...
    RLMAssertThrowsWithReason(
        [set sortedResultsUsingKeyPath:@"self" ascending:YES], @"thread");
    RLMAssertThrowsWithReason(
...
- (void)testAllMethodsCheckForInvalidation {
  ...
  RLMAssertThrowsWithReason(
      [set sortedResultsUsingKeyPath:@"self" ascending:YES], @"invalidated");
  RLMAssertThrowsWithReason(
      [set sortedResultsUsingDescriptors:@[ [RLMSortDescriptor
                                             sortDescriptorWithKeyPath:@"self"
                                                             ascending:YES] ]],
      @"invalidated");
...
- (void)testMutatingMethodsCheckForWriteTransaction {
  ...
  XCTAssertNoThrow([set sortedResultsUsingDescriptors:@[
    [RLMSortDescriptor sortDescriptorWithKeyPath:@"self" ascending:YES]
  ]]);
  ...
  RLMAssertThrowsWithReason([set setValue:@1 forKey:@"self"],
                            @"write transaction");
}
...
- (void)createObjectWithValueIndex:(NSUInteger)index {
  ...
  id obj = [AllPrimitiveSets
      createInRealm:realm
          withValue:@{
            ...
            @"decimalObj" :
                [@[ decimal128(1), decimal128(2) ] subarrayWithRange:range],
            @"objectIdObj" :
  ...
  obj = [AllOptionalPrimitiveSets
      createInRealm:realm
          withValue:@{
            @"boolObj" : [@[ NSNull.null, @NO, @YES ] subarrayWithRange:range],
            @"intObj" : [@[ NSNull.null, @2, @3 ] subarrayWithRange:range],
            @"floatObj" :
                [@[ NSNull.null, @2.2f, @3.3f ] subarrayWithRange:range],
            @"doubleObj" :
                [@[ NSNull.null, @2.2, @3.3 ] subarrayWithRange:range],
            @"stringObj" :
                [@[ NSNull.null, @"a", @"bc" ] subarrayWithRange:range],
            @"dataObj" :
                [@[ NSNull.null, data(1), data(2) ] subarrayWithRange:range],
            @"dateObj" :
                [@[ NSNull.null, date(1), date(2) ] subarrayWithRange:range],
            @"decimalObj" : [@[ NSNull.null, decimal128(1), decimal128(2) ]
                subarrayWithRange:range],
            @"objectIdObj" : [@[ NSNull.null, objectId(1), objectId(2) ]
                subarrayWithRange:range],
            @"uuidObj" : [@[
              NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
              uuid(@"00000000-0000-0000-0000-000000000000")
...
- (void)testQueryBasicOperators {
  ...
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY uuidObj = %@",
                 uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  ...
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyUUIDObj = %@",
                 uuid(@"00000000-0000-0000-0000-000000000000"));
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY floatObj = %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY doubleObj = %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY decimalObj = %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY objectIdObj = %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyDataObj != %@", data(1));
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyDateObj != %@", date(1));
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyDecimalObj != %@",
                 decimal128(1));
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyObjectIdObj != %@", objectId(1));
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyUUIDObj != %@",
                 uuid(@"00000000-0000-0000-0000-000000000000"));
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY boolObj != %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY intObj != %@", NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY floatObj != %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY stringObj != %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY dataObj != %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY dateObj != %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY decimalObj != %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY objectIdObj != %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY uuidObj != %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY intObj > %@", @2);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY floatObj > %@", @2.2f);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY doubleObj > %@", @2.2);
  ...
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY uuidObj = %@",
                 uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  ...
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyUUIDObj = %@",
                 uuid(@"00000000-0000-0000-0000-000000000000"));
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY floatObj = %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY doubleObj = %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY decimalObj = %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY objectIdObj = %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyDecimalObj != %@",
                 decimal128(2));
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY objectIdObj != %@",
                 objectId(1));
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY uuidObj != %@",
                 uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY intObj > %@", @2);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY floatObj > %@", @2.2f);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY doubleObj > %@", @2.2);
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY doubleObj >= %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY dateObj >= %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY decimalObj >= %@",
                 NSNull.null);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY intObj < %@", @2);
  ...
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyUUIDObj != %@",
                 uuid(@"00000000-0000-0000-0000-000000000000"));
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY boolObj != %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY intObj != %@", NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY floatObj != %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY stringObj != %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY dataObj != %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY dateObj != %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY decimalObj != %@",
  ...
  RLMAssertCount(AllPrimitiveSets, 2, @"ANY anyDecimalObj >= %@",
                 decimal128(1));
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY intObj < %@", @2);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY floatObj < %@", @2.2f);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY doubleObj < %@", @2.2);
  ...
  RLMAssertThrows(([AllPrimitiveSets objectsInRealm:realm
                                              where:@"ANY boolObj > %@", @NO]));
  RLMAssertThrows(
      ([AllPrimitiveSets objectsInRealm:realm
  ...
  RLMAssertThrows(([AllPrimitiveSets
      objectsInRealm:realm
               where:@"ANY uuidObj > %@",
                     uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")]));
  RLMAssertThrows(([AllOptionalPrimitiveSets
      objectsInRealm:realm
               where:@"ANY boolObj > %@", NSNull.null]));
  RLMAssertThrows(([AllOptionalPrimitiveSets
      objectsInRealm:realm
               where:@"ANY stringObj > %@", NSNull.null]));
  RLMAssertThrows(([AllOptionalPrimitiveSets
      objectsInRealm:realm
               where:@"ANY dataObj > %@", NSNull.null]));
  RLMAssertThrows(([AllOptionalPrimitiveSets
      objectsInRealm:realm
               where:@"ANY objectIdObj > %@", NSNull.null]));
  RLMAssertThrows(([AllOptionalPrimitiveSets
      objectsInRealm:realm
               where:@"ANY uuidObj > %@", NSNull.null]));
}
...
- (void)testQueryBetween {
  ...
  RLMAssertThrowsWithReason(
      ([AllPrimitiveSets
          objectsInRealm:realm
                   where:@"ANY stringObj BETWEEN %@", @[ @"a", @"bc" ]]),
  ...
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"ANY boolObj BETWEEN %@", @[ NSNull.null, @NO ]]),
      @"Operator 'BETWEEN' not supported for type 'bool'");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"ANY stringObj BETWEEN %@", @[ NSNull.null, @"a" ]]),
      @"Operator 'BETWEEN' not supported for type 'string'");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"ANY dataObj BETWEEN %@", @[ NSNull.null, data(1) ]]),
      @"Operator 'BETWEEN' not supported for type 'data'");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets objectsInRealm:realm
                                          where:@"ANY objectIdObj BETWEEN %@",
  ...
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY floatObj BETWEEN %@",
                 @[ @2.2f, @3.3f ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY doubleObj BETWEEN %@",
                 @[ @2.2, @3.3 ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY dateObj BETWEEN %@",
                 @[ date(1), date(2) ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY decimalObj BETWEEN %@",
                 @[ decimal128(1), decimal128(2) ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyIntObj BETWEEN %@", @[ @2, @3 ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyFloatObj BETWEEN %@",
                 @[ @2.2f, @3.3f ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyDoubleObj BETWEEN %@",
                 @[ @2.2, @3.3 ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyDateObj BETWEEN %@",
                 @[ date(1), date(2) ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyDecimalObj BETWEEN %@",
                 @[ decimal128(1), decimal128(2) ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY intObj BETWEEN %@",
                 @[ NSNull.null, @2 ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY floatObj BETWEEN %@",
                 @[ NSNull.null, @2.2f ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY doubleObj BETWEEN %@",
                 @[ NSNull.null, @2.2 ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY dateObj BETWEEN %@",
                 @[ NSNull.null, date(1) ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY decimalObj BETWEEN %@",
                 @[ NSNull.null, decimal128(1) ]);

  [self createObjectWithValueIndex:1];

  RLMAssertCount(AllPrimitiveSets, 1, @"ANY intObj BETWEEN %@", @[ @3, @3 ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY floatObj BETWEEN %@",
                 @[ @3.3f, @3.3f ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY doubleObj BETWEEN %@",
                 @[ @3.3, @3.3 ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY dateObj BETWEEN %@",
                 @[ date(2), date(2) ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY decimalObj BETWEEN %@",
                 @[ decimal128(2), decimal128(2) ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyIntObj BETWEEN %@", @[ @3, @3 ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyFloatObj BETWEEN %@",
                 @[ @3.3f, @3.3f ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyDoubleObj BETWEEN %@",
                 @[ @3.3, @3.3 ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyDateObj BETWEEN %@",
                 @[ date(2), date(2) ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyDecimalObj BETWEEN %@",
                 @[ decimal128(2), decimal128(2) ]);
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY intObj BETWEEN %@",
                 @[ @2, @2 ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY floatObj BETWEEN %@",
                 @[ @2.2f, @2.2f ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY doubleObj BETWEEN %@",
                 @[ @2.2, @2.2 ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY dateObj BETWEEN %@",
                 @[ date(1), date(1) ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY decimalObj BETWEEN %@",
                 @[ decimal128(1), decimal128(1) ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY intObj BETWEEN %@",
                 @[ @2, @3 ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY floatObj BETWEEN %@",
...
- (void)testQueryIn {
  ...
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY dataObj IN %@",
                 @[ data(1), data(2) ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY dateObj IN %@",
                 @[ date(1), date(2) ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY decimalObj IN %@",
                 @[ decimal128(1), decimal128(2) ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY objectIdObj IN %@",
                 @[ objectId(1), objectId(2) ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY uuidObj IN %@", @[
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
    uuid(@"00000000-0000-0000-0000-000000000000")
  ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyBoolObj IN %@", @[ @NO, @YES ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyIntObj IN %@", @[ @2, @3 ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyFloatObj IN %@",
                 @[ @2.2f, @3.3f ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyDoubleObj IN %@",
                 @[ @2.2, @3.3 ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyStringObj IN %@",
                 @[ @"a", @"b" ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyDataObj IN %@",
                 @[ data(1), data(2) ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyDateObj IN %@",
                 @[ date(1), date(2) ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyDecimalObj IN %@",
                 @[ decimal128(1), decimal128(2) ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyObjectIdObj IN %@",
                 @[ objectId(1), objectId(2) ]);
  RLMAssertCount(AllPrimitiveSets, 0, @"ANY anyUUIDObj IN %@", @[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY boolObj IN %@",
                 @[ NSNull.null, @NO ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY intObj IN %@",
                 @[ NSNull.null, @2 ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY floatObj IN %@",
                 @[ NSNull.null, @2.2f ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY doubleObj IN %@",
                 @[ NSNull.null, @2.2 ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY stringObj IN %@",
                 @[ NSNull.null, @"a" ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY dataObj IN %@",
                 @[ NSNull.null, data(1) ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY dateObj IN %@",
                 @[ NSNull.null, date(1) ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY decimalObj IN %@",
                 @[ NSNull.null, decimal128(1) ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY objectIdObj IN %@",
                 @[ NSNull.null, objectId(1) ]);
  RLMAssertCount(
      AllOptionalPrimitiveSets, 0, @"ANY uuidObj IN %@",
      @[ NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89") ]);
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY objectIdObj IN %@",
                 @[ objectId(1) ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 0, @"ANY uuidObj IN %@",
                 @[ uuid(@"137DECC8-B300-4954-A233-F89909F4FD89") ]);
  ...
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY dataObj IN %@",
                 @[ data(1), data(2) ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY dateObj IN %@",
                 @[ date(1), date(2) ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY decimalObj IN %@",
                 @[ decimal128(1), decimal128(2) ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY objectIdObj IN %@",
                 @[ objectId(1), objectId(2) ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY uuidObj IN %@", @[
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"),
    uuid(@"00000000-0000-0000-0000-000000000000")
  ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyBoolObj IN %@", @[ @NO, @YES ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyIntObj IN %@", @[ @2, @3 ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyFloatObj IN %@",
                 @[ @2.2f, @3.3f ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyDoubleObj IN %@",
                 @[ @2.2, @3.3 ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyStringObj IN %@",
                 @[ @"a", @"b" ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyDataObj IN %@",
                 @[ data(1), data(2) ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyDateObj IN %@",
                 @[ date(1), date(2) ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyDecimalObj IN %@",
                 @[ decimal128(1), decimal128(2) ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyObjectIdObj IN %@",
                 @[ objectId(1), objectId(2) ]);
  RLMAssertCount(AllPrimitiveSets, 1, @"ANY anyUUIDObj IN %@", @[
    uuid(@"00000000-0000-0000-0000-000000000000"),
    uuid(@"137DECC8-B300-4954-A233-F89909F4FD89")
  ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY boolObj IN %@",
                 @[ NSNull.null, @NO ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY intObj IN %@",
                 @[ NSNull.null, @2 ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY floatObj IN %@",
                 @[ NSNull.null, @2.2f ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY doubleObj IN %@",
                 @[ NSNull.null, @2.2 ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY stringObj IN %@",
                 @[ NSNull.null, @"a" ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY dataObj IN %@",
                 @[ NSNull.null, data(1) ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY dateObj IN %@",
                 @[ NSNull.null, date(1) ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY decimalObj IN %@",
                 @[ NSNull.null, decimal128(1) ]);
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"ANY objectIdObj IN %@",
                 @[ NSNull.null, objectId(1) ]);
  RLMAssertCount(
      AllOptionalPrimitiveSets, 1, @"ANY uuidObj IN %@",
      @[ NSNull.null, uuid(@"137DECC8-B300-4954-A233-F89909F4FD89") ]);
}
...
- (void)testQueryCount {
  ...
  [AllPrimitiveSets createInRealm:realm
                        withValue:@{
                          @"boolObj" : @[ @NO, @YES ],
                          @"intObj" : @[ @2, @3 ],
                          @"floatObj" : @[ @2.2f, @3.3f ],
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"decimalObj.@count == %@",
                 @(2));
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"objectIdObj.@count == %@",
                 @(2));
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"decimalObj.@count != %@",
                 @(2));
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"objectIdObj.@count != %@",
                 @(2));
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 1, @"objectIdObj.@count >= %@",
                 @(2));
...
- (void)testQuerySum {
  ...
  RLMAssertThrowsWithReason(
      ([AllPrimitiveSets objectsInRealm:realm where:@"boolObj.@sum = %@", @NO]),
  ...
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"boolObj.@sum = %@", NSNull.null]),
      @"Invalid keypath 'boolObj.@sum': @sum can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"stringObj.@sum = %@", NSNull.null]),
      @"Invalid keypath 'stringObj.@sum': @sum can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"dataObj.@sum = %@", NSNull.null]),
      @"Invalid keypath 'dataObj.@sum': @sum can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"objectIdObj.@sum = %@", NSNull.null]),
      @"Invalid keypath 'objectIdObj.@sum': @sum can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"uuidObj.@sum = %@", NSNull.null]),
      @"Invalid keypath 'uuidObj.@sum': @sum can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveSets objectsInRealm:realm
  ...
  RLMAssertThrowsWithReason(
      ([AllPrimitiveSets objectsInRealm:realm where:@"intObj.@sum = %@", @"a"]),
  ...
  [AllOptionalPrimitiveSets createInRealm:realm
                                withValue:@{
                                  @"intObj" : @[],
                                  @"floatObj" : @[],
                                  @"doubleObj" : @[],
  ...
  RLMAssertCount(AllPrimitiveSets, 2U, @"anyDecimalObj.@sum == %@",
                 decimal128(1));
  ...
  RLMAssertCount(AllPrimitiveSets, 3U, @"anyDecimalObj.@sum != %@",
                 decimal128(2));
  ...
  RLMAssertCount(AllPrimitiveSets, 1U, @"anyDecimalObj.@sum > %@",
                 decimal128(1));
  RLMAssertCount(AllPrimitiveSets, 3U, @"intObj.@sum < %@", @3);
  RLMAssertCount(AllPrimitiveSets, 3U, @"floatObj.@sum < %@", @3.3f);
  RLMAssertCount(AllPrimitiveSets, 3U, @"doubleObj.@sum < %@", @3.3);
  ...
  RLMAssertCount(AllPrimitiveSets, 4U, @"anyDecimalObj.@sum <= %@",
                 decimal128(2));
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 2U, @"decimalObj.@sum == %@",
                 decimal128(1));
  RLMAssertCount(AllOptionalPrimitiveSets, 2U, @"intObj.@sum != %@", @2);
  RLMAssertCount(AllOptionalPrimitiveSets, 2U, @"floatObj.@sum != %@", @2.2f);
  RLMAssertCount(AllOptionalPrimitiveSets, 2U, @"doubleObj.@sum != %@", @2.2);
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 3U, @"decimalObj.@sum >= %@",
                 decimal128(1));
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"decimalObj.@sum > %@",
                 decimal128(1));
...
- (void)testQueryAverage {
  ...
  RLMAssertThrowsWithReason(
      ([AllPrimitiveSets objectsInRealm:realm where:@"boolObj.@avg = %@", @NO]),
  ...
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"boolObj.@avg = %@", NSNull.null]),
      @"Invalid keypath 'boolObj.@avg': @avg can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"stringObj.@avg = %@", NSNull.null]),
      @"Invalid keypath 'stringObj.@avg': @avg can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"dataObj.@avg = %@", NSNull.null]),
      @"Invalid keypath 'dataObj.@avg': @avg can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"objectIdObj.@avg = %@", NSNull.null]),
      @"Invalid keypath 'objectIdObj.@avg': @avg can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"uuidObj.@avg = %@", NSNull.null]),
      @"Invalid keypath 'uuidObj.@avg': @avg can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveSets objectsInRealm:realm
  ...
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"dateObj.@avg = %@", NSNull.null]),
      @"Cannot sum or average date properties");

  RLMAssertThrowsWithReason(
      ([AllPrimitiveSets objectsInRealm:realm where:@"intObj.@avg = %@", @"a"]),
  ...
  RLMAssertCount(AllPrimitiveSets, 1U, @"anyDecimalObj.@avg == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"intObj.@avg == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"floatObj.@avg == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"doubleObj.@avg == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"decimalObj.@avg == %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllPrimitiveSets, 2U, @"anyDecimalObj.@avg == %@",
                 decimal128(2));
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 2U, @"decimalObj.@avg == %@",
                 decimal128(2));
  RLMAssertCount(AllPrimitiveSets, 2U, @"intObj.@avg != %@", @3);
  RLMAssertCount(AllPrimitiveSets, 2U, @"floatObj.@avg != %@", @3.3f);
  RLMAssertCount(AllPrimitiveSets, 2U, @"doubleObj.@avg != %@", @3.3);
  ...
  RLMAssertCount(AllPrimitiveSets, 3U, @"anyDecimalObj.@avg > %@",
                 decimal128(1));
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 3U, @"decimalObj.@avg > %@",
                 decimal128(1));
...
- (void)testQueryMin {
  ...
  RLMAssertThrowsWithReason(
      ([AllPrimitiveSets objectsInRealm:realm where:@"boolObj.@min = %@", @NO]),
  ...
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"boolObj.@min = %@", NSNull.null]),
      @"Invalid keypath 'boolObj.@min': @min can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"stringObj.@min = %@", NSNull.null]),
      @"Invalid keypath 'stringObj.@min': @min can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"dataObj.@min = %@", NSNull.null]),
      @"Invalid keypath 'dataObj.@min': @min can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"objectIdObj.@min = %@", NSNull.null]),
      @"Invalid keypath 'objectIdObj.@min': @min can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"uuidObj.@min = %@", NSNull.null]),
      @"Invalid keypath 'uuidObj.@min': @min can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveSets objectsInRealm:realm where:@"intObj.@min = %@", @"a"]),
  ...
  RLMAssertCount(AllPrimitiveSets, 0U, @"anyDecimalObj.@min == %@",
                 decimal128(1));
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"intObj.@min == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"floatObj.@min == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"doubleObj.@min == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"dateObj.@min == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"decimalObj.@min == %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllPrimitiveSets, 1U, @"anyDecimalObj.@min == %@",
                 decimal128(2));
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"decimalObj.@min == %@",
                 decimal128(1));
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 2U, @"decimalObj.@min == %@",
                 decimal128(1));
...
- (void)testQueryMax {
  ...
  RLMAssertThrowsWithReason(
      ([AllPrimitiveSets objectsInRealm:realm where:@"boolObj.@max = %@", @NO]),
  ...
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"boolObj.@max = %@", NSNull.null]),
      @"Invalid keypath 'boolObj.@max': @max can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"stringObj.@max = %@", NSNull.null]),
      @"Invalid keypath 'stringObj.@max': @max can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"dataObj.@max = %@", NSNull.null]),
      @"Invalid keypath 'dataObj.@max': @max can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"objectIdObj.@max = %@", NSNull.null]),
      @"Invalid keypath 'objectIdObj.@max': @max can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"uuidObj.@max = %@", NSNull.null]),
      @"Invalid keypath 'uuidObj.@max': @max can only be applied to a "
      @"collection of numeric values.");
  RLMAssertThrowsWithReason(
      ([AllPrimitiveSets objectsInRealm:realm where:@"intObj.@max = %@", @"a"]),
  ...
  RLMAssertCount(AllPrimitiveSets, 0U, @"anyDecimalObj.@max == %@",
                 decimal128(1));
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"intObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"floatObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"doubleObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"dateObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 0U, @"decimalObj.@max == %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllPrimitiveSets, 1U, @"anyDecimalObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"intObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"floatObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"doubleObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"dateObj.@max == %@",
                 NSNull.null);
  RLMAssertCount(AllOptionalPrimitiveSets, 1U, @"decimalObj.@max == %@",
                 NSNull.null);
  ...
  RLMAssertCount(AllOptionalPrimitiveSets, 2U, @"decimalObj.@max == %@",
                 decimal128(1));
  ...
  RLMAssertCount(AllPrimitiveSets, 2U, @"anyDecimalObj.@max == %@",
                 decimal128(2));
}
...
- (void)testQueryBasicOperatorsOverLink {
  ...
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.decimalObj = %@",
                 decimal128(1));
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.objectIdObj = %@",
                 objectId(1));
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.uuidObj = %@",
                 uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  ...
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.anyFloatObj = %@",
                 @2.2f);
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.anyDoubleObj = %@",
                 @2.2);
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.anyStringObj = %@",
                 @"a");
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.anyDataObj = %@",
                 data(1));
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.anyDateObj = %@",
                 date(1));
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.anyDecimalObj = %@",
                 decimal128(1));
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.anyObjectIdObj = %@",
                 objectId(1));
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.anyUUIDObj = %@",
                 uuid(@"00000000-0000-0000-0000-000000000000"));
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0, @"ANY link.boolObj = %@",
                 NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0, @"ANY link.intObj = %@",
                 NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0, @"ANY link.floatObj = %@",
                 NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0, @"ANY link.doubleObj = %@",
                 NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0, @"ANY link.stringObj = %@",
                 NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0, @"ANY link.dataObj = %@",
                 NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0, @"ANY link.dateObj = %@",
                 NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0, @"ANY link.decimalObj = %@",
                 NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0,
                 @"ANY link.objectIdObj = %@", NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0, @"ANY link.uuidObj = %@",
                 NSNull.null);
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.boolObj != %@", @NO);
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.intObj != %@", @2);
  RLMAssertCount(LinkToAllPrimitiveSets, 0, @"ANY link.floatObj != %@", @2.2f);
  ...
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0, @"ANY link.dateObj != %@",
                 NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0,
                 @"ANY link.decimalObj != %@", NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0,
                 @"ANY link.objectIdObj != %@", NSNull.null);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 0, @"ANY link.uuidObj != %@",
                 NSNull.null);
  ...
  RLMAssertCount(LinkToAllPrimitiveSets, 1, @"ANY link.decimalObj = %@",
                 decimal128(2));
  RLMAssertCount(LinkToAllPrimitiveSets, 1, @"ANY link.objectIdObj = %@",
                 objectId(2));
  RLMAssertCount(LinkToAllPrimitiveSets, 1, @"ANY link.uuidObj = %@",
                 uuid(@"00000000-0000-0000-0000-000000000000"));
  ...
  RLMAssertCount(LinkToAllPrimitiveSets, 1, @"ANY link.anyFloatObj = %@",
                 @3.3f);
  RLMAssertCount(LinkToAllPrimitiveSets, 1, @"ANY link.anyDoubleObj = %@",
                 @3.3);
  RLMAssertCount(LinkToAllPrimitiveSets, 1, @"ANY link.anyStringObj = %@",
                 @"b");
  RLMAssertCount(LinkToAllPrimitiveSets, 1, @"ANY link.anyDataObj = %@",
                 data(2));
  RLMAssertCount(LinkToAllPrimitiveSets, 1, @"ANY link.anyDateObj = %@",
                 date(2));
  RLMAssertCount(LinkToAllPrimitiveSets, 1, @"ANY link.anyDecimalObj = %@",
                 decimal128(2));
  RLMAssertCount(LinkToAllPrimitiveSets, 1, @"ANY link.anyObjectIdObj = %@",
                 objectId(2));
  RLMAssertCount(LinkToAllPrimitiveSets, 1, @"ANY link.anyUUIDObj = %@",
                 uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1, @"ANY link.boolObj = %@",
                 @NO);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1, @"ANY link.intObj = %@",
                 @2);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1, @"ANY link.floatObj = %@",
                 @2.2f);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1, @"ANY link.doubleObj = %@",
                 @2.2);
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1, @"ANY link.stringObj = %@",
                 @"a");
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1, @"ANY link.dataObj = %@",
                 data(1));
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1, @"ANY link.dateObj = %@",
                 date(1));
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1, @"ANY link.decimalObj = %@",
                 decimal128(1));
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1,
                 @"ANY link.objectIdObj = %@", objectId(1));
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1, @"ANY link.uuidObj = %@",
                 uuid(@"137DECC8-B300-4954-A233-F89909F4FD89"));
  ...
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1, @"ANY link.dateObj >= %@",
                 date(1));
  RLMAssertCount(LinkToAllOptionalPrimitiveSets, 1,
                 @"ANY link.decimalObj >= %@", decimal128(1));
  ...
  RLMAssertThrowsWithReason(
      ([LinkToAllPrimitiveSets objectsInRealm:realm
  ...
  RLMAssertThrowsWithReason(
      ([LinkToAllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"ANY link.boolObj > %@", NSNull.null]),
      @"Operator '>' not supported for type 'bool'");
  RLMAssertThrowsWithReason(
      ([LinkToAllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"ANY link.stringObj > %@", NSNull.null]),
      @"Operator '>' not supported for type 'string'");
  RLMAssertThrowsWithReason(
      ([LinkToAllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"ANY link.dataObj > %@", NSNull.null]),
      @"Operator '>' not supported for type 'data'");
  RLMAssertThrowsWithReason(
      ([LinkToAllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"ANY link.objectIdObj > %@", NSNull.null]),
      @"Operator '>' not supported for type 'object id'");
  RLMAssertThrowsWithReason(
      ([LinkToAllOptionalPrimitiveSets
          objectsInRealm:realm
                   where:@"ANY link.uuidObj > %@", NSNull.null]),
      @"Operator '>' not supported for type 'uuid'");
}
...
- (void)testSubstringQueries {
  ...
  void (^testNull)(NSString *, NSUInteger) =
      ^(NSString *operator, NSUInteger count) {
        ...
        RLMAssertThrowsWithReason(
            [AllPrimitiveSets objectsInRealm:realm where:query],
        ...
        RLMAssertThrowsWithReason(
            [LinkToAllPrimitiveSets objectsInRealm:realm where:query],
            @"Cannot compare value '(null)' of type '(null)' to property "
            @"'stringObj' of type 'string'");
        RLMAssertCount(LinkToAllOptionalPrimitiveSets, count, query,
                       NSNull.null);
...
- (void)testNotificationSentInitially {
  ...
  id token = [managed.intObj
      addNotificationBlock:^(RLMSet *set, RLMCollectionChange *change,
                             NSError *error) {
        XCTAssertNotNil(set);
...
- (void)testNotificationSentAfterCommit {
  ...
  [self dispatchAsyncAndWait:^{
    ...
    [r transactionWithBlock:^{
      RLMSet *set = [(AllPrimitiveSets *)[AllPrimitiveSets allObjectsInRealm:r]
                         .firstObject intObj];
      [set addObject:@0];
    }];
  }];
...
- (void)testNotificationNotSentForUnrelatedChange {
  ...
  id expectation = [self expectationWithDescription:@""];
  id token = [managed.intObj
      addNotificationBlock:^(__unused RLMSet *set,
...
- (void)testNotificationSentOnlyForActualRefresh {
  ...
  __block id expectation = [self expectationWithDescription:@""];
  id token = [managed.intObj
      addNotificationBlock:^(RLMSet *set, __unused RLMCollectionChange *change,
                             NSError *error) {
        XCTAssertNotNil(set);
        uncheckedAssertNil(error);
  ...
  [self waitForNotification:RLMRealmRefreshRequiredNotification
                      ...
                      block:^{
                        [self dispatchAsyncAndWait:^{
                          RLMRealm *r = [RLMRealm defaultRealm];
                          [r transactionWithBlock:^{
                            RLMSet *set = [(AllPrimitiveSets *)[AllPrimitiveSets
                                               allObjectsInRealm:r]
                                               .firstObject intObj];
                            [set addObject:@0];
                          }];
