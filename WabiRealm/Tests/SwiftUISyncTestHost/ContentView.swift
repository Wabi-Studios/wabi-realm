...
struct MainView: View {
  ...
  func getConfigurationForUser(_ user: User) -> WabiRealm.Configuration {
...
class LoginHelper: ObservableObject {
  ...
  func login(email: String, password: String, completion: @escaping (User) -> Void) {
    let app = WabiRealmKit.App(id: ProcessInfo.processInfo.environment["app_id"]!, configuration: appConfig)
