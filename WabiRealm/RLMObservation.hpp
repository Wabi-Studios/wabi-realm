...
// have it's accessors temporarily removed and added back so that the `Object`
// can be managed be the WabiRealm.
[[clang::objc_runtime_visible]] @interface RLMSwiftUIKVO : NSObject
