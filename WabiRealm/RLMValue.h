...
/**
 RLMValue is a property type which represents a polymorphic WabiRealm value.
This is similar to the usage of `AnyObject` / `Any` in Swift.
```
 ...
 AnotherObject *anotherObject = [AnotherObject createInRealm:realm
withValue:@[]]; myObject.myAnyValue = anotherObject; // underlying type is
RLMObject.
```
