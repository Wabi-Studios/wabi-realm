...
- (void)registerUserWithEmail:(NSString *)email
  ...
  self.client.register_email(email.UTF8String, password.UTF8String,
...
- (void)confirmUser:(NSString *)token
  ...
  self.client.confirm_user(token.UTF8String, tokenId.UTF8String,
                           RLMWrapCompletion(completion));
}
...
- (void)retryCustomConfirmation:(NSString *)email
                     completion:
                         (RLMEmailPasswordAuthOptionalErrorBlock)completion {
  self.client.retry_custom_confirmation(email.UTF8String,
                                        RLMWrapCompletion(completion));
}
...
- (void)resendConfirmationEmail:(NSString *)email
                     completion:
                         (RLMEmailPasswordAuthOptionalErrorBlock)completion {
  self.client.resend_confirmation_email(email.UTF8String,
                                        RLMWrapCompletion(completion));
}
...
- (void)sendResetPasswordEmail:(NSString *)email
                    completion:
                        (RLMEmailPasswordAuthOptionalErrorBlock)completion {
  self.client.send_reset_password_email(email.UTF8String,
                                        RLMWrapCompletion(completion));
}
...
- (void)resetPasswordTo:(NSString *)password
                ...
                tokenId:(NSString *)tokenId
             completion:(RLMEmailPasswordAuthOptionalErrorBlock)completion {
  self.client.reset_password(password.UTF8String, token.UTF8String,
                             tokenId.UTF8String, RLMWrapCompletion(completion));
}
