...
#import <WabiRealm/RLMObjectBase_Dynamic.h>
...
FOUNDATION_EXTERN RLMNotificationToken *RLMObjectBaseAddNotificationBlock(
    RLMObjectBase *obj, NSArray<NSString *> *_Nullable keyPaths,
    dispatch_queue_t _Nullable queue, RLMObjectNotificationCallback block);
...
// change when an unmanaged object is added to the WabiRealm.
...
// Initialize the given property on a *managed* object which previous was
// unmanaged
