...
#define RLMAssertEqual(lft, rgt)                                               \
  do {                                                                         \
    if (isObject) {                                                            \
      XCTAssertEqualObjects(lft.firstName, ((Person *)rgt).firstName);         \
    } else {                                                                   \
...
- (void)roundTripWithPropertyGetter:(RLMSet * (^)(id))propertyGetter
  ...
  RLMUser *readUser =
      [self logInUserForCredentials:[self basicCredentialsWithName:callerName
                                                          register:YES]];
  RLMUser *writeUser = [self
      logInUserForCredentials:
          [self basicCredentialsWithName:[callerName
                                             stringByAppendingString:@"Writer"]
                                register:YES]];

  RLMRealm *readRealm = [self openRealmForPartitionValue:callerName
                                                    user:readUser];
  RLMRealm *writeRealm = [self openRealmForPartitionValue:callerName
                                                     user:writeUser];
  auto write = [&](auto fn) {
  ...
  write(^{
    writeObj =
        [RLMSetSyncObject createInRealm:writeRealm
  ...
  RLMResults<RLMSetSyncObject *> *results =
      [RLMSetSyncObject allObjectsInRealm:readRealm];
...
- (void)testIntSet {
  [self
      roundTripWithPropertyGetter:^RLMSet *(RLMSetSyncObject *obj) {
        return obj.intSet;
      }
      values:@[ @123, @234, @345 ]
      otherPropertyGetter:^RLMSet *(RLMSetSyncObject *obj) {
        return obj.otherIntSet;
      }
...
- (void)testStringSet {
  [self
      roundTripWithPropertyGetter:^RLMSet *(RLMSetSyncObject *obj) {
        return obj.stringSet;
      }
      values:@[ @"Who", @"What", @"When" ]
      otherPropertyGetter:^RLMSet *(RLMSetSyncObject *obj) {
        return obj.otherStringSet;
      }
...
- (void)testDoubleSet {
  [self
      roundTripWithPropertyGetter:^RLMSet *(RLMSetSyncObject *obj) {
        return obj.doubleSet;
      }
      values:@[ @123.456, @234.456, @345.567 ]
      otherPropertyGetter:^RLMSet *(RLMSetSyncObject *obj) {
        return obj.otherDoubleSet;
      }
...
- (void)testObjectIdSet {
  [self
      roundTripWithPropertyGetter:^RLMSet *(RLMSetSyncObject *obj) {
        return obj.objectIdSet;
      }
      values:@[
        [[RLMObjectId alloc] initWithString:@"6058f12b957ba06156586a7c"
                                      error:nil],
        [[RLMObjectId alloc] initWithString:@"6058f12682b2fbb1f334ef1d"
                                      error:nil],
        [[RLMObjectId alloc] initWithString:@"6058f12d42e5a393e67538d0"
                                      error:nil]
      ]
      otherPropertyGetter:^RLMSet *(RLMSetSyncObject *obj) {
        return obj.otherObjectIdSet;
      }
      otherValues:@[
        [[RLMObjectId alloc] initWithString:@"6058f12b957ba06156586a7c"
                                      error:nil],
        [[RLMObjectId alloc] initWithString:@"6058f12682b2fbb1f334ef1e"
                                      error:nil],
        [[RLMObjectId alloc] initWithString:@"6058f12d42e5a393e67538df"
                                      error:nil]
      ]
      isObject:NO
      callerName:NSStringFromSelector(_cmd)];
...
- (void)testDecimalSet {
  [self
      roundTripWithPropertyGetter:^RLMSet *(RLMSetSyncObject *obj) {
        return obj.decimalSet;
      }
      values:@[
        [[RLMDecimal128 alloc] initWithNumber:@123.456],
        [[RLMDecimal128 alloc] initWithNumber:@223.456],
        [[RLMDecimal128 alloc] initWithNumber:@323.456]
      ]
      otherPropertyGetter:^RLMSet *(RLMSetSyncObject *obj) {
        return obj.otherDecimalSet;
      }
      otherValues:@[
        [[RLMDecimal128 alloc] initWithNumber:@123.456],
...
- (void)testUUIDSet {
  [self
      ...
      values:@[
        [[NSUUID alloc]
            initWithUUIDString:@"6b28ec45-b29a-4b0a-bd6a-343c7f6d90fd"],
        [[NSUUID alloc]
            initWithUUIDString:@"6b28ec45-b29a-4b0a-bd6a-343c7f6d90fe"],
        [[NSUUID alloc]
            initWithUUIDString:@"6b28ec45-b29a-4b0a-bd6a-343c7f6d90ff"]
      ]
      otherPropertyGetter:^RLMSet *(RLMSetSyncObject *obj) {
        return obj.otherUuidSet;
      }
      otherValues:@[
        [[NSUUID alloc]
            initWithUUIDString:@"6b28ec45-b29a-4b0a-bd6a-343c7f6d90fd"],
        [[NSUUID alloc]
            initWithUUIDString:@"6b28ec45-b29a-4b0a-bd6a-343c7f6d90ae"],
        [[NSUUID alloc]
            initWithUUIDString:@"6b28ec45-b29a-4b0a-bd6a-343c7f6d90bf"]
      ]
      isObject:NO
      callerName:NSStringFromSelector(_cmd)];
}
...
- (void)roundTripWithPropertyGetter:(RLMArray * (^)(id))propertyGetter
  ...
  write(^{
    writeObj =
        [RLMArraySyncObject createInRealm:writeRealm
                                withValue:@{@"_id" : [RLMObjectId objectId]}];
  });
  ...
  RLMResults<RLMArraySyncObject *> *results =
      [RLMArraySyncObject allObjectsInRealm:readRealm];
  ...
  write(^{
    [propertyGetter(writeObj) replaceObjectAtIndex:0 withObject:values[1]];
  });
...
- (void)testIntArray {
  [self
      roundTripWithPropertyGetter:^RLMArray *(RLMArraySyncObject *obj) {
        return obj.intArray;
      }
                           values:@[ @123, @234, @345 ]
                         isObject:NO
  ...
  [self
      roundTripWithPropertyGetter:^RLMArray *(RLMArraySyncObject *obj) {
        return obj.dataArray;
                           ...
                           values:@[
                             [NSData dataWithBytes:(unsigned char[]){0x0a}
                                            length:1],
...
- (void)testObjectIdArray {
  [self
      roundTripWithPropertyGetter:^RLMArray *(RLMArraySyncObject *obj) {
        return obj.objectIdArray;
      }
                           values:@[
                             [[RLMObjectId alloc]
                                 initWithString:@"6058f12b957ba06156586a7c"
                                          error:nil],
                             [[RLMObjectId alloc]
                                 initWithString:@"6058f12682b2fbb1f334ef1d"
                                          error:nil],
                             [[RLMObjectId alloc]
                                 initWithString:@"6058f12d42e5a393e67538d0"
                                          error:nil]
                           ]
                         isObject:NO
                       callerName:NSStringFromSelector(_cmd)];
...
- (void)testUUIDArray {
  [self
      roundTripWithPropertyGetter:^RLMArray *(RLMArraySyncObject *obj) {
        return obj.uuidArray;
      }
                           values:@[
                             [[NSUUID alloc]
                                 initWithUUIDString:
                                     @"6b28ec45-b29a-4b0a-bd6a-343c7f6d90fd"],
                             [[NSUUID alloc]
                                 initWithUUIDString:
                                     @"6b28ec45-b29a-4b0a-bd6a-343c7f6d90fe"],
                             [[NSUUID alloc]
                                 initWithUUIDString:
                                     @"6b28ec45-b29a-4b0a-bd6a-343c7f6d90ff"]
                           ]
                         isObject:NO
                       callerName:NSStringFromSelector(_cmd)];
}
...
- (void)roundTripWithPropertyGetter:(RLMDictionary * (^)(id))propertyGetter
  ...
  write(^{
    writeObj = [RLMDictionarySyncObject
        createInRealm:writeRealm
            withValue:@{@"_id" : [RLMObjectId objectId]}];
  });
  ...
  CHECK_COUNT(1, RLMDictionarySyncObject, readRealm);
  RLMResults<RLMDictionarySyncObject *> *results =
      [RLMDictionarySyncObject allObjectsInRealm:readRealm];
...
- (void)testIntDictionary {
  [self
      roundTripWithPropertyGetter:^RLMDictionary *(
          RLMDictionarySyncObject *obj) {
        return obj.intDictionary;
      }
                           values:@{
                             @"0" : @123,
                             @"1" : @234,
                           ...
                           values:@{
                             ...
                             @"2" :
                                 [NSData dataWithBytes:(unsigned char[]){0x0c}
                                                length:1],
                             @"3" :
                                 [NSData dataWithBytes:(unsigned char[]){0x0d}
                                                length:1],
                             @"4" :
                                 [NSData dataWithBytes:(unsigned char[]){0x0e}
                                                length:1]
                           }
                         isObject:NO
                       callerName:NSStringFromSelector(_cmd)];
                           ...
                           values:@{
                             ...
                             @"2" : [[RLMObjectId alloc]
                                 initWithString:@"6058f12d42e5a393e67538d0"
                                          error:nil],
                             @"3" : [[RLMObjectId alloc]
                                 initWithString:@"6058f12682b2fbb1f334ef1e"
                                          error:nil],
                             @"4" : [[RLMObjectId alloc]
                                 initWithString:@"6058f12d42e5a393e67538df"
                                          error:nil]
                           }
                         isObject:NO
                       callerName:NSStringFromSelector(_cmd)];
...
- (void)testDecimalDictionary {
  [self
      roundTripWithPropertyGetter:^RLMDictionary *(
          RLMDictionarySyncObject *obj) {
        return obj.decimalDictionary;
      }
                           values:@{
                             @"0" : [[RLMDecimal128 alloc]
                                 initWithNumber:@123.456],
                             @"1" : [[RLMDecimal128 alloc]
                                 initWithNumber:@223.456],
                             @"2" : [[RLMDecimal128 alloc]
                                 initWithNumber:@323.456],
                             @"3" : [[RLMDecimal128 alloc]
                                 initWithNumber:@423.456],
                             @"4" :
                                 [[RLMDecimal128 alloc] initWithNumber:@523.456]
                           }
                         isObject:NO
      ...
      roundTripWithPropertyGetter:^RLMDictionary *(
        ...
        return obj.uuidDictionary;
                           ...
                           values:@{
                             ...
                             @"3" : [[NSUUID alloc]
                                 initWithUUIDString:
                                     @"6b28ec45-b29a-4b0a-bd6a-343c7f6d90ae"],
                             @"4" : [[NSUUID alloc]
                                 initWithUUIDString:
                                     @"6b28ec45-b29a-4b0a-bd6a-343c7f6d90bf"]
                           }
                         isObject:NO
                       callerName:NSStringFromSelector(_cmd)];
}
