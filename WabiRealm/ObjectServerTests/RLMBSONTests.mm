...
- (void)testUUIDRoundTrip {
  NSUUID *uuid = [[NSUUID alloc]
      initWithUUIDString:@"b1c11e54-e719-4275-b631-69ec3f2d616d"];
...
- (void)testDocumentRoundTrip {
  NSDictionary<NSString *, id<RLMBSON>> *document = @{
    ...
    @"oid" : [[RLMObjectId alloc] initWithString:@"507f1f77bcf86cd799439011"
                                           error:nil],
    @"regex" : [[NSRegularExpression alloc] initWithPattern:@"^abc"
                                                    options:0
                                                      error:nil],
    @"array1" : @[ @1, @2 ],
  ...
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["nil"]),
                        document[@"nil"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["string"]),
                        document[@"string"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["true"]),
                        document[@"true"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["false"]),
                        document[@"false"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["int"]),
                        document[@"int"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["int32"]),
                        document[@"int32"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["int64"]),
                        document[@"int64"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["double"]),
                        document[@"double"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["decimal128"]),
                        document[@"decimal128"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["minkey"]),
                        document[@"minkey"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["maxkey"]),
                        document[@"maxkey"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["date"]),
                        document[@"date"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["nestedarray"]),
                        document[@"nestedarray"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["nesteddoc"]),
                        document[@"nesteddoc"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["oid"]),
                        document[@"oid"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["regex"]),
                        document[@"regex"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["array1"]),
                        document[@"array1"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["array2"]),
                        document[@"array2"]);
  XCTAssertEqualObjects(RLMConvertBsonToRLMBSON(bsonDocument["uuid"]),
                        document[@"uuid"]);
}
