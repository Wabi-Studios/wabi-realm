...
- (instancetype)initWithPrimaryKey:(NSUUID *)primaryKey
                            strCol:(NSString *)strCol
                            intCol:(NSInteger)intCol;
@end
...
@property NSString *strCol;
@property NSInteger intCol;
- (instancetype)initWithPrimaryKey:(NSInteger)primaryKey
                            strCol:(NSString *)strCol
                            intCol:(NSInteger)intCol;
@end
...
@property RLMDictionary<NSString *, RLMDecimal128 *>
    <RLMString, RLMDecimal128> *decimalDictionary;
...
@property RLMDictionary<NSString *, Person *>
    <RLMString, Person> *objectDictionary;
