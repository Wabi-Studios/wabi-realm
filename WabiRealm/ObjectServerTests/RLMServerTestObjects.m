...
+ (NSArray *)requiredProperties {
  return @[
    @"boolCol", @"cBoolcol", @"intCol", @"doubleCol", @"stringCol",
    @"binaryCol", @"dateCol", @"longCol", @"decimalCol", @"uuidCol",
    @"objectIdCol"
  ];
}
...
+ (NSArray *)requiredProperties {
  return @[
    @"intArray", @"boolArray", @"stringArray", @"dataArray", @"doubleArray",
    @"objectIdArray", @"decimalArray", @"uuidArray", @"anyArray"
  ];
}
...
+ (NSArray *)requiredProperties {
  return @[
    @"intSet", @"boolSet", @"stringSet", @"dataSet", @"doubleSet",
    @"objectIdSet", @"decimalSet", @"uuidSet", @"anySet", @"otherIntSet",
    @"otherBoolSet", @"otherStringSet", @"otherDataSet", @"otherDoubleSet",
    @"otherObjectIdSet", @"otherDecimalSet", @"otherUuidSet", @"otherAnySet"
  ];
}
...
+ (NSArray *)requiredProperties {
  return @[
    @"intDictionary", @"boolDictionary", @"stringDictionary", @"dataDictionary",
    @"doubleDictionary", @"objectIdDictionary", @"decimalDictionary",
    @"uuidDictionary", @"anyDictionary"
  ];
}
