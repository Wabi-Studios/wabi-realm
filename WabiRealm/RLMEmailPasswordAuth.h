...
/**
 ...
 @param password The password that the user created for the new email/password
 identity.
...
- (void)registerUserWithEmail:(NSString *)email
                   ...
                   completion:
                       (RLMEmailPasswordAuthOptionalErrorBlock)completionHandler
    NS_SWIFT_NAME(registerUser(email:password:completion:));
...
- (void)resendConfirmationEmail:(NSString *)email
                     completion:(RLMEmailPasswordAuthOptionalErrorBlock)
                                    completionHandler;
...
- (void)callResetPasswordFunction:(NSString *)email
                       ...
                       completion:(RLMEmailPasswordAuthOptionalErrorBlock)
                                      completionHandler NS_REFINED_FOR_SWIFT;
