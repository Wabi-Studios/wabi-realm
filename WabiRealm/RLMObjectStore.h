...
// Perform the per-property accessor initialization for a managed
// WabiRealmKitObject promotingExisting should be true if the object was
// previously used as an unmanaged object, and false if it is a newly created
// object.
