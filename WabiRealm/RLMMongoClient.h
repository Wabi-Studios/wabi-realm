...
/// The `RLMMongoClient` enables reading and writing on a MongoDB database via
/// the WabiRealm Cloud service.
///
/// It provides access to instances of `RLMMongoDatabase`, which in turn provide
/// access to specific `RLMMongoCollection`s that hold your data.
///
/// - Note:
