...
+ (instancetype)delegateWithCompletion:
    (RLMNetworkTransportCompletionBlock)completion;
@end

NSString *const RLMHTTPMethodToNSString[] = {[RLMHTTPMethodGET] = @"GET",
...
- (NSURLSession *)doStreamRequest:(nonnull RLMRequest *)request
  ...
  id delegate =
      [RLMEventSessionDelegate delegateWithEventSubscriber:subscriber];
...
- (void)URLSession:(__unused NSURLSession *)session
  ...
  response.body = [[NSString alloc] initWithData:_data
...
- (void)URLSession:(__unused NSURLSession *)session
  ...
  NSString *errorStatus =
      [NSString stringWithFormat:@"URLSession HTTP error code: %ld",
                                 (long)httpResponse.statusCode];
  NSError *error = [NSError
      errorWithDomain:RLMAppErrorDomain
                 code:RLMAppErrorHttpRequestFailed
             userInfo:@{
               NSLocalizedDescriptionKey : errorStatus,
...
- (void)URLSession:(__unused NSURLSession *)session
  ...
  NSError *wrappedError =
      [NSError errorWithDomain:RLMAppErrorDomain
                          code:RLMAppErrorHttpRequestFailed
                      userInfo:@{
                        NSLocalizedDescriptionKey : errorStatus,
                        RLMHTTPStatusCodeKey : @(httpResponse.statusCode),
