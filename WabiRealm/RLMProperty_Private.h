...
- (instancetype)initWithName:(NSString *)name
      ...
      linkPropertyDescriptor:
          (nullable RLMPropertyDescriptor *)linkPropertyDescriptor
...
/**
 ...
 building an app on WabiRealm, it is not recommended to use this method.
 ...
 @param linkOriginPropertyName The property name of the origin of a link. Used
 for linking objects properties.
