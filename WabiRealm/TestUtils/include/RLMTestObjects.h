...
@property RLMDictionary<NSString *, AllTypesObject *>
    <RLMString, AllTypesObject> *dictionary;
@end
...
@property RLMDictionary<NSString *, RLMDecimal128 *>
    <RLMString, RLMDecimal128> *decimalDict;
@property RLMDictionary<NSString *, RLMObjectId *>
    <RLMString, RLMObjectId> *objectIdDict;
@property RLMDictionary<NSString *, NSUUID *><RLMString, RLMUUID> *uuidDict;
@property RLMDictionary<NSString *, StringObject *>
    <RLMString, StringObject> *stringObjDict;
@end
...
@property RLMDictionary<NSString *, RLMDecimal128 *>
    <RLMString, RLMDecimal128> *decimalObj;
@property RLMDictionary<NSString *, RLMObjectId *>
    <RLMString, RLMObjectId> *objectIdObj;
@property RLMDictionary<NSString *, NSUUID *><RLMString, RLMUUID> *uuidObj;
@property RLMDictionary<NSString *, NSObject *>
    <RLMString, RLMValue> *anyBoolObj;
@property RLMDictionary<NSString *, NSObject *><RLMString, RLMValue> *anyIntObj;
@property RLMDictionary<NSString *, NSObject *>
    <RLMString, RLMValue> *anyFloatObj;
@property RLMDictionary<NSString *, NSObject *>
    <RLMString, RLMValue> *anyDoubleObj;
@property RLMDictionary<NSString *, NSObject *>
    <RLMString, RLMValue> *anyStringObj;
@property RLMDictionary<NSString *, NSObject *>
    <RLMString, RLMValue> *anyDataObj;
@property RLMDictionary<NSString *, NSObject *>
    <RLMString, RLMValue> *anyDateObj;
@property RLMDictionary<NSString *, NSObject *>
    <RLMString, RLMValue> *anyDecimalObj;
@property RLMDictionary<NSString *, NSObject *>
    <RLMString, RLMValue> *anyObjectIdObj;
@property RLMDictionary<NSString *, NSObject *>
    <RLMString, RLMValue> *anyUUIDObj;
@end
...
@property RLMDictionary<NSString *, EmployeeObject *>
    <RLMString, EmployeeObject> *employeeDict;
...
@property RLMDictionary<NSString *, CircleObject *>
    <RLMString, CircleObject> *circles;
@end
...
@property RLMDictionary<NSString *, StringObject *>
    <RLMString, StringObject> *stringDictionary;
@property RLMDictionary<NSString *, NSNumber *>
    <RLMString, RLMInt> *intDictionary;
@property RLMDictionary<NSString *, NSString *>
    <RLMString, RLMString> *primitiveStringDictionary;
@property RLMDictionary<NSString *, EmbeddedIntObject *>
    <RLMString, EmbeddedIntObject> *embeddedDictionary;
@property RLMDictionary<NSString *, IntObject *>
    <RLMString, IntObject> *intObjDictionary;
@end
...
@property RLMDictionary<NSString *, AggregateObject *>
    <RLMString, AggregateObject> *dictionary;
@end
...
@property NSInteger number;
@property RLMDictionary<NSString *, IntObject *>
    <RLMString, IntObject> *dictionary;
...
@property RLMDictionary<NSString *, PrimaryEmployeeObject *>
    <RLMString, PrimaryEmployeeObject> *employeeDict;
...
@property(nonatomic) RLMDictionary<NSString *, RenamedProperties *>
    <RLMString, RenamedProperties> *dictionary;
@end
...
@property(nonatomic) RLMDictionary<NSString *, RenamedProperties1 *>
    <RLMString, RenamedProperties1> *dictionary;
@end
...
@property(nonatomic) RLMDictionary<NSString *, RenamedProperties2 *>
    <RLMString, RenamedProperties2> *dictionary;
@end
