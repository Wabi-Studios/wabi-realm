...
#import <WabiRealm/RLMObject_Private.h>
...
+ (NSArray *)requiredProperties {
  return @[
    @"stringCol", @"dateCol", @"binaryCol", @"decimalCol", @"objectIdCol",
    @"uuidCol"
  ];
}
...
+ (NSDictionary *)values:(int)i
  ...
  NSMutableDictionary *dict = [NSMutableDictionary
      dictionaryWithDictionary:[self values:i stringObject:so]];
...
+ (NSArray *)requiredProperties {
  return @[
    ...
    @"dataObj", @"decimalObj", @"objectIdObj", @"uuidObj"
  ];
}
@end
...
+ (NSArray *)requiredProperties {
  return @[
    @"intObj",   @"floatObj",  @"doubleObj",   @"boolObj",      @"stringObj",
...
+ (NSDictionary *)_realmColumnNames {
  return @{@"intCol" : @"custom_intCol", @"stringCol" : @"custom_stringCol"};
}
@end
