...
/// The identifier of the inserted document if an upsert took place and the
/// document's primary key is an `ObjectId`.
@property(nonatomic, nullable, readonly) RLMObjectId *objectId
    __attribute__((deprecated(
        "Use documentId instead, which support all BSON types", "documentId")));
