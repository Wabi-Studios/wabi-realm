...
@class RLMObjectSchema, RLMPropertyDescriptor, RLMRealm, RLMNotificationToken,
    RLMPropertyChange;
typedef void (^RLMObjectChangeBlock)(
    BOOL deleted, NSArray<RLMPropertyChange *> *_Nullable changes,
    NSError *_Nullable error);
/**
 `RLMEmbeddedObject` is a base class used to define WabiRealm model objects.
 ...
 embedded objects cannot be directly created in or added to a WabiRealm.
 Instead, they can only be created as part of a parent object, or by assigning
 an unmanaged object to a parent object's property. Embedded objects are
...
/**
 ...
 Unmanaged embedded objects can be added to a WabiRealm by assigning them to an
 object property of a managed WabiRealm object or by adding them to a managed
 RLMArray.
 */
