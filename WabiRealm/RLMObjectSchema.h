...
/**
 This class represents WabiRealm model object schemas.

 When using WabiRealm, `RLMObjectSchema` instances allow performing migrations
 and introspecting the database's schema.
