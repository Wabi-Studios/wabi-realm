...
Whether you find a bug, typo or an API call that could be clarified, please [file an issue](https://github.com/Wabi-Studios/wabi-realm/issues) on our GitHub repository.
...
6. **Version of WabiRealm / Xcode / macOS**
...
$(test -e Podfile.lock && cat Podfile.lock | sed -nE 's/^  - (WabiRealm(Kit)? [^:]*):?/\1/p' || echo "(not in use here)")
...
We love contributions to WabiRealm! If you'd like to contribute code, documentation, or any other improvements, please [file a Pull Request](https://github.com/Wabi-Studios/wabi-realm/pulls) on our GitHub repository. Make sure to accept our [CLA](#cla) and to follow our [style guide](https://github.com/Wabi-Studios/wabi-realm/wiki/Objective-C-Style-Guide).
...
WabiRealm welcomes all contributions! The only requirement we have is that, like many other projects, we need to have a [Contributor License Agreement](https://en.wikipedia.org/wiki/Contributor_License_Agreement) (CLA) in place before we can accept any external code. Our own CLA is a modified version of the Apache Software Foundation’s CLA.
