...
Pod::Spec.new do |s|
  ...
  s.summary                 = 'WabiRealm is a modern data framework & database for iOS, macOS, tvOS & watchOS.'
  s.description             = <<-DESC
                              The WabiRealm Database, for Objective-C. (If you want to use WabiRealm from Swift, see the “WabiRealmKit” pod.)
  ...
  public_header_files       = 'include/WabiRealm.h',
  ...
  s.module_map              = 'WabiRealm/WabiRealm.modulemap'
  ...
  s.source_files            = private_header_files + ['WabiRealm/*.{m,mm}']
  s.private_header_files    = private_header_files
  s.header_mappings_dir     = 'include'
  s.pod_target_xcconfig     = { 'APPLICATION_EXTENSION_API_ONLY' => 'YES',
                                'CLANG_CXX_LANGUAGE_STANDARD' => 'c++20',
                                'CLANG_WARN_OBJC_IMPLICIT_RETAIN_SELF' => 'NO',
                                'OTHER_CPLUSPLUSFLAGS' => '-isystem "${PODS_ROOT}/WabiRealm/include/core" -fvisibility-inlines-hidden',
                                'OTHER_CPLUSPLUSFLAGS[arch=armv7]' => '-isystem "${PODS_ROOT}/WabiRealm/include/core" -fvisibility-inlines-hidden -fno-aligned-new',
                                'USER_HEADER_SEARCH_PATHS' => '"${PODS_ROOT}/WabiRealm/include" "${PODS_ROOT}/WabiRealm/include/WabiRealm"'
                              }
