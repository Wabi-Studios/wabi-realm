...
class ViewController: UIViewController {
  ...
  override func viewDidAppear(_ animated: Bool) {
    ...
    autoreleasepool {
      let configuration = WabiRealm.Configuration(encryptionKey: getKey() as Data)
    ...
    autoreleasepool {
      do {
        let configuration = WabiRealm.Configuration(encryptionKey: "1234567890123456789012345678901234567890123456789012345678901234".data(using: .utf8, allowLossyConversion: false))
  ...
  func getKey() -> NSData {
    ...
    let keychainIdentifier = "io.WabiRealm.EncryptionExampleKey"
