...
//
  ...
  // See https://github.com/Wabi-Studios/wabi-realm/issues/7060

  // Renaming tables is not supported yet: https://github.com/Wabi-Studios/wabi-realm/issues/2491
  ...
  let migrationBlock: MigrationBlock = { migration, oldSchemaVersion in
    ...
    if oldSchemaVersion == 2 {
      ...
      // Related issue: https://github.com/Wabi-Studios/wabi-realm/issues/6263
      migration.enumerateObjects(ofType: Person.className()) { oldObject, newObject in
      ...
      // Related issue: https://github.com/Wabi-Studios/wabi-realm/issues/6734
      ...
      // See https://github.com/Wabi-Studios/wabi-realm/issues/3686
  ...
  let migrationCheck: (WabiRealm) -> Void = { realm in
  ...
  let exampleData: (WabiRealm) -> Void = { realm in
