...
/**
 `PropertyType` is an enum describing all property types supported in WabiRealm models.

 For more information, see [Object Models and Schemas](https://www.mongodb.com/docs/wabi-realm/sdk/swift/fundamentals/object-models-and-schemas/).
...
/**
 An opaque token which is returned from methods which subscribe to changes to a WabiRealm.

 - see: `WabiRealm.observe(_:)`
 */
