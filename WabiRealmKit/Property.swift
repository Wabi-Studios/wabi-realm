...
/**
 `Property` instances represent properties managed by a WabiRealm in the context of an object schema. Such properties may be
 persisted to a WabiRealm file or computed from other data in the WabiRealm.

 When using WabiRealm, property instances allow performing migrations and introspecting the database's schema.
