...
/**
 `Schema` instances represent collections of model object schemas managed by a WabiRealm.

 When using WabiRealm, `Schema` instances allow performing migrations and introspecting the database's schema.
...
@frozen public struct Schema: CustomStringConvertible {
  ...
  /**
   An array of `ObjectSchema`s for all object types in the WabiRealm.
  ...
  /// Looks up and returns an `ObjectSchema` for the given class name in the WabiRealm, if it exists.
