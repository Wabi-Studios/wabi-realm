...
class SwiftUIObject: Object, ObjectKeyIdentifiable {
  @Persisted var list: WabiRealmKit.List<SwiftBoolObject>
  @Persisted var stringList: WabiRealmKit.List<SwiftStringObject>
  @Persisted var set: WabiRealmKit.MutableSet<SwiftBoolObject>
  @Persisted var map: Map<String, SwiftBoolObject?>
  @Persisted var primitiveList: WabiRealmKit.List<Int>
  @Persisted var primitiveSet: WabiRealmKit.MutableSet<Int>
...
class EmbeddedTreeSwiftUIObject1: EmbeddedObject, EmbeddedTreeObject, ObjectKeyIdentifiable {
  ...
  let children = WabiRealmKit.List<EmbeddedTreeObject2>()
}
