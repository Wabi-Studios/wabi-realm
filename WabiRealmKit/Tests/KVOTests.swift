...
class SwiftKVOObject: Object {
  ...
  @objc dynamic var binaryCol: Data = .init()
  @objc dynamic var dateCol: Date = .init(timeIntervalSince1970: 0)
  @objc dynamic var decimalCol: Decimal128 = .init(number: 1)
