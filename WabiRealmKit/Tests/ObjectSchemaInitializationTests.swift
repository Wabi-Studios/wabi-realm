...
class ObjectSchemaInitializationTests: TestCase {
  ...
  func testInvalidObjects() {
    ...
    assertThrows(RLMObjectSchema(forObjectClass: SwiftObjectWithManagedLazyProperty.self),
                 reason: "Lazy managed property 'foobar' is not allowed on a WabiRealm Swift object class.")
  ...
  func testCustomIndexableTypes() {
    ...
    func testPropertyPopulation() {
      ...
      assertType(Int?.none, .int, optional: true)
      assertType(Int8?.none, .int, optional: true)
      assertType(Int16?.none, .int, optional: true)
      assertType(Int32?.none, .int, optional: true)
      assertType(Int64?.none, .int, optional: true)
      assertType(Bool?.none, .bool, optional: true)
      assertType(Float?.none, .float, optional: true)
      assertType(Double?.none, .double, optional: true)
      assertType(String?.none, .string, optional: true)
      assertType(Data?.none, .data, optional: true)
      assertType(Date?.none, .date, optional: true)
      assertType(UUID?.none, .UUID, optional: true)
      assertType(Decimal128?.none, .decimal128, optional: true)
      assertType(ObjectId?.none, .objectId, optional: true)
      ...
      assertThrows(RLMProperty(name: "name", value: List<Object?>()),
                   reason: "List<WabiRealmKitObject> property 'name' must not be marked as optional.")
      assertThrows(RLMProperty(name: "name", value: MutableSet<Object?>()),
                   reason: "MutableSet<WabiRealmKitObject> property 'name' must not be marked as optional.")
      assertType(Object?.none, .object, optional: true, objectType: "WabiRealmKitObject")
      assertType(List<Object>(), .object, list: true, objectType: "WabiRealmKitObject", hasSelectors: false)
      assertType(MutableSet<Object>(), .object, set: true, objectType: "WabiRealmKitObject", hasSelectors: false)
    }

    func assertType<T: _Persistable>(_: T.Type, _ propertyType: PropertyType,
                                     optional: Bool = false, list: Bool = false,
    ...
    func testModernPropertyPopulation() {
      ...
      assertType(Object?.self, .object, optional: true, objectType: "WabiRealmKitObject")
      assertType(EmbeddedObject?.self, .object, optional: true, objectType: "WabiRealmKitEmbeddedObject")
      ...
      assertType(List<Object>.self, .object, list: true, objectType: "WabiRealmKitObject")
      assertType(List<EmbeddedObject>.self, .object, list: true, objectType: "WabiRealmKitEmbeddedObject")
      ...
      assertType(MutableSet<Object>.self, .object, set: true, objectType: "WabiRealmKitObject")
      assertType(MutableSet<EmbeddedObject>.self, .object, set: true, objectType: "WabiRealmKitEmbeddedObject")
      ...
      assertType(Map<String, Object?>.self, .object, optional: true, map: true, objectType: "WabiRealmKitObject")
      assertType(Map<String, EmbeddedObject?>.self, .object, optional: true, map: true, objectType: "WabiRealmKitEmbeddedObject")
      ...
      assertThrows(RLMProperty(name: "_name", value: Persisted<LinkingObjects<Object>>()),
                   reason: "LinkingObjects<WabiRealmKitObject> property 'name' must set the origin property name with @Persisted(originProperty: \"name\").")
      ...
      assertThrows(RLMProperty(name: "_name", value: Persisted<LinkingObjects<EmbeddedObject>>()),
                   reason: "LinkingObjects<WabiRealmKitEmbeddedObject> property 'name' must set the origin property name with @Persisted(originProperty: \"name\").")
      assertThrows(RLMProperty(name: "_name", value: Persisted<Map<String, Object>>()),
                   reason: "Map<String, WabiRealmKitObject> property 'name' must be marked as optional.")
...
extension Set: RealmOptionalType {
  public static func _rlmFromObjc(_: Any, insideOptional _: Bool) -> Set<Element>? {
    fatalError()
  }
