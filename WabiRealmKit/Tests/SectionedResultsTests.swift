...
class BasePrimitiveSectionedResultsTests<TestData: SectionedResultsTestData>: RLMTestCaseBase {
  ...
  override func setUp() {
    realm = try! WabiRealm(configuration: .init(inMemoryIdentifier: "BasePrimitiveSectionedResultsTests",
...
class BaseOptionalPrimitiveSectionedResultsTests<TestData: OptionalSectionedResultsTestData>: BaseSectionedResultsTests {
  override func setUp() {
    realm = try! WabiRealm(configuration: .init(inMemoryIdentifier: "BaseOptionalPrimitiveSectionedResultsTests",
                                                objectTypes: [ModernAllTypesObject.self]))
    obj = TestData.setupObject()
    try! realm?.write {
      realm?.add(obj!)
  ...
  private func assertOptional<T: RealmCollection>(_ collection: T, asending: Bool = true) where T.Element == TestData.Element? {
...
class SectionedResultsTestsBase: RLMTestCaseBase {
  func createObjects(_ r: WabiRealm? = nil) -> WabiRealm {
    ...
    o4.stringCol = "chalk"
    let realm = try! r ?? WabiRealm(configuration: .init(inMemoryIdentifier: "sectioned results test"))
    try! realm.write {
      realm.deleteAll()
...
class SectionedResultsTests: SectionedResultsTestsBase {
  ...
  func testObserveOnQueue() {
    ...
    let token = sectionedResults.observe(keyPaths: [\.stringCol],
                                         on: queue)
    { (changes: SectionedResultsChange) in
      switch changes {
      case let .initial(collection):
        XCTAssertEqual(collection.count, 3)
  ...
  func testFrozenSection() {
    ...
    func assert(ascending: Bool, beforeCount _: Int, afterCount _: Int, sectionKey: String) {
...
struct SectionedResultsTestDataInt: SectionedResultsTestData {
  ...
  static func orderedKeys(ascending _: Bool) -> [Int] {
    return [1, 0]
  }
...
struct SectionedResultsTestDataAnyRealmValue: SectionedResultsTestData {
  ...
  static func orderedKeys(ascending _: Bool) -> [String] {
...
struct SectionedResultsTestDataDate: SectionedResultsTestData {
  static var values: [Date] {
    [Date(timeIntervalSince1970: 1_656_547_200), // 6-30-22
     Date(timeIntervalSince1970: 1_653_868_800), // 5-30-22
     Date(timeIntervalSince1970: 1_651_276_800), // 4-30-22
     Date(timeIntervalSince1970: 1_650_412_800)] // 4-20-22
  }

  static var expectedSectionedValues: [Date: [Date]] {
    [Date(timeIntervalSince1970: 1_653_955_200): [Date(timeIntervalSince1970: 1_656_547_200)], // June
     Date(timeIntervalSince1970: 1_651_276_800): [Date(timeIntervalSince1970: 1_653_868_800)], // May
     Date(timeIntervalSince1970: 1_648_684_800): [Date(timeIntervalSince1970: 1_650_412_800), // April
                                                  Date(timeIntervalSince1970: 1_651_276_800)]]
  }

  static func orderedKeys(ascending: Bool) -> [Date] {
    let keys = [Date(timeIntervalSince1970: 1_648_684_800), Date(timeIntervalSince1970: 1_651_276_800), Date(timeIntervalSince1970: 1_653_955_200)]
...
struct SectionedResultsTestDataOptionalDate: OptionalSectionedResultsTestData {
  ...
  static func orderedKeysOpt(ascending: Bool) -> [Date?] {
    let keys = [nil, Date(timeIntervalSince1970: 1_648_684_800), Date(timeIntervalSince1970: 1_651_276_800), Date(timeIntervalSince1970: 1_653_955_200)]
    return ascending ? keys : keys.reversed()
  }
...
struct SectionedResultsTestDataBool: SectionedResultsTestData {
  ...
  static func results(_: ModernAllTypesObject) -> Results<Bool> {
...
struct SectionedResultsTestDataOptionalBool: OptionalSectionedResultsTestData {
  ...
  static func resultsOpt(_: ModernAllTypesObject) -> Results<Bool?> {
    fatalError("Not implemented")
  }
