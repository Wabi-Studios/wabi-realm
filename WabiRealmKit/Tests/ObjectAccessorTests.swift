...
class ObjectAccessorTests: TestCase {
  func setAndTestAllPropertiesViaNormalAccess(_ object: SwiftObject, _ optObject: SwiftOptionalObject) {
    ...
    object.floatCol = 16_777_217
    XCTAssertEqual(Double(object.floatCol), 16_777_216.0 as Double)

    object.doubleCol = 20
    XCTAssertEqual(object.doubleCol, 20)
    object.doubleCol = 20.2
    XCTAssertEqual(object.doubleCol, 20.2)
    object.doubleCol = 16_777_217
    XCTAssertEqual(object.doubleCol, 16_777_217)
  ...
  func setAndTestAllPropertiesViaSubscript(_ object: SwiftObject, _ optObject: SwiftOptionalObject) {
    ...
    object["floatCol"] = 16_777_217
    XCTAssertEqual(object["floatCol"] as! Float, 16_777_216 as Float)
    ...
    object["doubleCol"] = 16_777_217
    XCTAssertEqual(object["doubleCol"] as! Double, 16_777_217)
  ...
  func setAndTestAnyViaAccessorObjectWithCoercion(_ object: ObjectBase) {
    ...
    set(16_777_217 as Double)
    XCTAssertEqual(get() as! Double, 16_777_217)
  ...
  func setAndTestRealmPropertyViaAccessor(_ object: ObjectBase) {
    ...
    set(object, "otherFloat", 16_777_217 as Double)
    XCTAssertEqual(get(object, "otherFloat") as! Float, 16_777_216)
    ...
    set(object, "otherDouble", 16_777_217 as Double)
    XCTAssertEqual(get(object, "otherDouble") as! Double, 16_777_217)
  ...
  func setAndTestRealmOptionalViaAccessor(_ object: ObjectBase) {
    ...
    // 16777217 is not exactly representable as a float
    set(object, "optFloatCol", 16_777_217 as Double)
    XCTAssertEqual(get(object, "optFloatCol") as! Float, 16_777_216)
    ...
    set(object, "optDoubleCol", 16_777_217 as Double)
    XCTAssertEqual(get(object, "optDoubleCol") as! Double, 16_777_217)
