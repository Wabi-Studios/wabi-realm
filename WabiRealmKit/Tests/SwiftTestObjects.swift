...
class SwiftObject: Object {
  ...
  @objc dynamic var uuidCol: UUID = .init(uuidString: "137decc8-b300-4954-a233-f89909f4fd89")!
...
class SwiftPrimaryUUIDObject: Object, SwiftPrimaryKeyObjectType {
  @objc dynamic var uuidCol: UUID = .init(uuidString: "85d4fbee-6ec6-47df-bfa1-615931903d7e")!
  @objc dynamic var stringCol = ""
...
class SwiftPrimaryObjectIdObject: Object, SwiftPrimaryKeyObjectType {
  @objc dynamic var objectIdCol: ObjectId = .generate()
  @objc dynamic var intCol = 0
