...
class ModernObjectCreationTests: TestCase {
  ...
  func assertSetEquals<T: RealmCollectionValue>(_ set: MutableSet<T>, _ expected: [T]) {
  ...
  func assertEquivalent(_ actual: AnyRealmCollection<ModernAllTypesObject>,
                        _ expected: [ModernAllTypesObject],
  ...
  func assertMapEquals<T: RealmCollectionValue>(_ actual: Map<String, T>, _ expected: [String: T]) {
    XCTAssertEqual(actual.count, expected.count)
  ...
  func testCreateDefault() {
    ...
    let obj = try! realm.write {
      realm.create(ModernAllTypesObject.self)
    }
    verifyDefault(obj)
  }
  ...
  func testCreateWithArray() {
    ...
    arrayValues[0] = ObjectId.generate()
    let obj = try! realm.write {
      realm.create(ModernAllTypesObject.self, value: arrayValues)
    }
    verifyObject(obj)
  }
  ...
  func testCreateWithDictionary() {
    let realm = try! WabiRealm()
    let obj = try! realm.write {
      realm.create(ModernAllTypesObject.self, value: values!)
    }
    verifyObject(obj)
  }
  ...
  func testCreateWithObject() {
    let realm = try! WabiRealm()
    let obj = try! realm.write {
      realm.create(ModernAllTypesObject.self, value: ModernAllTypesObject(value: values!))
    }
    verifyObject(obj)
  }
  ...
  func testCreateNil() {
    let realm = try! WabiRealm()
    let obj = try! realm.write {
      realm.create(ModernAllTypesObject.self, value: nullValues())
    }
    verifyNil(obj)
  }
...
class ModernEnumObjectCreationTests: TestCase {
  ...
  func assertMapEqual<T: RealmCollectionValue>(_ actual: Map<String, T>, _ expected: [String: T]) {
    XCTAssertEqual(actual.count, expected.count)
    for (key, value) in expected {
      XCTAssertEqual(actual[key], value)
    }
  ...
  func testCreateDefault() {
    let realm = try! WabiRealm()
    let obj = try! realm.write {
      realm.create(ModernCollectionsOfEnums.self)
    }
    verifyDefault(obj)
  }
  ...
  func testCreateWithArray() {
    ...
    let arrayValues = ModernCollectionsOfEnums.sharedSchema()!.properties.map { values[$0.name] }
    let obj = try! realm.write {
      realm.create(ModernCollectionsOfEnums.self, value: arrayValues)
    }
    verifyObject(obj)
  }
  ...
  func testCreateWithDictionary() {
    let realm = try! WabiRealm()
    let obj = try! realm.write {
      realm.create(ModernCollectionsOfEnums.self, value: values)
    }
    verifyObject(obj)
  }
  ...
  func testCreateWithObject() {
    let realm = try! WabiRealm()
    let obj = try! realm.write {
      realm.create(ModernCollectionsOfEnums.self, value: ModernCollectionsOfEnums(value: values))
    }
    verifyObject(obj)
  }
