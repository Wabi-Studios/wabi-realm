...
class QueryTests: TestCase {
  ...
  private func getOrCreate<T: Object>(_: T.Type) -> T {
  ...
  override func setUp() {
    ...
    try! realm.write {
      ...
      objModernAllTypesObject.dateCol = Date(timeIntervalSince1970: 2_000_000)
      ...
      objAllCustomPersistableTypes.date = DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))
      ...
      objModernAllTypesObject.optDateCol = Date(timeIntervalSince1970: 2_000_000)
      ...
      objAllCustomPersistableTypes.optDate = DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))
      ...
      objModernAllTypesObject.arrayDate.append(objectsIn: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
      ...
      objCustomPersistableCollections.listDate.append(objectsIn: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
      ...
      objModernAllTypesObject.arrayOptDate.append(objectsIn: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
      ...
      objCustomPersistableCollections.listOptDate.append(objectsIn: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
      ...
      objModernAllTypesObject.setDate.insert(objectsIn: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
      ...
      objCustomPersistableCollections.setDate.insert(objectsIn: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
      ...
      objModernAllTypesObject.setOptDate.insert(objectsIn: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
      ...
      objCustomPersistableCollections.setOptDate.insert(objectsIn: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
      ...
      objModernAllTypesObject.mapDate["foo"] = Date(timeIntervalSince1970: 1_000_000)
      objModernAllTypesObject.mapDate["bar"] = Date(timeIntervalSince1970: 2_000_000)
      ...
      objCustomPersistableCollections.mapDate["foo"] = DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000))
      objCustomPersistableCollections.mapDate["bar"] = DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))
      ...
      objModernAllTypesObject.mapOptDate["foo"] = Date(timeIntervalSince1970: 1_000_000)
      objModernAllTypesObject.mapOptDate["bar"] = Date(timeIntervalSince1970: 2_000_000)
      ...
      objCustomPersistableCollections.mapOptDate["foo"] = DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000))
      objCustomPersistableCollections.mapOptDate["bar"] = DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))
  ...
  private func assertQuery<T: Object>(_: T.Type,
  ...
  private func assertQuery<T: Object>(_: T.Type, _ predicate: String,
                                      values: [Any] = [],
                                      count expectedCount: Int,
                                      _ query: (Query<T>) -> Query<Bool>)
  {
  ...
  func testEquals() {
    ...
    validateEquals("dateCol", \Query<ModernAllTypesObject>.dateCol, Date(timeIntervalSince1970: 2_000_000))
    ...
    validateEquals("date", \Query<AllCustomPersistableTypes>.date, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)))
    ...
    validateEquals("optDateCol", \Query<ModernAllTypesObject>.optDateCol, Date(timeIntervalSince1970: 2_000_000))
    ...
    validateEquals("optDate", \Query<AllCustomPersistableTypes>.optDate, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)))
  ...
  func testEqualAnyRealmValue() {
    ...
    setAnyRealmValueCol(with: .date(Date(timeIntervalSince1970: 1_000_000)), object: object)
    assertQuery("(anyCol == %@)", AnyRealmValue.date(Date(timeIntervalSince1970: 1_000_000)), count: 1) {
      $0.anyCol == .date(Date(timeIntervalSince1970: 1_000_000))
    }
  ...
  func testNotEqualAnyRealmValue() {
    ...
    setAnyRealmValueCol(with: .date(Date(timeIntervalSince1970: 1_000_000)), object: object)
    assertQuery("(anyCol != %@)", AnyRealmValue.date(Date(timeIntervalSince1970: 1_000_000)), count: 0) {
      $0.anyCol != .date(Date(timeIntervalSince1970: 1_000_000))
    }
    setAnyRealmValueCol(with: .object(circleObject), object: object)
  ...
  func validateNumericComparisons<Root: Object, T: _Persistable>(
    _ name: String, _ lhs: (Query<Root>) -> Query<T>,
    _ value: T, count: Int = 1, ltCount: Int = 0, gtCount: Int = 0
  ) where T.PersistedType: _QueryNumeric {
  ...
  func testNumericComparisons() {
    ...
    validateNumericComparisons("dateCol", \Query<ModernAllTypesObject>.dateCol, Date(timeIntervalSince1970: 2_000_000))
    ...
    validateNumericComparisons("date", \Query<AllCustomPersistableTypes>.date, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)))
    ...
    validateNumericComparisons("optDateCol", \Query<ModernAllTypesObject>.optDateCol, Date(timeIntervalSince1970: 2_000_000))
    ...
    validateNumericComparisons("optDate", \Query<AllCustomPersistableTypes>.optDate, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)))
  ...
  private func validateNumericContains<Root: Object, T: _RealmSchemaDiscoverable & OptionalProtocol>(
    _ name: String, _ lhs: (Query<Root>) -> Query<T>
  ) where T.Wrapped: Comparable & QueryValue {
  ...
  private func validateStringLike<Root: Object, T: _Persistable>(
    _ name: String, _ lhs: (Query<Root>) -> Query<T>, _ strings: [(T, Int, Int)], canMatch: Bool
  ) where T.PersistedType: _QueryString {
  ...
  func testCollectionContainsRange() {
    ...
    assertQuery(ModernAllTypesObject.self, "((arrayDate.@min >= %@) && (arrayDate.@max <= %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 1)
    {
      $0.arrayDate.contains(Date(timeIntervalSince1970: 1_000_000) ... Date(timeIntervalSince1970: 2_000_000))
    }
    assertQuery(ModernAllTypesObject.self, "((arrayDate.@min >= %@) && (arrayDate.@max < %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 0)
    {
      $0.arrayDate.contains(Date(timeIntervalSince1970: 1_000_000) ..< Date(timeIntervalSince1970: 2_000_000))
    }
    ...
    assertQuery(CustomPersistableCollections.self, "((listDate.@min >= %@) && (listDate.@max <= %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 1)
    {
      $0.listDate.persistableValue.contains(DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue ... DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue)
    }
    assertQuery(CustomPersistableCollections.self, "((listDate.@min >= %@) && (listDate.@max < %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 0)
    {
      $0.listDate.persistableValue.contains(DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue ..< DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue)
    }
    ...
    assertQuery(ModernAllTypesObject.self, "((arrayOptDate.@min >= %@) && (arrayOptDate.@max <= %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 1)
    {
      $0.arrayOptDate.contains(Date(timeIntervalSince1970: 1_000_000) ... Date(timeIntervalSince1970: 2_000_000))
    }
    assertQuery(ModernAllTypesObject.self, "((arrayOptDate.@min >= %@) && (arrayOptDate.@max < %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 0)
    {
    ...
    assertQuery(CustomPersistableCollections.self, "((listOptDate.@min >= %@) && (listOptDate.@max <= %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 1)
    {
      $0.listOptDate.persistableValue.contains(DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue ... DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue)
    }
    assertQuery(CustomPersistableCollections.self, "((listOptDate.@min >= %@) && (listOptDate.@max < %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 0)
    {
    ...
    assertQuery(ModernAllTypesObject.self, "((setDate.@min >= %@) && (setDate.@max <= %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 1)
    {
      $0.setDate.contains(Date(timeIntervalSince1970: 1_000_000) ... Date(timeIntervalSince1970: 2_000_000))
    }
    assertQuery(ModernAllTypesObject.self, "((setDate.@min >= %@) && (setDate.@max < %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 0)
    {
    ...
    assertQuery(CustomPersistableCollections.self, "((setDate.@min >= %@) && (setDate.@max <= %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 1)
    {
      $0.setDate.persistableValue.contains(DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue ... DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue)
    }
    assertQuery(CustomPersistableCollections.self, "((setDate.@min >= %@) && (setDate.@max < %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 0)
    {
    ...
    assertQuery(ModernAllTypesObject.self, "((setOptDate.@min >= %@) && (setOptDate.@max <= %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 1)
    {
      $0.setOptDate.contains(Date(timeIntervalSince1970: 1_000_000) ... Date(timeIntervalSince1970: 2_000_000))
    }
    assertQuery(ModernAllTypesObject.self, "((setOptDate.@min >= %@) && (setOptDate.@max < %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 0)
    {
    ...
    assertQuery(CustomPersistableCollections.self, "((setOptDate.@min >= %@) && (setOptDate.@max <= %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 1)
    {
      $0.setOptDate.persistableValue.contains(DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue ... DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue)
    }
    assertQuery(CustomPersistableCollections.self, "((setOptDate.@min >= %@) && (setOptDate.@max < %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 0)
    {
    ...
    assertQuery(ModernAllTypesObject.self, "((mapDate.@min >= %@) && (mapDate.@max <= %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 1)
    {
      $0.mapDate.contains(Date(timeIntervalSince1970: 1_000_000) ... Date(timeIntervalSince1970: 2_000_000))
    }
    assertQuery(ModernAllTypesObject.self, "((mapDate.@min >= %@) && (mapDate.@max < %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 0)
    {
    ...
    assertQuery(CustomPersistableCollections.self, "((mapDate.@min >= %@) && (mapDate.@max <= %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 1)
    {
      $0.mapDate.persistableValue.contains(DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue ... DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue)
    }
    assertQuery(CustomPersistableCollections.self, "((mapDate.@min >= %@) && (mapDate.@max < %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 0)
    {
    ...
    assertQuery(ModernAllTypesObject.self, "((mapOptDate.@min >= %@) && (mapOptDate.@max <= %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 1)
    {
      $0.mapOptDate.contains(Date(timeIntervalSince1970: 1_000_000) ... Date(timeIntervalSince1970: 2_000_000))
    }
    assertQuery(ModernAllTypesObject.self, "((mapOptDate.@min >= %@) && (mapOptDate.@max < %@))",
                values: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)], count: 0)
    {
    ...
    assertQuery(CustomPersistableCollections.self, "((mapOptDate.@min >= %@) && (mapOptDate.@max <= %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 1)
    {
      $0.mapOptDate.persistableValue.contains(DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue ... DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue)
    }
    assertQuery(CustomPersistableCollections.self, "((mapOptDate.@min >= %@) && (mapOptDate.@max < %@))",
                values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)).persistableValue, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)).persistableValue], count: 0)
    {
  ...
  func testListContainsAnyInObject() {
    ...
    assertQuery(ModernAllTypesObject.self, "(ANY arrayDate IN %@)",
                values: [NSArray(array: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])], count: 1)
    {
      $0.arrayDate.containsAny(in: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
    }
    ...
    assertQuery(CustomPersistableCollections.self, "(ANY listDate IN %@)",
                values: [NSArray(array: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])], count: 1)
    {
      $0.listDate.containsAny(in: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
    }
    ...
    assertQuery(ModernAllTypesObject.self, "(ANY arrayOptDate IN %@)",
                values: [NSArray(array: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])], count: 1)
    {
      $0.arrayOptDate.containsAny(in: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
    }
    ...
    assertQuery(CustomPersistableCollections.self, "(ANY listOptDate IN %@)",
                values: [NSArray(array: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])], count: 1)
    {
      $0.listOptDate.containsAny(in: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
    }
  ...
  func testCollectionFromProperty() {
    ...
    func test<Root: LinkToTestObject>(
      _: Root.Type, _ predicate: String, _ value: Any,
    ...
    test(LinkToModernAllTypesObject.self, "(dateCol == %@)",
         ...
         { $0.dateCol == Date(timeIntervalSince1970: 2_000_000) },
         { $0.dateCol == Date(timeIntervalSince1970: 2_000_000) })
    ...
    test(LinkToAllCustomPersistableTypes.self, "(date == %@)",
         DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)),
         { $0.date == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)) },
         { $0.date == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)) })
    ...
    test(LinkToModernAllTypesObject.self, "(optDateCol == %@)",
         Date(timeIntervalSince1970: 2_000_000),
         { $0.optDateCol == Date(timeIntervalSince1970: 2_000_000) },
         { $0.optDateCol == Date(timeIntervalSince1970: 2_000_000) })
    ...
    test(LinkToAllCustomPersistableTypes.self, "(optDate == %@)",
         DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)),
         { $0.optDate == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)) },
         { $0.optDate == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)) })
  ...
  func testSetContainsAnyInObject() {
    ...
    assertQuery(ModernAllTypesObject.self, "(ANY setDate IN %@)",
                values: [NSArray(array: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])], count: 1)
    {
      $0.setDate.containsAny(in: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
    }
    ...
    assertQuery(CustomPersistableCollections.self, "(ANY setDate IN %@)",
                values: [NSArray(array: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])], count: 1)
    {
      $0.setDate.containsAny(in: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
    }
    ...
    assertQuery(ModernAllTypesObject.self, "(ANY setOptDate IN %@)",
                values: [NSArray(array: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])], count: 1)
    {
      $0.setOptDate.containsAny(in: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
    }
    ...
    assertQuery(CustomPersistableCollections.self, "(ANY setOptDate IN %@)",
                values: [NSArray(array: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])], count: 1)
    {
      $0.setOptDate.containsAny(in: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
    }
  ...
  func testMapAllValues() {
    ...
    validateEquals("ANY mapDate.@allValues", \Query<ModernAllTypesObject>.mapDate.values, Date(timeIntervalSince1970: 1_000_000), notEqualCount: 1)
    validateNumericComparisons("ANY mapDate.@allValues", \Query<ModernAllTypesObject>.mapDate.values, Date(timeIntervalSince1970: 2_000_000), ltCount: 1)
    ...
    validateStringOperations("ANY mapString.@allValues", \Query<CustomPersistableCollections>.mapString.values,
                             (StringWrapper(persistedValue: "Foo"), StringWrapper(persistedValue: "Foo"), StringWrapper(persistedValue: "Foo")))
    { equals, options in
      // Non-enum maps have the keys Foo and Foó, so !=[d] doesn't match any
      if options.contains(.diacriticInsensitive) {
        return equals ? 1 : 0
    ...
    validateEquals("ANY mapDate.@allValues", \Query<CustomPersistableCollections>.mapDate.values, DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), notEqualCount: 1)
    validateNumericComparisons("ANY mapDate.@allValues", \Query<CustomPersistableCollections>.mapDate.values, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)), ltCount: 1)
    ...
    validateEquals("ANY mapOptDate.@allValues", \Query<ModernAllTypesObject>.mapOptDate.values, Date(timeIntervalSince1970: 1_000_000), notEqualCount: 1)
    validateNumericComparisons("ANY mapOptDate.@allValues", \Query<ModernAllTypesObject>.mapOptDate.values, Date(timeIntervalSince1970: 2_000_000), ltCount: 1)
    ...
    validateEquals("ANY mapOptDate.@allValues", \Query<CustomPersistableCollections>.mapOptDate.values, DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), notEqualCount: 1)
    validateNumericComparisons("ANY mapOptDate.@allValues", \Query<CustomPersistableCollections>.mapOptDate.values, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)), ltCount: 1)
  ...
  func testMapAllKeysAllValuesSubscript() {
    ...
    validateMapSubscriptEquality("mapDate", \Query<ModernAllTypesObject>.mapDate, value: Date(timeIntervalSince1970: 1_000_000))
    validateMapSubscriptNumericComparisons("mapDate", \Query<ModernAllTypesObject>.mapDate, value: Date(timeIntervalSince1970: 1_000_000))
    ...
    validateMapSubscriptEquality("mapDate", \Query<CustomPersistableCollections>.mapDate, value: DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)))
    validateMapSubscriptNumericComparisons("mapDate", \Query<CustomPersistableCollections>.mapDate, value: DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)))
    ...
    validateMapSubscriptEquality("mapOptDate", \Query<ModernAllTypesObject>.mapOptDate, value: Date(timeIntervalSince1970: 1_000_000))
    validateMapSubscriptNumericComparisons("mapOptDate", \Query<ModernAllTypesObject>.mapOptDate, value: Date(timeIntervalSince1970: 1_000_000))
    ...
    validateMapSubscriptEquality("mapOptDate", \Query<CustomPersistableCollections>.mapOptDate, value: DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)))
    validateMapSubscriptNumericComparisons("mapOptDate", \Query<CustomPersistableCollections>.mapOptDate, value: DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)))
  ...
  func testMapContainsAnyInObject() {
    ...
    assertQuery(ModernAllTypesObject.self, "(ANY mapDate IN %@)",
                values: [NSArray(array: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])], count: 1)
    {
      $0.mapDate.containsAny(in: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
    }
    ...
    assertQuery(CustomPersistableCollections.self, "(ANY mapDate IN %@)",
                values: [NSArray(array: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])], count: 1)
    {
      $0.mapDate.containsAny(in: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
    }
    ...
    assertQuery(ModernAllTypesObject.self, "(ANY mapOptDate IN %@)",
                values: [NSArray(array: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])], count: 1)
    {
      $0.mapOptDate.containsAny(in: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
    }
    ...
    assertQuery(CustomPersistableCollections.self, "(ANY mapOptDate IN %@)",
                values: [NSArray(array: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])], count: 1)
    {
      $0.mapOptDate.containsAny(in: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
    }
  ...
  func testCompoundOr() {
    ...
    assertQuery(ModernAllTypesObject.self, "((binaryCol == %@) || (dateCol == %@))", values: [Data(count: 128), Date(timeIntervalSince1970: 2_000_000)], count: 1) {
      $0.binaryCol == Data(count: 128) || $0.dateCol == Date(timeIntervalSince1970: 2_000_000)
    }
    assertQuery(ModernAllTypesObject.self, "((binaryCol == %@) || (dateCol == %@))", values: [Data(count: 128), Date(timeIntervalSince1970: 2_000_000)], count: 1) {
      ($0.binaryCol == Data(count: 128)) || ($0.dateCol == Date(timeIntervalSince1970: 2_000_000))
    }
    assertQuery(ModernAllTypesObject.self, "((dateCol == %@) || (decimalCol == %@))", values: [Date(timeIntervalSince1970: 2_000_000), Decimal128(234.567)], count: 1) {
      $0.dateCol == Date(timeIntervalSince1970: 2_000_000) || $0.decimalCol == Decimal128(234.567)
    }
    assertQuery(ModernAllTypesObject.self, "((dateCol == %@) || (decimalCol == %@))", values: [Date(timeIntervalSince1970: 2_000_000), Decimal128(234.567)], count: 1) {
      ($0.dateCol == Date(timeIntervalSince1970: 2_000_000)) || ($0.decimalCol == Decimal128(234.567))
    }
    ...
    assertQuery(AllCustomPersistableTypes.self, "((binary == %@) || (date == %@))", values: [DataWrapper(persistedValue: Data(count: 128)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))], count: 1) {
      $0.binary == DataWrapper(persistedValue: Data(count: 128)) || $0.date == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))
    }
    assertQuery(AllCustomPersistableTypes.self, "((binary == %@) || (date == %@))", values: [DataWrapper(persistedValue: Data(count: 128)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))], count: 1) {
      ($0.binary == DataWrapper(persistedValue: Data(count: 128))) || ($0.date == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)))
    }
    assertQuery(AllCustomPersistableTypes.self, "((date == %@) || (decimal == %@))", values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)), Decimal128Wrapper(persistedValue: Decimal128(234.567))], count: 1) {
      $0.date == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)) || $0.decimal == Decimal128Wrapper(persistedValue: Decimal128(234.567))
    }
    assertQuery(AllCustomPersistableTypes.self, "((date == %@) || (decimal == %@))", values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)), Decimal128Wrapper(persistedValue: Decimal128(234.567))], count: 1) {
      ($0.date == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))) || ($0.decimal == Decimal128Wrapper(persistedValue: Decimal128(234.567)))
    }
    ...
    assertQuery(ModernAllTypesObject.self, "((optBinaryCol == %@) || (optDateCol == %@))", values: [Data(count: 128), Date(timeIntervalSince1970: 2_000_000)], count: 1) {
      $0.optBinaryCol == Data(count: 128) || $0.optDateCol == Date(timeIntervalSince1970: 2_000_000)
    }
    assertQuery(ModernAllTypesObject.self, "((optBinaryCol == %@) || (optDateCol == %@))", values: [Data(count: 128), Date(timeIntervalSince1970: 2_000_000)], count: 1) {
      ($0.optBinaryCol == Data(count: 128)) || ($0.optDateCol == Date(timeIntervalSince1970: 2_000_000))
    }
    assertQuery(ModernAllTypesObject.self, "((optDateCol == %@) || (optDecimalCol == %@))", values: [Date(timeIntervalSince1970: 2_000_000), Decimal128(234.567)], count: 1) {
      $0.optDateCol == Date(timeIntervalSince1970: 2_000_000) || $0.optDecimalCol == Decimal128(234.567)
    }
    assertQuery(ModernAllTypesObject.self, "((optDateCol == %@) || (optDecimalCol == %@))", values: [Date(timeIntervalSince1970: 2_000_000), Decimal128(234.567)], count: 1) {
      ($0.optDateCol == Date(timeIntervalSince1970: 2_000_000)) || ($0.optDecimalCol == Decimal128(234.567))
    }
    ...
    assertQuery(AllCustomPersistableTypes.self, "((optBinary == %@) || (optDate == %@))", values: [DataWrapper(persistedValue: Data(count: 128)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))], count: 1) {
      $0.optBinary == DataWrapper(persistedValue: Data(count: 128)) || $0.optDate == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))
    }
    assertQuery(AllCustomPersistableTypes.self, "((optBinary == %@) || (optDate == %@))", values: [DataWrapper(persistedValue: Data(count: 128)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))], count: 1) {
      ($0.optBinary == DataWrapper(persistedValue: Data(count: 128))) || ($0.optDate == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)))
    }
    assertQuery(AllCustomPersistableTypes.self, "((optDate == %@) || (optDecimal == %@))", values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)), Decimal128Wrapper(persistedValue: Decimal128(234.567))], count: 1) {
      $0.optDate == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)) || $0.optDecimal == Decimal128Wrapper(persistedValue: Decimal128(234.567))
    }
    assertQuery(AllCustomPersistableTypes.self, "((optDate == %@) || (optDecimal == %@))", values: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)), Decimal128Wrapper(persistedValue: Decimal128(234.567))], count: 1) {
      ($0.optDate == DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))) || ($0.optDecimal == Decimal128Wrapper(persistedValue: Decimal128(234.567)))
    }
  ...
  func validateCompoundString<Root: Object, T: _Persistable, U: _Persistable>(
    _ name1: String, _ lhs1: (Query<Root>) -> Query<T>, _ value1: T,
    _ name2: String, _ lhs2: (Query<Root>) -> Query<U>, _ value2: U
  ) where U.PersistedType: _QueryBinary {
  ...
  func testCompoundMixed() {
    ...
    validateCompoundMixed("binaryCol", \Query<ModernAllTypesObject>.binaryCol, Data(count: 128),
                          "dateCol", \Query<ModernAllTypesObject>.dateCol, Date(timeIntervalSince1970: 2_000_000))
    validateCompoundMixed("dateCol", \Query<ModernAllTypesObject>.dateCol, Date(timeIntervalSince1970: 2_000_000),
    ...
    validateCompoundMixed("binary", \Query<AllCustomPersistableTypes>.binary, DataWrapper(persistedValue: Data(count: 128)),
                          "date", \Query<AllCustomPersistableTypes>.date, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)))
    validateCompoundMixed("date", \Query<AllCustomPersistableTypes>.date, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)),
    ...
    validateCompoundMixed("optBinaryCol", \Query<ModernAllTypesObject>.optBinaryCol, Data(count: 128),
                          "optDateCol", \Query<ModernAllTypesObject>.optDateCol, Date(timeIntervalSince1970: 2_000_000))
    validateCompoundMixed("optDateCol", \Query<ModernAllTypesObject>.optDateCol, Date(timeIntervalSince1970: 2_000_000),
    ...
    validateCompoundMixed("optBinary", \Query<AllCustomPersistableTypes>.optBinary, DataWrapper(persistedValue: Data(count: 128)),
                          "optDate", \Query<AllCustomPersistableTypes>.optDate, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)))
    validateCompoundMixed("optDate", \Query<AllCustomPersistableTypes>.optDate, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000)),
  ...
  func testAny() {
    ...
    assertQuery(ModernAllTypesObject.self, "(ANY arrayDate == %@)", Date(timeIntervalSince1970: 1_000_000), count: 1) {
      $0.arrayDate == Date(timeIntervalSince1970: 1_000_000)
    }
    ...
    assertQuery(CustomPersistableCollections.self, "(ANY listDate == %@)", DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), count: 1) {
      $0.listDate == DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000))
    }
    ...
    assertQuery(ModernAllTypesObject.self, "(ANY arrayOptDate == %@)", Date(timeIntervalSince1970: 1_000_000), count: 1) {
      $0.arrayOptDate == Date(timeIntervalSince1970: 1_000_000)
    }
    ...
    assertQuery(CustomPersistableCollections.self, "(ANY listOptDate == %@)", DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), count: 1) {
      $0.listOptDate == DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000))
    }
    ...
    assertQuery(ModernAllTypesObject.self, "(ANY setDate == %@)", Date(timeIntervalSince1970: 1_000_000), count: 1) {
      $0.setDate == Date(timeIntervalSince1970: 1_000_000)
    }
    ...
    assertQuery(CustomPersistableCollections.self, "(ANY setDate == %@)", DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), count: 1) {
      $0.setDate == DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000))
    }
    ...
    assertQuery(ModernAllTypesObject.self, "(ANY setOptDate == %@)", Date(timeIntervalSince1970: 1_000_000), count: 1) {
      $0.setOptDate == Date(timeIntervalSince1970: 1_000_000)
    }
    ...
    assertQuery(CustomPersistableCollections.self, "(ANY setOptDate == %@)", DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), count: 1) {
      $0.setOptDate == DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000))
    }
  ...
  func testKeypathCollectionAggregatesMin() {
    ...
    validateKeypathMin("doubleCol", min: 123.456, max: 345.678,
                       \Query<LinkToModernAllTypesObject>.list.doubleCol)
    validateKeypathMin("dateCol", min: Date(timeIntervalSince1970: 1_000_000), max: Date(timeIntervalSince1970: 3_000_000),
    ...
    validateKeypathMin("double", min: DoubleWrapper(persistedValue: 123.456), max: DoubleWrapper(persistedValue: 345.678),
                       \Query<LinkToAllCustomPersistableTypes>.list.double)
    validateKeypathMin("date", min: DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), max: DateWrapper(persistedValue: Date(timeIntervalSince1970: 3_000_000)),
    ...
    validateKeypathMin("optDoubleCol", min: 123.456, max: 345.678,
                       \Query<LinkToModernAllTypesObject>.list.optDoubleCol)
    validateKeypathMin("optDateCol", min: Date(timeIntervalSince1970: 1_000_000), max: Date(timeIntervalSince1970: 3_000_000),
    ...
    validateKeypathMin("optDouble", min: DoubleWrapper(persistedValue: 123.456), max: DoubleWrapper(persistedValue: 345.678),
                       \Query<LinkToAllCustomPersistableTypes>.list.optDouble)
    validateKeypathMin("optDate", min: DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), max: DateWrapper(persistedValue: Date(timeIntervalSince1970: 3_000_000)),
  ...
  func testKeypathCollectionAggregatesMax() {
    ...
    validateKeypathMax("doubleCol", min: 123.456, max: 345.678,
                       \Query<LinkToModernAllTypesObject>.list.doubleCol)
    validateKeypathMax("dateCol", min: Date(timeIntervalSince1970: 1_000_000), max: Date(timeIntervalSince1970: 3_000_000),
                       \Query<LinkToModernAllTypesObject>.list.dateCol)
    ...
    validateKeypathMax("double", min: DoubleWrapper(persistedValue: 123.456), max: DoubleWrapper(persistedValue: 345.678),
                       \Query<LinkToAllCustomPersistableTypes>.list.double)
    validateKeypathMax("date", min: DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), max: DateWrapper(persistedValue: Date(timeIntervalSince1970: 3_000_000)),
                       \Query<LinkToAllCustomPersistableTypes>.list.date)
    ...
    validateKeypathMax("optDoubleCol", min: 123.456, max: 345.678,
                       \Query<LinkToModernAllTypesObject>.list.optDoubleCol)
    validateKeypathMax("optDateCol", min: Date(timeIntervalSince1970: 1_000_000), max: Date(timeIntervalSince1970: 3_000_000),
                       \Query<LinkToModernAllTypesObject>.list.optDateCol)
    ...
    validateKeypathMax("optDouble", min: DoubleWrapper(persistedValue: 123.456), max: DoubleWrapper(persistedValue: 345.678),
                       \Query<LinkToAllCustomPersistableTypes>.list.optDouble)
    validateKeypathMax("optDate", min: DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), max: DateWrapper(persistedValue: Date(timeIntervalSince1970: 3_000_000)),
                       \Query<LinkToAllCustomPersistableTypes>.list.optDate)
  ...
  func testContainsIn() {
    ...
    assertQuery(ModernAllTypesObject.self, "(dateCol IN %@)",
                values: [NSArray(array: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])], count: 1)
    {
      $0.dateCol.in([Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
    }
    assertQuery(ModernAllTypesObject.self, "(NOT dateCol IN %@)",
                values: [NSArray(array: [Date(timeIntervalSince1970: 2_000_000)])], count: 0)
    {
      !$0.dateCol.in([Date(timeIntervalSince1970: 2_000_000)])
    }
    ...
    assertQuery(AllCustomPersistableTypes.self, "(date IN %@)",
                values: [NSArray(array: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])], count: 1)
    {
      $0.date.in([DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
    }
    assertQuery(AllCustomPersistableTypes.self, "(NOT date IN %@)",
                values: [NSArray(array: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])], count: 0)
    {
      !$0.date.in([DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
    }
    ...
    assertQuery(ModernAllTypesObject.self, "(optDateCol IN %@)",
                values: [NSArray(array: [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])], count: 1)
    {
      $0.optDateCol.in([Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000)])
    }
    assertQuery(ModernAllTypesObject.self, "(NOT optDateCol IN %@)",
                values: [NSArray(array: [Date(timeIntervalSince1970: 2_000_000)])], count: 0)
    {
      !$0.optDateCol.in([Date(timeIntervalSince1970: 2_000_000)])
    }
    ...
    assertQuery(AllCustomPersistableTypes.self, "(optDate IN %@)",
                values: [NSArray(array: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])], count: 1)
    {
      $0.optDate.in([DateWrapper(persistedValue: Date(timeIntervalSince1970: 1_000_000)), DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
    }
    assertQuery(AllCustomPersistableTypes.self, "(NOT optDate IN %@)",
                values: [NSArray(array: [DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])], count: 0)
    {
      !$0.optDate.in([DateWrapper(persistedValue: Date(timeIntervalSince1970: 2_000_000))])
    }
...
extension Date: QueryValue {
  static func queryValues() -> [Date] {
    return [Date(timeIntervalSince1970: 1_000_000), Date(timeIntervalSince1970: 2_000_000), Date(timeIntervalSince1970: 3_000_000)]
  }
}
...
extension Optional: AddableQueryValue where Wrapped: AddableQueryValue {
  fileprivate typealias SumType = Wrapped.SumType?
  fileprivate static func sum() -> SumType {
