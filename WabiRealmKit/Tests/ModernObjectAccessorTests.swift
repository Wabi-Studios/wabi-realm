...
class ModernObjectAccessorTests: TestCase {
  ...
  func setAndTestAllPropertiesViaNormalAccess(_ object: ModernAllTypesObject) {
    ...
    test(\.doubleCol, -Double.greatestFiniteMagnitude, Double.greatestFiniteMagnitude, 20, 20.2, 16_777_217)
    ...
    test(\.optDoubleCol, -Double.greatestFiniteMagnitude, Double.greatestFiniteMagnitude, 20, 20.2, 16_777_217, nil)
  ...
  func setAndTestAllPropertiesViaSubscript(_ object: ModernAllTypesObject) {
    func testNoConversion<T: Equatable>(_ keyPath: String, _: T.Type, _ values: T...) {
      for value in values {
    ...
    testNoConversion("doubleCol", Double.self, -Double.greatestFiniteMagnitude, Double.greatestFiniteMagnitude, 20, 20.2, 16_777_217)
    ...
    testNoConversion("optDoubleCol", Double?.self, -Double.greatestFiniteMagnitude, Double.greatestFiniteMagnitude, 20, 20.2, 16_777_217, nil)
  ...
  func assertMapEquals<T: RealmCollectionValue>(_ map: Map<String, T>, _ expected: [T]) {
  ...
  func testInvalidationChecking() {
    ...
    realm.invalidate()
    assertThrows(_ = obj.intCol, reason: "invalidated")
    assertThrows(obj.arrayInt.removeAll(), reason: "invalidated")
    assertThrows(obj.int8Col = 5, reason: "invalidated")
    assertThrows(obj.arrayInt8 = List<Int8>(), reason: "invalidated")
  }
