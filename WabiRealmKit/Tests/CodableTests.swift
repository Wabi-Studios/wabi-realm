...
final class CodableObject: Object, Codable {
  ...
  @objc dynamic var data: Data = .init()
...
class CodableTests: TestCase {
  ...
  func decode<T: RealmOptionalType & Codable & _RealmSchemaDiscoverable>(_: T.Type, _ str: String) -> RealmOptional<T> {
    return decode(RealmOptional<T>.self, str)
  }

  func decode<T: Codable>(_: T.Type, _ str: String) -> T {
