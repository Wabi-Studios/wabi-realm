...
/**
 `EmbeddedObject` is a base class used to define embedded WabiRealm model objects.
 ...
 embedded objects cannot be directly created in or added to a WabiRealm. Instead,
 ...
 ```
 */
public typealias EmbeddedObject = WabiRealmKitEmbeddedObject
extension EmbeddedObject: _RealmCollectionValueInsideOptional {
  ...
  /**
   ...
   An unmanaged embedded object can be added to a WabiRealm by assigning it to a property of a managed object or by adding it to a managed List.
  ...
  /// `invalidate()` is called on that WabiRealm.
  ...
  /**
   ...
   the WabiRealm that manages the object.
