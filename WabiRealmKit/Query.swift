...
public extension Query where T: RealmCollection {
  ...
  func containsAny<U: Sequence>(in collection: U) -> Query<Bool> where U.Element == T.Element {
    .init(.comparison(operator: .in, node, .constant(collection), options: []))
  }
}
...
public extension Query where T: RealmKeyedCollection {
  ...
  func containsAny<U: Sequence>(in collection: U) -> Query<Bool> where U.Element == T.Value {
    .init(.comparison(operator: .in, node, .constant(collection), options: []))
  }
...
public extension Query where T: _HasPersistedType, T.PersistedType: _QueryString {
  ...
  /**
   ...
   - parameter caseInsensitive: `true` if it is a case-insensitive search.
   */
  func like<U>(_ column: Query<U>, caseInsensitive: Bool = false) -> Query<Bool> {
...
public extension Query where T: _HasPersistedType, T.PersistedType: _QueryBinary {
  ...
  /**
   ...
   - parameter options: A Set of options used to evaluate the search query.
   */
  func starts<U>(with column: Query<U>, options: StringOptions = []) -> Query<Bool> {
  ...
  /**
   ...
   - parameter options: A Set of options used to evaluate the search query.
   */
  func ends<U>(with column: Query<U>, options: StringOptions = []) -> Query<Bool> {
  ...
  /**
   ...
   - parameter options: A Set of options used to evaluate the search query.
   */
  func equals<U>(_ column: Query<U>, options: StringOptions = []) -> Query<Bool> {
  ...
  /**
   ...
   - parameter options: A Set of options used to evaluate the search query.
   */
  func notEquals<U>(_ column: Query<U>, options: StringOptions = []) -> Query<Bool> {
